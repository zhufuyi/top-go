...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[casbin](https://github.com/hsluoyz/casbin) | 17.0k | Authorization library that supports access control models like ACL, RBAC, ABAC. |
...
| <b>[goth](https://github.com/markbates/goth) | 5.1k | provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box. |
...
| <b>[gologin](https://github.com/dghubble/gologin) | 1.8k | chainable handlers for login with OAuth1 and OAuth2 authentication providers. |
| <b>[gorbac](https://github.com/mikespook/gorbac) | 1.6k | provides a lightweight role-based access control (RBAC) implementation in Golang. |
| <b>[oidc](https://github.com/zitadel/oidc) | 1.2k | Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation |
| <b>[paseto](https://github.com/o1egl/paseto) | 813 | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
| <b>[jwt](https://github.com/cristalhq/jwt) | 647 | Safe, simple and fast JSON Web Tokens for Go. |
| <b>[go-guardian](https://github.com/shaj13/go-guardian) | 531 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
| <b>[permissions2](https://github.com/xyproto/permissions2) | 507 | Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. |
| <b>[jwt](https://github.com/pascaldekloe/jwt) | 351 | Lightweight JSON Web Token (JWT) library. |
| <b>[go-jose](https://github.com/go-jose/go-jose) | 274 | Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs. |
| <b>[jeff](https://github.com/abraithwaite/jeff) | 263 | Simple, flexible, secure and idiomatic web session management with pluggable backends. |
| <b>[jwt-auth](https://github.com/adam-hanna/jwt-auth) | 233 | JWT middleware for Golang http servers with many configuration options. |
| <b>[otpgen](https://github.com/grijul/otpgen) | 133 | Library to generate TOTP/HOTP codes. |
| <b>[sessionup](https://github.com/swithek/sessionup) | 124 | Simple, yet effective HTTP session management and identification package. |
| <b>[sjwt](https://github.com/brianvoe/sjwt) | 118 | Simple jwt generator and parser. |
| <b>[session](https://github.com/icza/session) | 116 | Go session management for web servers (including support for Google App Engine - GAE). |
| <b>[rbac](https://github.com/zpatrick/rbac) | 110 | Minimalistic RBAC package for Go applications. |
| <b>[branca](https://github.com/essentialkaos/branca) | 79 | branca token [specification implementation](https://github.com/tuupola/branca-spec) for Golang 1.15+. |
| <b>[securecookie](https://github.com/chmike/securecookie) | 77 | Efficient secure cookie encoding/decoding. |
| <b>[sessions](https://github.com/adam-hanna/sessions) | 77 | Dead simple, highly performant, highly customizable sessions service for go http servers. |
| <b>[otpgo](https://github.com/jltorresm/otpgo) | 66 | Time-Based One-Time Password (TOTP) and HMAC-Based One-Time Password (HOTP) library for Go. |
...
| <b>[telego](https://github.com/mymmrac/telego) | 428 | Telegram Bot API library for Golang with full one-to-one API implementation. |
...
| <b>[bubble-table](https://github.com/Evertras/bubble-table) | 336 | An interactive table component for bubbletea. |
...
| <b>[carapace](https://github.com/rsteube/carapace) | 260 | Command argument completion generator for spf13/cobra. |
...
| <b>[godotenv](https://github.com/joho/godotenv) | 7.7k | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
| <b>[kelseyhightower/envconfig](https://github.com/kelseyhightower/envconfig) | 4.9k | Go library for managing configuration data from environment variables. |
...
| <b>[kong](https://github.com/alecthomas/kong) | 1.9k | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
| <b>[cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 1.5k | Minimalistic configuration reader (from files, ENV, and wherever you want). |
| <b>[konfig](https://github.com/lalamove/konfig) | 647 | Composable, observable and performant config handling for Go for the distributed processing era. |
| <b>[xdg](https://github.com/adrg/xdg) | 597 | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
| <b>[gookit/config](https://github.com/gookit/config) | 523 | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| <b>[aconfig](https://github.com/cristalhq/aconfig) | 521 | Simple, useful and opinionated config loader. |
| <b>[confita](https://github.com/heetch/confita) | 490 | Load configuration in cascade from multiple backends into a struct. |
| <b>[fig](https://github.com/kkyr/fig) | 367 | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
| <b>[GoLobby/Config](https://github.com/golobby/config) | 359 | GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language. |
| <b>[config](https://github.com/JeremyLoy/config) | 336 | Cloud native application configuration. Bind ENV to structs in only two lines. |
| <b>[hjson](https://github.com/hjson/hjson-go) | 324 | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
| <b>[store](https://github.com/tucnak/store) | 276 | Lightweight configuration manager for Go. |
| <b>[config](https://github.com/olebedev/config) | 269 | JSON or YAML configuration wrapper with environment variables and flags parsing. |
| <b>[envconfig](https://github.com/vrischmann/envconfig) | 238 | Read your configuration from environment variables. |
...
| <b>[konf](https://github.com/nil-go/konf) | 192 | The simplest API for reading/watching config from file, env, flag and clouds (e.g. AWS, Azure, GCP). |
...
| <b>[harvester](https://github.com/beatlabs/harvester) | 130 | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
| <b>[onion](https://github.com/goraz/onion) | 115 | Layer based configuration for Go, Supports JSON, TOML, YAML, properties, etcd, env, and encryption using PGP. |
| <b>[configuration](https://github.com/BoRuDar/configuration) | 108 | Library for initializing configuration structs from env variables, files, flags and 'default' tag. |
| <b>[envcfg](https://github.com/tomazk/envcfg) | 103 | Un-marshaling environment variables to Go structs. |
| <b>[envh](https://github.com/antham/envh) | 99 | Helpers to manage environment variables. |
| <b>[configuro](https://github.com/sherifabdlnaby/configuro) | 92 | opinionated configuration loading & validation framework from ENV and Files focused towards 12-Factor compliant applications. |
...
| <b>[hocon](https://github.com/gurkankaymak/hocon) | 72 | Configuration library for working with the HOCON(a human-friendly JSON superset) format, supports features like environment variables, referencing other values, comments and multiple files. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[prometheus](https://github.com/prometheus/prometheus) | 53.0k | Monitoring system and time series database. |
...
| <b>[dolt](https://github.com/dolthub/dolt) | 17.0k | Dolt – It's Git for Data. |
...
| <b>[immudb](https://github.com/codenotary/immudb) | 8.5k | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| <b>[bbolt](https://github.com/etcd-io/bbolt) | 7.8k | An embedded key/value database for Go. |
...
| <b>[godis](https://github.com/hdt3213/godis) | 3.4k | A Golang implemented high-performance Redis server and cluster. |
| <b>[nutsdb](https://github.com/xujiajun/nutsdb) | 3.3k | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
...
| <b>[lotusdb](https://github.com/flower-corp/lotusdb) | 2.0k | Fast k/v database compatible with lsm and b+tree. |
| <b>[CovenantSQL](https://github.com/CovenantSQL/CovenantSQL) | 1.5k | CovenantSQL is a SQL database on blockchain. |
| <b>[column](https://github.com/kelindar/column) | 1.4k | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
| <b>[diskv](https://github.com/peterbourgon/diskv) | 1.4k | Home-grown disk-backed key-value store. |
...
| <b>[objectbox-go](https://github.com/objectbox/objectbox-go) | 1000 | High-performance embedded Object Database (NoSQL) with Go API. |
| <b>[eliasdb](https://github.com/krotik/eliasdb) | 993 | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| <b>[moss](https://github.com/couchbase/moss) | 946 | Moss is a simple LSM key-value storage engine written in 100% Go. |
| <b>[clover](https://github.com/ostafen/clover) | 616 | A lightweight document-oriented NoSQL database written in pure Golang. |
| <b>[levigo](https://github.com/jmhodges/levigo) | 413 | Levigo is a Go wrapper for LevelDB. |
...
| <b>[go-anytime](https://github.com/ijt/go-anytime) | 18 | Parse dates/times like "next dec 22nd at 3pm" and ranges like "from today until next thursday" without knowing the format in advance. |
...
| <b>[rain](https://github.com/cenkalti/rain) | 935 | BitTorrent client and library. |
...
| <b>[smtpmock](https://github.com/mocktools/go-smtp-mock) | 117 | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
| <b>[go-dkim](https://github.com/toorop/go-dkim) | 94 | DKIM library, to sign & verify email. |
| <b>[truemail-go](https://github.com/truemail-rb/truemail-go) | 89 | Configurable Golang email validator/verifier. Verify email via Regex, DNS, SMTP and even more. |
| <b>[smtp](https://github.com/mailhog/smtp) | 74 | SMTP server protocol state machine. |
| <b>[go-email-validator](https://github.com/go-email-validator/go-email-validator) | 51 | Modular email validator for syntax, disposable, smtp, etc... checking. |
| <b>[mailx](https://github.com/valord577/mailx) | 15 | Mailx is a library that makes it easier to send email via SMTP. It is an enhancement of the golang standard library `net/smtp`. |
...
| <b>[goja](https://github.com/dop251/goja) | 5.0k | ECMAScript 5.1(+) implementation in Go. |
| <b>[tengo](https://github.com/d5/tengo) | 3.5k | Bytecode compiled script language for Go. |
...
| <b>[metacall](https://github.com/metacall/core) | 1.5k | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
| <b>[anko](https://github.com/mattn/anko) | 1.4k | Scriptable interpreter written in Go. |
| <b>[go-php](https://github.com/deuill/go-php) | 923 | PHP bindings for Go. |
| <b>[go-duktape](https://github.com/olebedev/go-duktape) | 778 | Duktape JavaScript engine bindings for Go. |
| <b>[Wa/凹语言](https://github.com/wa-lang/wa) | 747 | The Wa Programming Language embedded in Go. |
| <b>[gval](https://github.com/PaesslerAG/gval) | 704 | A highly customizable expression language written in Go. |
| <b>[golua](https://github.com/aarzilli/golua) | 637 | Go bindings for Lua C API. |
| <b>[prolog](https://github.com/ichiban/prolog) | 546 | Embeddable Prolog. |
| <b>[gisp](https://github.com/jcla1/gisp) | 511 | Simple LISP in Go. |
| <b>[gentee](https://github.com/gentee/gentee) | 130 | Embeddable scripting programming language. |
| <b>[binder](https://github.com/alexeyco/binder) | 74 | Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua). |
| <b>[purl](https://github.com/ian-kent/purl) | 41 | Perl 5.18.2 embedded in Go. |
| <b>[ecal](https://github.com/krotik/ecal) | 40 | A simple embeddable scripting language which supports concurrent event processing. |
| <b>[ngaro](https://github.com/db47h/ngaro) | 26 | Embeddable Ngaro VM implementation enabling scripting in Retro. |
| <b>[starlet](https://github.com/1set/starlet) | 9 | Go wrapper for [starlark-go](https://github.com/google/starlark-go) that simplifies script execution, offers data conversion, and useful Starlark libraries and extensions. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[errors](https://github.com/pkg/errors) | 8.2k | Package that provides simple error handling primitives. |
| <b>[go-multierror](https://github.com/hashicorp/go-multierror) | 2.2k | Go (golang) package for representing a list of errors as a single error. |
| <b>[errors](https://github.com/cockroachdb/errors) | 2.0k | Go error library with error portability over the network. |
| <b>[eris](https://github.com/rotisserie/eris) | 1.5k | A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors. |
...
| <b>[tracerr](https://github.com/ztrue/tracerr) | 926 | Golang errors with stack trace and source fragments. |
| <b>[errlog](https://github.com/snwfdhmp/errlog) | 457 | Hackable package that determines responsible source code for an error (and some other fast-debugging features). Pluggable to any logger in-place. |
| <b>[emperror](https://github.com/emperror/emperror) | 330 | Error handling tools and best practices for Go libraries and applications. |
| <b>[oops](https://github.com/samber/oops) | 212 | Error handling with context, stack trace and source fragments. |
| <b>[errors](https://github.com/emperror/errors) | 192 | Drop-in replacement for the standard library errors package and github.com/pkg/errors. Provides various error handling primitives. |
| <b>[Fault](https://github.com/Southclaws/fault) | 150 | An ergonomic mechanism for wrapping errors in order to facilitate structured metadata and context for error values. |
| <b>[errors](https://github.com/bnkamalesh/errors) | 61 | Drop-in replacement for builting Go errors. This is a minimal error handling package with custom error types, user friendly messages, Unwrap & Is. With very easy to use and straightforward helper functions. |
| <b>[exception](https://github.com/rbrahul/exception) | 28 | A simple utility package for exception handling with try-catch in Golang. |
...
| <b>[gdu](https://github.com/dundee/gdu) | 3.4k | Disk usage analyzer with console interface. |
| <b>[notify](https://github.com/rjeczalik/notify) | 888 | File system event notification library with simple API, similar to os/signal. |
| <b>[copy](https://github.com/otiai10/copy) | 687 | Copy directory recursively. |
| <b>[gofs](https://github.com/no-src/gofs) | 427 | A file synchronization tool out of the box. |
| <b>[afs](https://github.com/viant/afs) | 291 | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
| <b>[vfs](https://github.com/C2FO/vfs) | 280 | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
| <b>[iso9660](https://github.com/kdomanski/iso9660) | 250 | A package for reading and creating ISO9660 disk images |
| <b>[bigfile](https://github.com/bigfile/bigfile) | 249 | A file transfer system, support to manage files with http api, rpc call and ftp client. |
| <b>[go-exiftool](https://github.com/barasher/go-exiftool) | 232 | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
| <b>[go-csv-tag](https://github.com/artonge/go-csv-tag) | 116 | Load csv file using tag. |
| <b>[checksum](https://github.com/codingsince1985/checksum) | 101 | Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files. |
| <b>[parquet](https://github.com/parsyl/parquet) | 100 | Read and write [parquet](https://parquet.apache.org) files. |
| <b>[skywalker](https://github.com/dixonwille/skywalker) | 97 | Package to allow one to concurrently go through a filesystem with ease. |
...
| <b>[baraka](https://github.com/xis/baraka) | 53 | A library to process http file uploads easily. |
| <b>[go-gtfs](https://github.com/artonge/go-gtfs) | 40 | Load gtfs files in go. |
...
| <b>[go-decent-copy](https://github.com/hugocarreira/go-decent-copy) | 22 | Copy files for humans. |
| <b>[higgs](https://github.com/dastoori/higgs) | 21 | A tiny cross-platform Go library to hide/unhide files and directories. |
| <b>[todotxt](https://github.com/1set/todotxt) | 21 | Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt). |
...
| <b>[go-money](https://github.com/rhymond/go-money) | 1.5k | Implementation of Fowler's Money pattern. |
| <b>[bbgo](https://github.com/c9s/bbgo) | 1.1k | A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies. |
| <b>[accounting](https://github.com/leekchan/accounting) | 867 | money and currency formatting for golang. |
| <b>[techan](https://github.com/sdcoffey/techan) | 803 | Technical analysis library with advanced market analysis and trading strategies. |
| <b>[go-finance](https://github.com/FlashBoys/go-finance) | 536 | Comprehensive financial markets data in Go. |
| <b>[currency](https://github.com/bojanz/currency) | 495 | Handles currency amounts, provides currency information and formatting. |
| <b>[ach](https://github.com/moov-io/ach) | 439 | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
| <b>[orderbook](https://github.com/i25959341/orderbook) | 407 | Matching Engine for Limit Order Book in Golang. |
| <b>[go-finance](https://github.com/alpeb/go-finance) | 166 | Library of financial functions for time value of money (annuities), cash flow, interest rate conversions, bonds and depreciation calculations. |
| <b>[sleet](https://github.com/BoltApp/sleet) | 139 | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
| <b>[ofxgo](https://github.com/aclindsa/ofxgo) | 133 | Query OFX servers and/or parse the responses (with example command-line client). |
| <b>[transaction](https://github.com/claygod/transaction) | 129 | Embedded transactional database of accounts, running in multithreaded mode. |
| <b>[vat](https://github.com/dannyvankooten/vat) | 110 | VAT number validation & EU VAT rates. |
| <b>[go-finnhub](https://github.com/m1/go-finnhub) | 90 | Client for stock market, forex and crypto data from finnhub.io. Access real-time financial market data from 60+ stock exchanges, 10 forex brokers, and 15+ crypto exchanges. |
| <b>[payme](https://github.com/jovandeginste/payme) | 83 | QR code generator (ASCII & PNG) for SEPA payments. |
| <b>[currency](https://github.com/bnkamalesh/currency) | 59 | High performant & accurate currency computation package. |
| <b>[fastme](https://github.com/newity/fastme) | 37 | Fast extensible matching engine Go implementation. |
| <b>[decimal](https://github.com/govalues/decimal) | 34 | Immutable decimal numbers with panic-free arithmetic. |
| <b>[fpdecimal](https://github.com/nikolaydubina/fpdecimal) | 29 | Fast and precise serialization and arithmetic for small fixed-point decimals |
| <b>[go-finance](https://github.com/pieterclaerhout/go-finance) | 27 | Module to fetch exchange rates, check VAT numbers via VIES and check IBAN bank account numbers. |
| <b>[fpmoney](https://github.com/nikolaydubina/fpmoney) | 24 | Fast and simple ISO4217 fixed-point decimal money. |
| <b>[money](https://github.com/govalues/money) | 15 | Immutable monetary amounts and exchange rates with panic-free arithmetic. |
| <b>[go-nowpayments](https://github.com/matm/go-nowpayments) | 3 | Library for the crypto NOWPayments API. |
| <b>[swift](https://code.pfad.fr/swift/) | - | Offline validity check of IBAN (International Bank Account Number) and retrieval of BIC (for some countries). |
...
| <b>[gorilla/csrf](https://github.com/gorilla/csrf) | 1000 | CSRF protection for Go web applications & services. |
| <b>[binding](https://github.com/mholt/binding) | 796 | Binds form and JSON data from net/http Request to struct. |
| <b>[form](https://github.com/go-playground/form) | 711 | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
| <b>[conform](https://github.com/leebenson/conform) | 317 | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
| <b>[httpin](https://github.com/ggicci/httpin) | 280 | Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc. |
| <b>[formam](https://github.com/monoculum/formam) | 187 | decode form's values into a struct. |
| <b>[forms](https://github.com/albrow/forms) | 137 | Framework-agnostic library for parsing and validating form/JSON data which supports multipart forms and files. |
| <b>[qs](https://github.com/sonh/qs) | 74 | Go module for encoding structs into URL query parameters. |
...
| <b>[checker](https://github.com/cinar/checker) | 8 | Checker helps validating user input through rules defined in struct tags or directly through functions. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[mo](https://github.com/samber/mo) | 2.3k | Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...). |
...
| <b>[fpGo](https://github.com/TeaEntityLab/fpGo) | 343 | Monad, Functional Programming features for Golang. |
| <b>[go-functional](https://github.com/BooleanCat/go-functional) | 314 | Functional programming in Go using generics |
| <b>[fp-go](https://github.com/repeale/fp-go) | 290 | Collection of Functional Programming helpers powered by Golang 1.18+ generics. |
| <b>[gofp](https://github.com/rbrahul/gofp) | 145 | A lodash like powerful utility library for Golang. |
| <b>[fuego](https://github.com/seborama/fuego) | 141 | Functional Experiment in Go. |
| <b>[underscore](https://github.com/rjNemo/underscore) | 107 | Functional programming helpers for Go 1.18 and beyond. |
...
| <b>[go-sdl2](https://github.com/veandco/go-sdl2) | 2.2k | Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/). |
| <b>[Pitaya](https://github.com/topfreegames/pitaya) | 2.2k | Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK. |
...
| <b>[raylib-go](https://github.com/gen2brain/raylib-go) | 1.4k | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| <b>[Azul3D](https://github.com/azul3d/engine) | 603 | 3D game engine written in Go. |
| <b>[go-astar](https://github.com/beefsack/go-astar) | 587 | Go implementation of the A\* path finding algorithm. |
| <b>[Harfang3D](https://github.com/harfang3d/harfang3d) | 518 | 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev](github.com/harfang3d/harfang-go)). |
| <b>[go3d](https://github.com/ungerik/go3d) | 295 | Performance oriented 2D/3D math package for Go. |
| <b>[tile](https://github.com/kelindar/tile) | 139 | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
| <b>[prototype](https://github.com/gonutz/prototype) | 87 | Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API. |
| <b>[fantasyname](https://github.com/s0rg/fantasyname) | 32 | Fantasy names generator. |
...
| <b>[go-linq](https://github.com/ahmetalpbalkan/go-linq) | 3.5k | .NET LINQ-like query methods for Go. |
| <b>[jennifer](https://github.com/dave/jennifer) | 3.2k | Generate arbitrary Go code without templates. |
| <b>[goderive](https://github.com/awalterschulze/goderive) | 1.2k | Derives functions from input types. |
| <b>[GoWrap](https://github.com/hexdigest/gowrap) | 969 | Generate decorators for Go interfaces using simple templates. |
| <b>[go-enum](https://github.com/abice/go-enum) | 670 | Code generation for enums from code comments. |
| <b>[goverter](https://github.com/jmattheis/goverter) | 450 | Generate converters by defining an interface. |
| <b>[interfaces](https://github.com/rjeczalik/interfaces) | 420 | Command line tool for generating interface definitions. |
| <b>[copygen](https://github.com/switchupcb/copygen) | 334 | Generate type-to-type code without reflection. |
| <b>[gotype](https://github.com/wzshiming/gotype) | 59 | Golang source code parsing, usage like reflect package. |
...
| <b>[convergen](https://github.com/reedom/convergen) | 30 | Feature rich type-to-type copy code generator. |
...
| <b>[mbtileserver](https://github.com/consbio/mbtileserver) | 608 | A simple Go-based server for map tiles stored in mbtiles format. |
| <b>[geoos](https://github.com/spatial-go/geoos) | 604 | A library provides spatial data and geometric algorithms. |
| <b>[osm](https://github.com/paulmach/osm) | 343 | Library for reading, writing and working with OpenStreetMap data and APIs. |
| <b>[H3](https://github.com/uber/h3-go) | 284 | Go bindings for H3, a hierarchical hexagonal geospatial indexing system. |
| <b>[simplefeatures](https://github.com/peterstace/simplefeatures) | 121 | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
| <b>[godal](https://github.com/airbusgeo/godal) | 120 | Go wrapper for GDAL. |
| <b>[WGS84](https://github.com/wroge/wgs84) | 115 | Library for Coordinate Conversion and Transformation (ETRS89, OSGB36, NAD83, RGF93, Web Mercator, UTM). |
| <b>[geoserver](https://github.com/hishamkaram/geoserver) | 86 | geoserver Is a Go Package For Manipulating a GeoServer Instance via the GeoServer REST API. |
| <b>[gismanager](https://github.com/hishamkaram/gismanager) | 53 | Publish Your GIS Data(Vector Data) to PostGIS and Geoserver. |
| <b>[pbf](https://github.com/maguro/pbf) | 48 | OpenStreetMap PBF golang encoder/decoder. |
| <b>[S2 geojson](https://github.com/pantrif/s2-geojson) | 27 | Convert geojson to s2 cells & demonstrating some S2 geometry features on map. |
| <b>[Web-Mercator-Projection](https://github.com/jorelosorio/web-mercator-projection) | 7 | A project to easily use and convert LonLat, Point and Tile to display info, markers, etc, in a map using the Web Mercator Projection. |
...
| <b>[tardisgo](https://github.com/tardisgo/tardisgo) | 431 | Golang to Haxe to CPP/CSharp/Java/JavaScript transpiler. |
| <b>[c4go](https://github.com/Konstantin8105/c4go) | 357 | Transpile C code to Go code. |
| <b>[c2go](https://github.com/goplus/c2go) | 307 | Convert C code to Go code. |
| <b>[esp32](https://github.com/andygeiss/esp32-transpiler) | 82 | Transpile Go into Arduino code. |
| <b>[f4go](https://github.com/Konstantin8105/f4go) | 42 | Transpile FORTRAN 77 code to Go code. |
...
| <b>[conc](https://github.com/sourcegraph/conc) | 8.5k | `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer. |
...
| <b>[pond](https://github.com/alitto/pond) | 1.3k | Minimalistic and High-performance goroutine worker pool written in Go. |
| <b>[workerpool](https://github.com/gammazero/workerpool) | 1.3k | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| <b>[grpool](https://github.com/ivpusic/grpool) | 740 | Lightweight Goroutine pool. |
| <b>[pool](https://github.com/go-playground/pool) | 721 | Limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation. |
| <b>[gowp](https://github.com/xxjwxc/gowp) | 492 | gowp is concurrency limiting goroutine pool. |
| <b>[flowmatic](https://github.com/carlmjohnson/flowmatic) | 324 | Structured concurrency made easy. |
| <b>[go-floc](https://github.com/workanator/go-floc) | 268 | Orchestrate goroutines with ease. |
| <b>[go-flow](https://github.com/kamildrazkiewicz/go-flow) | 218 | Control goroutines execution order. |
| <b>[routine](https://github.com/timandy/routine) | 196 | `routine` is a `ThreadLocal` for go library. It encapsulates and provides some easy-to-use, non-competitive, high-performance `goroutine` context access interfaces, which can help you access coroutine context information more gracefully. |
| <b>[artifex](https://github.com/borderstech/artifex) | 187 | Simple in-memory job queue for Golang using worker-based dispatching. |
| <b>[async](https://github.com/reugn/async) | 187 | An alternative sync library for Go (Future, Promise, Locks). |
| <b>[semaphore](https://github.com/marusama/semaphore) | 169 | Fast resizable semaphore implementation based on CAS (faster than channel-based semaphore implementations). |
| <b>[go-workers](https://github.com/catmullet/go-workers) | 163 | Easily and safely run workers for large data processing pipelines. |
| <b>[neilotoole/errgroup](https://github.com/neilotoole/errgroup) | 159 | Drop-in alternative to `sync/errgroup`, limited to a pool of N worker goroutines. |
| <b>[cyclicbarrier](https://github.com/marusama/cyclicbarrier) | 139 | CyclicBarrier for golang. |
| <b>[async](https://github.com/studiosol/async) | 134 | A safe way to execute functions asynchronously, recovering them in case of panic. |
| <b>[go-actor](https://github.com/vladopajic/go-actor) | 122 | A tiny library for writing concurrent programs using actor model. |
| <b>[gollback](https://github.com/vardius/gollback) | 120 | asynchronous simple function utilities, for managing execution of closures and callbacks. |
| <b>[threadpool](https://github.com/shettyh/threadpool) | 101 | Golang threadpool implementation. |
| <b>[Hunch](https://github.com/AaronJan/Hunch) | 99 | Hunch provides functions like: `All`, `First`, `Retry`, `Waterfall` etc., that makes asynchronous flow control more intuitive. |
| <b>[semaphore](https://github.com/kamilsk/semaphore) | 97 | Semaphore pattern implementation with timeout of lock/unlock operations based on channel and context. |
...
| <b>[goccm](https://github.com/zenthangplus/goccm) | 70 | Go Concurrency Manager package limits the number of goroutines that allowed to run concurrently. |
| <b>[gowl](https://github.com/hamed-yousefi/gowl) | 65 | Gowl is a process management and process monitoring tool at once. An infinite worker pool gives you the ability to control the pool and processes and monitor their status. |
...
| <b>[gohive](https://github.com/loveleshsharma/gohive) | 51 | A highly performant and easy to use Goroutine pool for Go. |
| <b>[kyoo](https://github.com/dirkaholic/kyoo) | 49 | Provides an unlimited job queue and concurrent worker pools. |
| <b>[go-waitgroup](https://github.com/pieterclaerhout/go-waitgroup) | 45 | Like `sync.WaitGroup` with error handling and concurrency control. |
| <b>[parallel-fn](https://github.com/rafaeljesus/parallel-fn) | 36 | Run functions in parallel. |
| <b>[go-trylock](https://github.com/subchen/go-trylock) | 34 | TryLock support on read-write lock for Golang. |
| <b>[channelify](https://github.com/ddelizia/channelify) | 29 | Transform your function to return channels for easy and powerful parallel processing. |
| <b>[stl](https://github.com/ssgreg/stl) | 29 | Software transactional locks based on Software Transactional Memory (STM) concurrency control mechanism. |
| <b>[execpool](https://github.com/hexdigest/execpool) | 20 | A pool built around exec.Cmd that spins up a given number of processes in advance and attaches stdin and stdout to them when needed. Very similar to FastCGI or Apache Prefork MPM but works for any command. |
| <b>[breaker](https://github.com/kamilsk/breaker) | 17 | Flexible mechanism to make execution flow interruptible. |
...
| <b>[queue](https://github.com/AnikHasibul/queue) | 16 | Gives you a `sync.WaitGroup` like queue group accessibility. Helps you to throttle and limit goroutines, wait for the end of the all goroutines and much more. |
| <b>[conexec](https://github.com/ITcathyh/conexec) | 15 | A concurrent toolkit to help execute funcs concurrently in an efficient and safe way. It supports specifying the overall timeout to avoid blocking and uses goroutine pool to improve efficiency. |
| <b>[go-tools/multithreading](https://github.com/nikhilsaraf/go-tools) | 15 | Manage a pool of goroutines using this lightweight library with a simple API. |
| <b>[go-workerpool](https://github.com/zenthangplus/go-workerpool) | 12 | Inspired from Java Thread Pool, Go WorkerPool aims to control heavy Go Routines. |
...
| <b>[app](https://github.com/murlokswarm/app) | 7.7k | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
...
| <b>[systray](https://github.com/getlantern/systray) | 3.2k | Cross platform Go library to place an icon and menu in the notification area. |
...
| <b>[zenity](https://github.com/ncruces/zenity) | 650 | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
| <b>[gosx-notifier](https://github.com/deckarep/gosx-notifier) | 585 | OSX Desktop Notifications library for Go. |
| <b>[gowd](https://github.com/dtylman/gowd) | 422 | Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform. |
| <b>[energy](https://github.com/energye/energy) | 306 | Cross-platform based on LCL(Native System UI Control Library) and CEF(Chromium Embedded Framework) (Windows/ macOS / Linux) |
| <b>[trayhost](https://github.com/shurcooL/trayhost) | 250 | Cross-platform Go library to place an icon in the host operating system's taskbar. |
| <b>[unison](https://github.com/richardwilkes/unison) | 157 | A unified graphical user experience toolkit for Go desktop applications. macOS, Windows, and Linux are supported. |
| <b>[mac-sleep-notifier](https://github.com/prashantgupta24/mac-sleep-notifier) | 32 | OSX Sleep/Wake notifications in golang. |
| <b>[mac-activity-tracker](https://github.com/prashantgupta24/activity-tracker) | 28 | OSX library to notify about any (pluggable) activity on your machine. |
| <b>[go-appindicator](https://github.com/dawidd6/go-appindicator) | 19 | Go bindings for libappindicator3 C library. |
| <b>[goradd/html5tag](https://github.com/goradd/html5tag) | 10 | Library for outputting HTML5 tags. |
...
| <b>[Spot](https://github/roblillack/spot) | - | Reactive, cross-platform desktop GUI toolkit. |
...
| <b>[ghw](https://github.com/jaypipes/ghw) | 1.6k | Golang hardware discovery/inspection library. |
| <b>[emgo](https://github.com/ziutek/emgo) | 1.1k | Go-like language for programming embedded systems (e.g. STM32 MCU). |
| <b>[sysinfo](https://github.com/zcalusic/sysinfo) | 504 | A pure Go library providing Linux OS / kernel / hardware system information. |
| <b>[goroslib](https://github.com/aler9/goroslib) | 305 | Robot Operating System (ROS) library for Go. |
| <b>[go-osc](https://github.com/hypebeast/go-osc) | 192 | Open Sound Control (OSC) bindings for Go. |
| <b>[joystick](https://github.com/0xcafed00d/joystick) | 57 | a polled API to read the state of an attached joystick. |
...
| <b>[imaging](https://github.com/disintegration/imaging) | 5.1k | Simple Go image processing package. |
...
| <b>[ln](https://github.com/fogleman/ln) | 3.3k | 3D line art rendering in Go. |
...
| <b>[govips](https://github.com/davidbyttow/govips) | 1.2k | A lightning fast image processing and resizing library for Go. |
| <b>[stegify](https://github.com/DimitarPetrov/stegify) | 1.2k | Go tool for LSB steganography, capable of hiding any file within an image. |
| <b>[image2ascii](https://github.com/qeesung/image2ascii) | 841 | Convert image to ASCII. |
| <b>[goimagehash](https://github.com/corona10/goimagehash) | 706 | Go Perceptual image hashing package. |
| <b>[govatar](https://github.com/o1egl/govatar) | 578 | Library and CMD tool for generating funny avatars. |
| <b>[draft](https://github.com/lucasepe/draft) | 576 | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| <b>[mort](https://github.com/aldor007/mort) | 501 | Storage and image processing server written in Go. |
| <b>[go-nude](https://github.com/koyachi/go-nude) | 409 | Nudity detection with Go. |
| <b>[steganography](https://github.com/auyer/steganography) | 301 | Pure Go Library for LSB steganography. |
| <b>[gltf](https://github.com/qmuntal/gltf) | 234 | Efficient and robust glTF 2.0 reader, writer and validator. |
| <b>[mergi](https://github.com/noelyahan/mergi) | 228 | Tool & Go library for image manipulation (Merge, Crop, Resize, Watermark, Animate). |
...
| <b>[rez](https://github.com/bamiaux/rez) | 211 | Image resizing in pure Go and SIMD. |
| <b>[go-webp](https://github.com/kolesa-team/go-webp) | 204 | Library for encode and decode webp pictures, using libwebp. |
| <b>[transformimgs](https://github.com/Pixboost/transformimgs) | 190 | Transformimgs resizes and optimises images for Web using next-generation formats. |
| <b>[img](https://github.com/hawx/img) | 152 | Selection of image manipulation tools. |
| <b>[go-cairo](https://github.com/ungerik/go-cairo) | 141 | Go binding for the cairo graphics library. |
| <b>[cameron](https://github.com/aofei/cameron) | 116 | An avatar generator for Go. |
| <b>[color-extractor](https://github.com/marekm4/color-extractor) | 86 | Dominant color extractor with no external dependencies. |
| <b>[gridder](https://github.com/shomali11/gridder) | 77 | A Grid based 2D Graphics library. |
| <b>[webp-server](https://github.com/mehdipourfar/webp-server) | 72 | Simple and minimal image server capable of storing, resizing, converting and caching images. |
...
| <b>[mpo](https://github.com/donatj/mpo) | 15 | Decoder and conversion tool for MPO 3D Photos. |
| <b>[scout](https://github.com/jonoton/scout) | 13 | Scout is a standalone open source software solution for DIY video security. |
...
| <b>[ekuiper](https://github.com/lf-edge/ekuiper) | 1.4k | Lightweight data stream processing engine for IoT edge. |
| <b>[gatt](https://github.com/paypal/gatt) | 1.1k | Gatt is a Go package for building Bluetooth Low Energy peripherals. |
| <b>[connectordb](https://github.com/connectordb/connectordb) | 396 | Open-Source Platform for Quantified Self & IoT. |
| <b>[devices](https://github.com/goiot/devices) | 263 | Suite of libraries for IoT devices, experimental for x/exp/io. |
| <b>[huego](https://github.com/amimof/huego) | 246 | An extensive Philips Hue client library for Go. |
| <b>[sensorbee](https://github.com/sensorbee/sensorbee) | 229 | Lightweight stream processing engine for IoT. |
| <b>[iot](https://github.com/vaelen/iot/) | 66 | IoT is a simple framework for implementing a Google IoT Core device. |
| <b>[eywa](https://github.com/xcodersun/eywa) | 62 | Project Eywa is essentially a connection manager that keeps track of connected devices. |
| <b>[mainflux](https://github.com/Mainflux/mainflux) | 31 | Industrial IoT Messaging and Device Management Server. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gocron](https://github.com/go-co-op/gocron) | 5.0k | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
| <b>[go-quartz](https://github.com/reugn/go-quartz) | 1.7k | Simple, zero-dependency scheduling library for Go. |
| <b>[Dagu](https://github.com/dagu-go/dagu) | 1.2k | No-code workflow executor. it executes DAGs defined in a simple YAML format. |
...
| <b>[JobRunner](https://github.com/bamzi/jobrunner) | 1000 | Smart and featureful cron job scheduler with job queuing and live monitoring built in. |
| <b>[jobs](https://github.com/albrow/jobs) | 496 | Persistent and flexible background jobs library. |
| <b>[scheduler](https://github.com/carlescere/scheduler) | 444 | Cronjobs scheduling made easy. |
| <b>[gronx](https://github.com/adhocore/gronx) | 379 | Cron expression parser, task runner and daemon consuming crontab like task list. |
| <b>[goflow](https://github.com/fieldryand/goflow) | 287 | A workflow orchestrator and scheduler for rapid prototyping of ETL/ML/AI pipelines. |
| <b>[tasks](https://github.com/madflojo/tasks) | 261 | An easy to use in-process scheduler for recurring tasks in Go. |
| <b>[go-cron](https://github.com/rk/go-cron) | 226 | Simple Cron library for go that can execute closures or functions at varying intervals, from once a second to once a year on a specific date and time. Primarily for web applications and long running daemons. |
| <b>[clockwerk](https://github.com/onatm/clockwerk) | 144 | Go package to schedule periodic jobs using a simple, fluent syntax. |
| <b>[cheek](https://github.com/datarootsio/cheek) | 127 | A simple crontab like scheduler that aims to offer a KISS approach to job scheduling. |
| <b>[leprechaun](https://github.com/kilgaloon/leprechaun) | 103 | Job scheduler that supports webhooks, crons and classic scheduling. |
| <b>[cdule](https://github.com/deepaksinghvi/cdule) | 45 | Job scheduler library with database support |
| <b>[sched](https://github.com/romshark/sched) | 28 | A job scheduler with the ability to fast-forward time. |
| <b>[cronticker](https://github.com/krayzpipes/cronticker) | 16 | A ticker implementation to support cron schedules. |
| <b>[go-dag](https://github.com/rhosocial/go-dag) | 6 | A framework developed in Go that manages the execution of workflows described by directed acyclic graphs. |
...
| <b>[gabs](https://github.com/Jeffail/gabs) | 3.4k | For parsing, creating and editing unknown or dynamic JSON in Go. |
| <b>[gojson](https://github.com/ChimeraCoder/gojson) | 2.7k | Automatically generate Go (golang) struct definitions from example JSON. |
| <b>[fastjson](https://github.com/valyala/fastjson) | 2.2k | Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection. |
| <b>[OjG](https://github.com/ohler55/ojg) | 801 | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
| <b>[jsondiff](https://github.com/wI2L/jsondiff) | 399 | JSON diff library for Go based on RFC6902 (JSON Patch). |
| <b>[marshmallow](https://github.com/PerimeterX/marshmallow) | 358 | Performant JSON unmarshaling for flexible use cases. |
| <b>[kazaam](https://github.com/Qntfy/kazaam) | 274 | API for arbitrary transformation of JSON documents. |
| <b>[ajson](https://github.com/spyzhov/ajson) | 221 | Abstract JSON for golang with JSONPath support. |
| <b>[gojq](https://github.com/elgs/gojq) | 191 | JSON query in Golang. |
| <b>[jsonvalue](https://github.com/Andrew-M-C/go.jsonvalue) | 177 | A fast and convinient library for unstructured JSON data, replacing `encoding/json`. |
| <b>[jettison](https://github.com/wI2L/jettison) | 170 | Fast and flexible JSON encoder for Go. |
| <b>[json2go](https://github.com/m-zajac/json2go) | 128 | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
| <b>[gjo](https://github.com/skanehira/gjo) | 123 | Small utility to create JSON objects. |
| <b>[jsongo](https://github.com/ricardolonga/jsongo) | 109 | Fluent API to make it easier to create Json objects. |
| <b>[JayDiff](https://github.com/yazgazan/jaydiff) | 105 | JSON diff utility written in Go. |
| <b>[jscan](https://github.com/romshark/jscan) | 85 | High performance zero-allocation JSON iterator. |
| <b>[ujson](https://github.com/olvrng/ujson) | 76 | Fast and minimal JSON parser and transformer that works on unstructured JSON. |
...
| <b>[jsoncolor](https://github.com/neilotoole/jsoncolor) | 43 | Drop-in replacement for `encoding/json` that outputs colorized JSON. |
| <b>[ask](https://github.com/simonnilsson/ask) | 40 | Easy access to nested values in maps and slices. Works in combination with encoding/json and other packages that "Unmarshal" arbitrary data into Go data-types. |
| <b>[vjson](https://github.com/miladibra10/vjson) | 39 | Go package for validating JSON objects with declaring a JSON schema with fluent API. |
| <b>[gojmapr](https://github.com/limiu82214/gojmapr) | 22 | Get simple struct from complex json by json path. |
| <b>[mapslice-json](https://github.com/mickep76/mapslice-json) | 18 | Go MapSlice for ordered marshal/ unmarshal of maps in JSON. |
| <b>[dynjson](https://github.com/cocoonspace/dynjson) | 16 | Client-customizable JSON formats for dynamic APIs. |
| <b>[go-jsonerror](https://github.com/ddymko/go-jsonerror) | 15 | Go-JsonError is ment to allow us to easily create json response errors that follow the JsonApi spec. |
| <b>[epoch](https://github.com/vtopc/epoch) | 14 | Contains primitives for marshaling/unmarshaling Unix timestamp/epoch to/from build-in time.Time type in JSON. |
...
| <b>[htmljson](https://github.com/nikolaydubina/htmljson) | 7 | Rich rendering of JSON as HTML in Go. |
...
| <b>[lumberjack](https://github.com/natefinch/lumberjack) | 4.7k | Simple rolling logger, implements io.WriteCloser. |
...
| <b>[pp](https://github.com/k0kubun/pp) | 1.8k | Colored pretty printer for Go language. |
| <b>[seelog](https://github.com/cihub/seelog) | 1.6k | Logging functionality with flexible dispatching, filtering, and formatting. |
| <b>[log](https://github.com/apex/log) | 1.4k | Structured logging package for Go. |
| <b>[log15](https://github.com/inconshreveable/log15) | 1.1k | Simple, powerful logging for Go. |
| <b>[tint](https://github.com/lmittmann/tint) | 623 | A slog.Handler that writes tinted logs. |
| <b>[phuslu/log](https://github.com/phuslu/log) | 613 | Structured Logging Made Easy. |
| <b>[onelog](https://github.com/francoispqt/onelog) | 416 | Onelog is a dead simple but very efficient JSON logger. It is the fastest JSON logger out there in all scenarios. Also, it is one of the logger with the lowest allocation. |
| <b>[httpretty](https://github.com/henvic/httpretty) | 390 | Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest). |
| <b>[logutils](https://github.com/hashicorp/logutils) | 366 | Utilities for slightly better logging in Go (Golang) extending the standard logger. |
| <b>[slog](https://github.com/gookit/slog) | 360 | Lightweight, configurable, extensible logger for Go. |
| <b>[logxi](https://github.com/mgutz/logxi) | 353 | 12-factor app logger that is fast and makes you happy. |
| <b>[sqldb-logger](https://github.com/simukti/sqldb-logger) | 345 | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
| <b>[rollingwriter](https://github.com/arthurkiller/rollingWriter) | 293 | RollingWriter is an auto-rotate `io.Writer` implementation with multi policies to provide log file rotation. |
| <b>[log](https://github.com/go-playground/log) | 290 | Simple, configurable and scalable Structured Logging for Go. |
| <b>[go-logger](https://github.com/apsdehal/go-logger) | 286 | Simple logger of Go Programs, with level handlers. |
| <b>[slog-multi](https://github.com/samber/slog-multi) | 277 | Chain of slog.Handler (pipeline, fanout...). |
...
| <b>[glg](https://github.com/kpango/glg) | 190 | glg is simple and fast leveled logging library for Go. |
...
| <b>[slog-formatter](https://github.com/samber/slog-formatter) | 91 | Common formatters for slog and helpers to build your own. |
...
| <b>[gone/log](https://github.com/One-com/gone/tree/master/log) | 48 | Fast, extendable, full-featured, std-lib source compatible log library. |
...
| <b>[go-log](https://github.com/ian-kent/go-log) | 43 | Log4j implementation in Go. |
...
| <b>[mlog](https://github.com/jbrodriguez/mlog) | 34 | Simple logging module for go, with 5 levels, an optional rotating logfile feature and stdout/stderr output. |
...
| <b>[zkits-logger](https://github.com/edoger/zkits-logger) | 26 | A powerful zero-dependency JSON logger. |
| <b>[gomol](https://github.com/aphistic/gomol) | 19 | Multiple-output, structured logging for Go with extensible logging outputs. |
| <b>[zax](https://github.com/yuseferi/zax) | 18 | Integrate Context with Zap logger, which leads to more flexibility in Go logging. |
| <b>[xylog](https://github.com/xybor-x/xylog) | 16 | Leveled and structured logging, dynamic fields, high performance, zone management, simple configuration, and readable syntax. |
...
| <b>[log](https://github.com/heartwilltell/log) | 15 | Simple leveled logging wrapper around standard log package. |
| <b>[go-log](https://github.com/subchen/go-log) | 14 | Simple and configurable Logging in Go, with level, formatters and writers. |
| <b>[kemba](https://github.com/clok/kemba) | 13 | A tiny debug logging tool inspired by [debug](https://github.com/visionmedia/debug), great for CLI tools and applications. |
...
| <b>[zl](https://github.com/nkmr-jp/zl) | 5 | High Developer Experience, zap based logger. It offers rich functionality but is easy to configure. |
...
| <b>[slogor](https://gitlab.com/greyxor/slogor) | - | A colorful slog handler. |
...
| <b>[gorse](https://github.com/zhenghaoz/gorse) | 8.2k | An offline recommender system backend based on collaborative filtering written in Go. |
...
| <b>[eaopt](https://github.com/MaxHalford/eaopt) | 876 | An evolutionary optimization library. |
| <b>[bayesian](https://github.com/jbrukh/bayesian) | 790 | Naive Bayesian Classification for Golang. |
...
| <b>[ocrserver](https://github.com/otiai10/ocrserver) | 667 | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
| <b>[onnx-go](https://github.com/owulveryck/onnx-go) | 646 | Go Interface to Open Neural Network Exchange (ONNX). |
| <b>[gobrain](https://github.com/goml/gobrain) | 554 | Neural Networks written in go. |
| <b>[go-deep](https://github.com/patrikeh/go-deep) | 521 | A feature-rich neural network library in Go. |
| <b>[regommend](https://github.com/muesli/regommend) | 311 | Recommendation & collaborative filtering engine. |
| <b>[Goptuna](https://github.com/c-bata/goptuna) | 251 | Bayesian optimization framework for black-box functions written in Go. Everything will be optimized. |
| <b>[goga](https://github.com/tomcraven/goga) | 213 | Genetic algorithm library for Go. |
| <b>[goRecommend](https://github.com/timkaye11/goRecommend) | 203 | Recommendation Algorithms library written in Go. |
| <b>[go-galib](https://github.com/thoj/go-galib) | 199 | Genetic Algorithms library written in Go / golang. |
| <b>[shield](https://github.com/eaigner/shield) | 156 | Bayesian text classifier with flexible tokenizers and storage backends for Go. |
| <b>[go-fann](https://github.com/white-pony/go-fann) | 115 | Go bindings for Fast Artificial Neural Networks(FANN) library. |
| <b>[go-featureprocessing](https://github.com/nikolaydubina/go-featureprocessing) | 115 | Fast and convenient feature processing for low latency machine learning in Go. |
| <b>[goscore](https://github.com/asafschers/goscore) | 96 | Go Scoring API for PMML. |
| <b>[gonet](https://github.com/dathoangnd/gonet) | 82 | Neural Network for Go. |
| <b>[fonet](https://github.com/Fontinalis/fonet) | 81 | A Deep Neural Network library written in Go. |
| <b>[GoMind](https://github.com/surenderthakran/gomind) | 79 | A simplistic Neural Network Library in Go. |
...
| <b>[neural-go](https://github.com/schuyler/neural-go) | 68 | Multilayer perceptron network implemented in Go, with training via backpropagation. |
| <b>[go-pr](https://github.com/daviddengcn/go-pr) | 62 | Pattern recognition package in Go lang. |
| <b>[Varis](https://github.com/Xamber/Varis) | 54 | Golang Neural Network. |
| <b>[golinear](https://github.com/danieldk/golinear) | 44 | liblinear bindings for Go. |
| <b>[randomforest](https://github.com/malaschitz/randomForest) | 41 | Easy to use Random Forest library for Go. |
...
| <b>[ddt](https://github.com/sgrodriguez/ddt) | 34 | Dynamic decision tree, create trees defining customizable rules. |
| <b>[evoli](https://github.com/khezen/evoli) | 30 | Genetic Algorithm and Particle Swarm Optimization library. |
...
| <b>[Centrifugo](https://github.com/centrifugal/centrifugo) | 8.0k | Real-time messaging (Websockets or SockJS) server in Go. |
| <b>[gorush](https://github.com/appleboy/gorush) | 7.8k | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
| <b>[Benthos](https://github.com/Jeffail/benthos) | 7.7k | A message streaming bridge between a range of protocols. |
...
| <b>[NATS Go Client](https://github.com/nats-io/nats) | 5.2k | Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library. |
...
| <b>[EventBus](https://github.com/asaskevich/EventBus) | 1.7k | The lightweight event bus with async compatibility. |
...
| <b>[amqp](https://github.com/rabbitmq/amqp091-go) | 1.4k | Go RabbitMQ Client Library. |
...
| <b>[dbus](https://github.com/godbus/dbus) | 951 | Native Go bindings for D-Bus. |
| <b>[Gollum](https://github.com/trivago/gollum) | 937 | A n:m multiplexer that gathers messages from different sources and broadcasts them to a set of destinations. |
| <b>[mangos](https://github.com/nanomsg/mangos) | 655 | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
| <b>[golongpoll](https://github.com/jcuga/golongpoll) | 653 | HTTP longpoll server library that makes web pub-sub simple. |
| <b>[emitter](https://github.com/olebedev/emitter) | 495 | Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins. |
| <b>[pubsub](https://github.com/tuxychandru/pubsub) | 414 | Simple pubsub package for go. |
| <b>[Glue](https://github.com/desertbit/glue) | 413 | Robust Go and Javascript Socket Library (Alternative to Socket.io). |
| <b>[Quamina](https://github.com/timbray/quamina) | 363 | Fast pattern-matching for filtering messages and events. |
| <b>[Bus](https://github.com/mustafaturan/bus) | 331 | Minimalist message bus implementation for internal communication. |
| <b>[messagebus](https://github.com/vardius/message-bus) | 266 | messagebus is a Go simple async message bus, perfect for using as event bus when doing event sourcing, CQRS, DDD. |
| <b>[rabtap](https://github.com/jandelgado/rabtap) | 254 | RabbitMQ swiss army knife cli app. |
| <b>[guble](https://github.com/smancke/guble) | 157 | Messaging server using push notifications (Google Firebase Cloud Messaging, Apple Push Notification services, SMS) as well as websockets, a REST API, featuring distributed operation and message-persistence. |
| <b>[hub](https://github.com/leandro-lugaresi/hub) | 142 | A Message/Event Hub for Go applications, using publish/subscribe pattern with support for alias like rabbitMQ exchanges. |
| <b>[redisqueue](https://github.com/robinjoseph08/redisqueue) | 123 | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
| <b>[oplog](https://github.com/dailymotion/oplog) | 111 | Generic oplog/replication system for REST APIs. |
| <b>[Ratus](https://github.com/hyperonym/ratus) | 104 | Ratus is a RESTful asynchronous task queue server. |
| <b>[rabbus](https://github.com/rafaeljesus/rabbus) | 98 | A tiny wrapper over amqp exchanges and queues. |
| <b>[go-mq](https://github.com/cheshir/go-mq) | 89 | RabbitMQ client with declarative configuration. |
| <b>[drone-line](https://github.com/appleboy/drone-line) | 80 | Sending [Line](https://at.line.me/en) notifications using a binary, docker or Drone CI. |
| <b>[nsq-event-bus](https://github.com/rafaeljesus/nsq-event-bus) | 78 | A tiny wrapper around NSQ topic and channel. |
| <b>[go-notify](https://github.com/TheCreeper/go-notify) | 68 | Native implementation of the freedesktop notification spec. |
...
| <b>[Commander](https://github.com/jeroenrinzema/commander) | 64 | A high-level event driven consumer/producer supporting various "dialects" such as Apache Kafka. |
...
| <b>[event](https://github.com/agoalofalife/event) | 56 | Implementation of the pattern observer. |
...
| <b>[gosd](https://github.com/alexsniffin/gosd) | 24 | A library for scheduling when to dispatch a message to a channel. |
...
| <b>[go-eventbus](https://github.com/stanipetrosyan/go-eventbus) | 2 | Simple Event Bus package for Go. |
...
| <b>[go-excel](https://github.com/szyhf/go-excel) | 190 | A simple and light reader to read a relate-db-like excel as a table. |
| <b>[xlsx](https://github.com/plandem/xlsx) | 172 | Fast and safe way to read/update your existing Microsoft Excel files in Go programs. |
| <b>[exl](https://github.com/go-the-way/exl) | 29 | Excel binding to struct written in Go.(Only supports Go1.18+) |
...
| <b>[do](https://github.com/samber/do) | 1.6k | A dependency injection framework based on Generics. |
| <b>[GoLobby/Container](https://github.com/golobby/container) | 541 | GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language. |
| <b>[goioc/di](https://github.com/goioc/di) | 343 | Spring-inspired Dependency Injection Container. |
| <b>[di](https://github.com/goava/di) | 228 | A dependency injection container for go programming language. |
| <b>[dingo](https://github.com/i-love-flamingo/dingo) | 176 | A dependency injection toolkit for Go, based on Guice. |
| <b>[kod](https://github.com/go-kod/kod) | 72 | A generics based dependency injection framework for Go. |
...
| <b>[gontainer](https://github.com/NVIDIA/gontainer) | 27 | A dependency injection service container for Go projects. |
| <b>[gocontainer](https://github.com/vardius/gocontainer) | 19 | Simple Dependency Injection Container. |
| <b>[gontainer/gontainer](https://github.com/gontainer/gontainer) | 15 | A YAML-based Dependency Injection container for GO. It supports dependencies' scopes, and auto-detection of circular dependencies. Gontainer is concurrent-safe. |
| <b>[kinit](https://github.com/go-kata/kinit) | 10 | Customizable dependency injection container with the global mode, cascade initialization and panic-safe finalization. |
| <b>[HnH/di](https://github.com/HnH/di) | 7 | DI container library that is focused on clean API and flexibility. |
| <b>[ore](https://github.com/firasdarwish/ore) | 5 | Lightweight, generic & simple dependency injection (DI) container. |
...
| <b>[cosban/di](https://gitlab.com/cosban/di) | - | A code generation based dependency injection wiring tool. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[golang-standards/project-layout](https://github.com/golang-standards/project-layout) | 46.0k | Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful. |
| <b>[ardanlabs/service](https://github.com/ardanlabs/service) | 3.4k | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
| <b>[modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1.8k | Go application boilerplate and example applying modern practices. |
| <b>[nunu](https://github.com/go-nunu/nunu) | 1.7k | Nunu is a scaffolding tool for building Go applications. |
| <b>[pagoda](https://github.com/mikestefanello/pagoda) | 1.3k | Rapid, easy full-stack web development starter kit built in Go. |
| <b>[cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 677 | A Go application boilerplate template for quick starting projects following production best practices. |
| <b>[go-starter](https://github.com/allaboutapps/go-starter) | 444 | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| <b>[golang-templates/seed](https://github.com/golang-templates/seed) | 444 | Go application GitHub repository template. |
| <b>[go-todo-backend](https://github.com/Fs02/go-todo-backend) | 310 | Go Todo Backend example using modular project layout for product microservice. |
| <b>[scaffold](https://github.com/catchplay/scaffold) | 149 | Scaffold generates a starter Go project layout. Lets you focus on business logic implemented. |
| <b>[go-sample](https://github.com/zitryss/go-sample) | 129 | A sample layout for Go application projects with the real code. |
| <b>[gobase](https://github.com/wajox/gobase) | 59 | A simple skeleton for golang application with basic setup for real golang application. |
| <b>[go-module](https://github.com/octomation/go-module) | 29 | Template for a typical module written on Go. |
| <b>[wangyoucao577/go-project-layout](https://github.com/wangyoucao577/go-project-layout) | 24 | Set of practices and discussions on how to structure Go project layout. |
| <b>[insidieux/inizio](https://github.com/insidieux/inizio) | 19 | Golang project layout generator with plugins. |
...
| <b>[sttr](https://github.com/abhimanyu003/sttr) | 862 | cross-platform, cli app to perform various operations on string. |
| <b>[gobeam/Stringy](https://github.com/gobeam/Stringy) | 221 | String manipulation library to convert string to camel case, snake case, kebab case / slugify etc. |
| <b>[strutil](https://github.com/ozgio/strutil) | 201 | String utilities. |
| <b>[caps](https://github.com/chanced/caps) | 53 | A case conversion library. |
| <b>[bexp](https://github.com/happy-sdk/happy-go/tree/main/strings/bexp) | 18 | Go implementation of Brace Expansion mechanism to generate arbitrary strings. |
| <b>[bexp](https://github.com/happy-sdk/happy/tree/main/pkg/strings/bexp) | 18 | Go implementation of Brace Expansion mechanism to generate arbitrary strings. |
...
| <b>[llvm](https://github.com/llir/llvm) | 1.2k | Library for interacting with LLVM IR in pure Go. |
| <b>[shortid](https://github.com/teris-io/shortid) | 922 | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| <b>[shoutrrr](https://github.com/containrrr/shoutrrr) | 881 | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
| <b>[stateless](https://github.com/qmuntal/stateless) | 804 | A fluent library for creating state machines. |
| <b>[health](https://github.com/alexliesenfeld/health) | 755 | A simple and flexible health check library for Go. |
| <b>[xz](https://github.com/ulikunitz/xz) | 465 | Pure golang package for reading and writing xz-compressed files. |
| <b>[health](https://github.com/dimiro1/health) | 447 | Easy to use, extensible health check library. |
| <b>[banner](https://github.com/dimiro1/banner) | 445 | Add beautiful banners into your Go applications. |
| <b>[gountries](https://github.com/pariz/gountries) | 407 | Package that exposes country and subdivision data. |
| <b>[conv](https://github.com/cstockton/go-conv) | 386 | Package conv provides fast and intuitive conversions across Go types. |
| <b>[lk](https://github.com/hyperboloide/lk) | 357 | A simple licensing library for golang. |
| <b>[ffmt](https://github.com/go-ffmt/ffmt) | 304 | Beautify data display for Humans. |
| <b>[go-unarr](https://github.com/gen2brain/go-unarr) | 275 | Decompression library for RAR, TAR, ZIP and 7z archives. |
| <b>[healthcheck](https://github.com/etherlabsio/healthcheck) | 265 | An opinionated and concurrent health-check HTTP handler for RESTful services. |
| <b>[antch](https://github.com/antchfx/antch) | 258 | A fast, powerful and extensible web crawling & scraping framework. |
| <b>[battery](https://github.com/distatus/battery) | 240 | Cross-platform, normalized battery information library. |
| <b>[bitio](https://github.com/icza/bitio) | 236 | Highly optimized bit-level Reader and Writer for Go. |
| <b>[gtree](https://github.com/ddddddO/gtree) | 201 | Provide CLI and Package for tree output and directories creation from Markdown or programmatically. |
...
| <b>[turtle](https://github.com/hackebrot/turtle) | 158 | Emojis for Go. |
| <b>[captcha](https://github.com/steambap/captcha) | 145 | Package captcha provides an easy to use, unopinionated API for captcha generation. |
| <b>[gommit](https://github.com/antham/gommit) | 110 | Analyze git commit messages to ensure they follow defined patterns. |
...
| <b>[indigo](https://github.com/osamingo/indigo) | 109 | Distributed unique ID generator of using Sonyflake and encoded by Base58. |
| <b>[faker](https://github.com/pioz/faker) | 89 | Random fake data and struct generator for Go. |
| <b>[persian](https://github.com/mavihq/persian) | 82 | Some utilities for Persian language in go. |
| <b>[morse](https://github.com/alwindoss/morse) | 81 | Library to convert to and from morse code. |
| <b>[pdfgen](https://github.com/hyperboloide/pdfgen) | 70 | HTTP service to generate PDF from Json requests. |
| <b>[xkg](https://github.com/go-xkg/xkg) | 56 | X Keyboard Grabber. |
| <b>[browscap_go](https://github.com/digitalcrab/browscap_go) | 48 | GoLang Library for [Browser Capabilities Project](https://browscap.org/). |
| <b>[datacounter](https://github.com/miolini/datacounter) | 48 | Go counters for readers/writer/http.ResponseWriter. |
| <b>[url-shortener](https://github.com/pantrif/url-shortener) | 47 | A modern, powerful, and robust URL shortener microservice with mysql support. |
| <b>[sandid](https://github.com/aofei/sandid) | 45 | Every grain of sand on earth has its own ID. |
...
| <b>[xdg](https://github.com/rkoesters/xdg) | 39 | FreeDesktop.org (xdg) Specs implemented in Go. |
...
| <b>[numa](https://github.com/lrita/numa) | 24 | NUMA is a utility library, which is written in go. It help us to write some NUMA-AWARED code. |
| <b>[shellwords](https://github.com/Wing924/shellwords) | 24 | A Golang library to manipulate strings according to the word parsing rules of the UNIX Bourne shell. |
...
| <b>[varint](https://github.com/chmike/varint) | 13 | A faster varying length integer encoder/decoder than the one provided in the standard library. |
| <b>[go-commandbus](https://github.com/lana/go-commandbus) | 12 | A slight and pluggable command-bus for Go. |
...
| <b>[sitemap-format](https://github.com/mingard/sitemap-format) | 5 | A simple sitemap generator, with a little syntactic sugar. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[whatlanggo](https://github.com/abadojack/whatlanggo) | 630 | Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc). |
| <b>[getlang](https://github.com/rylans/getlang) | 167 | Fast natural language detection package. |
...
| <b>[kagome](https://github.com/ikawaha/kagome) | 792 | JP morphological analyzer written in pure Go. |
| <b>[nlp](https://github.com/james-bowman/nlp) | 434 | Go Natural Language Processing library supporting LSA (Latent Semantic Analysis). |
| <b>[nlp](https://github.com/Shixzie/nlp) | 388 | Extract values from strings and fill your structs with nlp. |
| <b>[RAKE.go](https://github.com/afjoseph/RAKE.Go) | 112 | Go port of the Rapid Automatic Keyword Extraction Algorithm (RAKE). |
| <b>[go-stem](https://github.com/agonopol/go-stem) | 78 | Implementation of the porter stemming algorithm. |
| <b>[go2vec](https://github.com/danieldk/go2vec) | 53 | Reader and utility functions for word2vec embeddings. |
...
| <b>[snowball](https://github.com/goodsign/snowball) | 37 | Snowball stemmer port (cgo wrapper) for Go. Provides word stem extraction functionality [Snowball native](http://snowball.tartarus.org/). |
...
| <b>[go-slugify](https://github.com/mozillazg/go-slugify) | 91 | Make pretty slug with multiple languages support. |
| <b>[Slugify](https://github.com/avelino/slugify) | 33 | Go slugify application that handles string. |
...
| <b>[sentences](https://github.com/neurosnap/sentences) | 424 | Sentence tokenizer:  converts text into a list of sentences. |
| <b>[segment](https://github.com/blevesearch/segment) | 87 | Go library for performing Unicode Text Segmentation as described in [Unicode Standard Annex #29](https://www.unicode.org/reports/tr29/) |
| <b>[textcat](https://github.com/pebbe/textcat) | 72 | Go package for n-gram based text categorization, with support for utf-8 and raw text. |
| <b>[MMSEGO](https://github.com/awsong/MMSEGO) | 63 | This is a GO implementation of [MMSEG](http://technology.chtsai.org/mmseg/) which a Chinese word splitting algorithm. |
...
| <b>[go-pinyin](https://github.com/mozillazg/go-pinyin) | 1.6k | CN Hanzi to Hanyu Pinyin converter. |
| <b>[gotext](https://github.com/leonelquinteros/gotext) | 424 | GNU gettext utilities for Go. |
...
| <b>[iuliia-go](https://github.com/mehanizm/iuliia-go) | 47 | Transliterate Cyrillic → Latin in every possible way. |
| <b>[spreak](https://github.com/vorlif/spreak) | 46 | Flexible translation and humanization library for Go, based on the concepts behind gettext. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-unidecode](https://github.com/mozillazg/go-unidecode) | 125 | ASCII transliterations of Unicode text. |
| <b>[gounidecode](https://github.com/fiam/gounidecode) | 78 | Unicode transliterator (also known as unidecode) for Go. |
| <b>[transliterator](https://github.com/alexsergivan/transliterator) | 40 | Provides one-way string transliteration with supporting of language-specific transliteration rules. |
...
| <b>[dns](https://github.com/miekg/dns) | 7.8k | Go library for working with DNS. |
...
| <b>[gobgp](https://github.com/osrg/gobgp) | 3.5k | BGP implemented in the Go Programming Language. |
| <b>[ssh](https://github.com/gliderlabs/ssh) | 3.5k | Higher-level API for building SSH servers (wraps crypto/ssh). |
| <b>[fortio](https://github.com/fortio/fortio) | 3.2k | Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC. |
| <b>[nbio](https://github.com/lesismal/nbio) | 2.0k | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
| <b>[water](https://github.com/songgao/water) | 1.9k | Simple TUN/TAP library. |
...
| <b>[go-getter](https://github.com/hashicorp/go-getter) | 1.6k | Go library for downloading files or directories from various sources using a URL. |
| <b>[sftp](https://github.com/pkg/sftp) | 1.5k | Package sftp implements the SSH File Transfer Protocol as described in <https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt>. |
| <b>[grab](https://github.com/cavaliercoder/grab) | 1.4k | Go package for managing file downloads. |
| <b>[NFF-Go](https://github.com/intel-go/nff-go) | 1.4k | Framework for rapid development of performant network functions for cloud and bare-metal (former YANFF). |
...
| <b>[gosnmp](https://github.com/soniah/gosnmp) | 1.1k | Native Go library for performing SNMP actions. |
| <b>[mdns](https://github.com/hashicorp/mdns) | 1.1k | Simple mDNS (Multicast DNS) client/server library in Golang. |
| <b>[gws](https://github.com/lxzan/gws) | 1000 | High-Performance WebSocket Server & Client With AsyncIO Supporting . |
| <b>[gmqtt](https://github.com/DrmagicE/gmqtt) | 967 | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| <b>[vssh](https://github.com/yahoo/vssh) | 942 | Go library for building network and server automation over SSH protocol. |
| <b>[cidranger](https://github.com/yl2chen/cidranger) | 890 | Fast IP to CIDR lookup for Go. |
| <b>[easytcp](https://github.com/DarthPestilane/easytcp) | 794 | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
| <b>[lhttp](https://github.com/fanux/lhttp) | 695 | Powerful websocket framework, build your IM server more easily. |
| <b>[go-stun](https://github.com/ccding/go-stun) | 649 | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
| <b>[peerdiscovery](https://github.com/schollz/peerdiscovery) | 630 | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| <b>[gaio](https://github.com/xtaci/gaio) | 565 | High performance async-io networking for Golang in proactor mode. |
| <b>[gotcp](https://github.com/gansidui/gotcp) | 510 | Go package for quickly writing tcp applications. |
| <b>[stun](https://github.com/go-rtc/stun) | 491 | Go implementation of RFC 5389 STUN protocol. |
| <b>[gopcap](https://github.com/akrennmair/gopcap) | 486 | Go wrapper for libpcap. |
| <b>[tcp_server](https://github.com/firstrow/tcp_server) | 425 | Go library for building tcp servers faster. |
...
| <b>[winrm](https://github.com/masterzen/winrm) | 417 | Go WinRM client to remotely execute commands on Windows machines. |
| <b>[ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 399 | Fully featured FTP server library. |
| <b>[arp](https://github.com/mdlayher/arp) | 355 | Package arp implements the ARP protocol, as described in RFC 826. |
| <b>[dnsmonster](https://github.com/mosajjal/dnsmonster) | 308 | Passive DNS Capture/Monitoring Framework. |
| <b>[ethernet](https://github.com/mdlayher/ethernet) | 271 | Package ethernet implements marshaling and unmarshaling of IEEE 802.3 Ethernet II frames and IEEE 802.1Q VLAN tags. |
| <b>[buffstreams](https://github.com/stabbycutyou/buffstreams) | 253 | Streaming protocolbuffer data over TCP made easy. |
| <b>[gNxI](https://github.com/google/gnxi) | 250 | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
| <b>[jazigo](https://github.com/udhos/jazigo) | 210 | Jazigo is a tool written in Go for retrieving configuration for multiple network devices. |
| <b>[tcpack](https://github.com/lim-yoona/tcpack) | 174 | tcpack is an application protocol based on TCP to Pack and Unpack bytes stream in go program. |
| <b>[utp](https://github.com/anacrolix/utp) | 173 | Go uTP micro transport protocol implementation. |
| <b>[event](https://github.com/cheng-zhongliang/event) | 154 | Simple I/O event notification library written in Golang. |
| <b>[canopus](https://github.com/zubairhamed/canopus) | 154 | CoAP Client/Server implementation (RFC 7252). |
| <b>[xtcp](https://github.com/xfxdev/xtcp) | 149 | TCP Server Framework with simultaneous full duplex communication, graceful shutdown, and custom protocol. |
| <b>[sslb](https://github.com/eduardonunesp/sslb) | 148 | It's a Super Simples Load Balancer, just a little project to achieve some kind of performance. |
| <b>[iplib](https://github.com/c-robinson/iplib) | 133 | Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html) |
...
| <b>[natiu-mqtt](https://github.com/soypat/natiu-mqtt) | 82 | A dead-simple, non-allocating, low level implementation of MQTT well suited for embedded systems. |
| <b>[ether](https://github.com/songgao/ether) | 80 | Cross-platform Go package for sending and receiving ethernet frames. |
| <b>[go-powerdns](https://github.com/joeig/go-powerdns) | 80 | PowerDNS API bindings for Golang. |
| <b>[packet](https://github.com/aerogo/packet) | 78 | Send packets over TCP and UDP. It can buffer messages and hot-swap connections if needed. |
| <b>[dhcp6](https://github.com/mdlayher/dhcp6) | 77 | Package dhcp6 implements a DHCPv6 server, as described in RFC 3315. |
| <b>[fullproxy](https://github.com/shoriwe/fullproxy) | 74 | A fully featured scriptable and daemon configurable proxy and pivoting toolkit with SOCKS5, HTTP, raw ports and reverse proxy protocols. |
| <b>[portproxy](https://github.com/aybabtme/portproxy) | 56 | Simple TCP proxy which adds CORS support to API's which don't support it. |
| <b>[linkio](https://github.com/ian-kent/linkio) | 53 | Network link speed simulation for Reader/Writer interfaces. |
| <b>[fwdctl](https://github.com/alegrey91/fwdctl) | 43 | A simple and intuitive CLI to manage IPTables forwards in your Linux server. |
...
| <b>[httpproxy](https://github.com/wzshiming/httpproxy) | 23 | HTTP proxy handler and dialer. |
...
| <b>[gnet](https://github.com/fish-tennis/gnet) | 14 | `gnet` is a high-performance networking framework,especially for game servers. |
...
| <b>[go-sse](https://github.com/lampctl/go-sse) | 8 | Go client and server implementation of HTML server-sent events. |
...
| <b>[req](https://github.com/imroc/req) | 4.1k | Simple Go HTTP client with Black Magic (Less code and More efficiency). |
| <b>[heimdall](https://github.com/gojektech/heimdall) | 2.6k | An enhanced http client with retry and hystrix capabilities. |
| <b>[grequests](https://github.com/levigross/grequests) | 2.1k | A Go "clone" of the great and famous Requests library. |
| <b>[go-retryablehttp](https://github.com/hashicorp/go-retryablehttp) | 1.9k | Retryable HTTP client in Go. |
| <b>[sling](https://github.com/dghubble/sling) | 1.7k | Sling is a Go HTTP client library for creating and sending API requests. |
| <b>[requests](https://github.com/carlmjohnson/requests) | 1.4k | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| <b>[gentleman](https://github.com/h2non/gentleman) | 1.1k | Full-featured plugin-driven HTTP client library. |
| <b>[pester](https://github.com/sethgrid/pester) | 643 | Go HTTP client calls with retries, backoff, and concurrency. |
| <b>[go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) | 359 | Get easily stdlib HTTP client, which does not share any state with other clients. |
| <b>[request](https://github.com/monaco-io/request) | 286 | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
| <b>[go-http-client](https://github.com/bozd4g/go-http-client) | 75 | Make http calls simply and easily. |
...
| <b>[go-zoox/fetch](https://github.com/go-zoox/fetch) | 70 | A Powerful, Lightweight, Easy Http Client, inspired by Web Fetch API. |
| <b>[rq](https://github.com/ddo/rq) | 51 | A nicer interface for golang stdlib HTTP client. |
| <b>[httpretry](https://github.com/ybbus/httpretry) | 43 | Enriches the default go HTTP client with retry functionality. |
| <b>[fast-shot](https://github.com/opus-domini/fast-shot) | 35 | Hit your API targets with rapid-fire precision using Go's fastest and simple HTTP Client. |
...
| <b>[mathgl](https://github.com/go-gl/mathgl) | 535 | Pure Go math package specialized for 3D math, with inspiration from GLM. |
| <b>[goxjs/gl](https://github.com/goxjs/gl) | 172 | Go cross-platform OpenGL bindings (OS X, Linux, Windows, browsers, iOS, Android). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[GORM](https://github.com/go-gorm/gorm) | 36.0k | The fantastic ORM library for Golang, aims to be developer friendly. |
...
| <b>[bun](https://github.com/uptrace/bun) | 3.3k | SQL-first Golang ORM. Successor of go-pg. |
...
| <b>[rel](https://github.com/go-rel/rel) | 741 | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
| <b>[go-queryset](https://github.com/jirfag/go-queryset) | 724 | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
| <b>[Zoom](https://github.com/albrow/zoom) | 305 | Blazing-fast datastore and querying engine built on Redis. |
| <b>[go-sql](https://github.com/rushteam/gosql) | 177 | A easy ORM for mysql. |
| <b>[grimoire](https://github.com/Fs02/grimoire) | 161 | Grimoire is a database access layer and validation for golang. (Support: MySQL, PostgreSQL and SQLite3). |
| <b>[golobby/orm](https://github.com/golobby/orm) | 156 | Simple, fast, type-safe, generic orm for developer happiness. |
| <b>[go-store](https://github.com/gosuri/go-store) | 112 | Simple and fast Redis backed key-value store library for Go. |
| <b>[go-firestorm](https://github.com/jschoedt/go-firestorm) | 50 | A simple ORM for Google/Firebase Cloud Firestore. |
| <b>[cacheme](https://github.com/Yiling-J/cacheme-go) | 24 | Schema based, typed Redis caching/memoize framework for Go. |
| <b>[CQL](https://github.com/FrancoLiberali/cql) | 16 | Built on top of GORM, adds compile-time verified queries based on auto-generated code. |
...
| <b>[go-dbw](https://github.com/hashicorp/go-dbw) | 13 | A simple package that encapsulates database operations. |
...
| <b>[modgv](https://github.com/lucasepe/modgv) | 480 | Converts 'go mod graph' output into Graphviz's DOT language. |
| <b>[gup](https://github.com/nao1215/gup) | 280 | Update binaries installed by "go install". |
| <b>[nut](https://github.com/jingweno/nut) | 232 | Vendor Go dependencies. |
| <b>[johnny-deps](https://github.com/VividCortex/johnny-deps) | 214 | Minimal dependency version using Git. |
| <b>[mvn-golang](https://github.com/raydac/mvn-golang) | 161 | plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[jaeger](https://github.com/jaegertracing/jaeger) | 20.0k | A distributed tracing system. |
...
| <b>[go-instrument](https://github.com/nikolaydubina/go-instrument) | 147 | Automatically add spans to all methods and functions. |
| <b>[tracer](https://github.com/kamilsk/tracer) | 85 | Simple, lightweight tracing. |
...
| <b>[dasel](https://github.com/tomwright/dasel) | 4.9k | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| <b>[graphql](https://github.com/neelance/graphql-go) | 4.6k | GraphQL server with a focus on ease of use. |
| <b>[gojsonq](https://github.com/thedevsaddam/gojsonq) | 2.2k | A simple Go package to Query over JSON Data. |
| <b>[rql](https://github.com/a8m/rql) | 329 | Resource Query Language for REST API. |
| <b>[jsonql](https://github.com/elgs/jsonql) | 274 | JSON query expression library in Golang. |
| <b>[jsonslice](https://github.com/bhmj/jsonslice) | 84 | Jsonpath queries with advanced filters. |
| <b>[rqp](https://github.com/timsolov/rest-query-parser) | 71 | Query Parser for REST API. Filtering, validations, both `AND`, `OR` operations are supported directly in the query. |
...
| <b>[api-fu](https://github.com/ccbrown/api-fu) | 55 | Comprehensive GraphQL implementation. |
| <b>[mql](https://github.com/hashicorp/mql) | 38 | Model Query Language (mql) is a query language for your database models. |
| <b>[straf](https://github.com/SonicRoshan/straf) | 36 | Easily Convert Golang structs to GraphQL objects. |
| <b>[jsonpath](https://github.com/AsaiYusuke/jsonpath) | 23 | A query library for retrieving part of JSON based on JSONPath syntax. |
...
| <b>[vfsgen](https://github.com/shurcooL/vfsgen) | 982 | Generates a vfsdata.go file that statically implements the given virtual filesystem. |
| <b>[esc](https://github.com/mjibson/esc) | 639 | Embeds files into Go programs and provides http.FileSystem interfaces to them. |
| <b>[fileb0x](https://github.com/UnnoTed/fileb0x) | 633 | Simple tool to embed files in go with focus on "customization" and ease to use. |
| <b>[go-resources](https://github.com/omeid/go-resources) | 176 | Unfancy resources embedding with Go. |
| <b>[statics](https://github.com/go-playground/statics) | 68 | Embeds static resources into go files for single binary compilation + works with http.FileSystem + symlinks. |
| <b>[debme](https://github.com/leaanthony/debme) | 31 | Create an `embed.FS` from an existing `embed.FS` subdirectory. |
...
| <b>[mule](https://github.com/wlbr/mule) | 15 | Embed external resources like images, movies ... into Go source code to create single file binaries using `go generate`. Focussed on simplicity. |
...
| <b>[orb](https://github.com/paulmach/orb) | 849 | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| <b>[go-dsp](https://github.com/mjibson/go-dsp) | 848 | Digital Signal Processing for Go. |
| <b>[chart](https://github.com/vdobler/chart) | 768 | Simple Chart Plotting library for Go. Supports many graphs types. |
| <b>[goraph](https://github.com/gyuho/goraph) | 733 | Pure Go graph theory library(data structure, algorithm visualization). |
| <b>[graph](https://github.com/yourbasic/graph) | 690 | Library of basic graph algorithms. |
| <b>[ewma](https://github.com/VividCortex/ewma) | 432 | Exponentially-weighted moving averages. |
| <b>[calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 390 | Calendar heatmap in plain Go inspired by Github contribution activity. |
| <b>[TextRank](https://github.com/DavidBelicza/TextRank) | 196 | TextRank implementation in Golang with extendable features (summarization, weighting, phrase extraction) and multithreading (goroutine) support. |
| <b>[gohistogram](https://github.com/VividCortex/gohistogram) | 174 | Approximate histograms for data streams. |
| <b>[sparse](https://github.com/james-bowman/sparse) | 154 | Go Sparse matrix formats for linear algebra supporting scientific and machine learning applications, compatible with gonum matrix libraries. |
| <b>[go-estimate](https://github.com/milosgajdos/go-estimate) | 110 | State estimation and filtering algorithms in Go. |
| <b>[pagerank](https://github.com/alixaxel/pagerank) | 80 | Weighted PageRank algorithm implemented in Go. |
| <b>[jsonl-graph](https://github.com/nikolaydubina/jsonl-graph) | 72 | Tool to manipulate JSONL graphs with graphviz support. |
...
| <b>[gograph](https://github.com/hmdsefi/gograph) | 49 | A golang generic graph library that provides mathematical graph-theory and algorithms. |
| <b>[decimal](https://github.com/db47h/decimal) | 39 | Package decimal implements arbitrary-precision decimal floating-point arithmetic. |
...
| <b>[lego](https://github.com/go-acme/lego) | 7.4k | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
| <b>[CertMagic](https://github.com/caddyserver/certmagic) | 4.9k | Mature, robust, and powerful ACME client integration for fully-managed TLS certificate issuance and renewal. |
...
| <b>[Coraza](https://github.com/corazawaf/coraza) | 1.9k | Enterprise-ready, modsecurity and OWASP CRS compatible WAF library. |
...
| <b>[dongle](https://github.com/golang-module/dongle) | 856 | A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption. |
| <b>[beelzebub](https://github.com/mariocandela/beelzebub) | 585 | A secure low code honeypot framework, leveraging AI for System Virtualization. |
| <b>[nacl](https://github.com/kevinburke/nacl) | 544 | Go implementation of the NaCL set of API's. |
| <b>[go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 480 | Password validator based on raw cryptographic entropy values. |
| <b>[booster](https://github.com/anatol/booster) | 468 | Fast initramfs generator with full-disk encryption support. |
| <b>[ssh-vault](https://github.com/ssh-vault/ssh-vault) | 433 | encrypt/decrypt using ssh keys. |
| <b>[optimus-go](https://github.com/pjebs/optimus-go) | 358 | ID hashing and Obfuscation using Knuth's Algorithm. |
| <b>[go-yara](https://github.com/hillu/go-yara) | 347 | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
| <b>[firewalld-rest](https://github.com/prashantgupta24/firewalld-rest) | 338 | A rest application to dynamically update firewalld rules on a linux server. |
| <b>[BadActor](https://github.com/jaredfolkins/badactor) | 322 | In-memory, application-driven jailer built in the spirit of fail2ban. |
| <b>[teler-waf](https://github.com/kitabisa/teler-waf) | 297 | teler-waf is a Go HTTP middleware that provide teler IDS functionality to protect against web-based attacks and improve the security of Go-based web applications. It is highly configurable and easy to integrate into existing Go applications. |
| <b>[passlib](https://github.com/hlandau/passlib) | 290 | Futureproof password hashing library. |
| <b>[go-peer](https://github.com/number571/go-peer) | 203 | A software library for creating secure and anonymous decentralized systems. |
| <b>[simple-scrypt](https://github.com/elithrar/simple-scrypt) | 194 | Scrypt package with a simple, obvious API and automatic cost calibration built-in. |
| <b>[argon2pw](https://github.com/raja/argon2pw) | 89 | Argon2 password hash generation with constant-time password comparison. |
| <b>[goSecretBoxPassword](https://github.com/dwin/goSecretBoxPassword) | 59 | A probably paranoid package for securely hashing and encrypting passwords. |
| <b>[go-generate-password](https://github.com/m1/go-generate-password) | 52 | Password generator that can be used on the cli or as a library. |
| <b>[certificates](https://github.com/mvmaasakkers/certificates) | 37 | An opinionated tool for generating tls certificates. |
| <b>[passwap](https://github.com/zitadel/passwap) | 36 | Provides a unified implementation between different password hashing algorithms |
| <b>[go-htpasswd](https://github.com/tg123/go-htpasswd) | 35 | Apache htpasswd Parser for Go. |
| <b>[secureio](https://github.com/xaionaro-go/secureio) | 32 | An keyexchanging+authenticating+encrypting wrapper and multiplexer for `io.ReadWriteCloser` based on XChaCha20-poly1305, ECDH and ED25519. |
| <b>[secret](https://github.com/rsjethani/secret) | 27 | Prevent your secrets from leaking into logs, std* etc. |
| <b>[sslmgr](https://github.com/adrianosela/sslmgr) | 25 | SSL certificates made easy with a high level wrapper around acme/autocert. |
...
| <b>[multikey](https://github.com/adrianosela/multikey) | 4 | An n-out-of-N keys encryption/decryption framework based on Shamir's Secret Sharing algorithm. |
| <b>[Interpol](https://github.com/avahidi/interpol) | 4 | Rule-based data generator for fuzzing and penetration testing. |
| <b>[encid](https://github.com/bobg/encid) | 2 | Encode and decode encrypted integer IDs. |
| <b>[autocert](https://pkg.go.dev/golang.org/x/crypto/acme/autocert) | - | Auto provision Let's Encrypt certificates and start a TLS server. |
...
| <b>[mapstructure](https://github.com/mitchellh/mapstructure) | 7.8k | Go library for decoding generic map values into native Go structures. |
...
| <b>[csvutil](https://github.com/jszwec/csvutil) | 898 | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| <b>[colfer](https://github.com/pascaldekloe/colfer) | 733 | Code generation for the Colfer binary format. |
| <b>[cbor](https://github.com/fxamacker/cbor) | 669 | Small, safe, and easy CBOR encoding and decoding library. |
| <b>[go-capnproto](https://github.com/glycerine/go-capnproto) | 288 | Cap'n Proto library and parser for go. |
| <b>[php_session_decoder](https://github.com/yvasiyarov/php_session_decoder) | 161 | GoLang library for working with PHP session format and PHP Serialize/Unserialize functions. |
...
| <b>[binstruct](https://github.com/ghostiam/binstruct) | 92 | Golang binary decoder for mapping data into the structure. |
| <b>[bambam](https://github.com/glycerine/bambam) | 65 | generator for Cap'n Proto schemas from go. |
| <b>[asn1](https://github.com/PromonLogicalis/asn1) | 54 | Asn.1 BER and DER encoding library for golang. |
| <b>[bel](https://github.com/32leaves/bel) | 37 | Generate TypeScript interfaces from Go structs/interfaces. Useful for JSON RPC. |
...
| <b>[gotiny](https://github.com/raszia/gotiny) | 16 | Efficient Go serialization library, gotiny is almost as fast as serialization libraries that generate code. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Caddy](https://github.com/caddyserver/caddy) | 55.0k | Caddy is an alternative, HTTP/2 web server that's easy to configure and use. |
| <b>[etcd](https://github.com/etcd-io/etcd) | 47.0k | Highly-available key value store for shared configuration and service discovery. |
| <b>[etcd](https://github.com/coreos/etcd) | 47.0k | Highly-available key value store for shared configuration and service discovery. |
| <b>[minio](https://github.com/minio/minio) | 45.0k | Minio is a distributed object storage server. |
| <b>[SFTPGo](https://github.com/drakkan/sftpgo) | 8.4k | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| <b>[RoadRunner](https://github.com/spiral/roadrunner) | 7.7k | High-performance PHP application server, load-balancer and process manager. |
...
| <b>[flipt](https://github.com/markphelps/flipt) | 3.4k | A self contained feature flag solution written in Go and Vue.js |
...
| <b>[Trickster](https://github.com/tricksterproxy/trickster) | 2.0k | HTTP reverse proxy cache and time series accelerator. |
...
| <b>[go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 1.1k | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| <b>[Euterpe](https://github.com/ironsmile/euterpe) | 516 | Self-hosted music streaming server with built-in web UI and REST API. |
| <b>[dummy](https://github.com/neotoolkit/dummy) | 178 | Run mock server based off an API contract with one command. |
| <b>[dudeldu](https://github.com/krotik/dudeldu) | 144 | A simple SHOUTcast server. |
| <b>[go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) | 118 | Simple Reverse Proxy with Caching, written in Go, using Redis. |
| <b>[cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 100 | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
| <b>[lets-proxy2](https://github.com/rekby/lets-proxy2) | 94 | Reverse proxy for handle https with issue certificates in fly from lets-encrypt. |
| <b>[psql-streamer](https://github.com/blind-oracle/psql-streamer) | 58 | Stream database events from PostgreSQL to Kafka. |
| <b>[nginx-prometheus](https://github.com/blind-oracle/nginx-prometheus) | 41 | Nginx log parser and exporter to Prometheus. |
| <b>[simple-jwt-provider](https://github.com/leberKleber/simple-jwt-provider) | 39 | Simple and lightweight provider which exhibits JWTs, supports login, password-reset (via mail) and user management. |
| <b>[protoxy](https://github.com/camgraff/protoxy) | 35 | A proxy server that converts JSON request bodies to Protocol Buffers. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-streams](https://github.com/reugn/go-streams) | 1.8k | Go stream processing library. |
| <b>[machine](https://github.com/whitaker-io/machine) | 144 | Go library for writing and generating stream workers with built in metrics and traceability. |
| <b>[stream](https://github.com/youthlin/stream) | 87 | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
| <b>[goio](https://github.com/primetalk/goio) | 78 | An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2. |
...
| <b>[maroto](https://github.com/johnfercher/maroto) | 1.5k | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
| <b>[jet](https://github.com/CloudyKit/jet) | 1.2k | Jet template engine. |
| <b>[Razor](https://github.com/sipin/gorazor) | 846 | Razor view engine for Golang. |
| <b>[fasttemplate](https://github.com/valyala/fasttemplate) | 811 | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
| <b>[raymond](https://github.com/aymerick/raymond) | 585 | Complete handlebars implementation in Go. |
| <b>[ego](https://github.com/benbjohnson/ego) | 578 | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
| <b>[goview](https://github.com/foolin/goview) | 404 | Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application. |
| <b>[liquid](https://github.com/osteele/liquid) | 275 | Go implementation of Shopify Liquid templates. |
| <b>[Soy](https://github.com/robfig/soy) | 171 | Closure templates (aka Soy templates) for Go, following the [official spec](https://developers.google.com/closure/templates/). |
| <b>[extemplate](https://github.com/dannyvankooten/extemplate) | 57 | Tiny wrapper around html/template to allow for easy file-based template inheritance. |
| <b>[gospin](https://github.com/m1/gospin) | 55 | Article spinning and spintax/spinning syntax engine, useful for A/B, testing pieces of text/articles and creating more natural conversations. |
| <b>[got](https://github.com/goradd/got) | 27 | A Go code generator inspired by Hero and Fasttemplate. Has include files, custom tag definitions, injected Go code, language translation, and more. |
...
| <b>[gomponents](https://www.gomponents.com) | - | HTML 5 components in pure Go, that look something like this: `func(name string) g.Node { return Div(Class("headline"), g.Textf("Hi %v!", name)) }`. |
...
| <b>[GoConvey](https://github.com/smartystreets/goconvey/) | 8.1k | BDD-style framework with web UI and live reload. |
| <b>[go-cmp](https://github.com/google/go-cmp) | 4.0k | Package for comparing Go values in tests. |
| <b>[testcontainers-go](https://github.com/testcontainers/testcontainers-go) | 3.2k | A Go package that makes it simple to create and clean up container-based dependencies for automated integration/smoke tests. The clean, easy-to-use API enables developers to programmatically define containers that should be run as part of a test and clean up those resources when the test is done. |
...
| <b>[godog](https://github.com/cucumber/godog) | 2.2k | Cucumber BDD framework for Go. |
| <b>[godog](https://github.com/DATA-DOG/godog) | 2.2k | Cucumber or Behat like BDD framework for Go. |
...
| <b>[testfixtures](https://github.com/go-testfixtures/testfixtures) | 1.1k | A helper for Rails' like test fixtures to test database applications. |
...
| <b>[goblin](https://github.com/franela/goblin) | 884 | Mocha like testing framework fo Go. |
| <b>[goc](https://github.com/qiniu/goc) | 778 | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| <b>[baloo](https://github.com/h2non/baloo) | 772 | Expressive and versatile end-to-end HTTP API testing made easy. |
| <b>[embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 763 | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| <b>[go-mutesting](https://github.com/zimmski/go-mutesting) | 621 | Mutation testing for Go source code. |
| <b>[gotest.tools](https://github.com/gotestyourself/gotest.tools) | 494 | A collection of packages to augment the go testing package and support common patterns. |
| <b>[gofight](https://github.com/appleboy/gofight) | 440 | API Handler Testing for Golang Router framework. |
| <b>[go-testdeep](https://github.com/maxatome/go-testdeep) | 418 | Extremely flexible golang deep comparison, extends the go testing package. |
| <b>[testza](https://github.com/MarvinJWendt/testza) | 415 | Full-featured test framework with nice colorized output. |
| <b>[cupaloy](https://github.com/bradleyjkemp/cupaloy) | 289 | Simple snapshot testing addon for your test framework. |
| <b>[frisby](https://github.com/verdverm/frisby) | 276 | REST API testing framework. |
| <b>[got](https://github.com/ysmood/got) | 262 | An enjoyable golang test framework. |
| <b>[endly](https://github.com/viant/endly) | 260 | Declarative end to end functional testing. |
| <b>[go-hit](https://github.com/Eun/go-hit) | 252 | Hit is an http integration test framework written in golang. |
| <b>[go-carpet](https://github.com/msoap/go-carpet) | 243 | Tool for viewing test coverage in terminal. |
| <b>[commander](https://github.com/SimonBaeumer/commander) | 223 | Tool for testing cli applications on windows, linux and osx. |
| <b>[charlatan](https://github.com/percolate/charlatan) | 200 | Tool to generate fake interface implementations for tests. |
| <b>[dbcleaner](https://github.com/khaiql/dbcleaner) | 158 | Clean database for testing purpose, inspired by `database_cleaner` in Ruby. |
| <b>[jsonassert](https://github.com/kinbiko/jsonassert) | 121 | Package for verifying that your JSON payloads are serialized correctly. |
| <b>[testcase](https://github.com/adamluzsi/testcase) | 116 | Idiomatic testing framework for Behavior Driven Development. |
| <b>[GoSpec](https://github.com/orfjackal/gospec) | 114 | BDD-style testing framework for the Go programming language. |
| <b>[wstest](https://github.com/posener/wstest) | 102 | Websocket client for unit-testing a websocket http.Handler. |
| <b>[gocrest](https://github.com/corbym/gocrest) | 101 | Composable hamcrest-like matchers for Go assertions. |
| <b>[be](https://github.com/carlmjohnson/be) | 99 | The minimalist generic test assertion library. |
| <b>[Gont](https://github.com/stv0g/gont) | 73 | Go network testing toolkit for testing building complex network topologies using Linux namespaces. |
| <b>[gherkingen](https://github.com/hedhyw/gherkingen) | 69 | BDD boilerplate generator and framework. |
...
| <b>[covergates](https://github.com/covergates/covergates) | 61 | Self-hosted code coverage report review and management service. |
...
| <b>[gomatch](https://github.com/jfilipczyk/gomatch) | 46 | library created for testing JSON against patterns. |
| <b>[testcerts](https://github.com/madflojo/testcerts) | 46 | Dynamically generate self-signed certificates and certificate authorities within your test functions. |
| <b>[dsunit](https://github.com/viant/dsunit) | 43 | Datastore testing for SQL, NoSQL, structured files. |
| <b>[fluentassert](https://github.com/fluentassert/verify) | 39 | Extensible, type-safe, fluent assertion Go library. |
| <b>[Hamcrest](https://github.com/rdrdr/hamcrest) | 30 | fluent framework for declarative Matcher objects that, when applied to input values, produce self-describing results. |
| <b>[fixenv](https://github.com/rekby/fixenv) | 28 | Fixture manage engine, inspired by pytest fixtures. |
...
| <b>[biff](https://github.com/fulldump/biff) | 14 | Bifurcation testing framework, BDD compatible. |
...
| <b>[badio](https://github.com/cavaliercoder/badio) | 12 | Extensions to Go's `testing/iotest` package. |
| <b>[stop-and-go](https://github.com/elgohr/stop-and-go) | 10 | Testing helper for concurrency. |
| <b>[Tt](https://github.com/vcaesar/tt) | 7 | Simple and colorful test tools. |
...
| <b>[go-mysql-test-container](https://github.com/arikama/go-mysql-test-container) | 2 | Golang MySQL testcontainer to help with MySQL integration testing. |
...
| <b>[go-snaps](http://github.com/gkampitakis/go-snaps) | 0 | Jest-like snapshot testing in Golang. |
...
| <b>[go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 5.9k | Mock SQL driver for testing database interactions. |
...
| <b>[httpmock](https://github.com/jarcoal/httpmock) | 1.9k | Easy mocking of HTTP responses from external resources. |
| <b>[counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 925 | Tool for generating self-contained mock objects. |
| <b>[go-txdb](https://github.com/DATA-DOG/go-txdb) | 627 | Single transaction based database driver mainly for testing purposes. |
| <b>[minimock](https://github.com/gojuno/minimock) | 563 | Mock generator for Go interfaces. |
| <b>[xgo](https://github.com/xhd2015/xgo) | 246 | A general pureposed function mocking library. |
| <b>[govcr](https://github.com/seborama/govcr) | 165 | HTTP mock for Golang: record and replay HTTP interactions for offline testing. |
| <b>[go-localstack](https://github.com/elgohr/go-localstack) | 75 | Tool for using localstack in AWS testing. |
...
| <b>[mooncake](https://github.com/GuilhermeCaruso/mooncake) | 18 | A simple way to generate mocks for multiple purposes. |
...
| <b>[Tavor](https://github.com/zimmski/tavor) | 244 | Generic fuzzing and delta-debugging framework. |
...
| <b>[rod](https://github.com/go-rod/rod) | 4.9k | A Devtools driver to make web automation and scraping easy. |
...
| <b>[playwright-go](https://github.com/mxschmitt/playwright-go) | 1.8k | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| <b>[cdp](https://github.com/mafredri/cdp) | 718 | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
| <b>[ggr](https://github.com/aerokube/ggr) | 312 | a lightweight server that routes and proxies Selenium WebDriver requests to multiple Selenium hubs. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[failpoint](https://github.com/pingcap/failpoint) | 806 | An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| <b>[bytes](https://github.com/labstack/gommon/tree/master/bytes) | 527 | Formats and parses numeric byte values (10K, 2M, 3G, etc.). |
| <b>[gotabulate](https://github.com/bndr/gotabulate) | 312 | Easily pretty-print your tabular data with Go. |
| <b>[align](https://github.com/Guitarbum722/align) | 83 | A general purpose application that aligns text. |
| <b>[go-fixedwidth](https://github.com/ianlopshire/go-fixedwidth) | 80 | Fixed-width text formatting (encoder/decoder with reflection). |
| <b>[address](https://github.com/bojanz/address) | 70 | Handles address representation, validation and formatting. |
...
| <b>[goldmark](https://github.com/yuin/goldmark) | 3.4k | A Markdown parser written in Go. Easy to extend, standard (CommonMark) compliant, well structured. |
| <b>[go-toml](https://github.com/pelletier/go-toml) | 1.7k | Go library for the TOML format with query support and handy cli tools. |
| <b>[html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 739 | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
| <b>[htmlquery](https://github.com/antchfx/htmlquery) | 704 | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| <b>[mxj](https://github.com/clbanning/mxj) | 610 | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
| <b>[goq](https://github.com/andrewstuart/goq) | 254 | Declarative unmarshaling of HTML using struct tags with jQuery syntax (uses GoQuery). |
| <b>[bafi](https://github.com/mmalcek/bafi) | 94 | Universal JSON, BSON, YAML, XML translator to ANY format using templates. |
| <b>[go-output-format](https://github.com/drewstinnett/go-output-format) | 15 | Output go structures into multiple formats (YAML/JSON/etc) in your command line app. |
| <b>[bbConvert](https://github.com/CalebQ42/bbConvert) | 11 | Converts bbCode to HTML that allows you to add support for custom bbCode tags. |
| <b>[htmlyaml](https://github.com/nikolaydubina/htmlyaml) | 4 | Rich rendering of YAML as HTML in Go |
| <b>[htree](https://github.com/bobg/htree) | 4 | Traverse, navigate, filter, and otherwise process trees of [html.Node](https://pkg.go.dev/golang.org/x/net/html#Node) objects. |
...
| <b>[commonregex](https://github.com/mingrammer/commonregex) | 885 | A collection of common regular expressions for Go. |
| <b>[omniparser](https://github.com/jf-tech/omniparser) | 643 | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| <b>[gographviz](https://github.com/awalterschulze/gographviz) | 546 | Parses the Graphviz DOT language. |
| <b>[go-nmea](https://github.com/adrianmo/go-nmea) | 206 | NMEA parser library for the Go language. |
| <b>[editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) | 133 | Editorconfig file parser and manipulator for Go. |
| <b>[sdp](https://github.com/gortc/sdp) | 113 | SDP: Session Description Protocol [[RFC 4566](https://tools.ietf.org/html/rfc4566)]. |
| <b>[go-vcard](https://github.com/emersion/go-vcard) | 100 | Parse and format vCard. |
| <b>[did](https://github.com/ockam-network/did) | 86 | DID (Decentralized Identifiers) Parser and Stringer in Go. |
| <b>[tokenizer](https://github.com/bzick/tokenizer) | 86 | — Parse any string, slice or infinite buffer to any tokens. |
| <b>[allot](https://github.com/sbstjn/allot) | 58 | Placeholder and wildcard text parsing for CLI tools and bots. |
| <b>[normalize](https://github.com/avito-tech/normalize) | 46 | Sanitize, normalize and compare fuzzy text. |
| <b>[gonameparts](https://github.com/polera/gonameparts) | 41 | Parses human names into individual name parts. |
| <b>[xj2go](https://github.com/stackerzzq/xj2go) | 34 | Convert xml or json to go struct. |
| <b>[go-fasttld](https://github.com/elliotwutingfeng/go-fasttld) | 31 | High performance top level domains (TLD) extraction module. |
| <b>[codetree](https://github.com/aerogo/codetree) | 24 | Parses indented code (python, pixy, scarlet, etc.) and returns a tree structure. |
| <b>[parseargs-go](https://github.com/nproc/parseargs-go) | 10 | string argument parser that understands quotes and backslashes. |
| <b>[encdec](https://github.com/mickep76/encdec) | 9 | Package provides a generic interface to encoders and decoders. |
| <b>[ltsv](https://github.com/Wing924/ltsv) | 9 | High performance [LTSV (Labeled Tab Separated Value)](http://ltsv.org/) reader for Go. |
| <b>[doi](https://github.com/hscells/doi) | 8 | Document object identifier (doi) parser in Go. |
| <b>[prattle](https://github.com/askeladdk/prattle) | 6 | Scan and parse LL(1) grammars simply and efficiently. |
| <b>[parth](https://github.com/codemodus/parth) | 0 | URL path segmentation parsing. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[rex](https://github.com/hedhyw/rex) | 186 | Regular expressions builder. |
| <b>[regroup](https://github.com/oriser/regroup) | 142 | Match regex expression named groups into go struct using struct tags and automatic parsing. |
| <b>[goregen](https://github.com/zach-klippenstein/goregen) | 90 | Library for generating random strings from regular expressions. |
| <b>[genex](https://github.com/alixaxel/genex) | 76 | Count and expand Regular Expressions into all matching Strings. |
| <b>[go-wildcard](https://github.com/IGLOU-EU/go-wildcard) | 71 | Simple and lightweight wildcard pattern matching. |
...
| <b>[gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) | 63 | A sanitization-based swear filter for Go. |
...
| <b>[xurls](https://github.com/mvdan/xurls) | 1.2k | Extract urls from text. |
| <b>[dataflowkit](https://github.com/slotix/dataflowkit) | 646 | Web scraping Framework to turn websites into structured data. |
...
| <b>[pagser](https://github.com/foolin/pagser) | 102 | Pagser is a simple, extensible, configurable parse and deserialize html page to struct based on goquery and struct tags for golang crawler. |
| <b>[Tagify](https://github.com/zoomio/tagify) | 36 | Produces a set of tags from given source. |
| <b>[go-recipe](https://github.com/kkyr/go-recipe) | 25 | A package for scraping recipes from websites. |
| <b>[walker](https://github.com/cyucelen/walker) | 8 | Seamlessly fetch paginated data from any source. Simple and high performance API scraping included. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[podcast](https://github.com/eduncan911/podcast) | 128 | iTunes Compliant and RSS 2.0 Podcast Generator in Golang |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-runewidth](https://github.com/mattn/go-runewidth) | 592 | Functions to get fixed width of the character or string. |
| <b>[radix](https://github.com/yourbasic/radix) | 191 | Fast string sorting algorithm. |
| <b>[go-zero-width](https://github.com/trubitsyn/go-zero-width) | 109 | Zero-width character detection and removal for Go. |
| <b>[petrovich](https://github.com/striker2000/petrovich) | 44 | Petrovich is the library which inflects Russian names to given grammatical case. |
| <b>[kace](https://github.com/codemodus/kace) | 20 | Common case conversions covering common initialisms. |
| <b>[TySug](https://github.com/Dynom/TySug) | 18 | Alternative suggestions with respect to keyboard layouts. |
...
| <b>[go-openai](https://github.com/sashabaranov/go-openai) | 8.4k | OpenAI ChatGPT, DALL·E, Whisper API library for Go. |
| <b>[discordgo](https://github.com/bwmarrin/discordgo) | 4.8k | Go bindings for the Discord Chat API. |
...
| <b>[minio-go](https://github.com/minio/minio-go) | 2.3k | Minio Go Library for Amazon S3 compatible cloud storage. |
| <b>[stripe](https://github.com/stripe/stripe-go) | 2.0k | Go client for the Stripe API. |
...
| <b>[facebook](https://github.com/huandu/facebook) | 1.3k | Go Library that supports the Facebook Graph API. |
...
| <b>[webhooks](https://github.com/go-playground/webhooks) | 935 | Webhook receiver for GitHub and Bitbucket. |
| <b>[twitter-scraper](https://github.com/n0madic/twitter-scraper) | 863 | Scrape the Twitter Frontend API without authentication and limits. |
| <b>[paypal](https://github.com/logpacker/PayPal-Go-SDK) | 650 | Wrapper for PayPal payment API. |
| <b>[geo-golang](https://github.com/codingsince1985/geo-golang) | 502 | Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](https://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](https://opencagedata.com/api), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs. |
| <b>[lark](https://github.com/chyroc/lark) | 389 | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
| <b>[openaigo](https://github.com/otiai10/openaigo) | 286 | OpenAI GPT3/GPT3.5 ChatGPT API client library for Go. |
| <b>[ethrpc](https://github.com/onrik/ethrpc) | 262 | Go bindings for Ethereum JSON RPC API. |
...
| <b>[go-lark](https://github.com/go-lark/lark) | 189 | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
| <b>[wit-go](https://github.com/wit-ai/wit-go) | 151 | Go client for wit.ai HTTP API. |
| <b>[go-trending](https://github.com/andygrunwald/go-trending) | 140 | Go library for accessing [trending repositories](https://github.com/trending) and [developers](https://github.com/trending/developers) at Github. |
| <b>[pushover](https://github.com/gregdel/pushover) | 140 | Go wrapper for the Pushover API. |
| <b>[Medium](https://github.com/Medium/medium-sdk-go) | 139 | Golang SDK for Medium's OAuth2 API. |
| <b>[simples3](https://github.com/rhnvrm/simples3) | 136 | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
| <b>[gosip](https://github.com/koltyakov/gosip) | 135 | Go client library SharePoint API. |
...
| <b>[go-atlassian](https://github.com/ctreminiom/go-atlassian) | 109 | Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud) |
| <b>[hipchat](https://github.com/andybons/hipchat) | 104 | This project implements a golang client library for the Hipchat API. |
| <b>[golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 102 | Golang wrapper for The Movie Database API v3. |
...
| <b>[disgo](https://github.com/switchupcb/disgo) | 87 | Go API Wrapper for the Discord API. |
| <b>[gogtrends](https://github.com/groovili/gogtrends) | 79 | Google Trends Unofficial API. |
...
| <b>[go-postman-collection](https://github.com/rbretecher/go-postman-collection) | 73 | Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia). |
| <b>[go-unsplash](https://github.com/hbagdi/go-unsplash) | 73 | Go client library for the [Unsplash.com](https://unsplash.com) API. |
| <b>[airtable](https://github.com/mehanizm/airtable) | 71 | Go client library for the [Airtable API](https://airtable.com/api). |
| <b>[ynab](https://github.com/brunomvsouza/ynab.go) | 67 | Go wrapper for the YNAB API. |
| <b>[circleci](https://github.com/jszwedko/go-circleci) | 66 | Go client library for interacting with CircleCI's API. |
| <b>[go-redoc](https://github.com/mvrilo/go-redoc) | 66 | Embedded OpenAPI/Swagger documentation ui for Go using [ReDoc](https://redocly.com/). |
...
| <b>[GoMusicBrainz](https://github.com/michiwend/gomusicbrainz) | 56 | Go MusicBrainz WS2 client library. |
...
| <b>[spotify](https://github.com/rapito/go-spotify) | 50 | Go Library to access Spotify WEB API. |
| <b>[swag](https://github.com/zc2638/swag) | 45 | No comments, simple go wrapper to create swagger 2.0 compatible APIs. Support most routing frameworks, such as built-in, gin, chi, mux, echo, httprouter, fasthttp and more. |
| <b>[golyrics](https://github.com/mamal72/golyrics) | 41 | Golyrics is a Go library to fetch music lyrics data from the Wikia website. |
| <b>[go-myanimelist](https://github.com/nstratos/go-myanimelist) | 39 | Go client library for accessing the [MyAnimeList API](https://myanimelist.net/apiconfig/references/api/v2). |
| <b>[patreon-go](https://github.com/mxpv/patreon-go) | 38 | Go library for Patreon API. |
| <b>[lastpass-go](https://github.com/ansd/lastpass-go) | 34 | Go client library for the [LastPass](https://www.lastpass.com/) API. |
| <b>[gami](https://github.com/bit4bit/gami) | 33 | Go library for Asterisk Manager Interface. |
| <b>[translate](https://github.com/poorny/translate) | 33 | Go online translation package. |
| <b>[GoFreeDB](https://github.com/FreeLeh/GoFreeDB) | 33 | Golang library providing common and simple database abstractions on top of Google Sheets. |
| <b>[steam](https://github.com/sostronk/go-steam) | 32 | Go Library to interact with Steam game servers. |
| <b>[gcm](https://github.com/Aorioli/gcm) | 31 | Go library for Google Cloud Messaging. |
| <b>[shopify](https://github.com/rapito/go-shopify) | 26 | Go Library to make CRUD request to the Shopify API. |
| <b>[device-check-go](https://github.com/rinchsan/device-check-go) | 25 | Go client library for interacting with [iOS DeviceCheck API](https://developer.apple.com/documentation/devicecheck) v1. |
...
| <b>[go-openproject](https://github.com/manuelbcd/go-openproject) | 16 | Go client library for interacting with [OpenProject](https://docs.openproject.org/api/) API. |
| <b>[bqwriter](https://github.com/OTA-Insight/bqwriter) | 15 | High Level Go Library to write data into [Google BigQuery](https://cloud.google.com/bigquery) at a high throughout. |
...
| <b>[rawg-sdk-go](https://github.com/dimuska139/rawg-sdk-go) | 11 | Go library for the [RAWG Video Games Database](https://rawg.io/) API |
...
| <b>[goagi](https://github.com/staskobzar/goagi) | 10 | Go library to build Asterisk PBX agi/fastagi applications. |
| <b>[ip2location-io-go](https://github.com/ip2location/ip2location-io-go) | 10 | Go wrapper for the IP2Location.io API [IP2Location.io](https://www.ip2location.io/). |
...
| <b>[newsapi-go](https://github.com/jellydator/newsapi-go) | 7 | Go client for [NewsAPI](https://newsapi.org/). |
...
| <b>[gopensky](https://github.com/navidys/gopensky) | 2 | Go client implementation for [OpenSKY Network](https://opensky-network.org/) live's API (airspace ADS-B and Mode S data). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[fzf](https://github.com/junegunn/fzf) | 61.0k | Command-line fuzzy finder written in Go. |
| <b>[dive](https://github.com/wagoodman/dive) | 44.0k | A tool for exploring each layer in a Docker image. |
...
| <b>[lo](https://github.com/samber/lo) | 16.0k | A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...) |
| <b>[sqlx](https://github.com/jmoiron/sqlx) | 16.0k | provides a set of extensions on top of the excellent built-in database/sql package. |
| <b>[air](https://github.com/cosmtrek/air) | 16.0k | Air - Live reload for Go apps. |
...
| <b>[peco](https://github.com/peco/peco) | 7.6k | Simplistic interactive filtering tool. |
| <b>[go-funk](https://github.com/thoas/go-funk) | 4.6k | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| <b>[mc](https://github.com/minio/mc) | 2.7k | Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems. |
...
| <b>[retry-go](https://github.com/avast/retry-go) | 2.3k | Simple library for retry mechanism. |
...
| <b>[jump](https://github.com/gsamokovarov/jump) | 1.8k | Jump helps you navigate faster by learning your habits. |
...
| <b>[mimetype](https://github.com/gabriel-vasile/mimetype) | 1.4k | Package for MIME type detection based on magic numbers. |
| <b>[scany](https://github.com/georgysavva/scany) | 1.2k | Library for scanning data from a database into Go structs and more. |
| <b>[circuitbreaker](https://github.com/rubyist/circuitbreaker) | 1.1k | Circuit Breakers in Go. |
| <b>[hostctl](https://github.com/guumaster/hostctl) | 1000 | A CLI tool to manage /etc/hosts with easy commands. |
| <b>[git-time-metric](https://github.com/git-time-metric/gtm) | 965 | Simple, seamless, lightweight time tracking for Git. |
| <b>[immortal](https://github.com/immortal/immortal) | 795 | \*nix cross-platform (OS agnostic) supervisor. |
| <b>[upterm](https://github.com/owenthereal/upterm) | 786 | A tool for developers to share terminal/tmux sessions securely over the web. It’s perfect for remote pair programming, accessing computers behind NATs/firewalls, remote debugging, and more. |
| <b>[circuit](https://github.com/cep21/circuit) | 747 | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
| <b>[delve](https://github.com/derekparker/delve) | 626 | Go debugger. |
| <b>[changie](https://github.com/miniscruff/changie) | 615 | Automated changelog tool for preparing releases with lots of customization options. |
| <b>[ergo](https://github.com/cristianoliveira/ergo) | 615 | The management of multiple local services running over different ports made easy. |
| <b>[clockwork](https://github.com/jonboulle/clockwork) | 608 | A simple fake clock for golang. |
| <b>[htcat](https://github.com/htcat/htcat) | 554 | Parallel and Pipelined HTTP GET Utility. |
| <b>[clipboard](https://github.com/golang-design/clipboard) | 542 | 📋 cross-platform clipboard package in Go. |
| <b>[scan](https://github.com/blockloop/scan) | 525 | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
| <b>[koazee](https://github.com/wesovilabs/koazee) | 524 | Library inspired in Lazy evaluation and functional programming that takes the hassle out of working with arrays. |
| <b>[godaemon](https://github.com/VividCortex/godaemon) | 493 | Utility to write daemons. |
| <b>[remote-touchpad](https://github.com/Unrud/remote-touchpad) | 493 | Control mouse and keyboard from a smartphone. |
| <b>[go-dry](https://github.com/ungerik/go-dry) | 490 | DRY (don't repeat yourself) package for Go. |
| <b>[gubrak](https://github.com/novalagung/gubrak) | 479 | Golang utility library with syntactic sugar. It's like lodash, but for golang. |
| <b>[gopencils](https://github.com/bndr/gopencils) | 452 | Small and simple package to easily consume REST APIs. |
| <b>[Deepcopier](https://github.com/ulule/deepcopier) | 442 | Simple struct copying for Go. |
| <b>[mani](https://github.com/alajmo/mani) | 430 | CLI tool to help you manage multiple repositories. |
| <b>[request](https://github.com/mozillazg/request) | 427 | Go HTTP Requests for Humans™. |
| <b>[go-rate](https://github.com/beefsack/go-rate) | 397 | Timed rate limiter for Go. |
| <b>[countries](https://github.com/biter777/countries) | 368 | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
| <b>[limiters](https://github.com/mennanov/limiters) | 342 | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
| <b>[grofer](https://github.com/pesos/grofer) | 340 | A system and resource monitoring tool written in Golang! |
| <b>[retry](https://github.com/kamilsk/retry) | 335 | The most advanced functional mechanism to perform actions repetitively until successful. |
| <b>[serve](https://github.com/syntaqx/serve) | 326 | A static http server anywhere you need. |
| <b>[gotenv](https://github.com/subosito/gotenv) | 287 | Load environment variables from `.env` or any `io.Reader` in Go. |
| <b>[util](https://github.com/shomali11/util) | 287 | Collection of useful utility functions. (strings, concurrency, manipulations, ...). |
| <b>[config-file-validator](https://github.com/Boeing/config-file-validator) | 286 | Cross Platform tool to validate configuration files. |
| <b>[rospo](https://github.com/ferama/rospo) | 281 | Simple and reliable ssh tunnels with embedded ssh server in Golang. |
| <b>[gohper](https://github.com/cosiner/gohper) | 255 | Various tools/modules help for development. |
| <b>[wifiqr](https://github.com/reugn/wifiqr) | 254 | Wi-Fi QR Code Generator. |
| <b>[go-trigger](https://github.com/sadlil/go-trigger) | 245 | Go-lang global event triggerer, Register Events with an id and trigger the event from anywhere from your project. |
| <b>[pattern-match](https://github.com/alexpantyukhin/go-pattern-match) | 243 | Pattern matching libray. |
| <b>[go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 215 | XML Sitemap generator written in Go. |
| <b>[toolbox](https://github.com/viant/toolbox) | 196 | Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer. |
| <b>[Death](https://github.com/vrecan/death) | 194 | Managing go application shutdown with signals. |
| <b>[go-bind-plugin](https://github.com/wendigo/go-bind-plugin) | 184 | go:generate tool for wrapping symbols exported by golang plugins (1.8 only). |
| <b>[moldova](https://github.com/StabbyCutyou/moldova) | 168 | Utility for generating random data based on an input template. |
| <b>[apm](https://github.com/topfreegames/apm) | 167 | Process manager for Golang applications with an HTTP API. |
| <b>[rerun](https://github.com/ivpusic/rerun) | 167 | Recompiling and rerunning go apps when source changes. |
| <b>[go-bsdiff](https://github.com/gabstv/go-bsdiff) | 160 | Pure Go bsdiff and bspatch libraries and CLI tools. |
...
| <b>[cryptgo](https://github.com/Gituser143/cryptgo) | 151 | Crytpgo is a TUI based application written purely in Go to monitor and observe cryptocurrency prices in real time! |
| <b>[cmd](https://github.com/SimonBaeumer/cmd) | 149 | Library for executing shell commands on osx, windows and linux. |
| <b>[goval](https://github.com/maja42/goval) | 148 | Evaluate arbitrary expressions in Go. |
| <b>[filter](https://github.com/gookit/filter) | 147 | provide filtering, sanitizing, and conversion of Go data. |
| <b>[nostromo](https://github.com/pokanop/nostromo) | 141 | CLI for building powerful aliases. |
...
| <b>[sorty](https://github.com/jfcg/sorty) | 131 | Fast Concurrent / Parallel Sorting. |
| <b>[mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 130 | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
| <b>[lrserver](https://github.com/jaschaephraim/lrserver) | 124 | LiveReload server for Go. |
| <b>[goseaweedfs](https://github.com/linxGnu/goseaweedfs) | 114 | SeaweedFS client library with almost full features. |
| <b>[go-lock](https://github.com/viney-shih/go-lock) | 109 | go-lock is a lock library implementing read-write mutex and read-write trylock without starvation. |
...
| <b>[mimemagic](https://github.com/zRedShift/mimemagic) | 98 | Pure Go ultra performant MIME sniffing library/utility. |
| <b>[go-health](https://github.com/Talento90/go-health) | 93 | Health package simplifies the way you add health check to your services. |
| <b>[go-lambda-cleanup](https://github.com/karl-cardenas-coding/go-lambda-cleanup) | 88 | A CLI for removing unused or previous versions of AWS Lambdas. |
| <b>[pgo](https://github.com/arthurkushman/pgo) | 86 | Convenient functions for PHP community. |
| <b>[go-pattern-match](https://github.com/PhakornKiong/go-pattern-match) | 86 | A Pattern matching library inspired by ts-pattern. |
| <b>[repeat](https://github.com/ssgreg/repeat) | 85 | Go implementation of different backoff strategies useful for retrying operations and heartbeating. |
| <b>[countries](https://github.com/pioz/countries) | 84 | All you need when you are working with countries in Go. |
| <b>[pm](https://github.com/VividCortex/pm) | 81 | Process (i.e. goroutine) manager with an HTTP API. |
| <b>[equalizer](https://github.com/reugn/equalizer) | 80 | Quota manager and rate limiter collection for Go. |
| <b>[handy](https://github.com/miguelpragier/handy) | 79 | Many utilities and helpers like string handlers/formatters and validators. |
...
| <b>[go-astitodo](https://github.com/asticode/go-astitodo) | 62 | Parse TODOs in your GO code. |
...
| <b>[backscanner](https://github.com/icza/backscanner) | 61 | A scanner similar to bufio.Scanner, but it reads and returns lines in reverse order, starting at a given position and going backward. |
| <b>[dbt](https://github.com/nikogura/dbt) | 61 | A framework for running self-updating signed binaries from a central, trusted repository. |
| <b>[golog](https://github.com/mlimaloureiro/golog) | 61 | Easy and lightweight CLI tool to time track your tasks. |
| <b>[scan](https://github.com/wroge/scan) | 60 | Scan sql rows into any type powered by generics. |
...
| <b>[golarm](https://github.com/msempere/golarm) | 53 | Fire alarms with system events. |
...
| <b>[goback](https://github.com/carlescere/goback) | 49 | Go simple exponential backoff package. |
| <b>[retry-go](https://github.com/rafaeljesus/retry-go) | 48 | Retrying made simple and easy for golang. |
| <b>[copy](https://github.com/gotidy/copy) | 46 | Package for fast copying structs of different types. |
| <b>[cvt](https://github.com/shockerli/cvt) | 46 | Easy and safe convert any value to another type. |
...
| <b>[slicer](https://github.com/leaanthony/slicer) | 46 | Makes working with slices easier. |
| <b>[sshman](https://github.com/shoobyban/sshman) | 46 | SSH Manager for authorized_keys files on multiple remote servers. |
| <b>[gostrutils](https://github.com/ik5/gostrutils) | 44 | Collections of string manipulation and conversion functions. |
| <b>[ghokin](https://github.com/antham/ghokin) | 43 | Parallelized formatter with no external dependencies for gherkin (cucumber, behat...). |
...
| <b>[evaluator](https://github.com/nullne/evaluator) | 39 | Evaluate an expression dynamicly based on s-expression. It's simple and easy to extend. |
| <b>[yogo](https://github.com/antham/yogo) | 39 | Check yopmail mails from command line. |
| <b>[throttle](https://github.com/yudppp/throttle) | 37 | Throttle is an object that will perform exactly one action per duration. |
...
| <b>[mimesniffer](https://github.com/aofei/mimesniffer) | 33 | A MIME type sniffer for Go. |
...
| <b>[watchhttp](https://github.com/nikolaydubina/watchhttp) | 30 | Run command periodically and expose latest STDOUT or its rich delta as HTTP endpoint. |
| <b>[gofn](https://github.com/tiendc/gofn) | 30 | High performance utility functions written using Generics for Go 1.18+. |
| <b>[goplaceholder](https://github.com/michiwend/goplaceholder) | 29 | a small golang lib to generate placeholder images. |
...
| <b>[graterm](https://github.com/skovtunenko/graterm) | 26 | Provides primitives to perform ordered (sequential/concurrent) GRAceful TERMination (aka shutdown) in Go application. |
| <b>[ctxutil](https://github.com/posener/ctxutil) | 25 | A collection of utility functions for contexts. |
| <b>[ptr](https://github.com/gotidy/ptr) | 24 | Package that provide functions for simplified creation of pointers from constants of basic types. |
| <b>[structs](https://github.com/PumpkinSeed/structs) | 24 | Implement simple functions to manipulate structs. |
| <b>[go-convert](https://github.com/Eun/go-convert) | 23 | Package go-convert enables you to convert a value into another type. |
| <b>[jsend](https://github.com/clevergo/jsend) | 22 | JSend's implementation writen in Go. |
| <b>[just](https://github.com/kazhuravlev/just) | 22 | Just a collection of useful functions for working with generic data structures. |
| <b>[go-type](https://github.com/mikekonan/go-types) | 19 | Library providing Go types for store/validation and transfer of ISO-4217, ISO-3166, and other types. |
...
| <b>[go-qr](https://github.com/piglig/go-qr) | 16 | A native, high-quality and minimalistic QR code generator. |
| <b>[go-actuator](https://github.com/sinhashubham95/go-actuator) | 15 | Production ready features for Go based web frameworks. |
| <b>[command](https://github.com/txgruppi/command) | 14 | Command pattern for Go with thread safe serial and parallel dispatcher. |
| <b>[go-clip](https://github.com/prashantgupta24/go-clip) | 13 | A minimalistic clipboard manager for Mac. |
...
| <b>[statiks](https://github.com/janiltonmaciel/statiks) | 11 | Fast, zero-configuration, static HTTP filer server. |
| <b>[retry](https://github.com/percolate/retry) | 10 | A simple but highly configurable retry package for Go. |
| <b>[sliceconv](https://github.com/Henry-Sarabia/sliceconv) | 10 | Slice conversion between primitive types. |
| <b>[nfdump](https://github.com/chrispassas/nfdump) | 9 | Read nfdump netflow files. |
| <b>[goctx](https://github.com/zerosnake0/goctx) | 8 | Get your context value with high performance. |
| <b>[loncha](https://github.com/kazu/loncha) | 8 | A high-performance slice Utilities. |
| <b>[lets-go](https://github.com/aplescia-chwy/lets-go) | 7 | Go module that provides common utilities for Cloud Native REST API development. Also contains AWS Specific utilities. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[uuid](https://github.com/google/uuid) | 5.1k | Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services. |
...
| <b>[wuid](https://github.com/edwingeng/wuid) | 520 | An extremely fast unique number generator, 10-135 times faster than UUID. |
| <b>[sno](https://github.com/muyo/sno) | 89 | Compact, sortable and fast unique IDs with embedded metadata. |
| <b>[nanoid](https://github.com/aidarkhanov/nanoid) | 60 | A tiny and efficient Go unique string ID generator. |
| <b>[goid](https://github.com/jakehl/goid) | 41 | Generate and Parse RFC4122 compliant V4 UUIDs. |
| <b>[gouid](https://github.com/twharmon/gouid) | 23 | Generate cryptographically secure random string IDs with just one allocation. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[validator](https://github.com/go-playground/validator) | 16.0k | Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving. |
...
| <b>[validate](https://github.com/gookit/validate) | 1000 | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
| <b>[checkdigit](https://github.com/osamingo/checkdigit) | 111 | Provide check digit algorithms (Luhn, Verhoeff, Damm) and calculators (ISBN, EAN, JAN, UPC, etc.). |
| <b>[jio](https://github.com/faceair/jio) | 105 | jio is a json schema validator similar to [joi](https://github.com/hapijs/joi). |
| <b>[validate](https://github.com/gobuffalo/validate) | 95 | This package provides a framework for writing validations for Go applications. |
| <b>[terraform-validator](https://github.com/thazelart/terraform-validator) | 79 | A norms and conventions validator for Terraform. |
| <b>[gody](https://github.com/guiferpa/gody) | 67 | :balloon: A lightweight struct validator for Go. |
| <b>[govalid](https://github.com/twharmon/govalid) | 39 | Fast, tag-based validation for structs. |
| <b>[valix](https://github.com/marrow16/valix) | 26 | Go package for validating requests |
| <b>[hvalid](https://github.com/lyonnee/hvalid) | 9 | hvalid is a lightweight validation library written in Go language. It provides a custom validator interface and a series of common validation functions to help developers quickly implement data validation. |
...
| <b>[githooks](https://github.com/gabyx/githooks) | 98 | Per-repo and shared Git hooks with version control and auto update. |
| <b>[gh](https://github.com/rjeczalik/gh) | 82 | Scriptable server and net/http middleware for GitHub Webhooks. |
| <b>[go-vcs](https://github.com/sourcegraph/go-vcs) | 79 | manipulate and inspect VCS repositories in Go. |
| <b>[froggit-go](https://github.com/jfrog/froggit-go) | 42 | Froggit-Go is a Go library, allowing to perform actions on VCS providers. |
...
| <b>[m3u8](https://github.com/grafov/m3u8) | 1.2k | Parser and generator library of M3U8 playlists for Apple HLS. |
| <b>[gmf](https://github.com/3d0c/gmf) | 874 | Go bindings for FFmpeg av\* libraries. |
| <b>[gortsplib](https://github.com/aler9/gortsplib) | 624 | Pure Go RTSP server and client library. |
| <b>[go-astisub](https://github.com/asticode/go-astisub) | 558 | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| <b>[go-astits](https://github.com/asticode/go-astits) | 527 | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
| <b>[libvlc-go](https://github.com/adrg/libvlc-go) | 416 | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
| <b>[go-astiav](https://github.com/asticode/go-astiav) | 197 | Better C bindings for ffmpeg in GO. |
| <b>[gst](https://github.com/ziutek/gst) | 168 | Go bindings for GStreamer. |
| <b>[go-m3u8](https://github.com/quangngotan95/go-m3u8) | 112 | Parser and generator library for Apple m3u8 playlists. |
| <b>[v4l](https://github.com/korandiz/v4l) | 77 | Video capture library for Linux, written in Go. |
| <b>[go-m3u8](https://github.com/etherlabsio/go-m3u8) | 27 | Parser and generator library for Apple m3u8 playlists. Actively maintained version of quangngotan95/go-m3u8 with improvements and latest HLS playlist parsing compatibility. |
| <b>[libgosubs](https://github.com/wargarblgarbl/libgosubs) | 25 | Subtitle format support for go. Supports .srt, .ttml, and .ass. |
| <b>[go-mpd](https://github.com/unki2aut/go-mpd) | 22 | Parser and generator library for MPEG-DASH manifest files. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Gin](https://github.com/gin-gonic/gin) | 76.0k | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
| <b>[Fiber](https://github.com/gofiber/fiber) | 32.0k | An Express.js inspired web framework build on Fasthttp. |
...
| <b>[Hertz](https://github.com/cloudwego/hertz) | 4.8k | A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices. |
...
| <b>[Huma](https://github.com/danielgtaylor/huma/) | 1.5k | Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI. |
...
| <b>[REST Layer](https://github.com/rs/rest-layer) | 1.3k | Framework to build REST/GraphQL API on top of databases with mostly configuration over code. |
...
| <b>[GoFr](https://github.com/gofr-dev/gofr) | 1.1k | Gofr is an opinionated microservice development framework. |
...
| <b>[tango](https://github.com/lunny/tango) | 833 | Micro & pluggable web framework for Go. |
| <b>[Gearbox](https://github.com/abahmed/gearbox) | 746 | A web framework written in Go with a focus on high performance and memory optimization. |
| <b>[Aero](https://github.com/aerogo/aero) | 568 | High-performance web framework for Go, reaches top scores in Lighthouse. |
...
| <b>[rk-boot](https://github.com/rookie-ninja/rk-boot) | 499 | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
| <b>[Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 486 | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| <b>[Air](https://github.com/aofei/air) | 437 | An ideally refined web framework for Go. |
| <b>[Flamingo](https://github.com/i-love-flamingo/flamingo) | 429 | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| <b>[neo](https://github.com/ivpusic/neo) | 419 | Neo is minimal and fast Go Web Framework with extremely simple API. |
...
| <b>[uAdmin](https://github.com/uadmin/uadmin) | 327 | Fully featured web framework for Golang, inspired by Django. |
| <b>[Gondola](https://github.com/rainycape/gondola) | 312 | The web framework for writing faster sites, faster. |
| <b>[WebGo](https://github.com/bnkamalesh/webgo) | 298 | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
| <b>[Ginrpc](https://github.com/xxjwxc/ginrpc) | 288 | Gin parameter automatic binding tool,gin rpc tools. |
...
| <b>[Yokai](https://github.com/ankorstore/yokai) | 202 | Simple, modular, and observable Go framework for backend applications. |
| <b>[hiboot](https://github.com/hidevopsio/hiboot) | 182 | hiboot is a high performance web application framework with auto configuration and dependency injection support. |
| <b>[appy](https://github.com/appist/appy) | 131 | An opinionated productive web framework that helps scaling business easier. |
...
| <b>[Microservice](https://github.com/claygod/microservice) | 115 | The framework for the creation of microservices, written in Golang. |
| <b>[rux](https://github.com/gookit/rux) | 98 | Simple and fast web framework for build golang HTTP applications. |
| <b>[vox](https://github.com/aisk/vox) | 84 | A golang web framework for humans, inspired by Koa heavily. |
...
| <b>[Fireball](https://github.com/zpatrick/fireball) | 60 | More "natural" feeling web framework. |
...
| <b>[GoTuna](https://github.com/gotuna/gotuna) | 48 | Minimalistic web framework for Go with mux router, middlewares, sessions, templates, embedded views and static files. |
| <b>[Don](https://github.com/abemedia/go-don) | 48 | A highly performant and simple to use API framework. |
...
| <b>[Lit](https://github.com/jvcoutinho/lit) | 25 | Highly performant declarative web framework for Golang, aiming for simplicity and quality of life. |
| <b>[Banjo](https://github.com/nsheremet/banjo) | 24 | Very simple and fast web framework for Go. |
| <b>[golamb](https://github.com/twharmon/golamb) | 7 | Golamb makes it easier to write API endpoints for use with AWS Lambda and API Gateway. |
...
| <b>[Limiter](https://github.com/ulule/limiter) | 2.0k | Dead simple rate limit middleware for Go. |
| <b>[go-server-timing](https://github.com/mitchellh/go-server-timing) | 862 | Add/parse Server-Timing header. |
| <b>[go-fault](https://github.com/github/go-fault) | 500 | Fault injection middleware for Go. |
| <b>[ln-paywall](https://github.com/philippgille/ln-paywall) | 143 | Go middleware for monetizing APIs on a per-request basis with the Lightning Network (Bitcoin). |
| <b>[XFF](https://github.com/sebest/xff) | 98 | Handle `X-Forwarded-For` header and friends. |
| <b>[rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 72 | Middleware for gRPC with logging, metrics, auth, tracing etc. |
| <b>[rk-gin](https://github.com/rookie-ninja/rk-gin) | 43 | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
| <b>[formjson](https://github.com/rs/formjson) | 39 | Transparently handle JSON input as a standard form POST. |
| <b>[client-timing](https://github.com/posener/client-timing) | 24 | An HTTP client for Server-Timing header. |
| <b>[echo-middleware](https://github.com/faabiosr/echo-middleware) | 15 | Middleware for Echo framework with logging and metrics. |
...
| <b>[stats](https://github.com/thoas/stats) | 595 | Go middleware that stores various information about your web application. |
| <b>[interpose](https://github.com/carbocation/interpose) | 294 | Minimalist net/http middleware for golang. |
...
| <b>[chi](https://github.com/go-chi/chi) | 17.0k | Small, fast and expressive HTTP router built on net/context. |
...
| <b>[Goji](https://github.com/goji/goji) | 955 | Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`. |
...
| <b>[httptreemux](https://github.com/dimfeld/httptreemux) | 616 | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
| <b>[xujiajun/gorouter](https://github.com/xujiajun/gorouter) | 533 | A simple and fast HTTP router for Go. |
| <b>[ozzo-routing](https://github.com/go-ozzo/ozzo-routing) | 450 | An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs. |
...
| <b>[gowww/router](https://github.com/gowww/router) | 185 | Lightning fast HTTP router fully compatible with the net/http.Handler interface. |
| <b>[GoRouter](https://github.com/vardius/gorouter) | 153 | GoRouter is a Server/API micro framework, HTTP request router, multiplexer, mux that provides request router with middleware supporting `net/context`. |
...
| <b>[goblin](https://github.com/bmf-san/goblin) | 76 | A golang http router based on trie tree. |
| <b>[ngamux](https://github.com/ngamux/ngamux) | 65 | Simple HTTP router for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[tinygo](https://github.com/tinygo-org/tinygo) | 15.0k | Go compiler for small places. Microcontrollers, WebAssembly, and command-line tools. Based on LLVM. |
| <b>[dom](https://github.com/dennwc/dom) | 483 | DOM library. |
| <b>[go-canvas](https://github.com/markfarnan/go-canvas) | 232 | Library to use HTML5 Canvas, with all drawing within go code. |
| <b>[wasmbrowsertest](https://github.com/agnivade/wasmbrowsertest) | 178 | Run Go WASM tests in your browser. |
| <b>[webapi](https://github.com/gowebapi/webapi) | 164 | Bindings for DOM and HTML generated from WebIDL. |
| <b>[vert](https://github.com/norunners/vert) | 97 | Interop between Go and JS values. |
...
| <b>[d3d9](https://github.com/gonutz/d3d9) | 158 | Go bindings for Direct3D9. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[zek](https://github.com/miku/zek) | 736 | Generate a Go struct from XML. |
| <b>[xpath](https://github.com/antchfx/xpath) | 657 | XPath package for Go. |
| <b>[xquery](https://github.com/antchfx/xquery) | 159 | XQuery lets you extract data from HTML/XML documents using XPath expression. |
| <b>[xml2map](https://github.com/sbabiv/xml2map) | 63 | XML to MAP converter written Golang. |
| <b>[xmlwriter](https://github.com/shabbyrobe/xmlwriter) | 27 | Procedural XML generation API based on libxml2's xmlwriter module. |
...
| <b>[Spire](https://github.com/spiffe/spire) | 1.7k | SPIRE (the SPIFFE Runtime Environment) is a toolchain of APIs for establishing trust between software systems across a wide variety of hosting platforms. |
| <b>[in-toto](https://github.com/in-toto/in-toto-golang) | 114 | Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation. |
| <b>[Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) | 76 | Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[golangci-lint](https://github.com/golangci/golangci-lint) | 15.0k | – A fast Go linters runner. It runs linters in parallel, uses caching, supports `yaml` config, has integrations with all major IDE and has dozens of linters included. |
...
| <b>[revive](https://github.com/mgechev/revive) | 4.6k | – ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for `golint`. |
| <b>[GoLint](https://github.com/golang/lint) | 4.0k | Golint is a linter for Go source code. |
| <b>[errcheck](https://github.com/kisielk/errcheck) | 2.3k | Errcheck is a program for checking for unchecked errors in Go programs. |
| <b>[go-critic](https://github.com/go-critic/go-critic) | 1.8k | source code linter that brings checks that are currently not implemented in other linters. |
| <b>[GoPlantUML](https://github.com/jfeliu007/goplantuml) | 1.7k | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
...
| <b>[golines](https://github.com/segmentio/golines) | 847 | Formatter that automatically shortens long lines in Go code. |
| <b>[go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 827 | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
| <b>[goast-viewer](https://github.com/yuroyoro/goast-viewer) | 757 | Web based Golang AST visualizer. |
| <b>[go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 645 | An easy way to find outdated dependencies of your Go projects. |
| <b>[vaccum](https://github.com/daveshanley/vacuum) | 447 | An ultra-super-fast, lightweight OpenAPI linter and quality checking tool. |
| <b>[Chronos](https://github.com/amit-davidson/Chronos) | 423 | Detects race conditions statically |
| <b>[todocheck](https://github.com/preslavmihaylov/todocheck) | 417 | Static code analyser which links TODO comments in code with issues in your issue tracker. |
| <b>[unconvert](https://github.com/mdempsky/unconvert) | 375 | Remove unnecessary type conversions from Go source. |
| <b>[dupl](https://github.com/mibk/dupl) | 336 | Tool for code clone detection. |
| <b>[tickgit](https://github.com/augmentable-dev/tickgit) | 322 | CLI and go package for surfacing code comment TODOs (in any language) and applying a `git blame`to identify the author. |
...
| <b>[apicompat](https://github.com/bradleyfalzon/apicompat) | 178 | Checks recent changes to a Go project for backwards incompatible changes. |
| <b>[go-checkstyle](https://github.com/qiniu/checkstyle) | 129 | checkstyle is a style check tool like java checkstyle. This tool inspired by java checkstyle, golint. The style referred to some points in Go Code Review Comments. |
| <b>[testifylint](https://github.com/Antonboom/testifylint) | 79 | – A linter that checks usage of [github.com/stretchr/testify](https://github.com/stretchr/testify). |
| <b>[asty](https://github.com/asty-org/asty) | 76 | Converts golang AST to JSON and JSON to AST. |
...
| <b>[ChainJacking](https://github.com/Checkmarx/chainjacking) | 55 | Find which of your Go lang direct GitHub dependencies is susceptible to ChainJacking attack. |
...
| <b>[goimports](https://pkg.go.dev/golang.org/x/tools/cmd/goimports) | - | Tool to fix (add, remove) your Go imports automatically. |
...
| <b>[coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) | 565 | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| <b>[goimports-reviser](https://github.com/incu6us/goimports-reviser) | 549 | Formatting tool for imports. |
...
| <b>[Go Doc](https://github.com/msyrus/vscode-go-doc) | 8 | A Visual Studio Code extension for showing definition in output and generating go doc. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gotests](https://github.com/cweill/gotests) | 4.9k | Generate Go tests from your source code. |
| <b>[genny](https://github.com/cheekybits/genny) | 1.7k | Elegant generics for Go. |
| <b>[xgen](https://github.com/xuri/xgen) | 295 | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| <b>[hasgo](https://github.com/DylanMeeus/hasgo) | 136 | Generate Haskell inspired functions for your slices. |
| <b>[gonerics](https://github.com/bouk/gonerics) | 114 | Idiomatic Generics in Go. |
| <b>[gocontracts](https://github.com/Parquery/gocontracts) | 107 | brings design-by-contract to Go by synchronizing the code with the documentation. |
| <b>[gounit](https://github.com/hexdigest/gounit) | 80 | Generate Go tests using your own templates. |
| <b>[sqlgen](https://github.com/anqiansong/sqlgen) | 77 | Generate gorm, xorm, sqlx, bun, sql code from SQL file or DSN. |
| <b>[options-gen](https://github.com/kazhuravlev/options-gen) | 70 | Functional options described by Dave Cheney's post "Functional options for friendly APIs". |
| <b>[generic](https://github.com/usk81/generic) | 48 | flexible data type for Go. |
| <b>[envdoc](https://github.com/g4s8/envdoc) | 41 | generate documentation for environment variables from Go source files. |
...
| <b>[depth](https://github.com/KyleBanks/depth) | 888 | Visualize dependency trees of any package by analyzing imports. |
| <b>[richgo](https://github.com/kyoh86/richgo) | 832 | Enrich `go test` outputs with text decorations. |
| <b>[go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) | 522 | Analyze and visualize the size of dependencies in compiled Golang binaries, providing insight into their impact on the final build. |
| <b>[rts](https://github.com/galeone/rts) | 250 | RTS: response to struct. Generates Go structs from server responses. |
...
| <b>[typex](https://github.com/dtgorski/typex) | 196 | Examine Go types and their transitive dependencies, alternatively export results as TypeScript value objects (or types) declaration. |
| <b>[roumon](https://github.com/becheran/roumon) | 177 | Monitor current state of all active goroutines via a command line interface. |
| <b>[gothanks](https://github.com/psampaz/gothanks) | 123 | GoThanks automatically stars your go.mod github dependencies, sending this way some love to their maintainers. |
| <b>[colorgo](https://github.com/songgao/colorgo) | 113 | Wrapper around `go` command for colorized `go build` output. |
| <b>[gotestdox](https://github.com/bitfield/gotestdox) | 95 | Show Go test results as readable sentences. |
| <b>[igo](https://github.com/rocketlaunchr/igo) | 65 | An igo to go transpiler (new language features for Go language!) |
| <b>[go-james](https://github.com/pieterclaerhout/go-james) | 63 | Go project skeleton creator, builds and tests your projects without the manual setup. |
| <b>[go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) | 43 | Bash completion for go and wgo. |
| <b>[docs](https://github.com/go-oas/docs) | 35 | Automatically generate RESTful API documentation for GO projects - aligned with Open API Specification standard. |
| <b>[gomodrun](https://github.com/dustinblackman/gomodrun/) | 32 | Go tool that executes and caches binaries included in go.mod files. |
...
| <b>[decouple](https://github.com/bobg/decouple) | 20 | Find “overspecified” function parameters that could be generalized with interface types. |
| <b>[modver](https://github.com/bobg/modver) | 16 | Compare two versions of a Go module to check the version-number change required (major, minor, or patchlevel), according to [semver](https://semver.org/) rules. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[kubernetes](https://github.com/kubernetes/kubernetes) | 108.0k | Container Cluster Manager from Google. |
| <b>[Moby](https://github.com/moby/moby) | 68.0k | Collaborative project for the container ecosystem to assemble container-based systems. |
| <b>[traefik](https://github.com/containous/traefik) | 48.0k | Reverse proxy and load balancer with support for multiple backends. |
| <b>[Gitea](https://github.com/go-gitea/gitea) | 42.0k | Fork of Gogs, entirely community driven. |
...
| <b>[Ddosify](https://github.com/ddosify/ddosify) | 8.2k | High-performance load testing tool, written in Golang. |
...
| <b>[k3d](https://github.com/k3d-io/k3d) | 5.1k | Little helper to run CNCF's k3s in Docker. |
| <b>[script](https://github.com/bitfield/script) | 5.1k | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| <b>[Fleet device management](https://github.com/fleetdm/fleet) | 2.2k | Lightweight, programmable telemetry for servers and workstations. |
...
| <b>[kubeblocks](https://github.com/apecloud/kubeblocks) | 1.7k | KubeBlocks is an open-source control plane that runs and manages databases, message queues and other data infrastructure on K8s. |
...
| <b>[ghorg](https://github.com/gabrie30/ghorg) | 1.5k | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
...
| <b>[PipeCD](https://github.com/pipe-cd/pipecd) | 976 | A GitOps-style continuous delivery platform that provides consistent deployment and operations experience for any applications. |
| <b>[kwatch](https://github.com/abahmed/kwatch) | 935 | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
| <b>[skm](https://github.com/TimothyYe/skm) | 932 | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| <b>[Scaleway-cli](https://github.com/scaleway/scaleway-cli) | 870 | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| <b>[cassowary](https://github.com/rogerwelin/cassowary) | 731 | Modern cross-platform HTTP load-testing tool written in Go. |
| <b>[kool](https://github.com/kool-dev/kool) | 662 | Command line tool for managing Docker environments as an easy way. |
| <b>[aurora](https://github.com/xuri/aurora) | 594 | Cross-platform web-based Beanstalkd queue server console. |
| <b>[govvv](https://github.com/ahmetalpbalkan/govvv) | 537 | “go build” wrapper to easily add version information into Go binaries. |
| <b>[kubevpn](https://github.com/kubenetworks/kubevpn) | 434 | VPN tools to connect kubernetes cluster network and proxy workloads inbound traffic to local PC with service mesh. |
| <b>[Pewpew](https://github.com/bengadbois/pewpew) | 410 | Flexible HTTP command line stress tester. |
| <b>[jcli](https://github.com/jenkins-zh/jenkins-cli) | 379 | Jenkins CLI allows you manage your Jenkins as an easy way. |
| <b>[gobrew](https://github.com/kevincobain2000/gobrew) | 351 | Go version manager. Super simple tool to install and manage Go versions. Install go without root. Gobrew doesn't require shell rehash. |
| <b>[gonative](https://github.com/inconshreveable/gonative) | 340 | Tool which creates a build of Go that can cross compile to all platforms while still using the Cgo-enabled versions of the stdlib packages. |
...
| <b>[lstags](https://github.com/ivanilves/lstags) | 322 | Tool and API to sync Docker images across different registries. |
| <b>[Mora](https://github.com/emicklei/mora) | 315 | REST server for accessing MongoDB documents and meta data. |
| <b>[easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 309 | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
| <b>[Balerter](https://github.com/balerter/balerter) | 297 | A self-hosted script-based alerting manager. |
| <b>[manssh](https://github.com/xwjdsh/manssh) | 297 | manssh is a command line tool for managing your ssh alias config easily. |
| <b>[terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 273 | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
| <b>[s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 270 | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
| <b>[dogo](https://github.com/liudng/dogo) | 265 | Monitoring changes in the source file and automatically compile and run (restart). |
| <b>[tau](https://github.com/taubyte/tau) | 255 | Easily build Cloud Computing Platforms with features like Serverless WebAssembly Functions, Frontend Hosting, CI/CD, Object Storage, K/V Database, and Pub-Sub Messaging. |
| <b>[godbg](https://github.com/sirnewton01/godbg) | 227 | Web-based gdb front-end application. |
| <b>[Blast](https://github.com/dave/blast) | 217 | A simple tool for API load testing and batch jobs. |
| <b>[kcli](https://github.com/cswank/kcli) | 212 | Command line tool for inspecting kafka topics/partitions/messages. |
| <b>[abbreviate](https://github.com/dnnrly/abbreviate) | 211 | abbreviate is a tool turning long strings in to shorter ones with configurable seperaters, for example to embed branch names in to deployment stack IDs. |
...
| <b>[grapes](https://github.com/yaronsumel/grapes) | 167 | Lightweight tool designed to distribute commands over ssh with ease. |
| <b>[Dockerfile-Generator](https://github.com/ozankasikci/dockerfile-generator) | 165 | A go library and an executable that produces valid Dockerfiles using various input channels. |
| <b>[winrm-cli](https://github.com/masterzen/winrm-cli) | 163 | Cli tool to remotely execute commands on Windows machines. |
| <b>[tf-profile](https://github.com/datarootsio/tf-profile) | 146 | Profiler for Terraform runs. Generate global stats, resource-level stats or visualizations. |
| <b>[drone-scp](https://github.com/appleboy/drone-scp) | 139 | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
| <b>[Mantil](https://github.com/mantil-io/mantil) | 109 | Go specific framework for building serverless applications on AWS that enables you to focus on pure Go code while Mantil takes care of the infrastructure. |
| <b>[go-furnace](https://github.com/go-furnace/go-furnace) | 98 | Hosting solution written in Go. Deploy your Application with ease on AWS, GCP or DigitalOcean. |
| <b>[go-rocket-update](https://github.com/mouuff/go-rocket-update) | 96 | A simple way to make self updating Go applications - Supports Github and Gitlab. |
| <b>[decompose](https://github.com/s0rg/decompose) | 74 | tool to generate and process Docker containers connections graphs. |
...
| <b>[httpref](https://github.com/dnnrly/httpref) | 36 | httpref is a handy CLI reference for HTTP methods, status codes, headers, and TCP and UDP ports. |
...
| <b>[Seaweed File System](https://github.com/chrislusf/seaweedfs) | 21.0k | Fast, Simple and Scalable Distributed File System with O(1) disk seek. |
...
| <b>[confd](https://github.com/kelseyhightower/confd) | 8.3k | Manage local application configuration files using templates and data from etcd or consul. |
| <b>[LiteIDE](https://github.com/visualfc/liteide) | 7.5k | LiteIDE is a simple, open source, cross-platform Go IDE. |
...
| <b>[Duplicacy](https://github.com/gilbertchen/duplicacy) | 5.0k | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
...
| <b>[Documize](https://github.com/documize/community) | 2.1k | Modern wiki software that integrates data from SaaS tools. |
...
| <b>[Plik](https://github.com/root-gg/plik) | 1.4k | Plik is a temporary file upload system (Wetransfer like) in Go. |
| <b>[shell2http](https://github.com/msoap/shell2http) | 1.3k | Executing shell commands via http server (for prototyping or remote control). |
| <b>[portal](https://github.com/SpatiumPortae/portal) | 1.2k | Portal is a quick and easy command-line file transfer utility from any computer to another. |
| <b>[vFlow](https://github.com/VerizonDigital/vflow) | 1.1k | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
| <b>[Gokapi](https://github.com/Forceu/gokapi) | 1000 | Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload. |
| <b>[peg](https://github.com/pointlander/peg) | 981 | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
| <b>[Go Package Store](https://github.com/shurcooL/Go-Package-Store) | 899 | App that displays updates for the Go packages in your GOPATH. |
| <b>[Leaps](https://github.com/jeffail/leaps) | 746 | Pair programming service using Operational Transforms. |
| <b>[gfile](https://github.com/Antonito/gfile) | 733 | Securely transfer files between two computers, without any third party, over WebRTC. |
| <b>[Guora](https://github.com/meloalright/guora) | 665 | A self-hosted Quora like web application written in Go. |
| <b>[sake](https://github.com/alajmo/sake) | 640 | sake is a command runner for local and remote hosts. |
| <b>[Gebug](https://github.com/moshebe/gebug) | 632 | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
| <b>[gocc](https://github.com/goccmack/gocc) | 595 | Gocc is a compiler kit for Go written in Go. |
| <b>[yai](https://github.com/ekkinox/yai) | 562 | AI powered terminal assistant. |
| <b>[mockingjay](https://github.com/quii/mockingjay-server) | 553 | Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests. |
| <b>[go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 468 | Video streaming torrent client. |
| <b>[GoNB](https://github.com/janpfeifer/gonb) | 446 | Interactive Go programming with Jupyter Notebooks (also works in VSCode, Binder and Google's Colab). |
| <b>[woke](https://github.com/get-woke/woke) | 436 | Detect non-inclusive language in your source code. |
...
| <b>[ide](https://github.com/thestrukture/ide) | 356 | Browser accessible IDE. Designed for Go with Go. |
...
| <b>[hotswap](https://github.com/edwingeng/hotswap) | 311 | A complete solution to reload your go code without restarting your server, interrupting or blocking any ongoing procedure. |
| <b>[wellington](https://github.com/wellington/wellington) | 304 | Sass project management tool, extends the language with sprite functions (like Compass). |
| <b>[Cherry](https://github.com/rafael-santiago/cherry) | 300 | Tiny webchat server in Go. |
| <b>[Neo-cowsay](https://github.com/Code-Hex/Neo-cowsay) | 296 | 🐮 cowsay is reborn. for a New Era. |
| <b>[tcpdog](https://github.com/mehrdadrad/tcpdog) | 249 | eBPF based TCP observability. |
| <b>[crawley](https://github.com/s0rg/crawley) | 233 | Web scraper/crawler for cli. |
| <b>[joincap](https://github.com/assafmo/joincap) | 207 | Command-line utility for merging multiple pcap files together. |
| <b>[Orbit](https://github.com/gulien/orbit) | 179 | A simple tool for running commands and generating files from templates. |
| <b>[vaku](https://github.com/lingrino/vaku) | 152 | CLI & API for folder-based functions in Vault like copy, move, and search. |
| <b>[stew](https://github.com/marwanhawari/stew) | 135 | An independent package manager for compiled binaries. |
| <b>[fjira](https://github.com/mk-5/fjira) | 97 | A fuzzy-search based terminal UI application for Attlasian Jira |
...
| <b>[Wave Terminal](https://waveterm.dev) | - | Wave is an open-source, AI-native terminal built for seamless developer workflows with inline rendering, a modern UI, and persistent sessions. |
...
| <b>[gospeed](https://github.com/feyeleanor/GoSpeed) | 119 | Go micro-benchmarks for calculating the speed of language constructs. |
| <b>[autobench](https://github.com/davecheney/autobench) | 99 | Framework to compare the performance between different Go versions. |
...
| <b>[go-ml-benchmarks](https://github.com/nikolaydubina/go-ml-benchmarks) | 30 | benchmarks for machine learning inference in Go. |
...
| <b>[Go in Practice, Second Edition](https://www.manning.com/books/go-in-practice-second-edition) | - | Your practical guide on the ins-and-outs of Go development, covering the standard library and the most important tools from Go’s powerful ecosystem. |
...
| <b>[Web Application with Go the Anti-Textbook](https://github.com/thewhitetulip/web-dev-golang-anti-textbook/) | 3.2k | Learn how to write webapps without a framework in Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gophers](https://github.com/egonelbre/gophers) | 3.4k | Free gophers. |
| <b>[Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) | 3.3k | Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster. |
| <b>[gophers](https://github.com/ashleymcnamara/gophers) | 2.9k | Gopher artworks by Ashley McNamara. |
| <b>[gopherize.me](https://github.com/matryer/gopherize.me) | 680 | Gopherize yourself. |
| <b>[gophericons](https://github.com/shalakhin/gophericons) | 613 | 34 gopher images for Go developers community |
| <b>[gopher-stickers](https://github.com/tenntenn/gopher-stickers) | 582 | gopher stickers |
| <b>[gophers](https://github.com/sillecelik/go-gopher) | 139 | Gopher amigurumi toy pattern. |
| <b>[gopher-logos](https://github.com/GolangUA/gopher-logos) | 122 | adorable gopher logos. |
| <b>[Go-gopher-Vector](https://github.com/keygx/Go-gopher-Vector) | 69 | Go gopher Vector Data [.ai, .svg]. |
| <b>[gophers](https://github.com/rogeralsing/gophers) | 58 | random gopher graphics. |
| <b>[gophers](https://github.com/scraly/gophers) | 31 | Gophers by Aurélie Vache. |
...
| <b>[Lagos Gophers](https://www.meetup.com/GolangNigeria/) | - |  |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Go Projects](https://github.com/golang/go/wiki/Projects) | 120.0k | List of projects on the Go community wiki. |
...
| <b>[Awesome Golang Workshops](https://github.com/amit-davidson/awesome-golang-workshops) | 499 | A curated list of awesome golang workshops. |
...
| <b>[pkg.go.dev](https://pkg.go.dev/) | - | Documentation for open source Go packages. |
...
| <b>[Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) | 8.1k | Go's reference card. |
...
| <b>[goapp](https://github.com/bnkamalesh/goapp) | 775 | An opinionated guideline to structure & develop a Go web application/service. |
| <b>[Go in 7 days](https://github.com/harrytran103/7_days_of_go) | 136 | Learn everything about Go in 7 days (from a Nodejs developer). |
| <b>[Design Patterns in Go](https://github.com/shubhamzanwar/design-patterns) | 112 | Collection of programming design patterns implemented in Go. |
| <b>[Hex Monscape](https://github.com/Haraj-backend/hex-monscape) | 50 | Getting started guidelines in writing maintainable code using Hexagonal Architecture. |
| <b>[Debugged.it Go patterns](https://github.com/haveyoudebuggedit/go-patterns) | 12 | Advanced Go patterns with ready-to-run examples. |
...
| <b>[Understanding Go in a visual way](https://dev.to/aurelievache/series/26234) | - | Learn Go visually |
