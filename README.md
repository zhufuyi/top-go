...
| <b>[PortAudio](https://github.com/gordonklaus/portaudio) | 536 | Go bindings for the PortAudio audio I/O library. |
| <b>[music-theory](https://github.com/go-music-theory/music-theory) | 412 | Music theory models in Go. |
| <b>[id3v2](https://github.com/bogem/id3v2) | 264 | ID3 decoding and encoding library for Go. |
| <b>[GoAudio](https://github.com/DylanMeeus/GoAudio) | 253 | Native Go Audio Processing Library. |
| <b>[flac](https://github.com/mewkiz/flac) | 223 | Native Go FLAC encoder/decoder with support for FLAC streams. |
| <b>[malgo](https://github.com/gen2brain/malgo) | 200 | Mini audio library. |
...
| <b>[paseto](https://github.com/o1egl/paseto) | 640 | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
| <b>[jwt](https://github.com/cristalhq/jwt) | 569 | Safe, simple and fast JSON Web Tokens for Go. |
| <b>[permissions2](https://github.com/xyproto/permissions2) | 467 | Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. |
| <b>[go-guardian](https://github.com/shaj13/go-guardian) | 407 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
| <b>[jwt](https://github.com/pascaldekloe/jwt) | 298 | Lightweight JSON Web Token (JWT) library. |
| <b>[jeff](https://github.com/abraithwaite/jeff) | 241 | Simple, flexible, secure and idiomatic web session management with pluggable backends. |
...
| <b>[rbac](https://github.com/zpatrick/rbac) | 102 | Minimalistic RBAC package for Go applications. |
...
| <b>[branca](https://github.com/essentialkaos/branca) | 45 | branca token [specification implementation](https://github.com/tuupola/branca-spec) for Golang 1.15+. |
...
| <b>[solana-go](https://github.com/gagliardetto/solana-go) | 373 | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
| <b>[gossamer](https://github.com/ChainSafe/gossamer) | 359 | A Go implementation of the Polkadot Host. |
...
| <b>[Kelp](https://github.com/stellar/kelp) | 933 | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| <b>[Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) | 835 | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| <b>[go-chat-bot](https://github.com/go-chat-bot/bot) | 762 | IRC, Slack & Telegram bot written in Go. |
| <b>[slacker](https://github.com/shomali11/slacker) | 697 | Easy to use framework to create Slack bots. |
| <b>[wayback](https://github.com/wabarc/wayback) | 333 | A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages. |
| <b>[tbot](https://github.com/yanzay/tbot) | 330 | Telegram bot server with API similar to net/http. |
| <b>[go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 260 | Library to write bots for twitch.tv chat |
...
| <b>[echotron](https://github.com/NicoNex/echotron) | 192 | An elegant and concurrent library for Telegram Bots in Go. |
...
| <b>[slack-bot](https://github.com/innogames/slack-bot) | 116 | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
| <b>[telego](https://github.com/mymmrac/telego) | 105 | Telegram Bot API library for Golang with full one-to-one API implementation. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Task](https://github.com/go-task/task) | 5.9k | simple "Make" alternative. |
...
| <b>[goyek](https://github.com/goyek/goyek) | 309 | Create build pipelines in Go. |
| <b>[taskctl](https://github.com/taskctl/taskctl) | 217 | Concurrent task runner. |
| <b>[1build](https://github.com/gopinath-langote/1build) | 187 | Command line tool to frictionlessly manage project-specific commands. |
...
| <b>[uitable](https://github.com/gosuri/uitable) | 661 | Library to improve readability in terminal apps using tabular data. |
| <b>[go-colorable](https://github.com/mattn/go-colorable) | 648 | Colorable writer for windows. |
| <b>[go-isatty](https://github.com/mattn/go-isatty) | 647 | isatty for golang. |
| <b>[gommon/color](https://github.com/labstack/gommon/tree/master/color) | 470 | Style terminal text. |
| <b>[chalk](https://github.com/ttacon/chalk) | 410 | Intuitive package for prettifying terminal/console output. |
| <b>[simpletable](https://github.com/alexeyco/simpletable) | 390 | Simple tables in terminal with Go. |
| <b>[yacspin](https://github.com/theckman/yacspin) | 373 | Yet Another CLi Spinner package, for working with terminal spinners. |
| <b>[tabby](https://github.com/cheynewallace/tabby) | 320 | A tiny library for super simple Golang tables. |
| <b>[box-cli-maker](https://github.com/Delta456/box-cli-maker) | 244 | Make Highly Customized Boxes for your CLI. |
...
| <b>[tabular](https://github.com/InVisionApp/tabular) | 66 | Print ASCII tables from command line utilities without the need to pass large sets of data to the API. |
| <b>[cfmt](https://github.com/i582/cfmt) | 51 | Simple and convenient formatted stylized output fully compatible with fmt library. |
...
| <b>[table](https://github.com/tomlazar/table) | 37 | Small library for terminal color based tables . |
| <b>[marker](https://github.com/cyucelen/marker) | 33 | Easiest way to match and mark strings for colorful terminal outputs. |
...
| <b>[liner](https://github.com/peterh/liner) | 927 | Go readline-like library for command-line interfaces. |
| <b>[complete](https://github.com/posener/complete) | 862 | Write bash completions in Go + Go command bash completion. |
...
| <b>[cli](https://github.com/mkideal/cli) | 671 | Feature-rich and easy to use command-line package based on golang struct tags. |
| <b>[argparse](https://github.com/akamensky/argparse) | 463 | Command line argument parser inspired by Python's argparse module. |
...
| <b>[cmdr](https://github.com/hedzr/cmdr) | 114 | A POSIX/GNU style, getopt-like command-line UI Go library. |
| <b>[env](https://github.com/codingconcepts/env) | 98 | Tag-based environment configuration for structs. |
| <b>[carapace-bin](https://github.com/rsteube/carapace-bin) | 90 | Multi-shell multi-command argument completer. |
| <b>[acmd](https://github.com/cristalhq/acmd) | 61 | Simple, useful and opinionated CLI package in Go. |
...
| <b>[carapace](https://github.com/rsteube/carapace) | 55 | Command argument completion generator for spf13/cobra. |
...
| <b>[command-chain](https://github.com/rainu/go-command-chain) | 32 | A go library for configure and run command chains - such like pipelining in unix shells. |
...
| <b>[cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 751 | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| <b>[gookit/config](https://github.com/gookit/config) | 404 | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| <b>[aconfig](https://github.com/cristalhq/aconfig) | 398 | Simple, useful and opinionated config loader. |
...
| <b>[GoLobby/Config](https://github.com/golobby/config) | 295 | GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language. |
...
| <b>[xdg](https://github.com/adrg/xdg) | 275 | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
| <b>[store](https://github.com/tucnak/store) | 263 | Lightweight configuration manager for Go. |
| <b>[config](https://github.com/olebedev/config) | 255 | JSON or YAML configuration wrapper with environment variables and flags parsing. |
| <b>[fig](https://github.com/kkyr/fig) | 238 | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| <b>[env](https://github.com/junk1tm/env) | 29 | A lightweight package for loading environment variables into structs. |
...
| <b>[woodpecker](https://github.com/woodpecker-ci/woodpecker) | 1.5k | Woodpecker is a community fork of the Drone CI system. |
...
| <b>[gotestfmt](https://github.com/GoTestTools/gotestfmt) | 327 | go test output for humans. |
...
| <b>[gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 0 | go test output for humans. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gcss](https://github.com/yosssi/gcss) | 466 | Pure Go CSS Preprocessor. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[bitset](https://github.com/bits-and-blooms/bitset) | 981 | Go package implementing bitsets. |
| <b>[bitmap](https://github.com/kelindar/bitmap) | 173 | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| <b>[cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 937 | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
| <b>[cuckoo-filter](https://github.com/linvon/cuckoo-filter) | 230 | Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper is available. |
...
| <b>[gostl](https://github.com/liyue201/gostl) | 732 | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| <b>[algorithms](https://github.com/shady831213/algorithms) | 675 | Algorithms and data structures.CLRS study. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[iter](https://github.com/disksing/iter) | 169 | Go implementation of C++ STL iterators and algorithms. |
...
| <b>[go-tuple](https://github.com/barweiss/go-tuple) | 37 | Generic tuple implementation for Go 1.18+. |
...
| <b>[quadtree](https://github.com/s0rg/quadtree) | 17 | Generic, zero-alloc, 100%-test covered quadtree. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[deque](https://github.com/gammazero/deque) | 388 | Fast ring-buffer deque (double-ended queue). |
| <b>[goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 214 | Concurrent FIFO queue. |
| <b>[deque](https://github.com/edwingeng/deque) | 68 | A highly optimized double-ended queue. |
| <b>[memlog](https://github.com/embano1/memlog) | 63 | An easy to use, lightweight, thread-safe and append-only in-memory data structure inspired by Apache Kafka. |
...
| <b>[trie](https://github.com/derekparker/trie) | 610 | Trie implementation in Go. |
...
| <b>[go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 249 | Go implementation of Adaptive Radix Tree. |
| <b>[levenshtein](https://github.com/agnivade/levenshtein) | 238 | Implementation to calculate levenshtein distance in Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[skiplist](https://github.com/MauriceGit/skiplist) | 231 | Very fast Go Skiplist implementation. |
...
| <b>[ttlcache](https://github.com/jellydator/ttlcache) | 501 | An in-memory cache with item expiration and generics. |
...
| <b>[cache](https://github.com/akyoto/cache) | 116 | In-memory key:value store with expiration time, 0 dependencies, <100 LoC, 100% coverage. |
...
| <b>[go-cache](https://github.com/viney-shih/go-cache) | 79 | A flexible multi-layer Go caching library to deal with in-memory and shared cache by adopting Cache-Aside pattern. |
...
| <b>[column](https://github.com/kelindar/column) | 996 | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
| <b>[lotusdb](https://github.com/flower-corp/lotusdb) | 980 | Fast k/v database compatible with lsm and b+tree. |
| <b>[eliasdb](https://github.com/krotik/eliasdb) | 949 | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| <b>[pogreb](https://github.com/akrylysov/pogreb) | 948 | Embedded key-value store for read-heavy workloads. |
...
| <b>[clover](https://github.com/ostafen/clover) | 277 | A lightweight document-oriented NoSQL database written in pure Golang. |
...
| <b>[dtf](https://github.com/dtm-labs/dtf) | 231 | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[migrate](https://github.com/golang-migrate/migrate) | 9.9k | Database migrations. CLI and Golang library. |
| <b>[bytebase](https://github.com/bytebase/bytebase) | 4.1k | Safe database schema change and version control for DevOps teams. |
...
| <b>[goavro](https://github.com/linkedin/goavro) | 844 | A Go package that encodes and decodes Avro data. |
| <b>[gormigrate](https://github.com/go-gormigrate/gormigrate) | 828 | Database schema migration helper for Gorm ORM. |
| <b>[darwin](https://github.com/GuiaBolso/darwin) | 135 | Database schema evolution library for Go. |
...
| <b>[chproxy](https://github.com/Vertamedia/chproxy) | 999 | HTTP proxy for ClickHouse database. |
| <b>[pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 798 | Advanced scheduling for PostgreSQL. |
| <b>[clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 391 | Collects small inserts and sends big requests to ClickHouse servers. |
| <b>[rdb](https://github.com/HDT3213/rdb) | 189 | Redis RDB file parser for secondary development and memory analysis. |
...
| <b>[octillery](https://github.com/knocknote/octillery) | 173 | Go package for sharding databases ( Supports every ORM or raw SQL ). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sqlc](https://github.com/kyleconroy/sqlc) | 6.5k | Generate type-safe code from SQL. |
...
| <b>[jet](https://github.com/go-jet/jet) | 824 | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
| <b>[Dotsql](https://github.com/gchaincl/dotsql) | 648 | Go library that helps you keep sql files in one place and use them with ease. |
| <b>[ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 579 | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
| <b>[dbq](https://github.com/rocketlaunchr/dbq) | 352 | Zero boilerplate database operations for Go. |
| <b>[sqlingo](https://github.com/lqs/sqlingo) | 267 | A lightweight DSL to build SQL in Go. |
| <b>[sqrl](https://github.com/elgris/sqrl) | 245 | SQL query builder, fork of Squirrel with improved performance. |
| <b>[sq](https://github.com/bokwoon95/go-structured-query) | 174 | Type-safe SQL builder and struct mapper for Go. |
...
| <b>[buildsqlx](https://github.com/arthurkushman/buildsqlx) | 80 | Go database query builder library for PostgreSQL. |
...
| <b>[bqb](https://github.com/nullism/bqb) | 49 | Lightweight and easy to learn query builder. |
...
| <b>[gokv](https://github.com/philippgille/gokv) | 484 | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| <b>[pgx](https://github.com/jackc/pgx) | 6.1k | PostgreSQL driver supporting features beyond those exposed by database/sql. |
...
| <b>[sqlhooks](https://github.com/qustavo/sqlhooks) | 590 | Attach hooks to any database/sql driver. |
| <b>[godror](https://github.com/godror/godror) | 395 | Oracle driver for Go, using the ODPI-C driver. |
...
| <b>[KSQL](https://github.com/VinGarcia/ksql) | 186 | A Simple and Powerful Golang SQL Library |
| <b>[firebirdsql](https://github.com/nakagami/firebirdsql) | 179 | Firebird RDBMS SQL driver for Go. |
| <b>[go-adodb](https://github.com/mattn/go-adodb) | 130 | Microsoft ActiveX Object DataBase driver for go that uses database/sql. |
| <b>[Sqinn-Go](https://github.com/cvilsmeier/sqinn-go) | 127 | SQLite with pure Go. |
...
| <b>[ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) | 65 | native and database/sql driver YDB (Yandex Database) |
...
| <b>[qmgo](https://github.com/qiniu/qmgo) | 981 | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
| <b>[mgm](https://github.com/kamva/mgm) | 574 | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| <b>[go-rejson](https://github.com/nitishm/go-rejson) | 286 | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
| <b>[godis](https://github.com/piaohao/godis) | 107 | redis client implement by golang, inspired by jedis. |
...
| <b>[elasticsql](https://github.com/cch123/elasticsql) | 967 | Convert sql to elasticsearch dsl in Go. |
...
| <b>[carbon](https://github.com/uniplaces/carbon) | 728 | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
...
| <b>[date](https://github.com/rickb777/date) | 97 | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| <b>[go-doudou](https://github.com/unionj-cloud/go-doudou) | 864 | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
| <b>[redis-lock](https://github.com/bsm/redislock) | 828 | Simplified distributed locking implementation using Redis. |
| <b>[rain](https://github.com/cenkalti/rain) | 774 | BitTorrent client and library. |
| <b>[ringpop-go](https://github.com/uber/ringpop-go) | 753 | Scalable, fault-tolerant application-layer sharding for Go applications. |
| <b>[gorpc](https://github.com/valyala/gorpc) | 661 | Simple, fast and scalable RPC library for high load. |
| <b>[go-health](https://github.com/InVisionApp/go-health) | 639 | Library for enabling asynchronous dependency health checks in your service. |
| <b>[arpc](https://github.com/lesismal/arpc) | 614 | More effective network communication, support two-way-calling, notify, broadcast. |
| <b>[consistent](https://github.com/buraksezer/consistent) | 517 | Consistent hashing with bounded loads. |
...
| <b>[go-jump](https://github.com/dgryski/go-jump) | 352 | Port of Google's "Jump" Consistent Hash function. |
| <b>[jsonrpc](https://github.com/ybbus/jsonrpc) | 250 | JSON-RPC 2.0 HTTP client implementation. |
...
| <b>[outboxer](https://github.com/italolelis/outboxer) | 90 | Outboxer is a go library that implements the outbox pattern. |
...
| <b>[go-pdu](https://github.com/pdupub/go-pdu) | 41 | A decentralized identity-based social network. |
...
| <b>[DDNS](https://github.com/skibish/ddns) | 222 | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| <b>[SendGrid](https://github.com/sendgrid/sendgrid-go) | 855 | SendGrid's Go library for sending email. |
| <b>[mailgun-go](https://github.com/mailgun/mailgun-go) | 623 | Go library for sending mail with the Mailgun API. |
| <b>[email-verifier](https://github.com/AfterShip/email-verifier) | 526 | A Go library for email verification without sending any emails. |
| <b>[go-simple-mail](https://github.com/xhit/go-simple-mail) | 389 | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| <b>[go-message](https://github.com/emersion/go-message) | 273 | Streaming library for the Internet Message Format and mail messages. |
...
| <b>[go-mail](https://github.com/wneessen/go-mail) | 84 | A simple Go library for sending mails in Go. |
...
| <b>[smtpmock](https://github.com/mocktools/go-smtp-mock) | 55 | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
...
| <b>[truemail-go](https://github.com/truemail-rb/truemail-go) | 22 | Configurable Golang email validator/verifier. Verify email via Regex, DNS, SMTP and even more. |
...
| <b>[expr](https://github.com/antonmedv/expr) | 3.0k | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| <b>[golua](https://github.com/aarzilli/golua) | 597 | Go bindings for Lua C API. |
| <b>[gval](https://github.com/PaesslerAG/gval) | 539 | A highly customizable expression language written in Go. |
| <b>[gisp](https://github.com/jcla1/gisp) | 493 | Simple LISP in Go. |
...
| <b>[errorx](https://github.com/joomcode/errorx) | 898 | A feature rich error package with stack traces, composition of errors and more. |
| <b>[tracerr](https://github.com/ztrue/tracerr) | 742 | Golang errors with stack trace and source fragments. |
...
| <b>[errors](https://github.com/emperror/errors) | 163 | Drop-in replacement for the standard library errors package and github.com/pkg/errors. Provides various error handling primitives. |
...
| <b>[notify](https://github.com/rjeczalik/notify) | 764 | File system event notification library with simple API, similar to os/signal. |
| <b>[copy](https://github.com/otiai10/copy) | 463 | Copy directory recursively. |
| <b>[bigfile](https://github.com/bigfile/bigfile) | 232 | A file transfer system, support to manage files with http api, rpc call and ftp client. |
| <b>[afs](https://github.com/viant/afs) | 206 | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
...
| <b>[go-exiftool](https://github.com/barasher/go-exiftool) | 136 | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
| <b>[gofs](https://github.com/no-src/gofs) | 99 | A file synchronization tool out of the box. |
...
| <b>[checksum](https://github.com/codingsince1985/checksum) | 69 | Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files. |
...
| <b>[accounting](https://github.com/leekchan/accounting) | 770 | money and currency formatting for golang. |
| <b>[bbgo](https://github.com/c9s/bbgo) | 716 | A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies. |
| <b>[techan](https://github.com/sdcoffey/techan) | 682 | Technical analysis library with advanced market analysis and trading strategies. |
| <b>[go-finance](https://github.com/FlashBoys/go-finance) | 537 | Comprehensive financial markets data in Go. |
| <b>[ach](https://github.com/moov-io/ach) | 337 | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
...
| <b>[payme](https://github.com/jovandeginste/payme) | 12 | QR code generator (ASCII & PNG) for SEPA payments. |
...
| <b>[gorilla/csrf](https://github.com/gorilla/csrf) | 835 | CSRF protection for Go web applications & services. |
...
| <b>[conform](https://github.com/leebenson/conform) | 273 | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
...
| <b>[httpin](https://github.com/ggicci/httpin) | 118 | Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc. |
...
| <b>[mo](https://github.com/samber/mo) | 1000 | Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...). |
| <b>[fpGo](https://github.com/TeaEntityLab/fpGo) | 297 | Monad, Functional Programming features for Golang. |
| <b>[gofp](https://github.com/rbrahul/gofp) | 132 | A lodash like powerful utility library for Golang. |
| <b>[fp-go](https://github.com/repeale/fp-go) | 125 | Collection of Functional Programming helpers powered by Golang 1.18+ generics. |
...
| <b>[valor](https://github.com/phelmkamp/valor) | 9 | Generic option and result types that optionally contain a value. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Ebiten](https://github.com/hajimehoshi/ebiten) | 7.2k | dead simple 2D game library in Go. |
...
| <b>[raylib-go](https://github.com/gen2brain/raylib-go) | 880 | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
| <b>[Azul3D](https://github.com/azul3d/engine) | 558 | 3D game engine written in Go. |
| <b>[go-astar](https://github.com/beefsack/go-astar) | 524 | Go implementation of the A\* path finding algorithm. |
| <b>[go3d](https://github.com/ungerik/go3d) | 273 | Performance oriented 2D/3D math package for Go. |
...
| <b>[GoWrap](https://github.com/hexdigest/gowrap) | 673 | Generate decorators for Go interfaces using simple templates. |
| <b>[go-enum](https://github.com/abice/go-enum) | 384 | Code generation for enums from code comments. |
| <b>[interfaces](https://github.com/rjeczalik/interfaces) | 357 | Command line tool for generating interface definitions. |
| <b>[copygen](https://github.com/switchupcb/copygen) | 190 | Generate type-to-type code without reflection. |
| <b>[goverter](https://github.com/jmattheis/goverter) | 166 | Generate converters by defining an interface. |
...
| <b>[mbtileserver](https://github.com/consbio/mbtileserver) | 401 | A simple Go-based server for map tiles stored in mbtiles format. |
...
| <b>[simplefeatures](https://github.com/peterstace/simplefeatures) | 65 | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
...
| <b>[c2go](https://github.com/goplus/c2go) | 207 | Convert C code to Go code. |
...
| <b>[tunny](https://github.com/Jeffail/tunny) | 3.3k | Goroutine pool for golang. |
| <b>[goworker](https://github.com/benmanns/goworker) | 2.7k | goworker is a Go-based background worker. |
| <b>[workerpool](https://github.com/gammazero/workerpool) | 938 | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| <b>[grpool](https://github.com/ivpusic/grpool) | 716 | Lightweight Goroutine pool. |
| <b>[pool](https://github.com/go-playground/pool) | 698 | Limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation. |
| <b>[pond](https://github.com/alitto/pond) | 649 | Minimalistic and High-performance goroutine worker pool written in Go. |
| <b>[gowp](https://github.com/xxjwxc/gowp) | 421 | gowp is concurrency limiting goroutine pool. |
| <b>[go-floc](https://github.com/workanator/go-floc) | 261 | Orchestrate goroutines with ease. |
| <b>[go-flow](https://github.com/kamildrazkiewicz/go-flow) | 200 | Control goroutines execution order. |
...
| <b>[artifex](https://github.com/borderstech/artifex) | 137 | Simple in-memory job queue for Golang using worker-based dispatching. |
...
| <b>[cyclicbarrier](https://github.com/marusama/cyclicbarrier) | 112 | CyclicBarrier for golang. |
...
| <b>[routine](https://github.com/timandy/routine) | 68 | `routine` is a `ThreadLocal` for go library. It encapsulates and provides some easy-to-use, non-competitive, high-performance `goroutine` context access interfaces, which can help you access coroutine context information more gracefully. |
| <b>[goccm](https://github.com/zenthangplus/goccm) | 59 | Go Concurrency Manager package limits the number of goroutines that allowed to run concurrently. |
...
| <b>[go-actor](https://github.com/vladopajic/go-actor) | 14 | A tiny library for writing concurrent programs using actor model. |
...
| <b>[breaker](https://github.com/kamilsk/breaker) | 8 | Flexible mechanism to make execution flow interruptible. |
...
| <b>[gowd](https://github.com/dtylman/gowd) | 381 | Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform. |
| <b>[zenity](https://github.com/ncruces/zenity) | 349 | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
...
| <b>[sysinfo](https://github.com/zcalusic/sysinfo) | 384 | A pure Go library providing Linux OS / kernel / hardware system information. |
| <b>[goroslib](https://github.com/aler9/goroslib) | 226 | Robot Operating System (ROS) library for Go. |
| <b>[go-osc](https://github.com/hypebeast/go-osc) | 159 | Open Sound Control (OSC) bindings for Go. |
...
| <b>[govips](https://github.com/davidbyttow/govips) | 768 | A lightning fast image processing and resizing library for Go. |
| <b>[image2ascii](https://github.com/qeesung/image2ascii) | 700 | Convert image to ASCII. |
| <b>[draft](https://github.com/lucasepe/draft) | 551 | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| <b>[goimagehash](https://github.com/corona10/goimagehash) | 539 | Go Perceptual image hashing package. |
| <b>[govatar](https://github.com/o1egl/govatar) | 522 | Library and CMD tool for generating funny avatars. |
| <b>[mort](https://github.com/aldor007/mort) | 464 | Storage and image processing server written in Go. |
| <b>[go-nude](https://github.com/koyachi/go-nude) | 360 | Nudity detection with Go. |
...
| <b>[steganography](https://github.com/auyer/steganography) | 159 | Pure Go Library for LSB steganography. |
...
| <b>[cameron](https://github.com/aofei/cameron) | 93 | An avatar generator for Go. |
| <b>[go-webp](https://github.com/kolesa-team/go-webp) | 85 | Library for encode and decode webp pictures, using libwebp. |
...
| <b>[webp-server](https://github.com/mehdipourfar/webp-server) | 48 | Simple and minimal image server capable of storing, resizing, converting and caching images. |
...
| <b>[scout](https://github.com/jonoton/scout) | 7 | Scout is a standalone open source software solution for DIY video security. |
...
| <b>[connectordb](https://github.com/connectordb/connectordb) | 351 | Open-Source Platform for Quantified Self & IoT. |
| <b>[devices](https://github.com/goiot/devices) | 256 | Suite of libraries for IoT devices, experimental for x/exp/io. |
| <b>[huego](https://github.com/amimof/huego) | 219 | An extensive Philips Hue client library for Go. |
...
| <b>[go-quartz](https://github.com/reugn/go-quartz) | 954 | Simple, zero-dependency scheduling library for Go. |
...
| <b>[gron](https://github.com/roylee0704/gron) | 922 | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| <b>[jobs](https://github.com/albrow/jobs) | 493 | Persistent and flexible background jobs library. |
| <b>[Dagu](https://github.com/dagu-go/dagu) | 452 | No-code workflow executor. it executes DAGs defined in a simple YAML format. |
| <b>[scheduler](https://github.com/carlescere/scheduler) | 400 | Cronjobs scheduling made easy. |
| <b>[gronx](https://github.com/adhocore/gronx) | 216 | Cron expression parser, task runner and daemon consuming crontab like task list. |
...
| <b>[tasks](https://github.com/madflojo/tasks) | 114 | An easy to use in-process scheduler for recurring tasks in Go. |
| <b>[leprechaun](https://github.com/kilgaloon/leprechaun) | 91 | Job scheduler that supports webhooks, crons and classic scheduling. |
| <b>[goflow](https://github.com/fieldryand/goflow) | 68 | A workflow orchestrator and scheduler for rapid prototyping of ETL/ML/AI pipelines. |
| <b>[cheek](https://github.com/datarootsio/cheek) | 58 | A simple crontab like scheduler that aims to offer a KISS approach to job scheduling. |
...
| <b>[OjG](https://github.com/ohler55/ojg) | 519 | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
| <b>[kazaam](https://github.com/Qntfy/kazaam) | 241 | API for arbitrary transformation of JSON documents. |
| <b>[marshmallow](https://github.com/PerimeterX/marshmallow) | 212 | Performant JSON unmarshaling for flexible use cases. |
| <b>[jsondiff](https://github.com/wI2L/jsondiff) | 206 | JSON diff library for Go based on RFC6902 (JSON Patch). |
...
| <b>[ajson](https://github.com/spyzhov/ajson) | 133 | Abstract JSON for golang with JSONPath support. |
| <b>[gjo](https://github.com/skanehira/gjo) | 112 | Small utility to create JSON objects. |
...
| <b>[zerolog](https://github.com/rs/zerolog) | 7.1k | Zero-allocation JSON logger. |
...
| <b>[phuslu/log](https://github.com/phuslu/log) | 455 | Structured Logging Made Easy. |
...
| <b>[sqldb-logger](https://github.com/simukti/sqldb-logger) | 272 | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
...
| <b>[logur](https://github.com/logur/logur) | 177 | An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus), [go-kit log](https://github.com/go-kit/kit/tree/master/log), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog), etc). |
...
| <b>[slog](https://github.com/gookit/slog) | 133 | Lightweight, configurable, extensible logger for Go. |
...
| <b>[eaopt](https://github.com/MaxHalford/eaopt) | 813 | An evolutionary optimization library. |
| <b>[bayesian](https://github.com/jbrukh/bayesian) | 742 | Naive Bayesian Classification for Golang. |
| <b>[CloudForest](https://github.com/ryanbressler/CloudForest) | 718 | Fast, flexible, multi-threaded ensembles of decision trees for machine learning in pure Go. |
...
| <b>[onnx-go](https://github.com/owulveryck/onnx-go) | 430 | Go Interface to Open Neural Network Exchange (ONNX). |
| <b>[go-deep](https://github.com/patrikeh/go-deep) | 393 | A feature-rich neural network library in Go. |
...
| <b>[go-featureprocessing](https://github.com/nikolaydubina/go-featureprocessing) | 85 | Fast and convenient feature processing for low latency machine learning in Go. |
...
| <b>[Chanify](https://github.com/chanify/chanify) | 933 | A push notification server send message to your iOS devices. |
...
| <b>[dbus](https://github.com/godbus/dbus) | 765 | Native Go bindings for D-Bus. |
| <b>[golongpoll](https://github.com/jcuga/golongpoll) | 614 | HTTP longpoll server library that makes web pub-sub simple. |
| <b>[mangos](https://github.com/nanomsg/mangos) | 557 | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
| <b>[amqp](https://github.com/rabbitmq/amqp091-go) | 553 | Go RabbitMQ Client Library. |
| <b>[emitter](https://github.com/olebedev/emitter) | 437 | Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins. |
...
| <b>[Quamina](https://github.com/timbray/quamina) | 276 | Fast pattern-matching for filtering messages and events. |
...
| <b>[rabtap](https://github.com/jandelgado/rabtap) | 225 | RabbitMQ swiss army knife cli app. |
...
| <b>[redisqueue](https://github.com/robinjoseph08/redisqueue) | 89 | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
...
| <b>[Ratus](https://github.com/hyperonym/ratus) | 57 | Ratus is a RESTful asynchronous task queue server. |
...
| <b>[mob](https://github.com/erni27/mob) | 8 | mob is a generic-based, simple mediator / event aggregator library. It supports in-process requests / events processing. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[google/wire](https://github.com/google/wire) | 9.3k | Automated Initialization in Go. |
...
| <b>[do](https://github.com/samber/do) | 616 | A dependency injection framework based on Generics. |
| <b>[GoLobby/Container](https://github.com/golobby/container) | 385 | GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language. |
| <b>[goioc/di](https://github.com/goioc/di) | 212 | Spring-inspired Dependency Injection Container. |
...
| <b>[alice](https://github.com/magic003/alice) | 50 | Additive dependency injection container for Golang. |
...
| <b>[cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 550 | A Go application boilerplate template for quick starting projects following production best practices. |
| <b>[pagoda](https://github.com/mikestefanello/pagoda) | 465 | Rapid, easy full-stack web development starter kit built in Go. |
| <b>[golang-templates/seed](https://github.com/golang-templates/seed) | 335 | Go application GitHub repository template. |
| <b>[go-starter](https://github.com/allaboutapps/go-starter) | 259 | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| <b>[go-todo-backend](https://github.com/Fs02/go-todo-backend) | 175 | Go Todo Backend example using modular project layout for product microservice. |
| <b>[scaffold](https://github.com/catchplay/scaffold) | 127 | Scaffold generates a starter Go project layout. Lets you focus on business logic implemented. |
| <b>[go-sample](https://github.com/zitryss/go-sample) | 111 | A sample layout for Go application projects with the real code. |
| <b>[gobase](https://github.com/wajox/gobase) | 35 | A simple skeleton for golang application with basic setup for real golang application. |
...
| <b>[strutil](https://github.com/ozgio/strutil) | 187 | String utilities. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gopsutil](https://github.com/shirou/gopsutil) | 8.3k | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| <b>[llvm](https://github.com/llir/llvm) | 965 | Library for interacting with LLVM IR in pure Go. |
| <b>[shortid](https://github.com/teris-io/shortid) | 807 | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| <b>[health](https://github.com/alexliesenfeld/health) | 623 | A simple and flexible health check library for Go. |
| <b>[stateless](https://github.com/qmuntal/stateless) | 491 | A fluent library for creating state machines. |
| <b>[shoutrrr](https://github.com/containrrr/shoutrrr) | 466 | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
| <b>[health](https://github.com/dimiro1/health) | 436 | Easy to use, extensible health check library. |
| <b>[banner](https://github.com/dimiro1/banner) | 410 | Add beautiful banners into your Go applications. |
...
| <b>[gountries](https://github.com/pariz/gountries) | 361 | Package that exposes country and subdivision data. |
| <b>[ffmt](https://github.com/go-ffmt/ffmt) | 280 | Beautify data display for Humans. |
| <b>[lk](https://github.com/hyperboloide/lk) | 258 | A simple licensing library for golang. |
...
| <b>[go-unarr](https://github.com/gen2brain/go-unarr) | 206 | Decompression library for RAR, TAR, ZIP and 7z archives. |
| <b>[bitio](https://github.com/icza/bitio) | 201 | Highly optimized bit-level Reader and Writer for Go. |
...
| <b>[captcha](https://github.com/steambap/captcha) | 121 | Package captcha provides an easy to use, unopinionated API for captcha generation. |
| <b>[gommit](https://github.com/antham/gommit) | 99 | Analyze git commit messages to ensure they follow defined patterns. |
...
| <b>[persian](https://github.com/mavihq/persian) | 67 | Some utilities for Persian language in go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[whatlanggo](https://github.com/abadojack/whatlanggo) | 564 | Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc). |
...
| <b>[kagome](https://github.com/ikawaha/kagome) | 682 | JP morphological analyzer written in pure Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[slug](https://github.com/gosimple/slug) | 872 | URL-friendly slugify with multiple languages support. |
...
| <b>[gotext](https://github.com/leonelquinteros/gotext) | 356 | GNU gettext utilities for Go. |
...
| <b>[spreak](https://github.com/vorlif/spreak) | 12 | Flexible translation and humanization library for Go, based on the concepts behind gettext. |
...
| <b>[mdns](https://github.com/hashicorp/mdns) | 908 | Simple mDNS (Multicast DNS) client/server library in Golang. |
| <b>[gosnmp](https://github.com/soniah/gosnmp) | 903 | Native Go library for performing SNMP actions. |
| <b>[vssh](https://github.com/yahoo/vssh) | 867 | Go library for building network and server automation over SSH protocol. |
| <b>[nbio](https://github.com/lesismal/nbio) | 800 | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
| <b>[cidranger](https://github.com/yl2chen/cidranger) | 750 | Fast IP to CIDR lookup for Go. |
| <b>[gmqtt](https://github.com/DrmagicE/gmqtt) | 750 | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| <b>[lhttp](https://github.com/fanux/lhttp) | 676 | Powerful websocket framework, build your IM server more easily. |
| <b>[peerdiscovery](https://github.com/schollz/peerdiscovery) | 559 | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| <b>[go-stun](https://github.com/ccding/go-stun) | 526 | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
| <b>[gotcp](https://github.com/gansidui/gotcp) | 500 | Go package for quickly writing tcp applications. |
| <b>[easytcp](https://github.com/DarthPestilane/easytcp) | 490 | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
| <b>[stun](https://github.com/go-rtc/stun) | 487 | Go implementation of RFC 5389 STUN protocol. |
| <b>[gaio](https://github.com/xtaci/gaio) | 466 | High performance async-io networking for Golang in proactor mode. |
| <b>[gopcap](https://github.com/akrennmair/gopcap) | 458 | Go wrapper for libpcap. |
...
| <b>[ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 331 | Fully featured FTP server library. |
...
| <b>[gNxI](https://github.com/google/gnxi) | 223 | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
...
| <b>[fullproxy](https://github.com/shoriwe/fullproxy) | 38 | A fully featured scriptable and daemon configurable proxy and pivoting toolkit with SOCKS5, HTTP, raw ports and reverse proxy protocols. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[resty](https://github.com/go-resty/resty) | 6.8k | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| <b>[gentleman](https://github.com/h2non/gentleman) | 971 | Full-featured plugin-driven HTTP client library. |
| <b>[pester](https://github.com/sethgrid/pester) | 598 | Go HTTP client calls with retries, backoff, and concurrency. |
| <b>[requests](https://github.com/carlmjohnson/requests) | 424 | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| <b>[go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) | 265 | Get easily stdlib HTTP client, which does not share any state with other clients. |
| <b>[request](https://github.com/monaco-io/request) | 217 | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| <b>[gl](https://github.com/go-gl/gl) | 934 | Go bindings for OpenGL (generated via glow). |
| <b>[mathgl](https://github.com/go-gl/mathgl) | 463 | Pure Go math package specialized for 3D math, with inspiration from GLM. |
...
| <b>[go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 850 | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| <b>[go-queryset](https://github.com/jirfag/go-queryset) | 684 | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
| <b>[rel](https://github.com/go-rel/rel) | 585 | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| <b>[golobby/orm](https://github.com/golobby/orm) | 114 | Simple, fast, type-safe, generic orm for developer happiness. |
...
| <b>[gup](https://github.com/nao1215/gup) | 136 | Update binaries installed by "go install". |
...
| <b>[esc](https://github.com/mjibson/esc) | 627 | Embeds files into Go programs and provides http.FileSystem interfaces to them. |
| <b>[fileb0x](https://github.com/UnnoTed/fileb0x) | 616 | Simple tool to embed files in go with focus on "customization" and ease to use. |
...
| <b>[dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 893 | Dataframes for machine-learning and statistics (similar to pandas). |
| <b>[go-dsp](https://github.com/mjibson/go-dsp) | 795 | Digital Signal Processing for Go. |
| <b>[chart](https://github.com/vdobler/chart) | 738 | Simple Chart Plotting library for Go. Supports many graphs types. |
| <b>[goraph](https://github.com/gyuho/goraph) | 697 | Pure Go graph theory library(data structure, algorithm visualization). |
| <b>[graph](https://github.com/yourbasic/graph) | 585 | Library of basic graph algorithms. |
| <b>[orb](https://github.com/paulmach/orb) | 584 | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
...
| <b>[ode](https://github.com/ChristopherRabotin/ode) | 19 | Ordinary differential equation (ODE) solver which supports extended states and channel-based iteration stop conditions. |
...
| <b>[Coraza](https://github.com/corazawaf/coraza) | 688 | Enterprise-ready, modsecurity and OWASP CRS compatible WAF library. |
| <b>[nacl](https://github.com/kevinburke/nacl) | 529 | Go implementation of the NaCL set of API's. |
| <b>[go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 357 | Password validator based on raw cryptographic entropy values. |
| <b>[ssh-vault](https://github.com/ssh-vault/ssh-vault) | 357 | encrypt/decrypt using ssh keys. |
| <b>[firewalld-rest](https://github.com/prashantgupta24/firewalld-rest) | 325 | A rest application to dynamically update firewalld rules on a linux server. |
...
| <b>[dongle](https://github.com/golang-module/dongle) | 285 | A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption. |
...
| <b>[secret](https://github.com/rsjethani/secret) | 19 | Prevent your secrets from leaking into logs, std* etc. |
...
| <b>[csvutil](https://github.com/jszwec/csvutil) | 759 | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| <b>[colfer](https://github.com/pascaldekloe/colfer) | 678 | Code generation for the Colfer binary format. |
| <b>[cbor](https://github.com/fxamacker/cbor) | 497 | Small, safe, and easy CBOR encoding and decoding library. |
...
| <b>[bel](https://github.com/32leaves/bel) | 29 | Generate TypeScript interfaces from Go structs/interfaces. Useful for JSON RPC. |
...
| <b>[SFTPGo](https://github.com/drakkan/sftpgo) | 4.9k | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| <b>[go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 533 | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| <b>[Euterpe](https://github.com/ironsmile/euterpe) | 438 | Self-hosted music streaming server with built-in web UI and REST API. |
...
| <b>[cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 56 | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
...
| <b>[stream](https://github.com/youthlin/stream) | 68 | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
| <b>[goio](https://github.com/primetalk/goio) | 49 | An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2. |
...
| <b>[jet](https://github.com/CloudyKit/jet) | 959 | Jet template engine. |
| <b>[Razor](https://github.com/sipin/gorazor) | 799 | Razor view engine for Golang. |
| <b>[maroto](https://github.com/johnfercher/maroto) | 791 | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
| <b>[fasttemplate](https://github.com/valyala/fasttemplate) | 639 | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
...
| <b>[liquid](https://github.com/osteele/liquid) | 176 | Go implementation of Shopify Liquid templates. |
...
| <b>[go-vcr](https://github.com/dnaeon/go-vcr) | 955 | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
| <b>[gnomock](https://github.com/orlangure/gnomock) | 953 | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| <b>[goblin](https://github.com/franela/goblin) | 865 | Mocha like testing framework fo Go. |
| <b>[testfixtures](https://github.com/go-testfixtures/testfixtures) | 859 | A helper for Rails' like test fixtures to test database applications. |
| <b>[baloo](https://github.com/h2non/baloo) | 741 | Expressive and versatile end-to-end HTTP API testing made easy. |
| <b>[goc](https://github.com/qiniu/goc) | 578 | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| <b>[go-mutesting](https://github.com/zimmski/go-mutesting) | 556 | Mutation testing for Go source code. |
| <b>[embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 444 | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| <b>[gofight](https://github.com/appleboy/gofight) | 427 | API Handler Testing for Golang Router framework. |
| <b>[testza](https://github.com/MarvinJWendt/testza) | 401 | Full-featured test framework with nice colorized output. |
| <b>[gotest.tools](https://github.com/gotestyourself/gotest.tools) | 359 | A collection of packages to augment the go testing package and support common patterns. |
| <b>[go-testdeep](https://github.com/maxatome/go-testdeep) | 320 | Extremely flexible golang deep comparison, extends the go testing package. |
...
| <b>[dbcleaner](https://github.com/khaiql/dbcleaner) | 142 | Clean database for testing purpose, inspired by `database_cleaner` in Ruby. |
| <b>[go-hit](https://github.com/Eun/go-hit) | 141 | Hit is an http integration test framework written in golang. |
| <b>[GoSpec](https://github.com/orfjackal/gospec) | 114 | BDD-style testing framework for the Go programming language. |
| <b>[testcase](https://github.com/adamluzsi/testcase) | 101 | Idiomatic testing framework for Behavior Driven Development. |
...
| <b>[counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 726 | Tool for generating self-contained mock objects. |
| <b>[go-txdb](https://github.com/DATA-DOG/go-txdb) | 485 | Single transaction based database driver mainly for testing purposes. |
...
| <b>[go-localstack](https://github.com/elgohr/go-localstack) | 55 | Tool for using localstack in AWS testing. |
...
| <b>[Tavor](https://github.com/zimmski/tavor) | 237 | Generic fuzzing and delta-debugging framework. |
...
| <b>[playwright-go](https://github.com/mxschmitt/playwright-go) | 979 | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| <b>[cdp](https://github.com/mafredri/cdp) | 640 | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[failpoint](https://github.com/pingcap/failpoint) | 739 | An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| <b>[bytes](https://github.com/labstack/gommon/tree/master/bytes) | 470 | Formats and parses numeric byte values (10K, 2M, 3G, etc.). |
| <b>[gotabulate](https://github.com/bndr/gotabulate) | 291 | Easily pretty-print your tabular data with Go. |
...
| <b>[htmlquery](https://github.com/antchfx/htmlquery) | 524 | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| <b>[html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 401 | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
| <b>[goq](https://github.com/andrewstuart/goq) | 219 | Declarative unmarshaling of HTML using struct tags with jQuery syntax (uses GoQuery). |
...
| <b>[omniparser](https://github.com/jf-tech/omniparser) | 510 | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| <b>[gographviz](https://github.com/awalterschulze/gographviz) | 497 | Parses the Graphviz DOT language. |
...
| <b>[did](https://github.com/ockam-network/did) | 68 | DID (Decentralized Identifiers) Parser and Stringer in Go. |
...
| <b>[rex](https://github.com/hedhyw/rex) | 120 | Regular expressions builder. |
...
| <b>[xurls](https://github.com/mvdan/xurls) | 968 | Extract urls from text. |
| <b>[dataflowkit](https://github.com/slotix/dataflowkit) | 547 | Web scraping Framework to turn websites into structured data. |
| <b>[gospider](https://github.com/zhshch2002/gospider) | 177 | A simple golang spider/scraping framework,build a spider in 3 lines. migrated from [goribot](https://github.com/zhshch2002/goribot) |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-runewidth](https://github.com/mattn/go-runewidth) | 488 | Functions to get fixed width of the character or string. |
...
| <b>[githubql](https://github.com/shurcooL/githubql) | 929 | Go library for accessing the GitHub GraphQL API v4. |
| <b>[webhooks](https://github.com/go-playground/webhooks) | 780 | Webhook receiver for GitHub and Bitbucket. |
| <b>[paypal](https://github.com/logpacker/PayPal-Go-SDK) | 532 | Wrapper for PayPal payment API. |
| <b>[geo-golang](https://github.com/codingsince1985/geo-golang) | 441 | Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](https://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](https://opencagedata.com/api), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs. |
| <b>[twitter-scraper](https://github.com/n0madic/twitter-scraper) | 261 | Scrape the Twitter Frontend API without authentication and limits. |
| <b>[ethrpc](https://github.com/onrik/ethrpc) | 245 | Go bindings for Ethereum JSON RPC API. |
| <b>[lark](https://github.com/chyroc/lark) | 237 | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| <b>[wit-go](https://github.com/wit-ai/wit-go) | 131 | Go client for wit.ai HTTP API. |
...
| <b>[pushover](https://github.com/gregdel/pushover) | 126 | Go wrapper for the Pushover API. |
...
| <b>[golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 59 | Golang wrapper for The Movie Database API v3. |
...
| <b>[go-postman-collection](https://github.com/rbretecher/go-postman-collection) | 54 | Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia). |
| <b>[uptimerobot](https://github.com/bitfield/uptimerobot) | 51 | Go wrapper and command-line client for the Uptime Robot v2 API. |
...
| <b>[lo](https://github.com/samber/lo) | 8.1k | A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...) |
...
| <b>[retry-go](https://github.com/avast/retry-go) | 1.1k | Simple library for retry mechanism. |
| <b>[circuitbreaker](https://github.com/rubyist/circuitbreaker) | 1000 | Circuit Breakers in Go. |
| <b>[git-time-metric](https://github.com/git-time-metric/gtm) | 912 | Simple, seamless, lightweight time tracking for Git. |
| <b>[mimetype](https://github.com/gabriel-vasile/mimetype) | 853 | Package for MIME type detection based on magic numbers. |
| <b>[hostctl](https://github.com/guumaster/hostctl) | 813 | A CLI tool to manage /etc/hosts with easy commands. |
| <b>[immortal](https://github.com/immortal/immortal) | 752 | \*nix cross-platform (OS agnostic) supervisor. |
| <b>[scany](https://github.com/georgysavva/scany) | 730 | Library for scanning data from a database into Go structs and more. |
...
| <b>[ergo](https://github.com/cristianoliveira/ergo) | 538 | The management of multiple local services running over different ports made easy. |
| <b>[delve](https://github.com/derekparker/delve) | 530 | Go debugger. |
| <b>[koazee](https://github.com/wesovilabs/koazee) | 507 | Library inspired in Lazy evaluation and functional programming that takes the hassle out of working with arrays. |
...
| <b>[clockwork](https://github.com/jonboulle/clockwork) | 415 | A simple fake clock for golang. |
| <b>[Deepcopier](https://github.com/ulule/deepcopier) | 393 | Simple struct copying for Go. |
| <b>[changie](https://github.com/miniscruff/changie) | 392 | Automated changelog tool for preparing releases with lots of customization options. |
| <b>[go-rate](https://github.com/beefsack/go-rate) | 371 | Timed rate limiter for Go. |
| <b>[remote-touchpad](https://github.com/Unrud/remote-touchpad) | 335 | Control mouse and keyboard from a smartphone. |
...
| <b>[mani](https://github.com/alajmo/mani) | 318 | CLI tool to help you manage multiple repositories. |
| <b>[scan](https://github.com/blockloop/scan) | 308 | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
| <b>[serve](https://github.com/syntaqx/serve) | 281 | A static http server anywhere you need. |
| <b>[clipboard](https://github.com/golang-design/clipboard) | 279 | 📋 cross-platform clipboard package in Go. |
| <b>[util](https://github.com/shomali11/util) | 257 | Collection of useful utility functions. (strings, concurrency, manipulations, ...). |
| <b>[gohper](https://github.com/cosiner/gohper) | 256 | Various tools/modules help for development. |
| <b>[gotenv](https://github.com/subosito/gotenv) | 237 | Load environment variables from `.env` or any `io.Reader` in Go. |
...
| <b>[grofer](https://github.com/pesos/grofer) | 223 | A system and resource monitoring tool written in Golang! |
| <b>[wifiqr](https://github.com/reugn/wifiqr) | 215 | Wi-Fi QR Code Generator. |
| <b>[countries](https://github.com/biter777/countries) | 189 | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
...
| <b>[nostromo](https://github.com/pokanop/nostromo) | 120 | CLI for building powerful aliases. |
| <b>[cmd](https://github.com/SimonBaeumer/cmd) | 110 | Library for executing shell commands on osx, windows and linux. |
| <b>[sorty](https://github.com/jfcg/sorty) | 109 | Fast Concurrent / Parallel Sorting. |
| <b>[mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 107 | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
| <b>[limiters](https://github.com/mennanov/limiters) | 105 | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
...
| <b>[filter](https://github.com/gookit/filter) | 98 | provide filtering, sanitizing, and conversion of Go data. |
...
| <b>[goval](https://github.com/maja42/goval) | 90 | Evaluate arbitrary expressions in Go. |
...
| <b>[mimemagic](https://github.com/zRedShift/mimemagic) | 80 | Pure Go ultra performant MIME sniffing library/utility. |
...
| <b>[countries](https://github.com/pioz/countries) | 67 | All you need when you are working with countries in Go. |
...
| <b>[scan](https://github.com/wroge/scan) | 39 | Scan sql rows into any type powered by generics. |
| <b>[gostrutils](https://github.com/ik5/gostrutils) | 38 | Collections of string manipulation and conversion functions. |
| <b>[shutdown](https://github.com/ztrue/shutdown) | 38 | App shutdown hooks for `os.Signal` handling. |
| <b>[sshman](https://github.com/shoobyban/sshman) | 38 | SSH Manager for authorized_keys files on multiple remote servers. |
...
| <b>[ptr](https://github.com/gotidy/ptr) | 17 | Package that provide functions for simplified creation of pointers from constants of basic types. |
...
| <b>[validate](https://github.com/gookit/validate) | 793 | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| <b>[validate](https://github.com/gobuffalo/validate) | 77 | This package provides a framework for writing validations for Go applications. |
...
| <b>[githooks](https://github.com/gabyx/githooks) | 51 | Per-repo and shared Git hooks with version control and auto update. |
...
| <b>[m3u8](https://github.com/grafov/m3u8) | 967 | Parser and generator library of M3U8 playlists for Apple HLS. |
| <b>[gmf](https://github.com/3d0c/gmf) | 801 | Go bindings for FFmpeg av\* libraries. |
| <b>[go-astits](https://github.com/asticode/go-astits) | 439 | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
| <b>[go-astisub](https://github.com/asticode/go-astisub) | 414 | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| <b>[libvlc-go](https://github.com/adrg/libvlc-go) | 319 | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
| <b>[gortsplib](https://github.com/aler9/gortsplib) | 307 | Pure Go RTSP server and client library. |
...
| <b>[Gearbox](https://github.com/abahmed/gearbox) | 675 | A web framework written in Go with a focus on high performance and memory optimization. |
...
| <b>[Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 365 | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| <b>[Flamingo](https://github.com/i-love-flamingo/flamingo) | 320 | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| <b>[Gondola](https://github.com/rainycape/gondola) | 310 | The web framework for writing faster sites, faster. |
| <b>[rk-boot](https://github.com/rookie-ninja/rk-boot) | 305 | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
...
| <b>[uAdmin](https://github.com/uadmin/uadmin) | 209 | Fully featured web framework for Golang, inspired by Django. |
...
| <b>[Huma](https://github.com/danielgtaylor/huma/) | 140 | Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI. |
...
| <b>[go-server-timing](https://github.com/mitchellh/go-server-timing) | 841 | Add/parse Server-Timing header. |
| <b>[go-fault](https://github.com/github/go-fault) | 465 | Fault injection middleware for Go. |
...
| <b>[rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 51 | Middleware for gRPC with logging, metrics, auth, tracing etc. |
...
| <b>[renderer](https://github.com/thedevsaddam/renderer) | 246 | Simple, lightweight and faster response (JSON, JSONP, XML, YAML, HTML, File) rendering package for Go. |
...
| <b>[Goji](https://github.com/goji/goji) | 911 | Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`. |
...
| <b>[httptreemux](https://github.com/dimfeld/httptreemux) | 561 | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
| <b>[xujiajun/gorouter](https://github.com/xujiajun/gorouter) | 529 | A simple and fast HTTP router for Go. |
...
| <b>[GoRouter](https://github.com/vardius/gorouter) | 136 | GoRouter is a Server/API micro framework, HTTP request router, multiplexer, mux that provides request router with middleware supporting `net/context`. |
...
| <b>[dom](https://github.com/dennwc/dom) | 463 | DOM library. |
...
| <b>[webapi](https://github.com/gowebapi/webapi) | 121 | Bindings for DOM and HTML generated from WebIDL. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-ole](https://github.com/go-ole/go-ole) | 912 | Win32 OLE implementation for golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[zek](https://github.com/miku/zek) | 602 | Generate a Go struct from XML. |
| <b>[xpath](https://github.com/antchfx/xpath) | 517 | XPath package for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Cosign](https://github.com/sigstore/cosign) | 2.6k | Container Signing, Verification and Storage in an OCI registry. |
...
| <b>[in-toto](https://github.com/in-toto/in-toto-golang) | 66 | Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation. |
...
| <b>[goast-viewer](https://github.com/yuroyoro/goast-viewer) | 661 | Web based Golang AST visualizer. |
| <b>[go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 626 | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
...
| <b>[golines](https://github.com/segmentio/golines) | 481 | Formatter that automatically shortens long lines in Go code. |
...
| <b>[unconvert](https://github.com/mdempsky/unconvert) | 339 | Remove unnecessary type conversions from Go source. |
| <b>[dupl](https://github.com/mibk/dupl) | 298 | Tool for code clone detection. |
| <b>[tickgit](https://github.com/augmentable-dev/tickgit) | 284 | CLI and go package for surfacing code comment TODOs (in any language) and applying a `git blame`to identify the author. |
...
| <b>[coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) | 495 | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| <b>[goimports-reviser](https://github.com/incu6us/goimports-reviser) | 208 | Formatting tool for imports. |
...
| <b>[xgen](https://github.com/xuri/xgen) | 188 | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| <b>[gocontracts](https://github.com/Parquery/gocontracts) | 88 | brings design-by-contract to Go by synchronizing the code with the documentation. |
...
| <b>[depth](https://github.com/KyleBanks/depth) | 792 | Visualize dependency trees of any package by analyzing imports. |
...
| <b>[roumon](https://github.com/becheran/roumon) | 121 | Monitor current state of all active goroutines via a command line interface. |
...
| <b>[ko](https://github.com/google/ko) | 5.1k | Command line tool for building and deploying Go applications on Kubernetes |
| <b>[Ddosify](https://github.com/ddosify/ddosify) | 5.0k | High-performance load testing tool, written in Golang. |
...
| <b>[Mizu](https://github.com/up9inc/mizu) | 4.0k | API traffic viewer for Kubernetes enabling you to view all API communication between microservices, multiprotocol support: HTTP1.1, HTTP/2, AMQP, Kafka, Redis. |
...
| <b>[Fleet device management](https://github.com/fleetdm/fleet) | 946 | Lightweight, programmable telemetry for servers and workstations. |
| <b>[skm](https://github.com/TimothyYe/skm) | 831 | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| <b>[Scaleway-cli](https://github.com/scaleway/scaleway-cli) | 779 | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| <b>[uTask](https://github.com/ovh/utask) | 745 | Automation engine that models and executes business processes declared in yaml. |
| <b>[kwatch](https://github.com/abahmed/kwatch) | 683 | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
| <b>[cassowary](https://github.com/rogerwelin/cassowary) | 619 | Modern cross-platform HTTP load-testing tool written in Go. |
| <b>[kool](https://github.com/kool-dev/kool) | 614 | Command line tool for managing Docker environments as an easy way. |
| <b>[aurora](https://github.com/xuri/aurora) | 568 | Cross-platform web-based Beanstalkd queue server console. |
...
| <b>[manssh](https://github.com/xwjdsh/manssh) | 272 | manssh is a command line tool for managing your ssh alias config easily. |
| <b>[easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 262 | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
...
| <b>[abbreviate](https://github.com/dnnrly/abbreviate) | 189 | abbreviate is a tool turning long strings in to shorter ones with configurable seperaters, for example to embed branch names in to deployment stack IDs. |
...
| <b>[s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 136 | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
| <b>[drone-scp](https://github.com/appleboy/drone-scp) | 111 | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
| <b>[Mantil](https://github.com/mantil-io/mantil) | 94 | Go specific framework for building serverless applications on AWS that enables you to focus on pure Go code while Mantil takes care of the infrastructure. |
...
| <b>[shell2http](https://github.com/msoap/shell2http) | 992 | Executing shell commands via http server (for prototyping or remote control). |
...
| <b>[peg](https://github.com/pointlander/peg) | 874 | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
| <b>[Leaps](https://github.com/jeffail/leaps) | 730 | Pair programming service using Operational Transforms. |
| <b>[gfile](https://github.com/Antonito/gfile) | 683 | Securely transfer files between two computers, without any third party, over WebRTC. |
...
| <b>[Guora](https://github.com/meloalright/guora) | 609 | A self-hosted Quora like web application written in Go. |
| <b>[sake](https://github.com/alajmo/sake) | 551 | sake is a command runner for local and remote hosts. |
| <b>[gocc](https://github.com/goccmack/gocc) | 541 | Gocc is a compiler kit for Go written in Go. |
| <b>[mockingjay](https://github.com/quii/mockingjay-server) | 522 | Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests. |
| <b>[go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 454 | Video streaming torrent client. |
| <b>[Gokapi](https://github.com/Forceu/gokapi) | 427 | Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload. |
...
| <b>[Cherry](https://github.com/rafael-santiago/cherry) | 283 | Tiny webchat server in Go. |
| <b>[Neo-cowsay](https://github.com/Code-Hex/Neo-cowsay) | 230 | 🐮 cowsay is reborn. for a New Era. |
| <b>[tcpdog](https://github.com/mehrdadrad/tcpdog) | 208 | eBPF based TCP observability. |
...
| <b>[crawley](https://github.com/s0rg/crawley) | 92 | Web scraper/crawler for cli. |
...
| <b>[gopherize.me](https://github.com/matryer/gopherize.me) | 601 | Gopherize yourself. |
...
| <b>[Go-gopher-Vector](https://github.com/keygx/Go-gopher-Vector) | 55 | Go gopher Vector Data [.ai, .svg]. |
...
| <b>[goapp](https://github.com/bnkamalesh/goapp) | 525 | An opinionated guideline to structure & develop a Go web application/service. |
