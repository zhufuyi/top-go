...
| <b>[music-theory](https://github.com/go-music-theory/music-theory) | 406 | Music theory models in Go. |
| <b>[id3v2](https://github.com/bogem/id3v2) | 259 | ID3 decoding and encoding library for Go. |
...
| <b>[malgo](https://github.com/gen2brain/malgo) | 190 | Mini audio library. |
| <b>[gaad](https://github.com/Comcast/gaad) | 104 | Native Go AAC bitstream parser. |
| <b>[minimp3](https://github.com/tosone/minimp3) | 87 | Lightweight MP3 decoder library. |
...
| <b>[paseto](https://github.com/o1egl/paseto) | 625 | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
| <b>[jwt](https://github.com/cristalhq/jwt) | 561 | Safe, simple and fast JSON Web Tokens for Go. |
...
| <b>[go-guardian](https://github.com/shaj13/go-guardian) | 394 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
| <b>[jwt](https://github.com/pascaldekloe/jwt) | 294 | Lightweight JSON Web Token (JWT) library. |
...
| <b>[jwt-auth](https://github.com/adam-hanna/jwt-auth) | 219 | JWT middleware for Golang http servers with many configuration options. |
...
| <b>[sjwt](https://github.com/brianvoe/sjwt) | 101 | Simple jwt generator and parser. |
| <b>[rbac](https://github.com/zpatrick/rbac) | 100 | Minimalistic RBAC package for Go applications. |
...
| <b>[scope](https://github.com/SonicRoshan/scope) | 22 | Easily Manage OAuth2 Scopes In Go. |
...
| <b>[cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 4.4k | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| <b>[solana-go](https://github.com/gagliardetto/solana-go) | 360 | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
...
| <b>[Kelp](https://github.com/stellar/kelp) | 921 | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| <b>[Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) | 813 | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| <b>[go-chat-bot](https://github.com/go-chat-bot/bot) | 756 | IRC, Slack & Telegram bot written in Go. |
| <b>[slacker](https://github.com/shomali11/slacker) | 684 | Easy to use framework to create Slack bots. |
| <b>[tbot](https://github.com/yanzay/tbot) | 329 | Telegram bot server with API similar to net/http. |
| <b>[wayback](https://github.com/wabarc/wayback) | 309 | A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages. |
| <b>[go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 255 | Library to write bots for twitch.tv chat |
...
| <b>[echotron](https://github.com/NicoNex/echotron) | 176 | An elegant and concurrent library for Telegram Bots in Go. |
...
| <b>[slack-bot](https://github.com/innogames/slack-bot) | 110 | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
| <b>[telego](https://github.com/mymmrac/telego) | 91 | Telegram Bot API library for Golang with full one-to-one API implementation. |
| <b>[margelet](https://github.com/zhulik/margelet) | 73 | Framework for building Telegram bots. |
| <b>[larry](https://github.com/ezeoleaf/larry) | 72 | Larry 🐦 is a really simple Twitter bot generator that tweets random repositories from Github built in Go. |
| <b>[ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 65 | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Task](https://github.com/go-task/task) | 5.7k | simple "Make" alternative. |
...
| <b>[taskctl](https://github.com/taskctl/taskctl) | 210 | Concurrent task runner. |
...
| <b>[go-isatty](https://github.com/mattn/go-isatty) | 636 | isatty for golang. |
| <b>[go-colorable](https://github.com/mattn/go-colorable) | 632 | Colorable writer for windows. |
| <b>[gommon/color](https://github.com/labstack/gommon/tree/master/color) | 462 | Style terminal text. |
| <b>[chalk](https://github.com/ttacon/chalk) | 407 | Intuitive package for prettifying terminal/console output. |
| <b>[simpletable](https://github.com/alexeyco/simpletable) | 382 | Simple tables in terminal with Go. |
| <b>[yacspin](https://github.com/theckman/yacspin) | 361 | Yet Another CLi Spinner package, for working with terminal spinners. |
| <b>[tabby](https://github.com/cheynewallace/tabby) | 321 | A tiny library for super simple Golang tables. |
| <b>[box-cli-maker](https://github.com/Delta456/box-cli-maker) | 231 | Make Highly Customized Boxes for your CLI. |
| <b>[go-colortext](https://github.com/daviddengcn/go-colortext) | 213 | Go library for color output in terminals. |
| <b>[cfmt](https://github.com/mingrammer/cfmt) | 86 | Contextual fmt inspired by bootstrap color classes. |
...
| <b>[cfmt](https://github.com/i582/cfmt) | 47 | Simple and convenient formatted stylized output fully compatible with fmt library. |
...
| <b>[liner](https://github.com/peterh/liner) | 915 | Go readline-like library for command-line interfaces. |
| <b>[complete](https://github.com/posener/complete) | 856 | Write bash completions in Go + Go command bash completion. |
| <b>[mow.cli](https://github.com/jawher/mow.cli) | 824 | Go library for building CLI applications with sophisticated flag and argument parsing and validation. |
| <b>[flaggy](https://github.com/integrii/flaggy) | 806 | A robust and idiomatic flags package with excellent subcommand support. |
| <b>[cli](https://github.com/mkideal/cli) | 666 | Feature-rich and easy to use command-line package based on golang struct tags. |
| <b>[argparse](https://github.com/akamensky/argparse) | 448 | Command line argument parser inspired by Python's argparse module. |
...
| <b>[wmenu](https://github.com/dixonwille/wmenu) | 169 | Easy to use menu structure for cli applications that prompts users to make choices. |
...
| <b>[ukautz/clif](https://github.com/ukautz/clif) | 116 | Small command line interface framework. |
| <b>[cli](https://github.com/teris-io/cli) | 114 | Simple and complete API for building command line interfaces in Go. |
| <b>[cmdr](https://github.com/hedzr/cmdr) | 112 | A POSIX/GNU style, getopt-like command-line UI Go library. |
| <b>[env](https://github.com/codingconcepts/env) | 94 | Tag-based environment configuration for structs. |
| <b>[carapace-bin](https://github.com/rsteube/carapace-bin) | 69 | Multi-shell multi-command argument completer. |
| <b>[gocmd](https://github.com/devfacet/gocmd) | 58 | Go library for building command line applications. |
| <b>[wlog](https://github.com/dixonwille/wlog) | 57 | Simple logging interface that supports cross-platform color and concurrency. |
| <b>[acmd](https://github.com/cristalhq/acmd) | 49 | Simple, useful and opinionated CLI package in Go. |
| <b>[carapace](https://github.com/rsteube/carapace) | 46 | Command argument completion generator for spf13/cobra. |
...
| <b>[cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 714 | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| <b>[confita](https://github.com/heetch/confita) | 452 | Load configuration in cascade from multiple backends into a struct. |
| <b>[aconfig](https://github.com/cristalhq/aconfig) | 390 | Simple, useful and opinionated config loader. |
| <b>[gookit/config](https://github.com/gookit/config) | 387 | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| <b>[config](https://github.com/JeremyLoy/config) | 315 | Cloud native application configuration. Bind ENV to structs in only two lines. |
| <b>[GoLobby/Config](https://github.com/golobby/config) | 291 | GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language. |
| <b>[hjson](https://github.com/hjson/hjson-go) | 275 | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
| <b>[store](https://github.com/tucnak/store) | 261 | Lightweight configuration manager for Go. |
| <b>[xdg](https://github.com/adrg/xdg) | 255 | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
| <b>[config](https://github.com/olebedev/config) | 251 | JSON or YAML configuration wrapper with environment variables and flags parsing. |
| <b>[fig](https://github.com/kkyr/fig) | 225 | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
| <b>[envconfig](https://github.com/vrischmann/envconfig) | 223 | Read your configuration from environment variables. |
...
| <b>[onion](https://github.com/goraz/onion) | 107 | Layer based configuration for Go, Supports JSON, TOML, YAML, properties, etcd, env, and encryption using PGP. |
...
| <b>[configuration](https://github.com/BoRuDar/configuration) | 78 | Library for initializing configuration structs from env variables, files, flags and 'default' tag. |
...
| <b>[config](https://github.com/num30/config) | 24 | configure you app using file, environment variables, or flags in two lines of code |
...
| <b>[goveralls](https://github.com/mattn/goveralls) | 737 | Go integration for Coveralls.io continuous code coverage tracking system. |
| <b>[gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 237 | go test output for humans. |
...
| <b>[binpacker](https://github.com/zhuangsirui/binpacker) | 191 | Binary packer and unpacker helps user build custom binary stream. |
...
| <b>[bingo](https://github.com/iancmcc/bingo) | 11 | Fast, zero-allocation, lexicographical-order-preserving packing of native types to bytes. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[bitset](https://github.com/bits-and-blooms/bitset) | 963 | Go package implementing bitsets. |
...
| <b>[cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 924 | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
| <b>[cuckoo-filter](https://github.com/linvon/cuckoo-filter) | 225 | Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper is available. |
...
| <b>[gostl](https://github.com/liyue201/gostl) | 706 | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| <b>[algorithms](https://github.com/shady831213/algorithms) | 664 | Algorithms and data structures.CLRS study. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[iter](https://github.com/disksing/iter) | 161 | Go implementation of C++ STL iterators and algorithms. |
...
| <b>[go-tuple](https://github.com/barweiss/go-tuple) | 33 | Generic tuple implementation for Go 1.18+. |
| <b>[fsm](https://github.com/cocoonspace/fsm) | 28 | Finite-State Machine package. |
| <b>[genfuncs](https://github.com/nwillc/genfuncs) | 27 | Go 1.18+ generics package inspired by Kotlin's Sequence and Map. |
| <b>[go18ds](https://github.com/daichi-m/go18ds) | 24 | Go Data Structures using Go 1.18 generics. |
...
| <b>[slices](https://github.com/twharmon/slices) | 7 | Pure, generic functions for slices. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[nan](https://github.com/kak-tus/nan) | 55 | Zero allocation Nullable structures in one library with handy conversion functions, marshallers and unmarshallers. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[deque](https://github.com/gammazero/deque) | 366 | Fast ring-buffer deque (double-ended queue). |
| <b>[goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 204 | Concurrent FIFO queue. |
| <b>[deque](https://github.com/edwingeng/deque) | 62 | A highly optimized double-ended queue. |
...
| <b>[go-edlib](https://github.com/hbollon/go-edlib) | 343 | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| <b>[go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 244 | Go implementation of Adaptive Radix Tree. |
| <b>[levenshtein](https://github.com/agnivade/levenshtein) | 231 | Implementation to calculate levenshtein distance in Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[skiplist](https://github.com/MauriceGit/skiplist) | 224 | Very fast Go Skiplist implementation. |
...
| <b>[ttlcache](https://github.com/jellydator/ttlcache) | 475 | An in-memory cache with item expiration and generics. |
| <b>[cachego](https://github.com/fabiorphp/cachego) | 181 | Golang Cache component for multiple drivers. |
| <b>[cachego](https://github.com/faabiosr/cachego) | 181 | Golang Cache component for multiple drivers. |
...
| <b>[bcache](https://github.com/iwanbk/bcache) | 90 | Eventually consistent distributed in-memory  cache Go library. |
...
| <b>[VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 7.0k | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
...
| <b>[column](https://github.com/kelindar/column) | 975 | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
| <b>[lotusdb](https://github.com/flower-corp/lotusdb) | 942 | Fast k/v database compatible with lsm and b+tree. |
| <b>[eliasdb](https://github.com/krotik/eliasdb) | 941 | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| <b>[pogreb](https://github.com/akrylysov/pogreb) | 928 | Embedded key-value store for read-heavy workloads. |
| <b>[moss](https://github.com/couchbase/moss) | 881 | Moss is a simple LSM key-value storage engine written in 100% Go. |
...
| <b>[clover](https://github.com/ostafen/clover) | 256 | A lightweight document-oriented NoSQL database written in pure Golang. |
...
| <b>[dtf](https://github.com/dtm-labs/dtf) | 234 | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[migrate](https://github.com/golang-migrate/migrate) | 9.6k | Database migrations. CLI and Golang library. |
...
| <b>[goavro](https://github.com/linkedin/goavro) | 828 | A Go package that encodes and decodes Avro data. |
| <b>[gormigrate](https://github.com/go-gormigrate/gormigrate) | 809 | Database schema migration helper for Gorm ORM. |
| <b>[darwin](https://github.com/GuiaBolso/darwin) | 133 | Database schema evolution library for Go. |
| <b>[migrator](https://github.com/lopezator/migrator) | 129 | Dead simple Go database migration library. |
...
| <b>[sqlize](https://github.com/sunary/sqlize) | 38 | Database migration generator. Allows generate sql migration from model and existing sql by differ them. |
...
| <b>[chproxy](https://github.com/Vertamedia/chproxy) | 963 | HTTP proxy for ClickHouse database. |
| <b>[pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 775 | Advanced scheduling for PostgreSQL. |
| <b>[clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 377 | Collects small inserts and sends big requests to ClickHouse servers. |
...
| <b>[rdb](https://github.com/HDT3213/rdb) | 179 | Redis RDB file parser for secondary development and memory analysis. |
| <b>[octillery](https://github.com/knocknote/octillery) | 170 | Go package for sharding databases ( Supports every ORM or raw SQL ). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sqlc](https://github.com/kyleconroy/sqlc) | 6.2k | Generate type-safe code from SQL. |
...
| <b>[jet](https://github.com/go-jet/jet) | 777 | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
| <b>[Dotsql](https://github.com/gchaincl/dotsql) | 644 | Go library that helps you keep sql files in one place and use them with ease. |
| <b>[ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 569 | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
| <b>[dbq](https://github.com/rocketlaunchr/dbq) | 348 | Zero boilerplate database operations for Go. |
...
| <b>[sqlf](https://github.com/leporo/sqlf) | 82 | Fast SQL query builder. |
...
| <b>[gokv](https://github.com/philippgille/gokv) | 463 | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| <b>[pgx](https://github.com/jackc/pgx) | 5.9k | PostgreSQL driver supporting features beyond those exposed by database/sql. |
...
| <b>[sqlhooks](https://github.com/qustavo/sqlhooks) | 574 | Attach hooks to any database/sql driver. |
| <b>[godror](https://github.com/godror/godror) | 388 | Oracle driver for Go, using the ODPI-C driver. |
| <b>[Kivik](https://github.com/go-kivik/kivik) | 240 | Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases. |
| <b>[firebirdsql](https://github.com/nakagami/firebirdsql) | 172 | Firebird RDBMS SQL driver for Go. |
| <b>[KSQL](https://github.com/VinGarcia/ksql) | 151 | A Simple and Powerful Golang SQL Library |
...
| <b>[avatica](https://github.com/apache/calcite-avatica-go) | 99 | Apache Avatica/Phoenix SQL driver for database/sql. |
...
| <b>[qmgo](https://github.com/qiniu/qmgo) | 956 | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
| <b>[mgm](https://github.com/kamva/mgm) | 546 | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| <b>[go-rejson](https://github.com/nitishm/go-rejson) | 279 | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| <b>[elasticsql](https://github.com/cch123/elasticsql) | 952 | Convert sql to elasticsearch dsl in Go. |
...
| <b>[carbon](https://github.com/uniplaces/carbon) | 724 | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
...
| <b>[date](https://github.com/rickb777/date) | 92 | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| <b>[go-sunrise](https://github.com/nathan-osman/go-sunrise) | 56 | Calculate the sunrise and sunset times for a given location. |
| <b>[go-str2duration](https://github.com/xhit/go-str2duration) | 45 | Convert string to duration. Support time.Duration returned string and more. |
...
| <b>[go-doudou](https://github.com/unionj-cloud/go-doudou) | 844 | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
| <b>[redis-lock](https://github.com/bsm/redislock) | 786 | Simplified distributed locking implementation using Redis. |
| <b>[rain](https://github.com/cenkalti/rain) | 755 | BitTorrent client and library. |
| <b>[ringpop-go](https://github.com/uber/ringpop-go) | 745 | Scalable, fault-tolerant application-layer sharding for Go applications. |
| <b>[gorpc](https://github.com/valyala/gorpc) | 653 | Simple, fast and scalable RPC library for high load. |
| <b>[go-health](https://github.com/InVisionApp/go-health) | 634 | Library for enabling asynchronous dependency health checks in your service. |
| <b>[arpc](https://github.com/lesismal/arpc) | 589 | More effective network communication, support two-way-calling, notify, broadcast. |
| <b>[consistent](https://github.com/buraksezer/consistent) | 501 | Consistent hashing with bounded loads. |
...
| <b>[digota](https://github.com/digota/digota) | 457 | grpc ecommerce microservice. |
...
| <b>[go-jump](https://github.com/dgryski/go-jump) | 349 | Port of Google's "Jump" Consistent Hash function. |
| <b>[dht](https://github.com/anacrolix/dht) | 241 | BitTorrent Kademlia DHT implementation. |
| <b>[jsonrpc](https://github.com/ybbus/jsonrpc) | 238 | JSON-RPC 2.0 HTTP client implementation. |
...
| <b>[doublejump](https://github.com/edwingeng/doublejump) | 77 | A revamped Google's jump consistent hash. |
...
| <b>[gmsec](https://github.com/gmsec/micro) | 21 | A Go distributed systems development framework. |
...
| <b>[SendGrid](https://github.com/sendgrid/sendgrid-go) | 840 | SendGrid's Go library for sending email. |
| <b>[mailgun-go](https://github.com/mailgun/mailgun-go) | 621 | Go library for sending mail with the Mailgun API. |
| <b>[email-verifier](https://github.com/AfterShip/email-verifier) | 500 | A Go library for email verification without sending any emails. |
| <b>[go-simple-mail](https://github.com/xhit/go-simple-mail) | 369 | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| <b>[go-message](https://github.com/emersion/go-message) | 262 | Streaming library for the Internet Message Format and mail messages. |
| <b>[douceur](https://github.com/aymerick/douceur) | 220 | CSS inliner for your HTML emails. |
| <b>[Hectane](https://github.com/hectane/hectane) | 220 | Lightweight SMTP client providing an HTTP API. |
| <b>[mailchain](https://github.com/mailchain/mailchain) | 123 | Send encrypted emails to blockchain addresses written in Go. |
...
| <b>[go-mail](https://github.com/wneessen/go-mail) | 37 | A simple Go library for sending mails in Go. |
...
| <b>[go-php](https://github.com/deuill/go-php) | 869 | PHP bindings for Go. |
| <b>[go-duktape](https://github.com/olebedev/go-duktape) | 780 | Duktape JavaScript engine bindings for Go. |
| <b>[golua](https://github.com/aarzilli/golua) | 591 | Go bindings for Lua C API. |
| <b>[gval](https://github.com/PaesslerAG/gval) | 524 | A highly customizable expression language written in Go. |
| <b>[gisp](https://github.com/jcla1/gisp) | 489 | Simple LISP in Go. |
| <b>[prolog](https://github.com/ichiban/prolog) | 413 | Embeddable Prolog. |
...
| <b>[errorx](https://github.com/joomcode/errorx) | 886 | A feature rich error package with stack traces, composition of errors and more. |
| <b>[tracerr](https://github.com/ztrue/tracerr) | 736 | Golang errors with stack trace and source fragments. |
| <b>[errlog](https://github.com/snwfdhmp/errlog) | 408 | Hackable package that determines responsible source code for an error (and some other fast-debugging features). Pluggable to any logger in-place. |
| <b>[emperror](https://github.com/emperror/emperror) | 259 | Error handling tools and best practices for Go libraries and applications. |
| <b>[errors](https://github.com/emperror/errors) | 156 | Drop-in replacement for the standard library errors package and github.com/pkg/errors. Provides various error handling primitives. |
...
| <b>[notify](https://github.com/rjeczalik/notify) | 756 | File system event notification library with simple API, similar to os/signal. |
...
| <b>[afs](https://github.com/viant/afs) | 200 | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
| <b>[vfs](https://github.com/C2FO/vfs) | 190 | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
| <b>[go-exiftool](https://github.com/barasher/go-exiftool) | 133 | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
| <b>[go-csv-tag](https://github.com/artonge/go-csv-tag) | 97 | Load csv file using tag. |
| <b>[gofs](https://github.com/no-src/gofs) | 86 | A file synchronization tool out of the box. |
| <b>[skywalker](https://github.com/dixonwille/skywalker) | 83 | Package to allow one to concurrently go through a filesystem with ease. |
...
| <b>[accounting](https://github.com/leekchan/accounting) | 763 | money and currency formatting for golang. |
| <b>[bbgo](https://github.com/c9s/bbgo) | 670 | A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies. |
| <b>[techan](https://github.com/sdcoffey/techan) | 662 | Technical analysis library with advanced market analysis and trading strategies. |
...
| <b>[ach](https://github.com/moov-io/ach) | 327 | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
| <b>[orderbook](https://github.com/i25959341/orderbook) | 290 | Matching Engine for Limit Order Book in Golang. |
...
| <b>[ofxgo](https://github.com/aclindsa/ofxgo) | 106 | Query OFX servers and/or parse the responses (with example command-line client). |
| <b>[sleet](https://github.com/BoltApp/sleet) | 98 | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| <b>[fpmoney](https://github.com/nikolaydubina/fpmoney) | 7 | Fast and simple ISO4217 fixed-point decimal money. |
...
| <b>[gorilla/csrf](https://github.com/gorilla/csrf) | 827 | CSRF protection for Go web applications & services. |
| <b>[binding](https://github.com/mholt/binding) | 792 | Binds form and JSON data from net/http Request to struct. |
| <b>[form](https://github.com/go-playground/form) | 552 | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
| <b>[conform](https://github.com/leebenson/conform) | 266 | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
...
| <b>[httpin](https://github.com/ggicci/httpin) | 105 | Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc. |
...
| <b>[mo](https://github.com/samber/mo) | 808 | Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...). |
| <b>[fpGo](https://github.com/TeaEntityLab/fpGo) | 287 | Monad, Functional Programming features for Golang. |
| <b>[gofp](https://github.com/rbrahul/gofp) | 128 | A lodash like powerful utility library for Golang. |
| <b>[fuego](https://github.com/seborama/fuego) | 121 | Functional Experiment in Go. |
| <b>[fp-go](https://github.com/repeale/fp-go) | 107 | Collection of Functional Programming helpers powered by Golang 1.18+ generics. |
| <b>[underscore](https://github.com/rjNemo/underscore) | 66 | Functional programming helpers for Go 1.18 and beyond. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Ebiten](https://github.com/hajimehoshi/ebiten) | 7.0k | dead simple 2D game library in Go. |
...
| <b>[raylib-go](https://github.com/gen2brain/raylib-go) | 860 | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
| <b>[Azul3D](https://github.com/azul3d/engine) | 552 | 3D game engine written in Go. |
| <b>[go-astar](https://github.com/beefsack/go-astar) | 515 | Go implementation of the A\* path finding algorithm. |
| <b>[go3d](https://github.com/ungerik/go3d) | 267 | Performance oriented 2D/3D math package for Go. |
...
| <b>[tile](https://github.com/kelindar/tile) | 66 | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
...
| <b>[GoWrap](https://github.com/hexdigest/gowrap) | 651 | Generate decorators for Go interfaces using simple templates. |
| <b>[go-enum](https://github.com/abice/go-enum) | 366 | Code generation for enums from code comments. |
| <b>[interfaces](https://github.com/rjeczalik/interfaces) | 355 | Command line tool for generating interface definitions. |
| <b>[copygen](https://github.com/switchupcb/copygen) | 176 | Generate type-to-type code without reflection. |
| <b>[goverter](https://github.com/jmattheis/goverter) | 142 | Generate converters by defining an interface. |
...
| <b>[mbtileserver](https://github.com/consbio/mbtileserver) | 378 | A simple Go-based server for map tiles stored in mbtiles format. |
| <b>[osm](https://github.com/paulmach/osm) | 228 | Library for reading, writing and working with OpenStreetMap data and APIs. |
...
| <b>[c2go](https://github.com/goplus/c2go) | 195 | Convert C code to Go code. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[ants](https://github.com/panjf2000/ants) | 9.0k | A high-performance and low-cost goroutine pool in Go. |
...
| <b>[workerpool](https://github.com/gammazero/workerpool) | 901 | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| <b>[grpool](https://github.com/ivpusic/grpool) | 703 | Lightweight Goroutine pool. |
...
| <b>[pond](https://github.com/alitto/pond) | 616 | Minimalistic and High-performance goroutine worker pool written in Go. |
| <b>[gowp](https://github.com/xxjwxc/gowp) | 407 | gowp is concurrency limiting goroutine pool. |
| <b>[go-floc](https://github.com/workanator/go-floc) | 258 | Orchestrate goroutines with ease. |
| <b>[go-flow](https://github.com/kamildrazkiewicz/go-flow) | 196 | Control goroutines execution order. |
...
| <b>[neilotoole/errgroup](https://github.com/neilotoole/errgroup) | 132 | Drop-in alternative to `sync/errgroup`, limited to a pool of N worker goroutines. |
| <b>[async](https://github.com/studiosol/async) | 111 | A safe way to execute functions asynchronously, recovering them in case of panic. |
| <b>[cyclicbarrier](https://github.com/marusama/cyclicbarrier) | 101 | CyclicBarrier for golang. |
| <b>[gollback](https://github.com/vardius/gollback) | 96 | asynchronous simple function utilities, for managing execution of closures and callbacks. |
...
| <b>[gowl](https://github.com/hamed-yousefi/gowl) | 35 | Gowl is a process management and process monitoring tool at once. An infinite worker pool gives you the ability to control the pool and processes and monitor their status. |
...
| <b>[gowd](https://github.com/dtylman/gowd) | 377 | Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform. |
| <b>[zenity](https://github.com/ncruces/zenity) | 323 | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
...
| <b>[emgo](https://github.com/ziutek/emgo) | 987 | Go-like language for programming embedded systems (e.g. STM32 MCU). |
| <b>[sysinfo](https://github.com/zcalusic/sysinfo) | 375 | A pure Go library providing Linux OS / kernel / hardware system information. |
...
| <b>[govips](https://github.com/davidbyttow/govips) | 745 | A lightning fast image processing and resizing library for Go. |
| <b>[image2ascii](https://github.com/qeesung/image2ascii) | 690 | Convert image to ASCII. |
...
| <b>[goimagehash](https://github.com/corona10/goimagehash) | 526 | Go Perceptual image hashing package. |
| <b>[govatar](https://github.com/o1egl/govatar) | 514 | Library and CMD tool for generating funny avatars. |
...
| <b>[gltf](https://github.com/qmuntal/gltf) | 175 | Efficient and robust glTF 2.0 reader, writer and validator. |
| <b>[steganography](https://github.com/auyer/steganography) | 151 | Pure Go Library for LSB steganography. |
| <b>[img](https://github.com/hawx/img) | 140 | Selection of image manipulation tools. |
| <b>[go-cairo](https://github.com/ungerik/go-cairo) | 122 | Go binding for the cairo graphics library. |
| <b>[cameron](https://github.com/aofei/cameron) | 87 | An avatar generator for Go. |
| <b>[go-webp](https://github.com/kolesa-team/go-webp) | 67 | Library for encode and decode webp pictures, using libwebp. |
...
| <b>[eywa](https://github.com/xcodersun/eywa) | 56 | Project Eywa is essentially a connection manager that keeps track of connected devices. |
...
| <b>[JobRunner](https://github.com/bamzi/jobrunner) | 934 | Smart and featureful cron job scheduler with job queuing and live monitoring built in. |
| <b>[go-quartz](https://github.com/reugn/go-quartz) | 931 | Simple, zero-dependency scheduling library for Go. |
| <b>[gron](https://github.com/roylee0704/gron) | 907 | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| <b>[jobs](https://github.com/albrow/jobs) | 490 | Persistent and flexible background jobs library. |
| <b>[scheduler](https://github.com/carlescere/scheduler) | 393 | Cronjobs scheduling made easy. |
| <b>[Dagu](https://github.com/dagu-go/dagu) | 288 | No-code workflow executor. it executes DAGs defined in a simple YAML format. |
...
| <b>[gronx](https://github.com/adhocore/gronx) | 209 | Cron expression parser, task runner and daemon consuming crontab like task list. |
| <b>[clockwerk](https://github.com/onatm/clockwerk) | 123 | Go package to schedule periodic jobs using a simple, fluent syntax. |
| <b>[tasks](https://github.com/madflojo/tasks) | 106 | An easy to use in-process scheduler for recurring tasks in Go. |
| <b>[leprechaun](https://github.com/kilgaloon/leprechaun) | 88 | Job scheduler that supports webhooks, crons and classic scheduling. |
| <b>[goflow](https://github.com/fieldryand/goflow) | 58 | A workflow orchestrator and scheduler for rapid prototyping of ETL/ML/AI pipelines. |
...
| <b>[cronticker](https://github.com/krayzpipes/cronticker) | 4 | A ticker implementation to support cron schedules. |
...
| <b>[OjG](https://github.com/ohler55/ojg) | 503 | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
| <b>[kazaam](https://github.com/Qntfy/kazaam) | 235 | API for arbitrary transformation of JSON documents. |
| <b>[marshmallow](https://github.com/PerimeterX/marshmallow) | 199 | Performant JSON unmarshaling for flexible use cases. |
| <b>[jsondiff](https://github.com/wI2L/jsondiff) | 186 | JSON diff library for Go based on RFC6902 (JSON Patch). |
| <b>[gojq](https://github.com/elgs/gojq) | 182 | JSON query in Golang. |
| <b>[jettison](https://github.com/wI2L/jettison) | 130 | Fast and flexible JSON encoder for Go. |
| <b>[ajson](https://github.com/spyzhov/ajson) | 125 | Abstract JSON for golang with JSONPath support. |
...
| <b>[JayDiff](https://github.com/yazgazan/jaydiff) | 89 | JSON diff utility written in Go. |
...
| <b>[zerolog](https://github.com/rs/zerolog) | 6.8k | Zero-allocation JSON logger. |
...
| <b>[phuslu/log](https://github.com/phuslu/log) | 444 | Structured Logging Made Easy. |
| <b>[onelog](https://github.com/francoispqt/onelog) | 400 | Onelog is a dead simple but very efficient JSON logger. It is the fastest JSON logger out there in all scenarios. Also, it is one of the logger with the lowest allocation. |
| <b>[logxi](https://github.com/mgutz/logxi) | 349 | 12-factor app logger that is fast and makes you happy. |
| <b>[logutils](https://github.com/hashicorp/logutils) | 329 | Utilities for slightly better logging in Go (Golang) extending the standard logger. |
| <b>[log](https://github.com/go-playground/log) | 280 | Simple, configurable and scalable Structured Logging for Go. |
| <b>[go-logger](https://github.com/apsdehal/go-logger) | 277 | Simple logger of Go Programs, with level handlers. |
| <b>[httpretty](https://github.com/henvic/httpretty) | 271 | Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest). |
| <b>[sqldb-logger](https://github.com/simukti/sqldb-logger) | 259 | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
| <b>[rollingwriter](https://github.com/arthurkiller/rollingWriter) | 242 | RollingWriter is an auto-rotate `io.Writer` implementation with multi policies to provide log file rotation. |
| <b>[logur](https://github.com/logur/logur) | 174 | An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus), [go-kit log](https://github.com/go-kit/kit/tree/master/log), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog), etc). |
| <b>[glg](https://github.com/kpango/glg) | 169 | glg is simple and fast leveled logging library for Go. |
...
| <b>[slog](https://github.com/gookit/slog) | 117 | Lightweight, configurable, extensible logger for Go. |
| <b>[log-voyage](https://github.com/firstrow/logvoyage) | 91 | Full-featured logging saas written in golang. |
| <b>[go-cronowriter](https://github.com/utahta/go-cronowriter) | 49 | Simple writer that rotate log files automatically based on current date and time, like cronolog. |
...
| <b>[eaopt](https://github.com/MaxHalford/eaopt) | 809 | An evolutionary optimization library. |
| <b>[bayesian](https://github.com/jbrukh/bayesian) | 740 | Naive Bayesian Classification for Golang. |
...
| <b>[onnx-go](https://github.com/owulveryck/onnx-go) | 417 | Go Interface to Open Neural Network Exchange (ONNX). |
...
| <b>[goRecommend](https://github.com/timkaye11/goRecommend) | 190 | Recommendation Algorithms library written in Go. |
| <b>[goga](https://github.com/tomcraven/goga) | 165 | Genetic algorithm library for Go. |
...
| <b>[GoMind](https://github.com/surenderthakran/gomind) | 33 | A simplistic Neural Network Library in Go. |
...
| <b>[Asynq](https://github.com/hibiken/asynq) | 4.0k | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| <b>[Gollum](https://github.com/trivago/gollum) | 922 | A n:m multiplexer that gathers messages from different sources and broadcasts them to a set of destinations. |
| <b>[Chanify](https://github.com/chanify/chanify) | 909 | A push notification server send message to your iOS devices. |
| <b>[dbus](https://github.com/godbus/dbus) | 752 | Native Go bindings for D-Bus. |
| <b>[golongpoll](https://github.com/jcuga/golongpoll) | 605 | HTTP longpoll server library that makes web pub-sub simple. |
| <b>[mangos](https://github.com/nanomsg/mangos) | 539 | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
| <b>[amqp](https://github.com/rabbitmq/amqp091-go) | 481 | Go RabbitMQ Client Library. |
| <b>[emitter](https://github.com/olebedev/emitter) | 432 | Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins. |
...
| <b>[Bus](https://github.com/mustafaturan/bus) | 274 | Minimalist message bus implementation for internal communication. |
| <b>[Quamina](https://github.com/timbray/quamina) | 239 | Fast pattern-matching for filtering messages and events. |
| <b>[messagebus](https://github.com/vardius/message-bus) | 226 | messagebus is a Go simple async message bus, perfect for using as event bus when doing event sourcing, CQRS, DDD. |
| <b>[rabtap](https://github.com/jandelgado/rabtap) | 217 | RabbitMQ swiss army knife cli app. |
...
| <b>[hub](https://github.com/leandro-lugaresi/hub) | 119 | A Message/Event Hub for Go applications, using publish/subscribe pattern with support for alias like rabbitMQ exchanges. |
...
| <b>[redisqueue](https://github.com/robinjoseph08/redisqueue) | 85 | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
...
| <b>[go-excel](https://github.com/szyhf/go-excel) | 156 | A simple and light reader to read a relate-db-like excel as a table. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[google/wire](https://github.com/google/wire) | 9.0k | Automated Initialization in Go. |
...
| <b>[do](https://github.com/samber/do) | 514 | A dependency injection framework based on Generics. |
| <b>[GoLobby/Container](https://github.com/golobby/container) | 376 | GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language. |
| <b>[goioc/di](https://github.com/goioc/di) | 201 | Spring-inspired Dependency Injection Container. |
| <b>[di](https://github.com/goava/di) | 158 | A dependency injection container for go programming language. |
| <b>[dingo](https://github.com/i-love-flamingo/dingo) | 137 | A dependency injection toolkit for Go, based on Guice. |
...
| <b>[gocontainer](https://github.com/vardius/gocontainer) | 16 | Simple Dependency Injection Container. |
...
| <b>[cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 542 | A Go application boilerplate template for quick starting projects following production best practices. |
| <b>[pagoda](https://github.com/mikestefanello/pagoda) | 408 | Rapid, easy full-stack web development starter kit built in Go. |
| <b>[golang-templates/seed](https://github.com/golang-templates/seed) | 283 | Go application GitHub repository template. |
| <b>[go-starter](https://github.com/allaboutapps/go-starter) | 179 | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| <b>[go-todo-backend](https://github.com/Fs02/go-todo-backend) | 166 | Go Todo Backend example using modular project layout for product microservice. |
...
| <b>[go-sample](https://github.com/zitryss/go-sample) | 106 | A sample layout for Go application projects with the real code. |
...
| <b>[sttr](https://github.com/abhimanyu003/sttr) | 414 | cross-platform, cli app to perform various operations on string. |
| <b>[strutil](https://github.com/ozgio/strutil) | 182 | String utilities. |
| <b>[gobeam/Stringy](https://github.com/gobeam/Stringy) | 141 | String manipulation library to convert string to camel case, snake case, kebab case / slugify etc. |
| <b>[bexp](https://github.com/mkungla/bexp) | 9 | Go implementation of Brace Expansion mechanism to generate arbitrary strings. |
...
| <b>[llvm](https://github.com/llir/llvm) | 943 | Library for interacting with LLVM IR in pure Go. |
| <b>[shortid](https://github.com/teris-io/shortid) | 794 | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| <b>[health](https://github.com/alexliesenfeld/health) | 524 | A simple and flexible health check library for Go. |
| <b>[stateless](https://github.com/qmuntal/stateless) | 475 | A fluent library for creating state machines. |
| <b>[health](https://github.com/dimiro1/health) | 434 | Easy to use, extensible health check library. |
| <b>[shoutrrr](https://github.com/containrrr/shoutrrr) | 425 | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
| <b>[banner](https://github.com/dimiro1/banner) | 405 | Add beautiful banners into your Go applications. |
...
| <b>[gountries](https://github.com/pariz/gountries) | 355 | Package that exposes country and subdivision data. |
...
| <b>[healthcheck](https://github.com/etherlabsio/healthcheck) | 226 | An opinionated and concurrent health-check HTTP handler for RESTful services. |
| <b>[battery](https://github.com/distatus/battery) | 208 | Cross-platform, normalized battery information library. |
| <b>[go-unarr](https://github.com/gen2brain/go-unarr) | 198 | Decompression library for RAR, TAR, ZIP and 7z archives. |
...
| <b>[captcha](https://github.com/steambap/captcha) | 115 | Package captcha provides an easy to use, unopinionated API for captcha generation. |
...
| <b>[gtree](https://github.com/ddddddO/gtree) | 66 | Provide CLI and Package for tree output and directories creation from Markdown or programmatically. |
...
| <b>[kagome](https://github.com/ikawaha/kagome) | 665 | JP morphological analyzer written in pure Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[slug](https://github.com/gosimple/slug) | 851 | URL-friendly slugify with multiple languages support. |
...
| <b>[gotext](https://github.com/leonelquinteros/gotext) | 350 | GNU gettext utilities for Go. |
| <b>[go-localize](https://github.com/m1/go-localize) | 42 | Simple and easy to use i18n (Internationalization and localization) engine - used for translating locale strings. |
...
| <b>[webrtc](https://github.com/pions/webrtc) | 9.8k | A pure Go implementation of the WebRTC API. |
| <b>[quic-go](https://github.com/lucas-clemente/quic-go) | 7.2k | An implementation of the QUIC protocol in pure Go. |
...
| <b>[netpoll](https://github.com/cloudwego/netpoll) | 3.0k | A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance. |
...
| <b>[ftp](https://github.com/jlaffaye/ftp) | 978 | Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959). |
| <b>[mdns](https://github.com/hashicorp/mdns) | 898 | Simple mDNS (Multicast DNS) client/server library in Golang. |
| <b>[gosnmp](https://github.com/soniah/gosnmp) | 887 | Native Go library for performing SNMP actions. |
| <b>[vssh](https://github.com/yahoo/vssh) | 860 | Go library for building network and server automation over SSH protocol. |
| <b>[nbio](https://github.com/lesismal/nbio) | 763 | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
| <b>[cidranger](https://github.com/yl2chen/cidranger) | 739 | Fast IP to CIDR lookup for Go. |
| <b>[gmqtt](https://github.com/DrmagicE/gmqtt) | 726 | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| <b>[lhttp](https://github.com/fanux/lhttp) | 674 | Powerful websocket framework, build your IM server more easily. |
| <b>[peerdiscovery](https://github.com/schollz/peerdiscovery) | 556 | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| <b>[go-stun](https://github.com/ccding/go-stun) | 517 | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
| <b>[gotcp](https://github.com/gansidui/gotcp) | 496 | Go package for quickly writing tcp applications. |
| <b>[stun](https://github.com/go-rtc/stun) | 486 | Go implementation of RFC 5389 STUN protocol. |
| <b>[easytcp](https://github.com/DarthPestilane/easytcp) | 457 | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
| <b>[gaio](https://github.com/xtaci/gaio) | 454 | High performance async-io networking for Golang in proactor mode. |
| <b>[gopcap](https://github.com/akrennmair/gopcap) | 450 | Go wrapper for libpcap. |
...
| <b>[tcp_server](https://github.com/firstrow/tcp_server) | 418 | Go library for building tcp servers faster. |
| <b>[winrm](https://github.com/masterzen/winrm) | 376 | Go WinRM client to remotely execute commands on Windows machines. |
...
| <b>[ethernet](https://github.com/mdlayher/ethernet) | 243 | Package ethernet implements marshaling and unmarshaling of IEEE 802.3 Ethernet II frames and IEEE 802.1Q VLAN tags. |
...
| <b>[iplib](https://github.com/c-robinson/iplib) | 91 | Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html) |
...
| <b>[gldap](https://github.com/jimlambrt/gldap) | 73 | gldap provides an ldap server implementation and you provide handlers for its ldap operations. |
...
| <b>[fullproxy](https://github.com/shoriwe/fullproxy) | 32 | A fully featured scriptable and daemon configurable proxy and pivoting toolkit with SOCKS5, HTTP, raw ports and reverse proxy protocols. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[resty](https://github.com/go-resty/resty) | 6.6k | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| <b>[req](https://github.com/imroc/req) | 2.6k | Simple Go HTTP client with Black Magic (Less code and More efficiency). |
...
| <b>[gentleman](https://github.com/h2non/gentleman) | 964 | Full-featured plugin-driven HTTP client library. |
| <b>[pester](https://github.com/sethgrid/pester) | 597 | Go HTTP client calls with retries, backoff, and concurrency. |
| <b>[requests](https://github.com/carlmjohnson/requests) | 405 | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| <b>[go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) | 257 | Get easily stdlib HTTP client, which does not share any state with other clients. |
| <b>[request](https://github.com/monaco-io/request) | 211 | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
| <b>[go-otelroundtripper](https://github.com/NdoleStudio/go-otelroundtripper) | 61 | Go http.RoundTripper that emits open telemetry metrics for HTTP requests. |
...
| <b>[go-zoox/fetch](https://github.com/go-zoox/fetch) | 3 | A Powerful, Lightweight, Easy Http Client, inspired by Web Fetch API. |
...
| <b>[gl](https://github.com/go-gl/gl) | 921 | Go bindings for OpenGL (generated via glow). |
| <b>[mathgl](https://github.com/go-gl/mathgl) | 456 | Pure Go math package specialized for 3D math, with inspiration from GLM. |
...
| <b>[go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 826 | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| <b>[go-queryset](https://github.com/jirfag/go-queryset) | 673 | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
| <b>[rel](https://github.com/go-rel/rel) | 558 | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
| <b>[Zoom](https://github.com/albrow/zoom) | 292 | Blazing-fast datastore and querying engine built on Redis. |
| <b>[go-sql](https://github.com/rushteam/gosql) | 165 | A easy ORM for mysql. |
...
| <b>[golobby/orm](https://github.com/golobby/orm) | 108 | Simple, fast, type-safe, generic orm for developer happiness. |
...
| <b>[modgv](https://github.com/lucasepe/modgv) | 412 | Converts 'go mod graph' output into Graphviz's DOT language. |
...
| <b>[dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 875 | Dataframes for machine-learning and statistics (similar to pandas). |
| <b>[go-dsp](https://github.com/mjibson/go-dsp) | 787 | Digital Signal Processing for Go. |
...
| <b>[graph](https://github.com/yourbasic/graph) | 577 | Library of basic graph algorithms. |
| <b>[orb](https://github.com/paulmach/orb) | 569 | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| <b>[ewma](https://github.com/VividCortex/ewma) | 390 | Exponentially-weighted moving averages. |
| <b>[calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 355 | Calendar heatmap in plain Go inspired by Github contribution activity. |
...
| <b>[sparse](https://github.com/james-bowman/sparse) | 133 | Go Sparse matrix formats for linear algebra supporting scientific and machine learning applications, compatible with gonum matrix libraries. |
| <b>[go-estimate](https://github.com/milosgajdos/go-estimate) | 98 | State estimation and filtering algorithms in Go. |
...
| <b>[Coraza](https://github.com/corazawaf/coraza) | 648 | Enterprise-ready, modsecurity and OWASP CRS compatible WAF library. |
...
| <b>[go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 350 | Password validator based on raw cryptographic entropy values. |
| <b>[firewalld-rest](https://github.com/prashantgupta24/firewalld-rest) | 319 | A rest application to dynamically update firewalld rules on a linux server. |
| <b>[optimus-go](https://github.com/pjebs/optimus-go) | 319 | ID hashing and Obfuscation using Knuth's Algorithm. |
| <b>[BadActor](https://github.com/jaredfolkins/badactor) | 310 | In-memory, application-driven jailer built in the spirit of fail2ban. |
| <b>[dongle](https://github.com/golang-module/dongle) | 280 | A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption. |
| <b>[go-yara](https://github.com/hillu/go-yara) | 272 | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
...
| <b>[secret](https://github.com/rsjethani/secret) | 13 | Prevent your secrets from leaking into logs, std* etc. |
...
| <b>[csvutil](https://github.com/jszwec/csvutil) | 745 | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| <b>[colfer](https://github.com/pascaldekloe/colfer) | 674 | Code generation for the Colfer binary format. |
| <b>[cbor](https://github.com/fxamacker/cbor) | 478 | Small, safe, and easy CBOR encoding and decoding library. |
...
| <b>[Easegress](https://github.com/megaease/easegress) | 4.7k | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
...
| <b>[go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 498 | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| <b>[Euterpe](https://github.com/ironsmile/euterpe) | 423 | Self-hosted music streaming server with built-in web UI and REST API. |
| <b>[dummy](https://github.com/neotoolkit/dummy) | 159 | Run mock server based off an API contract with one command. |
...
| <b>[go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) | 63 | Simple Reverse Proxy with Caching, written in Go, using Redis. |
...
| <b>[machine](https://github.com/whitaker-io/machine) | 114 | Go library for writing and generating stream workers with built in metrics and traceability. |
| <b>[stream](https://github.com/youthlin/stream) | 65 | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
| <b>[goio](https://github.com/primetalk/goio) | 42 | An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2. |
...
| <b>[jet](https://github.com/CloudyKit/jet) | 949 | Jet template engine. |
| <b>[Razor](https://github.com/sipin/gorazor) | 798 | Razor view engine for Golang. |
| <b>[maroto](https://github.com/johnfercher/maroto) | 741 | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
...
| <b>[ego](https://github.com/benbjohnson/ego) | 531 | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
| <b>[raymond](https://github.com/aymerick/raymond) | 489 | Complete handlebars implementation in Go. |
| <b>[goview](https://github.com/foolin/goview) | 295 | Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application. |
...
| <b>[go-vcr](https://github.com/dnaeon/go-vcr) | 938 | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
| <b>[gnomock](https://github.com/orlangure/gnomock) | 926 | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| <b>[goblin](https://github.com/franela/goblin) | 862 | Mocha like testing framework fo Go. |
| <b>[testfixtures](https://github.com/go-testfixtures/testfixtures) | 839 | A helper for Rails' like test fixtures to test database applications. |
| <b>[baloo](https://github.com/h2non/baloo) | 733 | Expressive and versatile end-to-end HTTP API testing made easy. |
| <b>[goc](https://github.com/qiniu/goc) | 558 | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| <b>[go-mutesting](https://github.com/zimmski/go-mutesting) | 547 | Mutation testing for Go source code. |
| <b>[gofight](https://github.com/appleboy/gofight) | 424 | API Handler Testing for Golang Router framework. |
| <b>[embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 422 | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| <b>[testza](https://github.com/MarvinJWendt/testza) | 393 | Full-featured test framework with nice colorized output. |
| <b>[gotest.tools](https://github.com/gotestyourself/gotest.tools) | 346 | A collection of packages to augment the go testing package and support common patterns. |
| <b>[go-testdeep](https://github.com/maxatome/go-testdeep) | 315 | Extremely flexible golang deep comparison, extends the go testing package. |
| <b>[frisby](https://github.com/verdverm/frisby) | 271 | REST API testing framework. |
| <b>[got](https://github.com/ysmood/got) | 234 | An enjoyable golang test framework. |
| <b>[go-carpet](https://github.com/msoap/go-carpet) | 227 | Tool for viewing test coverage in terminal. |
| <b>[cupaloy](https://github.com/bradleyjkemp/cupaloy) | 222 | Simple snapshot testing addon for your test framework. |
| <b>[endly](https://github.com/viant/endly) | 217 | Declarative end to end functional testing. |
...
| <b>[go-hit](https://github.com/Eun/go-hit) | 124 | Hit is an http integration test framework written in golang. |
...
| <b>[jsonassert](https://github.com/kinbiko/jsonassert) | 89 | Package for verifying that your JSON payloads are serialized correctly. |
...
| <b>[be](https://github.com/carlmjohnson/be) | 18 | The minimalist generic test assertion library. |
...
| <b>[counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 715 | Tool for generating self-contained mock objects. |
| <b>[go-txdb](https://github.com/DATA-DOG/go-txdb) | 473 | Single transaction based database driver mainly for testing purposes. |
| <b>[minimock](https://github.com/gojuno/minimock) | 461 | Mock generator for Go interfaces. |
| <b>[govcr](https://github.com/seborama/govcr) | 125 | HTTP mock for Golang: record and replay HTTP interactions for offline testing. |
...
| <b>[playwright-go](https://github.com/mxschmitt/playwright-go) | 911 | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| <b>[cdp](https://github.com/mafredri/cdp) | 632 | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[failpoint](https://github.com/pingcap/failpoint) | 734 | An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| <b>[bytes](https://github.com/labstack/gommon/tree/master/bytes) | 462 | Formats and parses numeric byte values (10K, 2M, 3G, etc.). |
...
| <b>[htmlquery](https://github.com/antchfx/htmlquery) | 510 | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| <b>[html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 383 | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| <b>[bafi](https://github.com/mmalcek/bafi) | 61 | Universal JSON, BSON, YAML, XML translator to ANY format using templates. |
...
| <b>[commonregex](https://github.com/mingrammer/commonregex) | 826 | A collection of common regular expressions for Go. |
| <b>[gographviz](https://github.com/awalterschulze/gographviz) | 492 | Parses the Graphviz DOT language. |
| <b>[omniparser](https://github.com/jf-tech/omniparser) | 491 | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
...
| <b>[tokenizer](https://github.com/bzick/tokenizer) | 18 | — Parse any string, slice or infinite buffer to any tokens. |
...
| <b>[rex](https://github.com/hedhyw/rex) | 114 | Regular expressions builder. |
...
| <b>[xurls](https://github.com/mvdan/xurls) | 947 | Extract urls from text. |
| <b>[dataflowkit](https://github.com/slotix/dataflowkit) | 538 | Web scraping Framework to turn websites into structured data. |
| <b>[gospider](https://github.com/zhshch2002/gospider) | 171 | A simple golang spider/scraping framework,build a spider in 3 lines. migrated from [goribot](https://github.com/zhshch2002/goribot) |
| <b>[pagser](https://github.com/foolin/pagser) | 71 | Pagser is a simple, extensible, configurable parse and deserialize html page to struct based on goquery and struct tags for golang crawler. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-runewidth](https://github.com/mattn/go-runewidth) | 478 | Functions to get fixed width of the character or string. |
...
| <b>[githubql](https://github.com/shurcooL/githubql) | 909 | Go library for accessing the GitHub GraphQL API v4. |
| <b>[webhooks](https://github.com/go-playground/webhooks) | 772 | Webhook receiver for GitHub and Bitbucket. |
| <b>[paypal](https://github.com/logpacker/PayPal-Go-SDK) | 517 | Wrapper for PayPal payment API. |
...
| <b>[twitter-scraper](https://github.com/n0madic/twitter-scraper) | 247 | Scrape the Twitter Frontend API without authentication and limits. |
| <b>[ethrpc](https://github.com/onrik/ethrpc) | 240 | Go bindings for Ethereum JSON RPC API. |
| <b>[lark](https://github.com/chyroc/lark) | 222 | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| <b>[wit-go](https://github.com/wit-ai/wit-go) | 127 | Go client for wit.ai HTTP API. |
...
| <b>[go-lark](https://github.com/go-lark/lark) | 109 | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
...
| <b>[simples3](https://github.com/rhnvrm/simples3) | 90 | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
| <b>[gosip](https://github.com/koltyakov/gosip) | 80 | Go client library SharePoint API. |
...
| <b>[go-postman-collection](https://github.com/rbretecher/go-postman-collection) | 50 | Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia). |
...
| <b>[lo](https://github.com/samber/lo) | 7.5k | A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...) |
...
| <b>[git-time-metric](https://github.com/git-time-metric/gtm) | 902 | Simple, seamless, lightweight time tracking for Git. |
| <b>[hostctl](https://github.com/guumaster/hostctl) | 801 | A CLI tool to manage /etc/hosts with easy commands. |
| <b>[mimetype](https://github.com/gabriel-vasile/mimetype) | 801 | Package for MIME type detection based on magic numbers. |
| <b>[immortal](https://github.com/immortal/immortal) | 748 | \*nix cross-platform (OS agnostic) supervisor. |
| <b>[circuit](https://github.com/cep21/circuit) | 659 | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
| <b>[scany](https://github.com/georgysavva/scany) | 642 | Library for scanning data from a database into Go structs and more. |
| <b>[htcat](https://github.com/htcat/htcat) | 549 | Parallel and Pipelined HTTP GET Utility. |
| <b>[ergo](https://github.com/cristianoliveira/ergo) | 532 | The management of multiple local services running over different ports made easy. |
| <b>[delve](https://github.com/derekparker/delve) | 518 | Go debugger. |
...
| <b>[gubrak](https://github.com/novalagung/gubrak) | 412 | Golang utility library with syntactic sugar. It's like lodash, but for golang. |
| <b>[clockwork](https://github.com/jonboulle/clockwork) | 409 | A simple fake clock for golang. |
| <b>[Deepcopier](https://github.com/ulule/deepcopier) | 391 | Simple struct copying for Go. |
| <b>[changie](https://github.com/miniscruff/changie) | 376 | Automated changelog tool for preparing releases with lots of customization options. |
| <b>[go-rate](https://github.com/beefsack/go-rate) | 367 | Timed rate limiter for Go. |
| <b>[retry](https://github.com/kamilsk/retry) | 323 | The most advanced functional mechanism to perform actions repetitively until successful. |
| <b>[mani](https://github.com/alajmo/mani) | 308 | CLI tool to help you manage multiple repositories. |
| <b>[scan](https://github.com/blockloop/scan) | 301 | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
...
| <b>[clipboard](https://github.com/golang-design/clipboard) | 254 | 📋 cross-platform clipboard package in Go. |
...
| <b>[grofer](https://github.com/pesos/grofer) | 217 | A system and resource monitoring tool written in Golang! |
...
| <b>[rospo](https://github.com/ferama/rospo) | 180 | Simple and reliable ssh tunnels with embedded ssh server in Golang. |
| <b>[countries](https://github.com/biter777/countries) | 175 | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
...
| <b>[cryptgo](https://github.com/Gituser143/cryptgo) | 117 | Crytpgo is a TUI based application written purely in Go to monitor and observe cryptocurrency prices in real time! |
...
| <b>[cmd](https://github.com/SimonBaeumer/cmd) | 102 | Library for executing shell commands on osx, windows and linux. |
| <b>[limiters](https://github.com/mennanov/limiters) | 101 | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
...
| <b>[goval](https://github.com/maja42/goval) | 84 | Evaluate arbitrary expressions in Go. |
...
| <b>[go-lock](https://github.com/viney-shih/go-lock) | 76 | go-lock is a lock library implementing read-write mutex and read-write trylock without starvation. |
...
| <b>[cvt](https://github.com/shockerli/cvt) | 18 | Easy and safe convert any value to another type. |
...
| <b>[wuid](https://github.com/edwingeng/wuid) | 469 | An extremely fast unique number generator, 10-135 times faster than UUID. |
...
| <b>[validate](https://github.com/gookit/validate) | 775 | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| <b>[validate](https://github.com/gobuffalo/validate) | 73 | This package provides a framework for writing validations for Go applications. |
...
| <b>[gmf](https://github.com/3d0c/gmf) | 783 | Go bindings for FFmpeg av\* libraries. |
| <b>[go-astits](https://github.com/asticode/go-astits) | 432 | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
...
| <b>[libvlc-go](https://github.com/adrg/libvlc-go) | 312 | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
| <b>[gortsplib](https://github.com/aler9/gortsplib) | 287 | Pure Go RTSP server and client library. |
...
| <b>[Gearbox](https://github.com/abahmed/gearbox) | 666 | A web framework written in Go with a focus on high performance and memory optimization. |
| <b>[Aero](https://github.com/aerogo/aero) | 490 | High-performance web framework for Go, reaches top scores in Lighthouse. |
...
| <b>[Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 350 | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| <b>[Flamingo](https://github.com/i-love-flamingo/flamingo) | 310 | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| <b>[Gondola](https://github.com/rainycape/gondola) | 309 | The web framework for writing faster sites, faster. |
| <b>[rk-boot](https://github.com/rookie-ninja/rk-boot) | 275 | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
...
| <b>[WebGo](https://github.com/bnkamalesh/webgo) | 257 | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
| <b>[Ginrpc](https://github.com/xxjwxc/ginrpc) | 233 | Gin parameter automatic binding tool,gin rpc tools. |
...
| <b>[Huma](https://github.com/danielgtaylor/huma/) | 128 | Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI. |
...
| <b>[XFF](https://github.com/sebest/xff) | 91 | Handle `X-Forwarded-For` header and friends. |
| <b>[rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 45 | Middleware for gRPC with logging, metrics, auth, tracing etc. |
...
| <b>[fasthttprouter](https://github.com/buaazp/fasthttprouter) | 868 | High performance router forked from `httprouter`. The first router fit for `fasthttp`. |
...
| <b>[xujiajun/gorouter](https://github.com/xujiajun/gorouter) | 526 | A simple and fast HTTP router for Go. |
| <b>[ozzo-routing](https://github.com/go-ozzo/ozzo-routing) | 442 | An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs. |
...
| <b>[goblin](https://github.com/bmf-san/goblin) | 36 | A golang http router based on trie tree. |
...
| <b>[dom](https://github.com/dennwc/dom) | 459 | DOM library. |
| <b>[go-canvas](https://github.com/markfarnan/go-canvas) | 172 | Library to use HTML5 Canvas, with all drawing within go code. |
| <b>[wasmbrowsertest](https://github.com/agnivade/wasmbrowsertest) | 129 | Run Go WASM tests in your browser. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-ole](https://github.com/go-ole/go-ole) | 896 | Win32 OLE implementation for golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[zek](https://github.com/miku/zek) | 588 | Generate a Go struct from XML. |
| <b>[xpath](https://github.com/antchfx/xpath) | 505 | XPath package for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Cosign](https://github.com/sigstore/cosign) | 2.4k | Container Signing, Verification and Storage in an OCI registry. |
...
| <b>[php-parser](https://github.com/z7zmey/php-parser) | 885 | A Parser for PHP written in Go. |
| <b>[goast-viewer](https://github.com/yuroyoro/goast-viewer) | 645 | Web based Golang AST visualizer. |
| <b>[go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 616 | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
| <b>[go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 596 | An easy way to find outdated dependencies of your Go projects. |
| <b>[golines](https://github.com/segmentio/golines) | 449 | Formatter that automatically shortens long lines in Go code. |
| <b>[todocheck](https://github.com/preslavmihaylov/todocheck) | 388 | Static code analyser which links TODO comments in code with issues in your issue tracker. |
| <b>[unconvert](https://github.com/mdempsky/unconvert) | 326 | Remove unnecessary type conversions from Go source. |
| <b>[dupl](https://github.com/mibk/dupl) | 287 | Tool for code clone detection. |
...
| <b>[usestdlibvars](https://github.com/sashamelentyev/usestdlibvars) | 18 | A linter that detect the possibility to use variables/constants from the Go standard library. |
...
| <b>[coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) | 481 | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| <b>[Watch](https://github.com/eaburns/Watch) | 192 | Runs a command in an acme win on file changes. |
| <b>[goimports-reviser](https://github.com/incu6us/goimports-reviser) | 175 | Formatting tool for imports. |
...
| <b>[xgen](https://github.com/xuri/xgen) | 179 | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| <b>[depth](https://github.com/KyleBanks/depth) | 782 | Visualize dependency trees of any package by analyzing imports. |
| <b>[richgo](https://github.com/kyoh86/richgo) | 721 | Enrich `go test` outputs with text decorations. |
...
| <b>[roumon](https://github.com/becheran/roumon) | 114 | Monitor current state of all active goroutines via a command line interface. |
...
| <b>[gotestdox](https://github.com/bitfield/gotestdox) | 15 | Show Go test results as readable sentences. |
| <b>[docs](https://github.com/go-oas/docs) | 12 | Automatically generate RESTful API documentation for GO projects - aligned with Open API Specification standard. |
...
| <b>[Fleet device management](https://github.com/fleetdm/fleet) | 898 | Lightweight, programmable telemetry for servers and workstations. |
| <b>[skm](https://github.com/TimothyYe/skm) | 804 | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| <b>[Scaleway-cli](https://github.com/scaleway/scaleway-cli) | 764 | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| <b>[uTask](https://github.com/ovh/utask) | 718 | Automation engine that models and executes business processes declared in yaml. |
| <b>[kwatch](https://github.com/abahmed/kwatch) | 671 | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
| <b>[cassowary](https://github.com/rogerwelin/cassowary) | 609 | Modern cross-platform HTTP load-testing tool written in Go. |
| <b>[kool](https://github.com/kool-dev/kool) | 606 | Command line tool for managing Docker environments as an easy way. |
...
| <b>[Pewpew](https://github.com/bengadbois/pewpew) | 348 | Flexible HTTP command line stress tester. |
| <b>[jcli](https://github.com/jenkins-zh/jenkins-cli) | 335 | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| <b>[trubka](https://github.com/xitonix/trubka) | 323 | A CLI tool to manage and troubleshoot Apache Kafka clusters with the ability of generically publishing/consuming protocol buffer and plain text events to/from Kafka. |
...
| <b>[easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 253 | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
| <b>[dogo](https://github.com/liudng/dogo) | 248 | Monitoring changes in the source file and automatically compile and run (restart). |
| <b>[godbg](https://github.com/sirnewton01/godbg) | 224 | Web-based gdb front-end application. |
| <b>[terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 215 | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
| <b>[Blast](https://github.com/dave/blast) | 208 | A simple tool for API load testing and batch jobs. |
...
| <b>[kcli](https://github.com/cswank/kcli) | 182 | Command line tool for inspecting kafka topics/partitions/messages. |
...
| <b>[Dockerfile-Generator](https://github.com/ozankasikci/dockerfile-generator) | 133 | A go library and an executable that produces valid Dockerfiles using various input channels. |
| <b>[s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 123 | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| <b>[Mantil](https://github.com/mantil-io/mantil) | 77 | Go specific framework for building serverless applications on AWS that enables you to focus on pure Go code while Mantil takes care of the infrastructure. |
...
| <b>[shell2http](https://github.com/msoap/shell2http) | 970 | Executing shell commands via http server (for prototyping or remote control). |
| <b>[vFlow](https://github.com/VerizonDigital/vflow) | 915 | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| <b>[peg](https://github.com/pointlander/peg) | 865 | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
...
| <b>[Guora](https://github.com/meloalright/guora) | 603 | A self-hosted Quora like web application written in Go. |
| <b>[Gebug](https://github.com/moshebe/gebug) | 597 | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| <b>[sake](https://github.com/alajmo/sake) | 460 | sake is a command runner for local and remote hosts. |
| <b>[go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 453 | Video streaming torrent client. |
| <b>[Gokapi](https://github.com/Forceu/gokapi) | 385 | Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload. |
...
| <b>[woke](https://github.com/get-woke/woke) | 342 | Detect non-inclusive language in your source code. |
...
| <b>[tcpdog](https://github.com/mehrdadrad/tcpdog) | 199 | eBPF based TCP observability. |
...
| <b>[stew](https://github.com/marwanhawari/stew) | 101 | An independent package manager for compiled binaries. |
...
| <b>[crawley](https://github.com/s0rg/crawley) | 66 | Web scraper/crawler for cli. |
...
| <b>[speedtest-resize](https://github.com/fawick/speedtest-resize) | 219 | Compare various Image resize algorithms for the Go language. |
...
| <b>[gopherize.me](https://github.com/matryer/gopherize.me) | 593 | Gopherize yourself. |
...
| <b>[gophers](https://github.com/sillecelik/go-gopher) | 104 | Gopher amigurumi toy pattern. |
...
| <b>[go-clean-template](https://github.com/evrone/go-clean-template) | 3.5k | Clean Architecture template for Golang services. |
...
| <b>[goapp](https://github.com/bnkamalesh/goapp) | 510 | An opinionated guideline to structure & develop a Go web application/service. |
