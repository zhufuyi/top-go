...
| <b>[PortAudio](https://github.com/gordonklaus/portaudio) | 514 | Go bindings for the PortAudio audio I/O library. |
| <b>[music-theory](https://github.com/go-music-theory/music-theory) | 399 | Music theory models in Go. |
| <b>[id3v2](https://github.com/bogem/id3v2) | 249 | ID3 decoding and encoding library for Go. |
| <b>[GoAudio](https://github.com/DylanMeeus/GoAudio) | 233 | Native Go Audio Processing Library. |
| <b>[flac](https://github.com/mewkiz/flac) | 214 | Native Go FLAC encoder/decoder with support for FLAC streams. |
| <b>[malgo](https://github.com/gen2brain/malgo) | 180 | Mini audio library. |
| <b>[gaad](https://github.com/Comcast/gaad) | 102 | Native Go AAC bitstream parser. |
...
| <b>[paseto](https://github.com/o1egl/paseto) | 610 | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
| <b>[jwt](https://github.com/cristalhq/jwt) | 552 | Safe, simple and fast JSON Web Tokens for Go. |
| <b>[permissions2](https://github.com/xyproto/permissions2) | 458 | Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. |
| <b>[go-guardian](https://github.com/shaj13/go-guardian) | 382 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
| <b>[jwt](https://github.com/pascaldekloe/jwt) | 285 | Lightweight JSON Web Token (JWT) library. |
| <b>[jeff](https://github.com/abraithwaite/jeff) | 239 | Simple, flexible, secure and idiomatic web session management with pluggable backends. |
...
| <b>[go-email-normalizer](https://github.com/dimuska139/go-email-normalizer) | 47 | Golang library for providing a canonical representation of email address. |
| <b>[branca](https://github.com/essentialkaos/branca) | 40 | branca token [specification implementation](https://github.com/tuupola/branca-spec) for Golang 1.15+. |
| <b>[otpgo](https://github.com/jltorresm/otpgo) | 36 | Time-Based One-Time Password (TOTP) and HMAC-Based One-Time Password (HOTP) library for Go. |
...
| <b>[cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 4.2k | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| <b>[gossamer](https://github.com/ChainSafe/gossamer) | 339 | A Go implementation of the Polkadot Host. |
| <b>[solana-go](https://github.com/gagliardetto/solana-go) | 331 | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) | 3.8k | Simple and clean Telegram bot client. |
...
| <b>[Kelp](https://github.com/stellar/kelp) | 902 | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| <b>[Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) | 804 | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| <b>[go-chat-bot](https://github.com/go-chat-bot/bot) | 747 | IRC, Slack & Telegram bot written in Go. |
| <b>[slacker](https://github.com/shomali11/slacker) | 614 | Easy to use framework to create Slack bots. |
| <b>[tbot](https://github.com/yanzay/tbot) | 324 | Telegram bot server with API similar to net/http. |
| <b>[wayback](https://github.com/wabarc/wayback) | 286 | A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages. |
...
| <b>[go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 242 | Library to write bots for twitch.tv chat |
| <b>[Tenyks](https://github.com/kyleterry/tenyks) | 172 | Service oriented IRC bot using Redis and JSON for messaging. |
| <b>[echotron](https://github.com/NicoNex/echotron) | 148 | An elegant and concurrent library for Telegram Bots in Go. |
...
| <b>[slack-bot](https://github.com/innogames/slack-bot) | 101 | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
| <b>[margelet](https://github.com/zhulik/margelet) | 73 | Framework for building Telegram bots. |
| <b>[larry](https://github.com/ezeoleaf/larry) | 70 | Larry 🐦 is a really simple Twitter bot generator that tweets random repositories from Github built in Go. |
...
| <b>[telego](https://github.com/mymmrac/telego) | 59 | Telegram Bot API library for Golang with full one-to-one API implementation. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Task](https://github.com/go-task/task) | 5.4k | simple "Make" alternative. |
...
| <b>[goyek](https://github.com/goyek/goyek) | 296 | Create build pipelines in Go. |
| <b>[taskctl](https://github.com/taskctl/taskctl) | 195 | Concurrent task runner. |
...
| <b>[anko](https://github.com/GuilhermeCaruso/anko) | 25 | Simple application watcher for multiple programming languages. |
...
| <b>[gocui](https://github.com/jroimartin/gocui) | 8.3k | Minimalist Go library aimed at creating Console User Interfaces. |
...
| <b>[pterm](https://github.com/pterm/pterm) | 2.8k | A library to beautify console output on every platform with many combinable components. |
...
| <b>[uitable](https://github.com/gosuri/uitable) | 651 | Library to improve readability in terminal apps using tabular data. |
| <b>[go-isatty](https://github.com/mattn/go-isatty) | 626 | isatty for golang. |
| <b>[go-colorable](https://github.com/mattn/go-colorable) | 624 | Colorable writer for windows. |
| <b>[gommon/color](https://github.com/labstack/gommon/tree/master/color) | 450 | Style terminal text. |
| <b>[chalk](https://github.com/ttacon/chalk) | 398 | Intuitive package for prettifying terminal/console output. |
| <b>[simpletable](https://github.com/alexeyco/simpletable) | 365 | Simple tables in terminal with Go. |
| <b>[yacspin](https://github.com/theckman/yacspin) | 345 | Yet Another CLi Spinner package, for working with terminal spinners. |
| <b>[tabby](https://github.com/cheynewallace/tabby) | 318 | A tiny library for super simple Golang tables. |
| <b>[box-cli-maker](https://github.com/Delta456/box-cli-maker) | 213 | Make Highly Customized Boxes for your CLI. |
...
| <b>[cfmt](https://github.com/i582/cfmt) | 42 | Simple and convenient formatted stylized output fully compatible with fmt library. |
...
| <b>[table](https://github.com/tomlazar/table) | 31 | Small library for terminal color based tables . |
| <b>[marker](https://github.com/cyucelen/marker) | 29 | Easiest way to match and mark strings for colorful terminal outputs. |
...
| <b>[ops](https://github.com/nanovms/ops) | 992 | Unikernel Builder/Orchestrator. |
| <b>[liner](https://github.com/peterh/liner) | 903 | Go readline-like library for command-line interfaces. |
| <b>[complete](https://github.com/posener/complete) | 835 | Write bash completions in Go + Go command bash completion. |
...
| <b>[flaggy](https://github.com/integrii/flaggy) | 802 | A robust and idiomatic flags package with excellent subcommand support. |
| <b>[cli](https://github.com/mkideal/cli) | 656 | Feature-rich and easy to use command-line package based on golang struct tags. |
| <b>[argparse](https://github.com/akamensky/argparse) | 433 | Command line argument parser inspired by Python's argparse module. |
...
| <b>[wmenu](https://github.com/dixonwille/wmenu) | 166 | Easy to use menu structure for cli applications that prompts users to make choices. |
| <b>[commandeer](https://github.com/jaffee/commandeer) | 157 | Dev-friendly CLI apps: sets up flags, defaults, and usage based on struct fields and tags. |
...
| <b>[flag](https://github.com/cosiner/flag) | 119 | Simple but powerful command line option parsing library for Go supporting subcommand. |
| <b>[job](https://github.com/liujianping/job) | 119 | JOB, make your short-term command as a long-term job. |
| <b>[clîr](https://github.com/leaanthony/clir) | 117 | A Simple and Clear CLI library. Dependency free. |
| <b>[ukautz/clif](https://github.com/ukautz/clif) | 113 | Small command line interface framework. |
| <b>[cmdr](https://github.com/hedzr/cmdr) | 109 | A POSIX/GNU style, getopt-like command-line UI Go library. |
...
| <b>[carapace-bin](https://github.com/rsteube/carapace-bin) | 57 | Multi-shell multi-command argument completer. |
...
| <b>[acmd](https://github.com/cristalhq/acmd) | 46 | Simple, useful and opinionated CLI package in Go. |
...
| <b>[godotenv](https://github.com/joho/godotenv) | 5.1k | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| <b>[kong](https://github.com/alecthomas/kong) | 992 | Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (succesor to `kingpin`). |
| <b>[cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 641 | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| <b>[confita](https://github.com/heetch/confita) | 445 | Load configuration in cascade from multiple backends into a struct. |
| <b>[aconfig](https://github.com/cristalhq/aconfig) | 379 | Simple, useful and opinionated config loader. |
| <b>[gookit/config](https://github.com/gookit/config) | 366 | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| <b>[config](https://github.com/JeremyLoy/config) | 312 | Cloud native application configuration. Bind ENV to structs in only two lines. |
| <b>[GoLobby/Config](https://github.com/golobby/config) | 285 | GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language. |
...
| <b>[xdg](https://github.com/adrg/xdg) | 230 | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
| <b>[envconfig](https://github.com/vrischmann/envconfig) | 222 | Read your configuration from environment variables. |
| <b>[fig](https://github.com/kkyr/fig) | 214 | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
| <b>[joshbetz/config](https://github.com/joshbetz/config) | 211 | Small configuration library for Go that parses environment variables, JSON files, and reloads automatically on SIGHUP. |
...
| <b>[harvester](https://github.com/beatlabs/harvester) | 110 | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
...
| <b>[configuration](https://github.com/BoRuDar/configuration) | 66 | Library for initializing configuration structs from env variables, files, flags and 'default' tag. |
...
| <b>[config](https://github.com/num30/config) | 21 | configure you app using file, environment variables, or flags in two lines of code |
...
| <b>[goveralls](https://github.com/mattn/goveralls) | 729 | Go integration for Coveralls.io continuous code coverage tracking system. |
| <b>[gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 216 | go test output for humans. |
...
| <b>[binpacker](https://github.com/zhuangsirui/binpacker) | 188 | Binary packer and unpacker helps user build custom binary stream. |
| <b>[bit](https://github.com/yourbasic/bit) | 122 | Golang set data structure with bonus bit-twiddling functions. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[bitset](https://github.com/bits-and-blooms/bitset) | 901 | Go package implementing bitsets. |
| <b>[bitmap](https://github.com/kelindar/bitmap) | 155 | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| <b>[cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 916 | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
| <b>[cuckoo-filter](https://github.com/linvon/cuckoo-filter) | 220 | Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper is available. |
...
| <b>[gostl](https://github.com/liyue201/gostl) | 674 | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| <b>[algorithms](https://github.com/shady831213/algorithms) | 649 | Algorithms and data structures.CLRS study. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[cmap](https://github.com/lrita/cmap) | 29 | a thread-safe concurrent map for go, support using `interface{}` as key and auto scale up shards. |
| <b>[dict](https://github.com/srfrog/dict) | 25 | Python-like dictionaries (dict) for Go. |
| <b>[goradd/maps](https://github.com/goradd/maps) | 7 | Go 1.18+ generic map interface for maps; safe maps; ordered maps; ordered, safe maps; etc. |
...
| <b>[hyperloglog](https://github.com/axiomhq/hyperloglog) | 782 | HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |
| <b>[go-geoindex](https://github.com/hailocab/go-geoindex) | 341 | In-memory geo index. |
...
| <b>[hide](https://github.com/emvi/hide) | 47 | ID type with marshalling to/from hash to prevent sending IDs to clients. |
| <b>[concurrent-writer](https://github.com/free/concurrent-writer) | 44 | Highly concurrent drop-in replacement for `bufio.Writer`. |
...
| <b>[genfuncs](https://github.com/nwillc/genfuncs) | 19 | Go 1.18+ generics package inspired by Kotlin's Sequence and Map. |
| <b>[go18ds](https://github.com/daichi-m/go18ds) | 15 | Go Data Structures using Go 1.18 generics. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[deque](https://github.com/gammazero/deque) | 352 | Fast ring-buffer deque (double-ended queue). |
| <b>[goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 192 | Concurrent FIFO queue. |
...
| <b>[deque](https://github.com/edwingeng/deque) | 49 | A highly optimized double-ended queue. |
...
| <b>[goset](https://github.com/zoumo/goset) | 47 | A useful Set collection implementation for Go. |
...
| <b>[trie](https://github.com/derekparker/trie) | 592 | Trie implementation in Go. |
| <b>[go-edlib](https://github.com/hbollon/go-edlib) | 333 | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| <b>[go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 234 | Go implementation of Adaptive Radix Tree. |
| <b>[levenshtein](https://github.com/agnivade/levenshtein) | 215 | Implementation to calculate levenshtein distance in Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[skiplist](https://github.com/MauriceGit/skiplist) | 210 | Very fast Go Skiplist implementation. |
| <b>[skiplist](https://github.com/gansidui/skiplist) | 79 | Skiplist implementation in Go. |
| <b>[treemap](https://github.com/igrmk/treemap) | 21 | Generic key-sorted map using a red-black tree under the hood. |
...
| <b>[merkle](https://github.com/bobg/merkle) | 3 | Space-efficient computation of Merkle root hashes and inclusion proofs. |
...
| <b>[ttlcache](https://github.com/jellydator/ttlcache) | 447 | An in-memory cache with item expiration and generics. |
| <b>[cachego](https://github.com/fabiorphp/cachego) | 179 | Golang Cache component for multiple drivers. |
...
| <b>[cache](https://github.com/akyoto/cache) | 108 | In-memory key:value store with expiration time, 0 dependencies, <100 LoC, 100% coverage. |
...
| <b>[immudb](https://github.com/codenotary/immudb) | 7.7k | immudb is a lightweight, high-speed immutable database for systems and applications written in Go. |
| <b>[VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 6.7k | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
| <b>[bbolt](https://github.com/etcd-io/bbolt) | 5.7k | An embedded key/value database for Go. |
...
| <b>[rosedb](https://github.com/roseduan/rosedb) | 3.0k | An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset. |
| <b>[tiedot](https://github.com/HouzuoGuo/tiedot) | 2.7k | Your NoSQL database powered by Golang. |
| <b>[nutsdb](https://github.com/xujiajun/nutsdb) | 2.3k | Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as  list, set, sorted set. |
| <b>[godis](https://github.com/hdt3213/godis) | 2.0k | A Golang implemented high-performance Redis server and cluster. |
...
| <b>[Databunker](https://github.com/paranoidguy/databunker) | 992 | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
| <b>[column](https://github.com/kelindar/column) | 948 | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
| <b>[eliasdb](https://github.com/krotik/eliasdb) | 926 | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| <b>[pogreb](https://github.com/akrylysov/pogreb) | 903 | Embedded key-value store for read-heavy workloads. |
| <b>[lotusdb](https://github.com/flower-corp/lotusdb) | 872 | Fast k/v database compatible with lsm and b+tree. |
| <b>[moss](https://github.com/couchbase/moss) | 872 | Moss is a simple LSM key-value storage engine written in 100% Go. |
| <b>[levigo](https://github.com/jmhodges/levigo) | 404 | Levigo is a Go wrapper for LevelDB. |
| <b>[pudge](https://github.com/recoilme/pudge) | 325 | Fast and simple key/value store written using Go's standard library. |
...
| <b>[clover](https://github.com/ostafen/clover) | 227 | A lightweight document-oriented NoSQL database written in pure Golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[migrate](https://github.com/golang-migrate/migrate) | 9.1k | Database migrations. CLI and Golang library. |
| <b>[goose](https://github.com/pressly/goose) | 2.8k | Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts. |
...
| <b>[goavro](https://github.com/linkedin/goavro) | 813 | A Go package that encodes and decodes Avro data. |
| <b>[gormigrate](https://github.com/go-gormigrate/gormigrate) | 787 | Database schema migration helper for Gorm ORM. |
| <b>[darwin](https://github.com/GuiaBolso/darwin) | 130 | Database schema evolution library for Go. |
| <b>[migrator](https://github.com/lopezator/migrator) | 128 | Dead simple Go database migration library. |
...
| <b>[avro](https://github.com/khezen/avro) | 37 | Discover SQL schemas and convert them to AVRO schemas. Query SQL records into AVRO bytes. |
| <b>[sqlize](https://github.com/sunary/sqlize) | 35 | Database migration generator. Allows generate sql migration from model and existing sql by differ them. |
...
| <b>[chproxy](https://github.com/Vertamedia/chproxy) | 930 | HTTP proxy for ClickHouse database. |
| <b>[pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 734 | Advanced scheduling for PostgreSQL. |
| <b>[clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 367 | Collects small inserts and sends big requests to ClickHouse servers. |
...
| <b>[octillery](https://github.com/knocknote/octillery) | 166 | Go package for sharding databases ( Supports every ORM or raw SQL ). |
| <b>[rdb](https://github.com/HDT3213/rdb) | 151 | Redis RDB file parser for secondary development and memory analysis. |
| <b>[dbbench](https://github.com/sj14/dbbench) | 71 | Database benchmarking tool with support for several databases and scripts. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sqlc](https://github.com/kyleconroy/sqlc) | 5.9k | Generate type-safe code from SQL. |
| <b>[Squirrel](https://github.com/Masterminds/squirrel) | 5.0k | Go library that helps you build SQL queries. |
...
| <b>[jet](https://github.com/go-jet/jet) | 752 | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
| <b>[Dotsql](https://github.com/gchaincl/dotsql) | 639 | Go library that helps you keep sql files in one place and use them with ease. |
| <b>[ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 554 | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
| <b>[dbq](https://github.com/rocketlaunchr/dbq) | 346 | Zero boilerplate database operations for Go. |
| <b>[sqlingo](https://github.com/lqs/sqlingo) | 244 | A lightweight DSL to build SQL in Go. |
| <b>[sqrl](https://github.com/elgris/sqrl) | 244 | SQL query builder, fork of Squirrel with improved performance. |
| <b>[sq](https://github.com/bokwoon95/go-structured-query) | 163 | Type-safe SQL builder and struct mapper for Go. |
...
| <b>[sqlf](https://github.com/leporo/sqlf) | 74 | Fast SQL query builder. |
| <b>[buildsqlx](https://github.com/arthurkushman/buildsqlx) | 66 | Go database query builder library for PostgreSQL. |
...
| <b>[gokv](https://github.com/philippgille/gokv) | 443 | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| <b>[pgx](https://github.com/jackc/pgx) | 5.7k | PostgreSQL driver supporting features beyond those exposed by database/sql. |
...
| <b>[sqlhooks](https://github.com/qustavo/sqlhooks) | 556 | Attach hooks to any database/sql driver. |
| <b>[godror](https://github.com/godror/godror) | 369 | Oracle driver for Go, using the ODPI-C driver. |
...
| <b>[avatica](https://github.com/apache/calcite-avatica-go) | 97 | Apache Avatica/Phoenix SQL driver for database/sql. |
...
| <b>[mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 6.8k | Official MongoDB driver for the Go language. |
...
| <b>[qmgo](https://github.com/qiniu/qmgo) | 925 | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
| <b>[mgm](https://github.com/kamva/mgm) | 523 | MongoDB model-based ODM for Go (based on official MongoDB driver). |
| <b>[redeo](https://github.com/bsm/redeo) | 414 | Redis-protocol compatible TCP servers/services. |
...
| <b>[go-rejson](https://github.com/nitishm/go-rejson) | 271 | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[elastic](https://github.com/olivere/elastic) | 6.9k | Elasticsearch client for Go. |
...
| <b>[elasticsql](https://github.com/cch123/elasticsql) | 931 | Convert sql to elasticsearch dsl in Go. |
...
| <b>[carbon](https://github.com/uniplaces/carbon) | 711 | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
| <b>[durafmt](https://github.com/hako/durafmt) | 442 | Time duration formatting library for Go. |
...
| <b>[go-str2duration](https://github.com/xhit/go-str2duration) | 41 | Convert string to duration. Support time.Duration returned string and more. |
...
| <b>[rpcx](https://github.com/smallnest/rpcx) | 7.1k | Distributed pluggable RPC service framework like alibaba Dubbo. |
| <b>[raft](https://github.com/hashicorp/raft) | 6.2k | Golang implementation of the Raft consensus protocol, by HashiCorp. |
...
| <b>[go-doudou](https://github.com/unionj-cloud/go-doudou) | 825 | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
| <b>[rain](https://github.com/cenkalti/rain) | 747 | BitTorrent client and library. |
| <b>[ringpop-go](https://github.com/uber/ringpop-go) | 737 | Scalable, fault-tolerant application-layer sharding for Go applications. |
| <b>[redis-lock](https://github.com/bsm/redislock) | 733 | Simplified distributed locking implementation using Redis. |
| <b>[gorpc](https://github.com/valyala/gorpc) | 651 | Simple, fast and scalable RPC library for high load. |
| <b>[go-health](https://github.com/InVisionApp/go-health) | 624 | Library for enabling asynchronous dependency health checks in your service. |
| <b>[arpc](https://github.com/lesismal/arpc) | 542 | More effective network communication, support two-way-calling, notify, broadcast. |
| <b>[consistent](https://github.com/buraksezer/consistent) | 490 | Consistent hashing with bounded loads. |
| <b>[go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 488 | A library built to provide support for defining async service health checks for golang services. |
| <b>[digota](https://github.com/digota/digota) | 451 | grpc ecommerce microservice. |
| <b>[sleuth](https://github.com/ursiform/sleuth) | 354 | Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq)). |
| <b>[go-jump](https://github.com/dgryski/go-jump) | 343 | Port of Google's "Jump" Consistent Hash function. |
| <b>[dht](https://github.com/anacrolix/dht) | 239 | BitTorrent Kademlia DHT implementation. |
| <b>[jsonrpc](https://github.com/ybbus/jsonrpc) | 235 | JSON-RPC 2.0 HTTP client implementation. |
...
| <b>[dot](https://github.com/dotchain/dot/) | 71 | distributed sync using operational transformation/OT. |
...
| <b>[drmaa](https://github.com/dgruber/drmaa) | 39 | Job submission library for cluster schedulers based on the DRMAA standard. |
...
| <b>[DDNS](https://github.com/skibish/ddns) | 212 | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| <b>[SendGrid](https://github.com/sendgrid/sendgrid-go) | 828 | SendGrid's Go library for sending email. |
| <b>[mailgun-go](https://github.com/mailgun/mailgun-go) | 609 | Go library for sending mail with the Mailgun API. |
| <b>[email-verifier](https://github.com/AfterShip/email-verifier) | 482 | A Go library for email verification without sending any emails. |
| <b>[go-simple-mail](https://github.com/xhit/go-simple-mail) | 343 | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| <b>[go-message](https://github.com/emersion/go-message) | 259 | Streaming library for the Internet Message Format and mail messages. |
...
| <b>[mailchain](https://github.com/mailchain/mailchain) | 119 | Send encrypted emails to blockchain addresses written in Go. |
...
| <b>[smtpmock](https://github.com/mocktools/go-smtp-mock) | 48 | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
...
| <b>[go-mail](https://github.com/wneessen/go-mail) | 25 | A simple Go library for sending mails in Go. |
| <b>[truemail-go](https://github.com/truemail-rb/truemail-go) | 16 | Configurable Golang email validator/verifier. Verify email via Regex, DNS, SMTP and even more. |
...
| <b>[goja](https://github.com/dop251/goja) | 3.1k | ECMAScript 5.1(+) implementation in Go. |
...
| <b>[metacall](https://github.com/metacall/core) | 980 | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
| <b>[go-php](https://github.com/deuill/go-php) | 865 | PHP bindings for Go. |
| <b>[go-duktape](https://github.com/olebedev/go-duktape) | 780 | Duktape JavaScript engine bindings for Go. |
| <b>[golua](https://github.com/aarzilli/golua) | 590 | Go bindings for Lua C API. |
| <b>[gval](https://github.com/PaesslerAG/gval) | 510 | A highly customizable expression language written in Go. |
| <b>[gisp](https://github.com/jcla1/gisp) | 485 | Simple LISP in Go. |
| <b>[prolog](https://github.com/ichiban/prolog) | 381 | Embeddable Prolog. |
...
| <b>[errorx](https://github.com/joomcode/errorx) | 875 | A feature rich error package with stack traces, composition of errors and more. |
| <b>[tracerr](https://github.com/ztrue/tracerr) | 727 | Golang errors with stack trace and source fragments. |
...
| <b>[errors](https://github.com/emperror/errors) | 150 | Drop-in replacement for the standard library errors package and github.com/pkg/errors. Provides various error handling primitives. |
...
| <b>[exception](https://github.com/rbrahul/exception) | 13 | A simple utility package for exception handling with try-catch in Golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[afero](https://github.com/spf13/afero) | 4.6k | FileSystem Abstraction System for Go. |
...
| <b>[notify](https://github.com/rjeczalik/notify) | 744 | File system event notification library with simple API, similar to os/signal. |
| <b>[copy](https://github.com/otiai10/copy) | 443 | Copy directory recursively. |
| <b>[bigfile](https://github.com/bigfile/bigfile) | 228 | A file transfer system, support to manage files with http api, rpc call and ftp client. |
| <b>[afs](https://github.com/viant/afs) | 190 | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
| <b>[vfs](https://github.com/C2FO/vfs) | 175 | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
| <b>[go-exiftool](https://github.com/barasher/go-exiftool) | 119 | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
| <b>[go-csv-tag](https://github.com/artonge/go-csv-tag) | 94 | Load csv file using tag. |
| <b>[skywalker](https://github.com/dixonwille/skywalker) | 81 | Package to allow one to concurrently go through a filesystem with ease. |
| <b>[gofs](https://github.com/no-src/gofs) | 80 | A file synchronization tool out of the box. |
| <b>[opc](https://github.com/qmuntal/opc) | 72 | Load Open Packaging Conventions (OPC) files for Go. |
| <b>[checksum](https://github.com/codingsince1985/checksum) | 63 | Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files. |
...
| <b>[todotxt](https://github.com/1set/todotxt) | 14 | Go library for Gina Trapani's [_todo.txt_](http://todotxt.org/) files, supports parsing and manipulating of task lists in the [_todo.txt_ format](https://github.com/todotxt/todo.txt). |
...
| <b>[decimal](https://github.com/shopspring/decimal) | 4.2k | Arbitrary-precision fixed-point decimal numbers. |
| <b>[go-money](https://github.com/rhymond/go-money) | 1.1k | Implementation of Fowler's Money pattern. |
| <b>[accounting](https://github.com/leekchan/accounting) | 756 | money and currency formatting for golang. |
| <b>[techan](https://github.com/sdcoffey/techan) | 650 | Technical analysis library with advanced market analysis and trading strategies. |
| <b>[go-finance](https://github.com/FlashBoys/go-finance) | 537 | Comprehensive financial markets data in Go. |
| <b>[currency](https://github.com/bojanz/currency) | 322 | Handles currency amounts, provides currency information and formatting. |
| <b>[ach](https://github.com/moov-io/ach) | 318 | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
| <b>[orderbook](https://github.com/i25959341/orderbook) | 274 | Matching Engine for Limit Order Book in Golang. |
...
| <b>[transaction](https://github.com/claygod/transaction) | 110 | Embedded transactional database of accounts, running in multithreaded mode. |
| <b>[ofxgo](https://github.com/aclindsa/ofxgo) | 102 | Query OFX servers and/or parse the responses (with example command-line client). |
| <b>[sleet](https://github.com/BoltApp/sleet) | 96 | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
| <b>[vat](https://github.com/dannyvankooten/vat) | 92 | VAT number validation & EU VAT rates. |
| <b>[go-finnhub](https://github.com/m1/go-finnhub) | 72 | Client for stock market, forex and crypto data from finnhub.io. Access real-time financial market data from 60+ stock exchanges, 10 forex brokers, and 15+ crypto exchanges. |
...
| <b>[fpmoney](https://github.com/nikolaydubina/fpmoney) | 3 | Fast and simple ISO4217 fixed-point decimal money. |
...
| <b>[gorilla/csrf](https://github.com/gorilla/csrf) | 806 | CSRF protection for Go web applications & services. |
| <b>[binding](https://github.com/mholt/binding) | 791 | Binds form and JSON data from net/http Request to struct. |
| <b>[form](https://github.com/go-playground/form) | 533 | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
| <b>[conform](https://github.com/leebenson/conform) | 262 | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
| <b>[formam](https://github.com/monoculum/formam) | 171 | decode form's values into a struct. |
...
| <b>[httpin](https://github.com/ggicci/httpin) | 93 | Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc. |
...
| <b>[gbind](https://github.com/bdjimmy/gbind) | 6 | Bind data to any Go value. Can use built-in and custom expression binding capabilities; supports data validation |
...
| <b>[mo](https://github.com/samber/mo) | 615 | Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...). |
| <b>[fpGo](https://github.com/TeaEntityLab/fpGo) | 275 | Monad, Functional Programming features for Golang. |
| <b>[gofp](https://github.com/rbrahul/gofp) | 126 | A lodash like powerful utility library for Golang. |
| <b>[fuego](https://github.com/seborama/fuego) | 118 | Functional Experiment in Go. |
| <b>[fp-go](https://github.com/repeale/fp-go) | 73 | Collection of Functional Programming helpers powered by Golang 1.18+ generics. |
| <b>[underscore](https://github.com/rjNemo/underscore) | 57 | Functional programming helpers for Go 1.18 and beyond. |
| <b>[valor](https://github.com/phelmkamp/valor) | 4 | Generic option and result types that optionally contain a value. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Ebiten](https://github.com/hajimehoshi/ebiten) | 6.7k | dead simple 2D game library in Go. |
...
| <b>[raylib-go](https://github.com/gen2brain/raylib-go) | 825 | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
...
| <b>[go3d](https://github.com/ungerik/go3d) | 264 | Performance oriented 2D/3D math package for Go. |
| <b>[prototype](https://github.com/gonutz/prototype) | 72 | Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API. |
| <b>[tile](https://github.com/kelindar/tile) | 56 | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
...
| <b>[goderive](https://github.com/awalterschulze/goderive) | 990 | Derives functions from input types. |
| <b>[GoWrap](https://github.com/hexdigest/gowrap) | 614 | Generate decorators for Go interfaces using simple templates. |
| <b>[go-enum](https://github.com/abice/go-enum) | 346 | Code generation for enums from code comments. |
| <b>[interfaces](https://github.com/rjeczalik/interfaces) | 346 | Command line tool for generating interface definitions. |
| <b>[copygen](https://github.com/switchupcb/copygen) | 151 | Generate type-to-type code without reflection. |
| <b>[goverter](https://github.com/jmattheis/goverter) | 132 | Generate converters by defining an interface. |
| <b>[gotype](https://github.com/wzshiming/gotype) | 43 | Golang source code parsing, usage like reflect package. |
...
| <b>[mbtileserver](https://github.com/consbio/mbtileserver) | 361 | A simple Go-based server for map tiles stored in mbtiles format. |
| <b>[osm](https://github.com/paulmach/osm) | 215 | Library for reading, writing and working with OpenStreetMap data and APIs. |
| <b>[WGS84](https://github.com/wroge/wgs84) | 83 | Library for Coordinate Conversion and Transformation (ETRS89, OSGB36, NAD83, RGF93, Web Mercator, UTM). |
...
| <b>[simplefeatures](https://github.com/peterstace/simplefeatures) | 54 | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
| <b>[gismanager](https://github.com/hishamkaram/gismanager) | 45 | Publish Your GIS Data(Vector Data) to PostGIS and Geoserver. |
| <b>[pbf](https://github.com/maguro/pbf) | 36 | OpenStreetMap PBF golang encoder/decoder. |
...
| <b>[c4go](https://github.com/Konstantin8105/c4go) | 321 | Transpile C code to Go code. |
| <b>[c2go](https://github.com/goplus/c2go) | 173 | Convert C code to Go code. |
| <b>[esp32](https://github.com/andygeiss/esp32-transpiler) | 47 | Transpile Go into Arduino code. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[ants](https://github.com/panjf2000/ants) | 8.7k | A high-performance and low-cost goroutine pool in Go. |
...
| <b>[workerpool](https://github.com/gammazero/workerpool) | 846 | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| <b>[grpool](https://github.com/ivpusic/grpool) | 695 | Lightweight Goroutine pool. |
| <b>[pool](https://github.com/go-playground/pool) | 688 | Limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation. |
| <b>[pond](https://github.com/alitto/pond) | 570 | Minimalistic and High-performance goroutine worker pool written in Go. |
| <b>[gowp](https://github.com/xxjwxc/gowp) | 400 | gowp is concurrency limiting goroutine pool. |
| <b>[go-floc](https://github.com/workanator/go-floc) | 255 | Orchestrate goroutines with ease. |
| <b>[go-flow](https://github.com/kamildrazkiewicz/go-flow) | 194 | Control goroutines execution order. |
| <b>[semaphore](https://github.com/marusama/semaphore) | 146 | Fast resizable semaphore implementation based on CAS (faster than channel-based semaphore implementations). |
| <b>[go-workers](https://github.com/catmullet/go-workers) | 145 | Easily and safely run workers for large data processing pipelines. |
| <b>[artifex](https://github.com/borderstech/artifex) | 135 | Simple in-memory job queue for Golang using worker-based dispatching. |
| <b>[neilotoole/errgroup](https://github.com/neilotoole/errgroup) | 128 | Drop-in alternative to `sync/errgroup`, limited to a pool of N worker goroutines. |
...
| <b>[gollback](https://github.com/vardius/gollback) | 90 | asynchronous simple function utilities, for managing execution of closures and callbacks. |
...
| <b>[Hunch](https://github.com/AaronJan/Hunch) | 83 | Hunch provides functions like: `All`, `First`, `Retry`, `Waterfall` etc., that makes asynchronous flow control more intuitive. |
| <b>[worker-pool](https://github.com/vardius/worker-pool) | 82 | goworker is a Go simple async worker pool. |
| <b>[async](https://github.com/reugn/async) | 81 | An alternative sync library for Go (Future, Promise, Locks). |
| <b>[threadpool](https://github.com/shettyh/threadpool) | 72 | Golang threadpool implementation. |
| <b>[goccm](https://github.com/zenthangplus/goccm) | 53 | Go Concurrency Manager package limits the number of goroutines that allowed to run concurrently. |
...
| <b>[nursery](https://github.com/arunsworld/nursery) | 46 | Structured concurrency in Go. |
| <b>[kyoo](https://github.com/dirkaholic/kyoo) | 38 | Provides an unlimited job queue and concurrent worker pools. |
| <b>[gohive](https://github.com/loveleshsharma/gohive) | 37 | A highly performant and easy to use Goroutine pool for Go. |
...
| <b>[gowl](https://github.com/hamed-yousefi/gowl) | 24 | Gowl is a process management and process monitoring tool at once. An infinite worker pool gives you the ability to control the pool and processes and monitor their status. |
...
| <b>[robotgo](https://github.com/go-vgo/robotgo) | 7.7k | Go Native cross-platform GUI system automation. Control the mouse, keyboard and other. |
| <b>[app](https://github.com/murlokswarm/app) | 6.3k | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
...
| <b>[gosx-notifier](https://github.com/deckarep/gosx-notifier) | 572 | OSX Desktop Notifications library for Go. |
| <b>[gowd](https://github.com/dtylman/gowd) | 364 | Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform. |
| <b>[zenity](https://github.com/ncruces/zenity) | 289 | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
| <b>[trayhost](https://github.com/shurcooL/trayhost) | 227 | Cross-platform Go library to place an icon in the host operating system's taskbar. |
...
| <b>[emgo](https://github.com/ziutek/emgo) | 983 | Go-like language for programming embedded systems (e.g. STM32 MCU). |
| <b>[sysinfo](https://github.com/zcalusic/sysinfo) | 363 | A pure Go library providing Linux OS / kernel / hardware system information. |
| <b>[goroslib](https://github.com/aler9/goroslib) | 201 | Robot Operating System (ROS) library for Go. |
...
| <b>[gowitness](https://github.com/sensepost/gowitness) | 1.6k | Screenshoting webpages using go and headless chrome on command line. |
...
| <b>[canvas](https://github.com/tdewolff/canvas) | 993 | Vector graphics to PDF, SVG or rasterized image. |
| <b>[govips](https://github.com/davidbyttow/govips) | 708 | A lightning fast image processing and resizing library for Go. |
| <b>[image2ascii](https://github.com/qeesung/image2ascii) | 671 | Convert image to ASCII. |
| <b>[draft](https://github.com/lucasepe/draft) | 538 | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| <b>[goimagehash](https://github.com/corona10/goimagehash) | 511 | Go Perceptual image hashing package. |
| <b>[govatar](https://github.com/o1egl/govatar) | 500 | Library and CMD tool for generating funny avatars. |
...
| <b>[rez](https://github.com/bamiaux/rez) | 206 | Image resizing in pure Go and SIMD. |
| <b>[darkroom](https://github.com/gojek/darkroom) | 193 | An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency. |
| <b>[mergi](https://github.com/noelyahan/mergi) | 176 | Tool & Go library for image manipulation (Merge, Crop, Resize, Watermark, Animate). |
| <b>[gltf](https://github.com/qmuntal/gltf) | 162 | Efficient and robust glTF 2.0 reader, writer and validator. |
| <b>[steganography](https://github.com/auyer/steganography) | 147 | Pure Go Library for LSB steganography. |
...
| <b>[go-webp](https://github.com/kolesa-team/go-webp) | 57 | Library for encode and decode webp pictures, using libwebp. |
...
| <b>[connectordb](https://github.com/connectordb/connectordb) | 340 | Open-Source Platform for Quantified Self & IoT. |
...
| <b>[gron](https://github.com/roylee0704/gron) | 898 | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| <b>[go-quartz](https://github.com/reugn/go-quartz) | 883 | Simple, zero-dependency scheduling library for Go. |
...
| <b>[gronx](https://github.com/adhocore/gronx) | 205 | Cron expression parser, task runner and daemon consuming crontab like task list. |
| <b>[Dagu](https://github.com/dagu-go/dagu) | 146 | No-code workflow executor. it executes DAGs defined in a simple YAML format. |
| <b>[clockwerk](https://github.com/onatm/clockwerk) | 120 | Go package to schedule periodic jobs using a simple, fluent syntax. |
| <b>[tasks](https://github.com/madflojo/tasks) | 97 | An easy to use in-process scheduler for recurring tasks in Go. |
| <b>[leprechaun](https://github.com/kilgaloon/leprechaun) | 87 | Job scheduler that supports webhooks, crons and classic scheduling. |
| <b>[cheek](https://github.com/datarootsio/cheek) | 42 | A simple crontab like scheduler that aims to offer a KISS approach to job scheduling. |
| <b>[goflow](https://github.com/fieldryand/goflow) | 42 | A workflow orchestrator and scheduler for rapid prototyping of ETL/ML/AI pipelines. |
...
| <b>[OjG](https://github.com/ohler55/ojg) | 483 | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
| <b>[kazaam](https://github.com/Qntfy/kazaam) | 232 | API for arbitrary transformation of JSON documents. |
| <b>[gojq](https://github.com/elgs/gojq) | 182 | JSON query in Golang. |
| <b>[jsondiff](https://github.com/wI2L/jsondiff) | 174 | JSON diff library for Go based on RFC6902 (JSON Patch). |
| <b>[jettison](https://github.com/wI2L/jettison) | 128 | Fast and flexible JSON encoder for Go. |
| <b>[ajson](https://github.com/spyzhov/ajson) | 119 | Abstract JSON for golang with JSONPath support. |
...
| <b>[JayDiff](https://github.com/yazgazan/jaydiff) | 87 | JSON diff utility written in Go. |
...
| <b>[zerolog](https://github.com/rs/zerolog) | 6.5k | Zero-allocation JSON logger. |
| <b>[spew](https://github.com/davecgh/go-spew) | 5.1k | Implements a deep pretty printer for Go data structures to aid in debugging. |
| <b>[lumberjack](https://github.com/natefinch/lumberjack) | 3.4k | Simple rolling logger, implements io.WriteCloser. |
...
| <b>[phuslu/log](https://github.com/phuslu/log) | 429 | Structured Logging Made Easy. |
...
| <b>[httpretty](https://github.com/henvic/httpretty) | 264 | Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest). |
| <b>[rollingwriter](https://github.com/arthurkiller/rollingWriter) | 235 | RollingWriter is an auto-rotate `io.Writer` implementation with multi policies to provide log file rotation. |
| <b>[sqldb-logger](https://github.com/simukti/sqldb-logger) | 223 | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
| <b>[glg](https://github.com/kpango/glg) | 163 | glg is simple and fast leveled logging library for Go. |
| <b>[logur](https://github.com/logur/logur) | 163 | An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus), [go-kit log](https://github.com/go-kit/kit/tree/master/log), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog), etc). |
| <b>[logger](https://github.com/azer/logger) | 154 | Minimalistic logging library for Go. |
...
| <b>[slog](https://github.com/gookit/slog) | 93 | Lightweight, configurable, extensible logger for Go. |
...
| <b>[gorse](https://github.com/zhenghaoz/gorse) | 5.9k | An offline recommender system backend based on collaborative filtering written in Go. |
...
| <b>[bayesian](https://github.com/jbrukh/bayesian) | 735 | Naive Bayesian Classification for Golang. |
| <b>[CloudForest](https://github.com/ryanbressler/CloudForest) | 713 | Fast, flexible, multi-threaded ensembles of decision trees for machine learning in pure Go. |
| <b>[gobrain](https://github.com/goml/gobrain) | 525 | Neural Networks written in go. |
| <b>[ocrserver](https://github.com/otiai10/ocrserver) | 508 | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
| <b>[onnx-go](https://github.com/owulveryck/onnx-go) | 400 | Go Interface to Open Neural Network Exchange (ONNX). |
| <b>[go-deep](https://github.com/patrikeh/go-deep) | 378 | A feature-rich neural network library in Go. |
| <b>[regommend](https://github.com/muesli/regommend) | 299 | Recommendation & collaborative filtering engine. |
| <b>[Goptuna](https://github.com/c-bata/goptuna) | 216 | Bayesian optimization framework for black-box functions written in Go. Everything will be optimized. |
| <b>[go-galib](https://github.com/thoj/go-galib) | 192 | Genetic Algorithms library written in Go / golang. |
| <b>[goRecommend](https://github.com/timkaye11/goRecommend) | 187 | Recommendation Algorithms library written in Go. |
| <b>[goga](https://github.com/tomcraven/goga) | 163 | Genetic algorithm library for Go. |
...
| <b>[goscore](https://github.com/asafschers/goscore) | 80 | Go Scoring API for PMML. |
...
| <b>[fonet](https://github.com/Fontinalis/fonet) | 68 | A Deep Neural Network library written in Go. |
| <b>[neat](https://github.com/jinyeom/neat) | 64 | Plug-and-play, parallel Go framework for NeuroEvolution of Augmenting Topologies (NEAT). |
...
| <b>[GoMind](https://github.com/surenderthakran/gomind) | 31 | A simplistic Neural Network Library in Go. |
...
| <b>[Asynq](https://github.com/hibiken/asynq) | 3.6k | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| <b>[Gollum](https://github.com/trivago/gollum) | 919 | A n:m multiplexer that gathers messages from different sources and broadcasts them to a set of destinations. |
| <b>[Chanify](https://github.com/chanify/chanify) | 880 | A push notification server send message to your iOS devices. |
| <b>[dbus](https://github.com/godbus/dbus) | 724 | Native Go bindings for D-Bus. |
| <b>[golongpoll](https://github.com/jcuga/golongpoll) | 603 | HTTP longpoll server library that makes web pub-sub simple. |
| <b>[mangos](https://github.com/nanomsg/mangos) | 524 | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
| <b>[emitter](https://github.com/olebedev/emitter) | 430 | Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins. |
| <b>[Glue](https://github.com/desertbit/glue) | 402 | Robust Go and Javascript Socket Library (Alternative to Socket.io). |
| <b>[amqp](https://github.com/rabbitmq/amqp091-go) | 401 | Go RabbitMQ Client Library. |
| <b>[pubsub](https://github.com/tuxychandru/pubsub) | 377 | Simple pubsub package for go. |
| <b>[Bus](https://github.com/mustafaturan/bus) | 268 | Minimalist message bus implementation for internal communication. |
| <b>[Quamina](https://github.com/timbray/quamina) | 225 | Fast pattern-matching for filtering messages and events. |
| <b>[messagebus](https://github.com/vardius/message-bus) | 222 | messagebus is a Go simple async message bus, perfect for using as event bus when doing event sourcing, CQRS, DDD. |
| <b>[rabtap](https://github.com/jandelgado/rabtap) | 215 | RabbitMQ swiss army knife cli app. |
...
| <b>[hub](https://github.com/leandro-lugaresi/hub) | 116 | A Message/Event Hub for Go applications, using publish/subscribe pattern with support for alias like rabbitMQ exchanges. |
...
| <b>[hare](https://github.com/leozz37/hare) | 48 | A user friendly library for sending messages and listening to TCP sockets. |
...
| <b>[go-vitotrol](https://github.com/maxatome/go-vitotrol) | 18 | Client library to Viessmann Vitotrol web service. |
...
| <b>[nject](https://github.com/muir/nject) | 16 | A type safe, reflective framework for libraries, tests, http endpoints, and service startup. |
...
| <b>[cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 529 | A Go application boilerplate template for quick starting projects following production best practices. |
| <b>[pagoda](https://github.com/mikestefanello/pagoda) | 354 | Rapid, easy full-stack web development starter kit built in Go. |
| <b>[golang-templates/seed](https://github.com/golang-templates/seed) | 274 | Go application GitHub repository template. |
| <b>[go-starter](https://github.com/allaboutapps/go-starter) | 163 | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| <b>[go-todo-backend](https://github.com/Fs02/go-todo-backend) | 158 | Go Todo Backend example using modular project layout for product microservice. |
| <b>[scaffold](https://github.com/catchplay/scaffold) | 115 | Scaffold generates a starter Go project layout. Lets you focus on business logic implemented. |
| <b>[go-sample](https://github.com/zitryss/go-sample) | 104 | A sample layout for Go application projects with the real code. |
...
| <b>[sttr](https://github.com/abhimanyu003/sttr) | 384 | cross-platform, cli app to perform various operations on string. |
| <b>[strutil](https://github.com/ozgio/strutil) | 177 | String utilities. |
| <b>[gobeam/Stringy](https://github.com/gobeam/Stringy) | 134 | String manipulation library to convert string to camel case, snake case, kebab case / slugify etc. |
...
| <b>[go-resiliency](https://github.com/eapache/go-resiliency) | 1.5k | Resiliency patterns for golang. |
...
| <b>[llvm](https://github.com/llir/llvm) | 915 | Library for interacting with LLVM IR in pure Go. |
| <b>[shortid](https://github.com/teris-io/shortid) | 775 | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| <b>[health](https://github.com/alexliesenfeld/health) | 510 | A simple and flexible health check library for Go. |
| <b>[stateless](https://github.com/qmuntal/stateless) | 456 | A fluent library for creating state machines. |
| <b>[health](https://github.com/dimiro1/health) | 431 | Easy to use, extensible health check library. |
| <b>[banner](https://github.com/dimiro1/banner) | 399 | Add beautiful banners into your Go applications. |
| <b>[shoutrrr](https://github.com/containrrr/shoutrrr) | 382 | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
| <b>[xz](https://github.com/ulikunitz/xz) | 380 | Pure golang package for reading and writing xz-compressed files. |
| <b>[conv](https://github.com/cstockton/go-conv) | 378 | Package conv provides fast and intuitive conversions across Go types. |
| <b>[gountries](https://github.com/pariz/gountries) | 344 | Package that exposes country and subdivision data. |
| <b>[ffmt](https://github.com/go-ffmt/ffmt) | 271 | Beautify data display for Humans. |
| <b>[lk](https://github.com/hyperboloide/lk) | 249 | A simple licensing library for golang. |
| <b>[antch](https://github.com/antchfx/antch) | 233 | A fast, powerful and extensible web crawling & scraping framework. |
| <b>[healthcheck](https://github.com/etherlabsio/healthcheck) | 222 | An opinionated and concurrent health-check HTTP handler for RESTful services. |
| <b>[battery](https://github.com/distatus/battery) | 205 | Cross-platform, normalized battery information library. |
| <b>[bitio](https://github.com/icza/bitio) | 194 | Highly optimized bit-level Reader and Writer for Go. |
| <b>[go-unarr](https://github.com/gen2brain/go-unarr) | 188 | Decompression library for RAR, TAR, ZIP and 7z archives. |
...
| <b>[captcha](https://github.com/steambap/captcha) | 109 | Package captcha provides an easy to use, unopinionated API for captcha generation. |
| <b>[gommit](https://github.com/antham/gommit) | 96 | Analyze git commit messages to ensure they follow defined patterns. |
...
| <b>[sandid](https://github.com/aofei/sandid) | 36 | Every grain of sand on earth has its own ID. |
...
| <b>[getlang](https://github.com/rylans/getlang) | 137 | Fast natural language detection package. |
...
| <b>[kagome](https://github.com/ikawaha/kagome) | 656 | JP morphological analyzer written in pure Go. |
| <b>[nlp](https://github.com/Shixzie/nlp) | 381 | Extract values from strings and fill your structs with nlp. |
| <b>[nlp](https://github.com/james-bowman/nlp) | 369 | Go Natural Language Processing library supporting LSA (Latent Semantic Analysis). |
| <b>[RAKE.go](https://github.com/afjoseph/RAKE.Go) | 93 | Go port of the Rapid Automatic Keyword Extraction Algorithm (RAKE). |
| <b>[go-stem](https://github.com/agonopol/go-stem) | 67 | Implementation of the porter stemming algorithm. |
| <b>[go2vec](https://github.com/danieldk/go2vec) | 47 | Reader and utility functions for word2vec embeddings. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[slug](https://github.com/gosimple/slug) | 830 | URL-friendly slugify with multiple languages support. |
...
| <b>[sentences](https://github.com/neurosnap/sentences) | 323 | Sentence tokenizer:  converts text into a list of sentences. |
...
| <b>[gotext](https://github.com/leonelquinteros/gotext) | 342 | GNU gettext utilities for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-unidecode](https://github.com/mozillazg/go-unidecode) | 93 | ASCII transliterations of Unicode text. |
...
| <b>[webrtc](https://github.com/pions/webrtc) | 9.5k | A pure Go implementation of the WebRTC API. |
| <b>[quic-go](https://github.com/lucas-clemente/quic-go) | 6.9k | An implementation of the QUIC protocol in pure Go. |
| <b>[gnet](https://github.com/panjf2000/gnet) | 6.7k | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
...
| <b>[netpoll](https://github.com/cloudwego/netpoll) | 2.8k | A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance. |
...
| <b>[ftp](https://github.com/jlaffaye/ftp) | 953 | Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959). |
| <b>[mdns](https://github.com/hashicorp/mdns) | 891 | Simple mDNS (Multicast DNS) client/server library in Golang. |
| <b>[gosnmp](https://github.com/soniah/gosnmp) | 861 | Native Go library for performing SNMP actions. |
| <b>[vssh](https://github.com/yahoo/vssh) | 854 | Go library for building network and server automation over SSH protocol. |
| <b>[cidranger](https://github.com/yl2chen/cidranger) | 722 | Fast IP to CIDR lookup for Go. |
| <b>[nbio](https://github.com/lesismal/nbio) | 715 | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
| <b>[gmqtt](https://github.com/DrmagicE/gmqtt) | 684 | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| <b>[lhttp](https://github.com/fanux/lhttp) | 674 | Powerful websocket framework, build your IM server more easily. |
| <b>[peerdiscovery](https://github.com/schollz/peerdiscovery) | 548 | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| <b>[go-stun](https://github.com/ccding/go-stun) | 509 | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
| <b>[gotcp](https://github.com/gansidui/gotcp) | 493 | Go package for quickly writing tcp applications. |
| <b>[stun](https://github.com/go-rtc/stun) | 487 | Go implementation of RFC 5389 STUN protocol. |
| <b>[gopcap](https://github.com/akrennmair/gopcap) | 444 | Go wrapper for libpcap. |
| <b>[gaio](https://github.com/xtaci/gaio) | 442 | High performance async-io networking for Golang in proactor mode. |
...
| <b>[easytcp](https://github.com/DarthPestilane/easytcp) | 399 | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
| <b>[winrm](https://github.com/masterzen/winrm) | 367 | Go WinRM client to remotely execute commands on Windows machines. |
| <b>[ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 317 | Fully featured FTP server library. |
...
| <b>[dnsmonster](https://github.com/mosajjal/dnsmonster) | 196 | Passive DNS Capture/Monitoring Framework. |
...
| <b>[xtcp](https://github.com/xfxdev/xtcp) | 134 | TCP Server Framework with simultaneous full duplex communication, graceful shutdown, and custom protocol. |
| <b>[iplib](https://github.com/c-robinson/iplib) | 84 | Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html) |
...
| <b>[gldap](https://github.com/jimlambrt/gldap) | 70 | gldap provides an ldap server implementation and you provide handlers for its ldap operations. |
| <b>[packet](https://github.com/aerogo/packet) | 70 | Send packets over TCP and UDP. It can buffer messages and hot-swap connections if needed. |
| <b>[go-powerdns](https://github.com/joeig/go-powerdns) | 57 | PowerDNS API bindings for Golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[resty](https://github.com/go-resty/resty) | 6.3k | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| <b>[gentleman](https://github.com/h2non/gentleman) | 958 | Full-featured plugin-driven HTTP client library. |
| <b>[pester](https://github.com/sethgrid/pester) | 591 | Go HTTP client calls with retries, backoff, and concurrency. |
| <b>[requests](https://github.com/carlmjohnson/requests) | 358 | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| <b>[go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) | 253 | Get easily stdlib HTTP client, which does not share any state with other clients. |
| <b>[request](https://github.com/monaco-io/request) | 206 | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| <b>[gl](https://github.com/go-gl/gl) | 912 | Go bindings for OpenGL (generated via glow). |
| <b>[mathgl](https://github.com/go-gl/mathgl) | 444 | Pure Go math package specialized for 3D math, with inspiration from GLM. |
...
| <b>[go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 800 | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| <b>[go-queryset](https://github.com/jirfag/go-queryset) | 664 | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
| <b>[rel](https://github.com/go-rel/rel) | 546 | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
| <b>[Zoom](https://github.com/albrow/zoom) | 290 | Blazing-fast datastore and querying engine built on Redis. |
| <b>[go-sql](https://github.com/rushteam/gosql) | 161 | A easy ORM for mysql. |
...
| <b>[golobby/orm](https://github.com/golobby/orm) | 95 | Simple, fast, type-safe, generic orm for developer happiness. |
| <b>[go-firestorm](https://github.com/jschoedt/go-firestorm) | 34 | A simple ORM for Google/Firebase Cloud Firestore. |
...
| <b>[modgv](https://github.com/lucasepe/modgv) | 409 | Converts 'go mod graph' output into Graphviz's DOT language. |
...
| <b>[VenGO](https://github.com/DamnWidget/VenGO) | 121 | create and manage exportable isolated go virtual environments. |
...
| <b>[dasel](https://github.com/tomwright/dasel) | 3.4k | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| <b>[gojsonq](https://github.com/thedevsaddam/gojsonq) | 1.9k | A simple Go package to Query over JSON Data. |
| <b>[rql](https://github.com/a8m/rql) | 258 | Resource Query Language for REST API. |
| <b>[jsonql](https://github.com/elgs/jsonql) | 252 | JSON query expression library in Golang. |
...
| <b>[goven](https://github.com/SeldonIO/goven) | 34 | A drop-in query language for any database schema. |
...
| <b>[esc](https://github.com/mjibson/esc) | 625 | Embeds files into Go programs and provides http.FileSystem interfaces to them. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gonum](https://github.com/gonum/gonum) | 5.9k | Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more. |
...
| <b>[dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 845 | Dataframes for machine-learning and statistics (similar to pandas). |
| <b>[go-dsp](https://github.com/mjibson/go-dsp) | 778 | Digital Signal Processing for Go. |
| <b>[chart](https://github.com/vdobler/chart) | 729 | Simple Chart Plotting library for Go. Supports many graphs types. |
| <b>[goraph](https://github.com/gyuho/goraph) | 688 | Pure Go graph theory library(data structure, algorithm visualization). |
| <b>[graph](https://github.com/yourbasic/graph) | 558 | Library of basic graph algorithms. |
| <b>[orb](https://github.com/paulmach/orb) | 548 | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| <b>[ewma](https://github.com/VividCortex/ewma) | 387 | Exponentially-weighted moving averages. |
| <b>[calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 352 | Calendar heatmap in plain Go inspired by Github contribution activity. |
...
| <b>[lego](https://github.com/go-acme/lego) | 5.4k | Pure Go ACME client library and CLI tool (for use with Let's Encrypt). |
...
| <b>[Coraza](https://github.com/corazawaf/coraza) | 550 | Enterprise-ready, modsecurity and OWASP CRS compatible WAF library. |
| <b>[nacl](https://github.com/kevinburke/nacl) | 524 | Go implementation of the NaCL set of API's. |
| <b>[ssh-vault](https://github.com/ssh-vault/ssh-vault) | 350 | encrypt/decrypt using ssh keys. |
| <b>[go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 344 | Password validator based on raw cryptographic entropy values. |
| <b>[optimus-go](https://github.com/pjebs/optimus-go) | 317 | ID hashing and Obfuscation using Knuth's Algorithm. |
...
| <b>[go-yara](https://github.com/hillu/go-yara) | 264 | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
| <b>[dongle](https://github.com/golang-module/dongle) | 258 | A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption. |
...
| <b>[go-generate-password](https://github.com/m1/go-generate-password) | 43 | Password generator that can be used on the cli or as a library. |
...
| <b>[secret](https://github.com/rsjethani/secret) | 11 | Prevent your secrets from leaking into logs, std* etc. |
...
| <b>[mapstructure](https://github.com/mitchellh/mapstructure) | 5.9k | Go library for decoding generic map values into native Go structures. |
...
| <b>[csvutil](https://github.com/jszwec/csvutil) | 728 | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| <b>[colfer](https://github.com/pascaldekloe/colfer) | 667 | Code generation for the Colfer binary format. |
| <b>[cbor](https://github.com/fxamacker/cbor) | 459 | Small, safe, and easy CBOR encoding and decoding library. |
| <b>[go-capnproto](https://github.com/glycerine/go-capnproto) | 283 | Cap'n Proto library and parser for go. |
...
| <b>[structomap](https://github.com/tuvistavie/structomap) | 133 | Library to easily and dynamically generate maps from static structures. |
...
| <b>[bel](https://github.com/32leaves/bel) | 25 | Generate TypeScript interfaces from Go structs/interfaces. Useful for JSON RPC. |
...
| <b>[RoadRunner](https://github.com/spiral/roadrunner) | 6.6k | High-performance PHP application server, load-balancer and process manager. |
...
| <b>[SFTPGo](https://github.com/drakkan/sftpgo) | 4.5k | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| <b>[go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 454 | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| <b>[Euterpe](https://github.com/ironsmile/euterpe) | 408 | Self-hosted music streaming server with built-in web UI and REST API. |
| <b>[dummy](https://github.com/neotoolkit/dummy) | 153 | Run mock server based off an API contract with one command. |
...
| <b>[go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) | 57 | Simple Reverse Proxy with Caching, written in Go, using Redis. |
| <b>[cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 48 | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-streams](https://github.com/reugn/go-streams) | 979 | Go stream processing library. |
...
| <b>[stream](https://github.com/youthlin/stream) | 61 | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
| <b>[goio](https://github.com/primetalk/goio) | 37 | An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2. |
...
| <b>[jet](https://github.com/CloudyKit/jet) | 940 | Jet template engine. |
| <b>[Razor](https://github.com/sipin/gorazor) | 799 | Razor view engine for Golang. |
| <b>[maroto](https://github.com/johnfercher/maroto) | 677 | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
| <b>[fasttemplate](https://github.com/valyala/fasttemplate) | 612 | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
| <b>[ego](https://github.com/benbjohnson/ego) | 527 | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
| <b>[raymond](https://github.com/aymerick/raymond) | 481 | Complete handlebars implementation in Go. |
| <b>[goview](https://github.com/foolin/goview) | 285 | Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application. |
| <b>[Soy](https://github.com/robfig/soy) | 164 | Closure templates (aka Soy templates) for Go, following the [official spec](https://developers.google.com/closure/templates/). |
| <b>[liquid](https://github.com/osteele/liquid) | 160 | Go implementation of Shopify Liquid templates. |
...
| <b>[tbd](https://github.com/lucasepe/tbd) | 19 | A really simple way to create text templates with placeholders - exposes extra builtin Git repo metadata. |
...
| <b>[go-vcr](https://github.com/dnaeon/go-vcr) | 890 | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
| <b>[gnomock](https://github.com/orlangure/gnomock) | 857 | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| <b>[goblin](https://github.com/franela/goblin) | 852 | Mocha like testing framework fo Go. |
| <b>[testfixtures](https://github.com/go-testfixtures/testfixtures) | 816 | A helper for Rails' like test fixtures to test database applications. |
| <b>[baloo](https://github.com/h2non/baloo) | 725 | Expressive and versatile end-to-end HTTP API testing made easy. |
| <b>[go-mutesting](https://github.com/zimmski/go-mutesting) | 539 | Mutation testing for Go source code. |
| <b>[goc](https://github.com/qiniu/goc) | 537 | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| <b>[gofight](https://github.com/appleboy/gofight) | 402 | API Handler Testing for Golang Router framework. |
| <b>[embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 396 | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| <b>[testza](https://github.com/MarvinJWendt/testza) | 390 | Full-featured test framework with nice colorized output. |
| <b>[gotest.tools](https://github.com/gotestyourself/gotest.tools) | 325 | A collection of packages to augment the go testing package and support common patterns. |
| <b>[go-testdeep](https://github.com/maxatome/go-testdeep) | 309 | Extremely flexible golang deep comparison, extends the go testing package. |
...
| <b>[endly](https://github.com/viant/endly) | 211 | Declarative end to end functional testing. |
...
| <b>[dbcleaner](https://github.com/khaiql/dbcleaner) | 140 | Clean database for testing purpose, inspired by `database_cleaner` in Ruby. |
| <b>[go-hit](https://github.com/Eun/go-hit) | 116 | Hit is an http integration test framework written in golang. |
| <b>[GoSpec](https://github.com/orfjackal/gospec) | 112 | BDD-style testing framework for the Go programming language. |
| <b>[testcase](https://github.com/adamluzsi/testcase) | 95 | Idiomatic testing framework for Behavior Driven Development. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gomock](https://github.com/golang/mock) | 7.6k | Mocking framework for the Go programming language. |
| <b>[go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) | 4.5k | Mock SQL driver for testing database interactions. |
| <b>[mockery](https://github.com/vektra/mockery) | 3.7k | Tool to generate Go interfaces. |
...
| <b>[counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 695 | Tool for generating self-contained mock objects. |
| <b>[minimock](https://github.com/gojuno/minimock) | 456 | Mock generator for Go interfaces. |
| <b>[go-txdb](https://github.com/DATA-DOG/go-txdb) | 452 | Single transaction based database driver mainly for testing purposes. |
...
| <b>[go-localstack](https://github.com/elgohr/go-localstack) | 51 | Tool for using localstack in AWS testing. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[chromedp](https://github.com/knq/chromedp) | 7.8k | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| <b>[rod](https://github.com/go-rod/rod) | 2.6k | A Devtools driver to make web automation and scraping easy. |
...
| <b>[playwright-go](https://github.com/mxschmitt/playwright-go) | 852 | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| <b>[cdp](https://github.com/mafredri/cdp) | 614 | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
| <b>[ggr](https://github.com/aerokube/ggr) | 285 | a lightweight server that routes and proxies Selenium WebDriver requests to multiple Selenium hubs. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[failpoint](https://github.com/pingcap/failpoint) | 703 | An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| <b>[bytes](https://github.com/labstack/gommon/tree/master/bytes) | 450 | Formats and parses numeric byte values (10K, 2M, 3G, etc.). |
| <b>[gotabulate](https://github.com/bndr/gotabulate) | 284 | Easily pretty-print your tabular data with Go. |
...
| <b>[mxj](https://github.com/clbanning/mxj) | 523 | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
| <b>[htmlquery](https://github.com/antchfx/htmlquery) | 494 | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| <b>[html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 370 | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sh](https://github.com/mvdan/sh) | 4.9k | Shell parser and formatter. |
...
| <b>[commonregex](https://github.com/mingrammer/commonregex) | 818 | A collection of common regular expressions for Go. |
| <b>[gographviz](https://github.com/awalterschulze/gographviz) | 484 | Parses the Graphviz DOT language. |
| <b>[omniparser](https://github.com/jf-tech/omniparser) | 469 | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| <b>[go-nmea](https://github.com/adrianmo/go-nmea) | 179 | NMEA parser library for the Go language. |
| <b>[sdp](https://github.com/gortc/sdp) | 115 | SDP: Session Description Protocol [[RFC 4566](https://tools.ietf.org/html/rfc4566)]. |
| <b>[editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) | 101 | Editorconfig file parser and manipulator for Go. |
| <b>[go-vcard](https://github.com/emersion/go-vcard) | 73 | Parse and format vCard. |
| <b>[did](https://github.com/ockam-network/did) | 61 | DID (Decentralized Identifiers) Parser and Stringer in Go. |
...
| <b>[xj2go](https://github.com/stackerzzq/xj2go) | 25 | Convert xml or json to go struct. |
| <b>[codetree](https://github.com/aerogo/codetree) | 20 | Parses indented code (python, pixy, scarlet, etc.) and returns a tree structure. |
| <b>[tokenizer](https://github.com/bzick/tokenizer) | 14 | — Parse any string, slice or infinite buffer to any tokens. |
...
| <b>[go-fasttld](https://github.com/elliotwutingfeng/go-fasttld) | 7 | High performance top level domains (TLD) extraction module. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[regroup](https://github.com/oriser/regroup) | 112 | Match regex expression named groups into go struct using struct tags and automatic parsing. |
...
| <b>[xurls](https://github.com/mvdan/xurls) | 923 | Extract urls from text. |
| <b>[dataflowkit](https://github.com/slotix/dataflowkit) | 534 | Web scraping Framework to turn websites into structured data. |
| <b>[gospider](https://github.com/zhshch2002/gospider) | 167 | A simple golang spider/scraping framework,build a spider in 3 lines. migrated from [goribot](https://github.com/zhshch2002/goribot) |
| <b>[pagser](https://github.com/foolin/pagser) | 63 | Pagser is a simple, extensible, configurable parse and deserialize html page to struct based on goquery and struct tags for golang crawler. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-runewidth](https://github.com/mattn/go-runewidth) | 464 | Functions to get fixed width of the character or string. |
...
| <b>[discordgo](https://github.com/bwmarrin/discordgo) | 3.2k | Go bindings for the Discord Chat API. |
...
| <b>[githubql](https://github.com/shurcooL/githubql) | 900 | Go library for accessing the GitHub GraphQL API v4. |
| <b>[webhooks](https://github.com/go-playground/webhooks) | 735 | Webhook receiver for GitHub and Bitbucket. |
| <b>[paypal](https://github.com/logpacker/PayPal-Go-SDK) | 503 | Wrapper for PayPal payment API. |
| <b>[geo-golang](https://github.com/codingsince1985/geo-golang) | 435 | Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](https://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](https://opencagedata.com/api), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs. |
| <b>[twitter-scraper](https://github.com/n0madic/twitter-scraper) | 237 | Scrape the Twitter Frontend API without authentication and limits. |
...
| <b>[lark](https://github.com/chyroc/lark) | 185 | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| <b>[wit-go](https://github.com/wit-ai/wit-go) | 121 | Go client for wit.ai HTTP API. |
...
| <b>[go-lark](https://github.com/go-lark/lark) | 101 | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
...
| <b>[go-unsplash](https://github.com/hbagdi/go-unsplash) | 64 | Go client library for the [Unsplash.com](https://unsplash.com) API. |
...
| <b>[amazon-product-advertising-api](https://github.com/ngs/go-amazon-product-advertising-api) | 52 | Go Client Library for [Amazon Product Advertising API](https://affiliate-program.amazon.com/gp/advertising/api/detail/main.html). |
...
| <b>[uptimerobot](https://github.com/bitfield/uptimerobot) | 47 | Go wrapper and command-line client for the Uptime Robot v2 API. |
...
| <b>[airtable](https://github.com/mehanizm/airtable) | 40 | Go client library for the [Airtable API](https://airtable.com/api). |
...
| <b>[google-play-scraper](https://github.com/n0madic/google-play-scraper) | 35 | Get data from Google Play Store. |
...
| <b>[lastpass-go](https://github.com/ansd/lastpass-go) | 28 | Go client library for the [LastPass](https://www.lastpass.com/) API. |
...
| <b>[lo](https://github.com/samber/lo) | 6.6k | A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...) |
...
| <b>[EaseProbe](https://github.com/megaease/easeprobe) | 885 | A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification. |
| <b>[hostctl](https://github.com/guumaster/hostctl) | 766 | A CLI tool to manage /etc/hosts with easy commands. |
| <b>[mimetype](https://github.com/gabriel-vasile/mimetype) | 764 | Package for MIME type detection based on magic numbers. |
| <b>[immortal](https://github.com/immortal/immortal) | 740 | \*nix cross-platform (OS agnostic) supervisor. |
| <b>[circuit](https://github.com/cep21/circuit) | 652 | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
| <b>[scany](https://github.com/georgysavva/scany) | 599 | Library for scanning data from a database into Go structs and more. |
| <b>[htcat](https://github.com/htcat/htcat) | 548 | Parallel and Pipelined HTTP GET Utility. |
| <b>[ergo](https://github.com/cristianoliveira/ergo) | 528 | The management of multiple local services running over different ports made easy. |
| <b>[delve](https://github.com/derekparker/delve) | 507 | Go debugger. |
| <b>[koazee](https://github.com/wesovilabs/koazee) | 500 | Library inspired in Lazy evaluation and functional programming that takes the hassle out of working with arrays. |
| <b>[godaemon](https://github.com/VividCortex/godaemon) | 487 | Utility to write daemons. |
| <b>[go-dry](https://github.com/ungerik/go-dry) | 477 | DRY (don't repeat yourself) package for Go. |
| <b>[gopencils](https://github.com/bndr/gopencils) | 437 | Small and simple package to easily consume REST APIs. |
| <b>[request](https://github.com/mozillazg/request) | 415 | Go HTTP Requests for Humans™. |
| <b>[gubrak](https://github.com/novalagung/gubrak) | 407 | Golang utility library with syntactic sugar. It's like lodash, but for golang. |
| <b>[clockwork](https://github.com/jonboulle/clockwork) | 397 | A simple fake clock for golang. |
| <b>[Deepcopier](https://github.com/ulule/deepcopier) | 389 | Simple struct copying for Go. |
| <b>[go-rate](https://github.com/beefsack/go-rate) | 360 | Timed rate limiter for Go. |
...
| <b>[changie](https://github.com/miniscruff/changie) | 293 | Automated changelog tool for preparing releases with lots of customization options. |
| <b>[mani](https://github.com/alajmo/mani) | 281 | CLI tool to help you manage multiple repositories. |
| <b>[scan](https://github.com/blockloop/scan) | 275 | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
| <b>[serve](https://github.com/syntaqx/serve) | 271 | A static http server anywhere you need. |
...
| <b>[clipboard](https://github.com/golang-design/clipboard) | 231 | 📋 cross-platform clipboard package in Go. |
...
| <b>[gotenv](https://github.com/subosito/gotenv) | 226 | Load environment variables from `.env` or any `io.Reader` in Go. |
| <b>[grofer](https://github.com/pesos/grofer) | 210 | A system and resource monitoring tool written in Golang! |
| <b>[wifiqr](https://github.com/reugn/wifiqr) | 206 | Wi-Fi QR Code Generator. |
| <b>[pattern-match](https://github.com/alexpantyukhin/go-pattern-match) | 182 | Pattern matching libray. |
...
| <b>[rospo](https://github.com/ferama/rospo) | 173 | Simple and reliable ssh tunnels with embedded ssh server in Golang. |
| <b>[countries](https://github.com/biter777/countries) | 167 | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
| <b>[moldova](https://github.com/StabbyCutyou/moldova) | 162 | Utility for generating random data based on an input template. |
| <b>[rerun](https://github.com/ivpusic/rerun) | 162 | Recompiling and rerunning go apps when source changes. |
...
| <b>[cryptgo](https://github.com/Gituser143/cryptgo) | 113 | Crytpgo is a TUI based application written purely in Go to monitor and observe cryptocurrency prices in real time! |
| <b>[sorty](https://github.com/jfcg/sorty) | 105 | Fast Concurrent / Parallel Sorting. |
| <b>[mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 99 | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
| <b>[cmd](https://github.com/SimonBaeumer/cmd) | 98 | Library for executing shell commands on osx, windows and linux. |
| <b>[limiters](https://github.com/mennanov/limiters) | 97 | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
...
| <b>[go-health](https://github.com/Talento90/go-health) | 89 | Health package simplifies the way you add health check to your services. |
| <b>[filter](https://github.com/gookit/filter) | 87 | provide filtering, sanitizing, and conversion of Go data. |
| <b>[goval](https://github.com/maja42/goval) | 80 | Evaluate arbitrary expressions in Go. |
...
| <b>[go-lock](https://github.com/viney-shih/go-lock) | 68 | go-lock is a lock library implementing read-write mutex and read-write trylock without starvation. |
...
| <b>[pgo](https://github.com/arthurkushman/pgo) | 66 | Convenient functions for PHP community. |
...
| <b>[backscanner](https://github.com/icza/backscanner) | 36 | A scanner similar to bufio.Scanner, but it reads and returns lines in reverse order, starting at a given position and going backward. |
...
| <b>[mimesniffer](https://github.com/aofei/mimesniffer) | 22 | A MIME type sniffer for Go. |
...
| <b>[wuid](https://github.com/edwingeng/wuid) | 466 | An extremely fast unique number generator, 10-135 times faster than UUID. |
| <b>[sno](https://github.com/muyo/sno) | 67 | Compact, sortable and fast unique IDs with embedded metadata. |
...
| <b>[validate](https://github.com/gookit/validate) | 738 | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
| <b>[checkdigit](https://github.com/osamingo/checkdigit) | 91 | Provide check digit algorithms (Luhn, Verhoeff, Damm) and calculators (ISBN, EAN, JAN, UPC, etc.). |
| <b>[terraform-validator](https://github.com/thazelart/terraform-validator) | 78 | A norms and conventions validator for Terraform. |
| <b>[validate](https://github.com/gobuffalo/validate) | 68 | This package provides a framework for writing validations for Go applications. |
| <b>[jio](https://github.com/faceair/jio) | 67 | jio is a json schema validator similar to [joi](https://github.com/hapijs/joi). |
| <b>[gody](https://github.com/guiferpa/gody) | 60 | :balloon: A lightweight struct validator for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-git](https://github.com/go-git/go-git) | 3.6k | highly extensible Git implementation in pure Go. |
...
| <b>[githooks](https://github.com/gabyx/githooks) | 45 | Per-repo and shared Git hooks with version control and auto update. |
| <b>[froggit-go](https://github.com/jfrog/froggit-go) | 18 | Froggit-Go is a Go library, allowing to perform actions on VCS providers. |
...
| <b>[m3u8](https://github.com/grafov/m3u8) | 938 | Parser and generator library of M3U8 playlists for Apple HLS. |
| <b>[gmf](https://github.com/3d0c/gmf) | 772 | Go bindings for FFmpeg av\* libraries. |
| <b>[go-astits](https://github.com/asticode/go-astits) | 425 | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
...
| <b>[libvlc-go](https://github.com/adrg/libvlc-go) | 307 | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
| <b>[gortsplib](https://github.com/aler9/gortsplib) | 273 | Pure Go RTSP server and client library. |
| <b>[gst](https://github.com/ziutek/gst) | 164 | Go bindings for GStreamer. |
| <b>[go-m3u8](https://github.com/quangngotan95/go-m3u8) | 96 | Parser and generator library for Apple m3u8 playlists. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Gin](https://github.com/gin-gonic/gin) | 61.0k | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
...
| <b>[Gearbox](https://github.com/abahmed/gearbox) | 648 | A web framework written in Go with a focus on high performance and memory optimization. |
| <b>[Aero](https://github.com/aerogo/aero) | 477 | High-performance web framework for Go, reaches top scores in Lighthouse. |
...
| <b>[Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 332 | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| <b>[Gondola](https://github.com/rainycape/gondola) | 309 | The web framework for writing faster sites, faster. |
| <b>[Flamingo](https://github.com/i-love-flamingo/flamingo) | 304 | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| <b>[WebGo](https://github.com/bnkamalesh/webgo) | 248 | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
| <b>[rk-boot](https://github.com/rookie-ninja/rk-boot) | 244 | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
| <b>[Ginrpc](https://github.com/xxjwxc/ginrpc) | 227 | Gin parameter automatic binding tool,gin rpc tools. |
...
| <b>[appy](https://github.com/appist/appy) | 123 | An opinionated productive web framework that helps scaling business easier. |
| <b>[Huma](https://github.com/danielgtaylor/huma/) | 113 | Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI. |
| <b>[Microservice](https://github.com/claygod/microservice) | 98 | The framework for the creation of microservices, written in Golang. |
...
| <b>[rux](https://github.com/gookit/rux) | 80 | Simple and fast web framework for build golang HTTP applications. |
...
| <b>[go-server-timing](https://github.com/mitchellh/go-server-timing) | 838 | Add/parse Server-Timing header. |
| <b>[go-fault](https://github.com/github/go-fault) | 439 | Fault injection middleware for Go. |
| <b>[ln-paywall](https://github.com/philippgille/ln-paywall) | 125 | Go middleware for monetizing APIs on a per-request basis with the Lightning Network (Bitcoin). |
...
| <b>[rk-gin](https://github.com/rookie-ninja/rk-gin) | 32 | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
...
| <b>[stats](https://github.com/thoas/stats) | 585 | Go middleware that stores various information about your web application. |
...
| <b>[Goji](https://github.com/goji/goji) | 903 | Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`. |
| <b>[fasthttprouter](https://github.com/buaazp/fasthttprouter) | 867 | High performance router forked from `httprouter`. The first router fit for `fasthttp`. |
| <b>[httptreemux](https://github.com/dimfeld/httptreemux) | 548 | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
| <b>[xujiajun/gorouter](https://github.com/xujiajun/gorouter) | 525 | A simple and fast HTTP router for Go. |
| <b>[ozzo-routing](https://github.com/go-ozzo/ozzo-routing) | 439 | An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs. |
...
| <b>[pure](https://github.com/go-playground/pure) | 126 | Is a lightweight HTTP router that sticks to the std "net/http" implementation. |
...
| <b>[dom](https://github.com/dennwc/dom) | 456 | DOM library. |
| <b>[go-canvas](https://github.com/markfarnan/go-canvas) | 168 | Library to use HTML5 Canvas, with all drawing within go code. |
| <b>[wasmbrowsertest](https://github.com/agnivade/wasmbrowsertest) | 125 | Run Go WASM tests in your browser. |
| <b>[webapi](https://github.com/gowebapi/webapi) | 116 | Bindings for DOM and HTML generated from WebIDL. |
| <b>[vert](https://github.com/norunners/vert) | 73 | Interop between Go and JS values. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-ole](https://github.com/go-ole/go-ole) | 880 | Win32 OLE implementation for golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[zek](https://github.com/miku/zek) | 570 | Generate a Go struct from XML. |
| <b>[xpath](https://github.com/antchfx/xpath) | 492 | XPath package for Go. |
| <b>[xquery](https://github.com/antchfx/xquery) | 155 | XQuery lets you extract data from HTML/XML documents using XPath expression. |
| <b>[xml2map](https://github.com/sbabiv/xml2map) | 41 | XML to MAP converter written Golang. |
...
| <b>[in-toto](https://github.com/in-toto/in-toto-golang) | 59 | Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation. |
| <b>[Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) | 37 | Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication. |
...
| <b>[GoPlantUML](https://github.com/jfeliu007/goplantuml) | 997 | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
| <b>[php-parser](https://github.com/z7zmey/php-parser) | 879 | A Parser for PHP written in Go. |
| <b>[goast-viewer](https://github.com/yuroyoro/goast-viewer) | 625 | Web based Golang AST visualizer. |
| <b>[go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 604 | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
| <b>[go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 588 | An easy way to find outdated dependencies of your Go projects. |
| <b>[golines](https://github.com/segmentio/golines) | 424 | Formatter that automatically shortens long lines in Go code. |
| <b>[todocheck](https://github.com/preslavmihaylov/todocheck) | 386 | Static code analyser which links TODO comments in code with issues in your issue tracker. |
| <b>[unconvert](https://github.com/mdempsky/unconvert) | 319 | Remove unnecessary type conversions from Go source. |
...
| <b>[ChainJacking](https://github.com/Checkmarx/chainjacking) | 26 | Find which of your Go lang direct GitHub dependencies is susceptible to ChainJacking attack. |
...
| <b>[vscode-go](https://github.com/golang/vscode-go) | 2.8k | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| <b>[coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) | 467 | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| <b>[Watch](https://github.com/eaburns/Watch) | 192 | Runs a command in an acme win on file changes. |
| <b>[goimports-reviser](https://github.com/incu6us/goimports-reviser) | 144 | Formatting tool for imports. |
...
| <b>[xgen](https://github.com/xuri/xgen) | 166 | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| <b>[gocontracts](https://github.com/Parquery/gocontracts) | 84 | brings design-by-contract to Go by synchronizing the code with the documentation. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-swagger](https://github.com/go-swagger/go-swagger) | 7.8k | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
...
| <b>[go-callvis](https://github.com/TrueFurby/go-callvis) | 4.2k | Visualize call graph of your Go program using dot format. |
| <b>[depth](https://github.com/KyleBanks/depth) | 762 | Visualize dependency trees of any package by analyzing imports. |
| <b>[richgo](https://github.com/kyoh86/richgo) | 715 | Enrich `go test` outputs with text decorations. |
| <b>[rts](https://github.com/galeone/rts) | 231 | RTS: response to struct. Generates Go structs from server responses. |
...
| <b>[roumon](https://github.com/becheran/roumon) | 83 | Monitor current state of all active goroutines via a command line interface. |
| <b>[go-james](https://github.com/pieterclaerhout/go-james) | 51 | Go project skeleton creator, builds and tests your projects without the manual setup. |
...
| <b>[gotestdox](https://github.com/bitfield/gotestdox) | 9 | Show Go test results as readable sentences. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[kubernetes](https://github.com/kubernetes/kubernetes) | 90.0k | Container Cluster Manager from Google. |
...
| <b>[webhook](https://github.com/adnanh/webhook) | 7.9k | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| <b>[GVM](https://github.com/moovweb/gvm) | 7.5k | GVM provides an interface to manage Go versions. |
...
| <b>[Ddosify](https://github.com/ddosify/ddosify) | 4.5k | High-performance load testing tool, written in Golang. |
...
| <b>[go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 996 | Enable your Go applications to self update. |
| <b>[ghorg](https://github.com/gabrie30/ghorg) | 950 | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
| <b>[skm](https://github.com/TimothyYe/skm) | 786 | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| <b>[Scaleway-cli](https://github.com/scaleway/scaleway-cli) | 755 | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| <b>[uTask](https://github.com/ovh/utask) | 672 | Automation engine that models and executes business processes declared in yaml. |
| <b>[kwatch](https://github.com/abahmed/kwatch) | 629 | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
| <b>[cassowary](https://github.com/rogerwelin/cassowary) | 598 | Modern cross-platform HTTP load-testing tool written in Go. |
| <b>[kool](https://github.com/kool-dev/kool) | 596 | Command line tool for managing Docker environments as an easy way. |
| <b>[aurora](https://github.com/xuri/aurora) | 565 | Cross-platform web-based Beanstalkd queue server console. |
| <b>[govvv](https://github.com/ahmetalpbalkan/govvv) | 525 | “go build” wrapper to easily add version information into Go binaries. |
| <b>[Pewpew](https://github.com/bengadbois/pewpew) | 341 | Flexible HTTP command line stress tester. |
...
| <b>[trubka](https://github.com/xitonix/trubka) | 319 | A CLI tool to manage and troubleshoot Apache Kafka clusters with the ability of generically publishing/consuming protocol buffer and plain text events to/from Kafka. |
| <b>[Mora](https://github.com/emicklei/mora) | 302 | REST server for accessing MongoDB documents and meta data. |
| <b>[lstags](https://github.com/ivanilves/lstags) | 288 | Tool and API to sync Docker images across different registries. |
| <b>[Balerter](https://github.com/balerter/balerter) | 267 | A self-hosted script-based alerting manager. |
| <b>[manssh](https://github.com/xwjdsh/manssh) | 267 | manssh is a command line tool for managing your ssh alias config easily. |
| <b>[dogo](https://github.com/liudng/dogo) | 248 | Monitoring changes in the source file and automatically compile and run (restart). |
| <b>[easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 248 | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
| <b>[godbg](https://github.com/sirnewton01/godbg) | 225 | Web-based gdb front-end application. |
| <b>[terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 207 | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| <b>[kcli](https://github.com/cswank/kcli) | 176 | Command line tool for inspecting kafka topics/partitions/messages. |
...
| <b>[winrm-cli](https://github.com/masterzen/winrm-cli) | 142 | Cli tool to remotely execute commands on Windows machines. |
| <b>[Dockerfile-Generator](https://github.com/ozankasikci/dockerfile-generator) | 131 | A go library and an executable that produces valid Dockerfiles using various input channels. |
| <b>[s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 109 | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
| <b>[drone-scp](https://github.com/appleboy/drone-scp) | 106 | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
...
| <b>[Mantil](https://github.com/mantil-io/mantil) | 73 | Go specific framework for building serverless applications on AWS that enables you to focus on pure Go code while Mantil takes care of the infrastructure. |
...
| <b>[docker-go-mingw](https://github.com/x1unix/docker-go-mingw) | 31 | Docker image for building Go binaries for Windows with MinGW toolchain. |
...
| <b>[toxiproxy](https://github.com/shopify/toxiproxy) | 8.3k | Proxy to simulate network and system conditions for automated tests. |
...
| <b>[scc](https://github.com/boyter/scc) | 3.6k | Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates. |
...
| <b>[shell2http](https://github.com/msoap/shell2http) | 950 | Executing shell commands via http server (for prototyping or remote control). |
| <b>[vFlow](https://github.com/VerizonDigital/vflow) | 903 | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
| <b>[Go Package Store](https://github.com/shurcooL/Go-Package-Store) | 885 | App that displays updates for the Go packages in your GOPATH. |
| <b>[peg](https://github.com/pointlander/peg) | 856 | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
...
| <b>[Gebug](https://github.com/moshebe/gebug) | 577 | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
...
| <b>[go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 450 | Video streaming torrent client. |
| <b>[ipe](https://github.com/dimiro1/ipe) | 354 | Open source Pusher server implementation compatible with Pusher client libraries written in GO. |
| <b>[ide](https://github.com/thestrukture/ide) | 333 | Browser accessible IDE. Designed for Go with Go. |
| <b>[woke](https://github.com/get-woke/woke) | 331 | Detect non-inclusive language in your source code. |
...
| <b>[Gokapi](https://github.com/Forceu/gokapi) | 312 | Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload. |
...
| <b>[Cherry](https://github.com/rafael-santiago/cherry) | 280 | Tiny webchat server in Go. |
| <b>[Neo-cowsay](https://github.com/Code-Hex/Neo-cowsay) | 212 | 🐮 cowsay is reborn. for a New Era. |
| <b>[tcpdog](https://github.com/mehrdadrad/tcpdog) | 192 | eBPF based TCP observability. |
| <b>[joincap](https://github.com/assafmo/joincap) | 174 | Command-line utility for merging multiple pcap files together. |
| <b>[Orbit](https://github.com/gulien/orbit) | 168 | A simple tool for running commands and generating files from templates. |
| <b>[vaku](https://github.com/lingrino/vaku) | 136 | CLI & API for folder-based functions in Vault like copy, move, and search. |
| <b>[stew](https://github.com/marwanhawari/stew) | 96 | An independent package manager for compiled binaries. |
...
| <b>[crawley](https://github.com/s0rg/crawley) | 61 | Web scraper/crawler for cli. |
...
| <b>[gopherize.me](https://github.com/matryer/gopherize.me) | 581 | Gopherize yourself. |
| <b>[gopher-stickers](https://github.com/tenntenn/gopher-stickers) | 533 | gopher stickers |
...
| <b>[Go-gopher-Vector](https://github.com/keygx/Go-gopher-Vector) | 53 | Go gopher Vector Data [.ai, .svg]. |
...
| <b>[Trybe](https://github.com/betrybe/playbook-go/blob/main/README_EN.md) | 307 | Playbook da linguagem Go |
...
| <b>[go-clean-template](https://github.com/evrone/go-clean-template) | 3.1k | Clean Architecture template for Golang services. |
...
| <b>[goapp](https://github.com/bnkamalesh/goapp) | 478 | An opinionated guideline to structure & develop a Go web application/service. |
| <b>[Design Patterns in Go](https://github.com/shubhamzanwar/design-patterns) | 80 | Collection of programming design patterns implemented in Go. |
