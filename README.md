...
| <b>[PortAudio](https://github.com/gordonklaus/portaudio) | 529 | Go bindings for the PortAudio audio I/O library. |
| <b>[music-theory](https://github.com/go-music-theory/music-theory) | 408 | Music theory models in Go. |
| <b>[id3v2](https://github.com/bogem/id3v2) | 262 | ID3 decoding and encoding library for Go. |
| <b>[GoAudio](https://github.com/DylanMeeus/GoAudio) | 249 | Native Go Audio Processing Library. |
| <b>[flac](https://github.com/mewkiz/flac) | 217 | Native Go FLAC encoder/decoder with support for FLAC streams. |
| <b>[malgo](https://github.com/gen2brain/malgo) | 193 | Mini audio library. |
| <b>[gaad](https://github.com/Comcast/gaad) | 104 | Native Go AAC bitstream parser. |
| <b>[minimp3](https://github.com/tosone/minimp3) | 86 | Lightweight MP3 decoder library. |
| <b>[gosamplerate](https://github.com/dh1tw/gosamplerate) | 21 | libsamplerate bindings for go. |
...
| <b>[paseto](https://github.com/o1egl/paseto) | 626 | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
| <b>[jwt](https://github.com/cristalhq/jwt) | 563 | Safe, simple and fast JSON Web Tokens for Go. |
| <b>[permissions2](https://github.com/xyproto/permissions2) | 464 | Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. |
| <b>[go-guardian](https://github.com/shaj13/go-guardian) | 396 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
| <b>[jwt](https://github.com/pascaldekloe/jwt) | 295 | Lightweight JSON Web Token (JWT) library. |
...
| <b>[jwt-auth](https://github.com/adam-hanna/jwt-auth) | 220 | JWT middleware for Golang http servers with many configuration options. |
...
| <b>[session](https://github.com/icza/session) | 108 | Go session management for web servers (including support for Google App Engine - GAE). |
| <b>[sjwt](https://github.com/brianvoe/sjwt) | 103 | Simple jwt generator and parser. |
| <b>[rbac](https://github.com/zpatrick/rbac) | 101 | Minimalistic RBAC package for Go applications. |
| <b>[sessions](https://github.com/adam-hanna/sessions) | 67 | Dead simple, highly performant, highly customizable sessions service for go http servers. |
...
| <b>[scope](https://github.com/SonicRoshan/scope) | 23 | Easily Manage OAuth2 Scopes In Go. |
...
| <b>[solana-go](https://github.com/gagliardetto/solana-go) | 362 | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
| <b>[gossamer](https://github.com/ChainSafe/gossamer) | 351 | A Go implementation of the Polkadot Host. |
...
| <b>[Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) | 826 | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| <b>[go-chat-bot](https://github.com/go-chat-bot/bot) | 759 | IRC, Slack & Telegram bot written in Go. |
| <b>[slacker](https://github.com/shomali11/slacker) | 687 | Easy to use framework to create Slack bots. |
| <b>[tbot](https://github.com/yanzay/tbot) | 328 | Telegram bot server with API similar to net/http. |
| <b>[wayback](https://github.com/wabarc/wayback) | 314 | A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages. |
| <b>[go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 258 | Library to write bots for twitch.tv chat |
| <b>[go-sarah](https://github.com/oklahomer/go-sarah) | 247 | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
| <b>[echotron](https://github.com/NicoNex/echotron) | 185 | An elegant and concurrent library for Telegram Bots in Go. |
...
| <b>[go-tgbot](https://github.com/olebedev/go-tgbot) | 114 | Pure Golang Telegram Bot API wrapper, generated from swagger file, session-based router and middleware. |
| <b>[slack-bot](https://github.com/innogames/slack-bot) | 112 | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
| <b>[telego](https://github.com/mymmrac/telego) | 95 | Telegram Bot API library for Golang with full one-to-one API implementation. |
| <b>[larry](https://github.com/ezeoleaf/larry) | 78 | Larry 🐦 is a really simple Twitter bot generator that tweets random repositories from Github built in Go. |
...
| <b>[govkbot](https://github.com/nikepan/govkbot) | 40 | Simple Go [VK](https://vk.com) bot library. |
...
| <b>[taskctl](https://github.com/taskctl/taskctl) | 212 | Concurrent task runner. |
| <b>[1build](https://github.com/gopinath-langote/1build) | 180 | Command line tool to frictionlessly manage project-specific commands. |
...
| <b>[anko](https://github.com/GuilhermeCaruso/anko) | 27 | Simple application watcher for multiple programming languages. |
...
| <b>[uitable](https://github.com/gosuri/uitable) | 654 | Library to improve readability in terminal apps using tabular data. |
| <b>[go-isatty](https://github.com/mattn/go-isatty) | 641 | isatty for golang. |
| <b>[go-colorable](https://github.com/mattn/go-colorable) | 637 | Colorable writer for windows. |
| <b>[gommon/color](https://github.com/labstack/gommon/tree/master/color) | 463 | Style terminal text. |
| <b>[chalk](https://github.com/ttacon/chalk) | 409 | Intuitive package for prettifying terminal/console output. |
| <b>[simpletable](https://github.com/alexeyco/simpletable) | 382 | Simple tables in terminal with Go. |
| <b>[yacspin](https://github.com/theckman/yacspin) | 363 | Yet Another CLi Spinner package, for working with terminal spinners. |
| <b>[tabby](https://github.com/cheynewallace/tabby) | 320 | A tiny library for super simple Golang tables. |
| <b>[box-cli-maker](https://github.com/Delta456/box-cli-maker) | 234 | Make Highly Customized Boxes for your CLI. |
| <b>[go-colortext](https://github.com/daviddengcn/go-colortext) | 213 | Go library for color output in terminals. |
| <b>[cfmt](https://github.com/mingrammer/cfmt) | 87 | Contextual fmt inspired by bootstrap color classes. |
...
| <b>[cfmt](https://github.com/i582/cfmt) | 48 | Simple and convenient formatted stylized output fully compatible with fmt library. |
| <b>[ctc](https://github.com/wzshiming/ctc) | 40 | The non-invasive cross-platform terminal color library does not need to modify the Print method. |
| <b>[table](https://github.com/tomlazar/table) | 33 | Small library for terminal color based tables . |
...
| <b>[crab-config-files-templating](https://github.com/alfiankan/crab-config-files-templating) | 4 | Dynamic configuration file templating tool for kubernetes manifest or general configuration files. |
...
| <b>[liner](https://github.com/peterh/liner) | 921 | Go readline-like library for command-line interfaces. |
| <b>[complete](https://github.com/posener/complete) | 859 | Write bash completions in Go + Go command bash completion. |
| <b>[mow.cli](https://github.com/jawher/mow.cli) | 829 | Go library for building CLI applications with sophisticated flag and argument parsing and validation. |
| <b>[flaggy](https://github.com/integrii/flaggy) | 809 | A robust and idiomatic flags package with excellent subcommand support. |
| <b>[cli](https://github.com/mkideal/cli) | 669 | Feature-rich and easy to use command-line package based on golang struct tags. |
| <b>[argparse](https://github.com/akamensky/argparse) | 455 | Command line argument parser inspired by Python's argparse module. |
| <b>[climax](https://github.com/tucnak/climax) | 199 | Alternative CLI with "human face", in spirit of Go command. |
| <b>[hiboot cli](https://github.com/hidevopsio/hiboot/tree/master/pkg/app/cli) | 177 | cli application framework with auto configuration and dependency injection. |
| <b>[wmenu](https://github.com/dixonwille/wmenu) | 173 | Easy to use menu structure for cli applications that prompts users to make choices. |
| <b>[commandeer](https://github.com/jaffee/commandeer) | 159 | Dev-friendly CLI apps: sets up flags, defaults, and usage based on struct fields and tags. |
...
| <b>[flag](https://github.com/cosiner/flag) | 122 | Simple but powerful command line option parsing library for Go supporting subcommand. |
| <b>[clîr](https://github.com/leaanthony/clir) | 121 | A Simple and Clear CLI library. Dependency free. |
| <b>[job](https://github.com/liujianping/job) | 119 | JOB, make your short-term command as a long-term job. |
| <b>[ukautz/clif](https://github.com/ukautz/clif) | 117 | Small command line interface framework. |
| <b>[cli](https://github.com/teris-io/cli) | 115 | Simple and complete API for building command line interfaces in Go. |
| <b>[cmdr](https://github.com/hedzr/cmdr) | 112 | A POSIX/GNU style, getopt-like command-line UI Go library. |
| <b>[env](https://github.com/codingconcepts/env) | 95 | Tag-based environment configuration for structs. |
| <b>[carapace-bin](https://github.com/rsteube/carapace-bin) | 78 | Multi-shell multi-command argument completer. |
| <b>[gocmd](https://github.com/devfacet/gocmd) | 59 | Go library for building command line applications. |
| <b>[wlog](https://github.com/dixonwille/wlog) | 58 | Simple logging interface that supports cross-platform color and concurrency. |
| <b>[acmd](https://github.com/cristalhq/acmd) | 54 | Simple, useful and opinionated CLI package in Go. |
| <b>[carapace](https://github.com/rsteube/carapace) | 48 | Command argument completion generator for spf13/cobra. |
| <b>[strumt](https://github.com/antham/strumt) | 48 | Library to create prompt chain. |
| <b>[go-getoptions](https://github.com/DavidGamba/go-getoptions) | 45 | Go option parser inspired on the flexibility of Perl’s GetOpt::Long. |
| <b>[flagvar](https://github.com/sgreben/flagvar) | 40 | A collection of flag argument types for Go's standard `flag` package. |
| <b>[argv](https://github.com/cosiner/argv) | 34 | Go library to split command line string as arguments array using the bash syntax. |
...
| <b>[command-chain](https://github.com/rainu/go-command-chain) | 28 | A go library for configure and run command chains - such like pipelining in unix shells. |
...
| <b>[cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 728 | Minimalistic configuration reader (from files, ENV, and wherever you want). |
| <b>[konfig](https://github.com/lalamove/konfig) | 630 | Composable, observable and performant config handling for Go for the distributed processing era. |
| <b>[confita](https://github.com/heetch/confita) | 453 | Load configuration in cascade from multiple backends into a struct. |
| <b>[gookit/config](https://github.com/gookit/config) | 396 | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| <b>[aconfig](https://github.com/cristalhq/aconfig) | 393 | Simple, useful and opinionated config loader. |
| <b>[config](https://github.com/JeremyLoy/config) | 317 | Cloud native application configuration. Bind ENV to structs in only two lines. |
| <b>[GoLobby/Config](https://github.com/golobby/config) | 292 | GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language. |
| <b>[hjson](https://github.com/hjson/hjson-go) | 278 | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
| <b>[store](https://github.com/tucnak/store) | 262 | Lightweight configuration manager for Go. |
| <b>[xdg](https://github.com/adrg/xdg) | 261 | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
| <b>[config](https://github.com/olebedev/config) | 253 | JSON or YAML configuration wrapper with environment variables and flags parsing. |
| <b>[fig](https://github.com/kkyr/fig) | 228 | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
| <b>[envconfig](https://github.com/vrischmann/envconfig) | 225 | Read your configuration from environment variables. |
...
| <b>[harvester](https://github.com/beatlabs/harvester) | 114 | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
| <b>[onion](https://github.com/goraz/onion) | 108 | Layer based configuration for Go, Supports JSON, TOML, YAML, properties, etcd, env, and encryption using PGP. |
...
| <b>[configuration](https://github.com/BoRuDar/configuration) | 79 | Library for initializing configuration structs from env variables, files, flags and 'default' tag. |
| <b>[xdg](https://github.com/OpenPeeDeeP/xdg) | 70 | Cross platform package that follows the [XDG Standard](https://standards.freedesktop.org/basedir-spec/basedir-spec-latest.html). |
...
| <b>[uConfig](https://github.com/omeid/uconfig) | 51 | Lightweight, zero-dependency, and extendable configuration management. |
...
| <b>[gone/jconf](https://github.com/One-com/gone/tree/master/jconf) | 41 | Modular JSON configuration. Keep you config structs along with the code they configure and delegate parsing to submodules without sacrificing full config serialization. |
...
| <b>[ingo](https://github.com/schachmat/ingo) | 35 | Flags persisted in an ini-like config file. |
...
| <b>[config](https://github.com/num30/config) | 25 | configure you app using file, environment variables, or flags in two lines of code |
...
| <b>[nfigure](https://github.com/muir/nfigure) | 2 | Per-library struct-tag based configuration from command lines (Posix & Go-style); environment, JSON, YAML |
...
| <b>[goveralls](https://github.com/mattn/goveralls) | 739 | Go integration for Coveralls.io continuous code coverage tracking system. |
| <b>[gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 311 | go test output for humans. |
...
| <b>[roveralls](https://github.com/LawrenceWoodman/roveralls) | 18 | Recursive coverage testing tool. |
| <b>[go-fuzz-action](https://github.com/jidicula/go-fuzz-action) | 3 | Use Go 1.18's built-in fuzz testing in GitHub Actions. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gcss](https://github.com/yosssi/gcss) | 462 | Pure Go CSS Preprocessor. |
| <b>[go-libsass](https://github.com/wellington/go-libsass) | 189 | Go wrapper to the 100% Sass compatible libsass project. |
...
| <b>[binpacker](https://github.com/zhuangsirui/binpacker) | 192 | Binary packer and unpacker helps user build custom binary stream. |
| <b>[bit](https://github.com/yourbasic/bit) | 127 | Golang set data structure with bonus bit-twiddling functions. |
| <b>[crunch](https://github.com/superwhiskers/crunch) | 60 | Go package implementing buffers for handling various datatypes easily. |
| <b>[go-ef](https://github.com/amallia/go-ef) | 23 | A Go implementation of the Elias-Fano encoding. |
| <b>[bingo](https://github.com/iancmcc/bingo) | 12 | Fast, zero-allocation, lexicographical-order-preserving packing of native types to bytes. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[bitset](https://github.com/bits-and-blooms/bitset) | 972 | Go package implementing bitsets. |
| <b>[bitmap](https://github.com/kelindar/bitmap) | 165 | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| <b>[cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 926 | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
| <b>[cuckoo-filter](https://github.com/linvon/cuckoo-filter) | 227 | Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper is available. |
...
| <b>[gostl](https://github.com/liyue201/gostl) | 712 | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| <b>[algorithms](https://github.com/shady831213/algorithms) | 667 | Algorithms and data structures.CLRS study. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[iter](https://github.com/disksing/iter) | 164 | Go implementation of C++ STL iterators and algorithms. |
| <b>[goterator](https://github.com/yaa110/goterator) | 10 | Iterator implementation to provide map and reduce functionalities. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[cmap](https://github.com/lrita/cmap) | 35 | a thread-safe concurrent map for go, support using `interface{}` as key and auto scale up shards. |
| <b>[dict](https://github.com/srfrog/dict) | 29 | Python-like dictionaries (dict) for Go. |
| <b>[goradd/maps](https://github.com/goradd/maps) | 11 | Go 1.18+ generic map interface for maps; safe maps; ordered maps; ordered, safe maps; etc. |
...
| <b>[hyperloglog](https://github.com/axiomhq/hyperloglog) | 797 | HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |
...
| <b>[conjungo](https://github.com/InVisionApp/conjungo) | 107 | A small, powerful and flexible merge library. |
| <b>[go-rampart](https://github.com/francesconi/go-rampart) | 82 | Determine how intervals relate to each other. |
...
| <b>[hide](https://github.com/emvi/hide) | 50 | ID type with marshalling to/from hash to prevent sending IDs to clients. |
| <b>[concurrent-writer](https://github.com/free/concurrent-writer) | 45 | Highly concurrent drop-in replacement for `bufio.Writer`. |
| <b>[go-tuple](https://github.com/barweiss/go-tuple) | 34 | Generic tuple implementation for Go 1.18+. |
| <b>[fsm](https://github.com/cocoonspace/fsm) | 29 | Finite-State Machine package. |
| <b>[genfuncs](https://github.com/nwillc/genfuncs) | 27 | Go 1.18+ generics package inspired by Kotlin's Sequence and Map. |
| <b>[go18ds](https://github.com/daichi-m/go18ds) | 25 | Go Data Structures using Go 1.18 generics. |
| <b>[gofal](https://github.com/xxjwxc/gofal) | 15 | fractional api for Go. |
| <b>[slices](https://github.com/twharmon/slices) | 9 | Pure, generic functions for slices. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[nan](https://github.com/kak-tus/nan) | 56 | Zero allocation Nullable structures in one library with handy conversion functions, marshallers and unmarshallers. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[deque](https://github.com/gammazero/deque) | 372 | Fast ring-buffer deque (double-ended queue). |
| <b>[goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 208 | Concurrent FIFO queue. |
| <b>[deque](https://github.com/edwingeng/deque) | 65 | A highly optimized double-ended queue. |
...
| <b>[trie](https://github.com/derekparker/trie) | 604 | Trie implementation in Go. |
| <b>[go-edlib](https://github.com/hbollon/go-edlib) | 347 | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| <b>[go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 245 | Go implementation of Adaptive Radix Tree. |
| <b>[levenshtein](https://github.com/agnivade/levenshtein) | 235 | Implementation to calculate levenshtein distance in Go. |
| <b>[levenshtein](https://github.com/agext/levenshtein) | 69 | Levenshtein distance and similarity metrics with customizable edit costs and Winkler-like bonus for common prefix. |
| <b>[ptrie](https://github.com/viant/ptrie) | 28 | An implementation of prefix tree. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[skiplist](https://github.com/MauriceGit/skiplist) | 227 | Very fast Go Skiplist implementation. |
| <b>[skiplist](https://github.com/gansidui/skiplist) | 78 | Skiplist implementation in Go. |
...
| <b>[merkle](https://github.com/bobg/merkle) | 6 | Space-efficient computation of Merkle root hashes and inclusion proofs. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[pipeline](https://github.com/hyfather/pipeline) | 43 | An implementation of pipelines with fan-in and fan-out. |
| <b>[parapipe](https://github.com/nazar256/parapipe) | 20 | FIFO Pipeline which parallels execution on each stage while maintaining the order of messages and results. |
...
| <b>[ttlcache](https://github.com/jellydator/ttlcache) | 481 | An in-memory cache with item expiration and generics. |
| <b>[cachego](https://github.com/fabiorphp/cachego) | 183 | Golang Cache component for multiple drivers. |
| <b>[cachego](https://github.com/faabiosr/cachego) | 183 | Golang Cache component for multiple drivers. |
| <b>[remember-go](https://github.com/rocketlaunchr/remember-go) | 116 | A universal interface for caching slow database queries (backed by redis, memcached, ristretto, or in-memory). |
...
| <b>[bcache](https://github.com/iwanbk/bcache) | 93 | Eventually consistent distributed in-memory  cache Go library. |
| <b>[go-mcache](https://github.com/OrlovEvgeny/go-mcache) | 83 | Fast in-memory key:value store/cache library. Pointer caches. |
| <b>[go-cache](https://github.com/viney-shih/go-cache) | 71 | A flexible multi-layer Go caching library to deal with in-memory and shared cache by adopting Cache-Aside pattern. |
...
| <b>[VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 7.1k | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
...
| <b>[column](https://github.com/kelindar/column) | 982 | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
| <b>[lotusdb](https://github.com/flower-corp/lotusdb) | 956 | Fast k/v database compatible with lsm and b+tree. |
| <b>[eliasdb](https://github.com/krotik/eliasdb) | 944 | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| <b>[pogreb](https://github.com/akrylysov/pogreb) | 934 | Embedded key-value store for read-heavy workloads. |
| <b>[moss](https://github.com/couchbase/moss) | 885 | Moss is a simple LSM key-value storage engine written in 100% Go. |
| <b>[levigo](https://github.com/jmhodges/levigo) | 406 | Levigo is a Go wrapper for LevelDB. |
| <b>[pudge](https://github.com/recoilme/pudge) | 329 | Fast and simple key/value store written using Go's standard library. |
| <b>[clover](https://github.com/ostafen/clover) | 263 | A lightweight document-oriented NoSQL database written in pure Golang. |
| <b>[Vasto](https://github.com/chrislusf/vasto) | 239 | A distributed high-performance key-value store. On Disk. Eventual consistent. HA. Able to grow or shrink without service interruption. |
| <b>[dtf](https://github.com/dtm-labs/dtf) | 232 | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
| <b>[piladb](https://github.com/fern4lvarez/piladb) | 198 | Lightweight RESTful database engine based on stack data structures. |
| <b>[unitdb](https://github.com/unit-io/unitdb) | 96 | Fast timeseries database for IoT, realtime messaging  applications. Access unitdb with pubsub over tcp or websocket using github.com/unit-io/unitd application. |
| <b>[hare](https://github.com/jameycribbs/hare) | 60 | A simple database management system that stores each table as a text file of line-delimited JSON. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[migrate](https://github.com/golang-migrate/migrate) | 9.7k | Database migrations. CLI and Golang library. |
| <b>[bytebase](https://github.com/bytebase/bytebase) | 3.8k | Safe database schema change and version control for DevOps teams. |
...
| <b>[atlas](https://github.com/ariga/atlas) | 1.8k | A Database Toolkit. A CLI designed to help companies better work with their data. |
...
| <b>[goavro](https://github.com/linkedin/goavro) | 834 | A Go package that encodes and decodes Avro data. |
| <b>[gormigrate](https://github.com/go-gormigrate/gormigrate) | 813 | Database schema migration helper for Gorm ORM. |
| <b>[darwin](https://github.com/GuiaBolso/darwin) | 133 | Database schema evolution library for Go. |
| <b>[migrator](https://github.com/lopezator/migrator) | 130 | Dead simple Go database migration library. |
...
| <b>[sqlize](https://github.com/sunary/sqlize) | 39 | Database migration generator. Allows generate sql migration from model and existing sql by differ them. |
...
| <b>[gorm-seeder](https://github.com/Kachit/gorm-seeder) | 3 | Simple database seeder for Gorm ORM. |
| <b>[godfish](https://github.com/rafaelespinoza/godfish) | 2 | Database migration manager, works with native query language. Support for cassandra, mysql, postgres, sqlite3. |
...
| <b>[chproxy](https://github.com/Vertamedia/chproxy) | 978 | HTTP proxy for ClickHouse database. |
| <b>[pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 782 | Advanced scheduling for PostgreSQL. |
| <b>[clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 379 | Collects small inserts and sends big requests to ClickHouse servers. |
...
| <b>[rdb](https://github.com/HDT3213/rdb) | 181 | Redis RDB file parser for secondary development and memory analysis. |
| <b>[octillery](https://github.com/knocknote/octillery) | 171 | Go package for sharding databases ( Supports every ORM or raw SQL ). |
...
| <b>[dynago](https://github.com/twharmon/dynago) | 3 | Simplify working with AWS DynamoDB. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sqlc](https://github.com/kyleconroy/sqlc) | 6.3k | Generate type-safe code from SQL. |
...
| <b>[jet](https://github.com/go-jet/jet) | 786 | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
| <b>[Dotsql](https://github.com/gchaincl/dotsql) | 646 | Go library that helps you keep sql files in one place and use them with ease. |
| <b>[ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 571 | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
| <b>[dbq](https://github.com/rocketlaunchr/dbq) | 349 | Zero boilerplate database operations for Go. |
| <b>[sqlingo](https://github.com/lqs/sqlingo) | 260 | A lightweight DSL to build SQL in Go. |
| <b>[sqrl](https://github.com/elgris/sqrl) | 242 | SQL query builder, fork of Squirrel with improved performance. |
| <b>[sq](https://github.com/bokwoon95/go-structured-query) | 171 | Type-safe SQL builder and struct mapper for Go. |
| <b>[igor](https://github.com/galeone/igor) | 87 | Abstraction layer for PostgreSQL that supports advanced functionality and uses gorm-like syntax. |
| <b>[sqlf](https://github.com/leporo/sqlf) | 83 | Fast SQL query builder. |
| <b>[buildsqlx](https://github.com/arthurkushman/buildsqlx) | 72 | Go database query builder library for PostgreSQL. |
...
| <b>[bqb](https://github.com/nullism/bqb) | 46 | Lightweight and easy to learn query builder. |
| <b>[gosql](https://github.com/twharmon/gosql) | 24 | SQL Query builder with better null values support. |
...
| <b>[gokv](https://github.com/philippgille/gokv) | 469 | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| <b>[go-oci8](https://github.com/mattn/go-oci8) | 594 | Oracle driver for go that uses database/sql. |
| <b>[sqlhooks](https://github.com/qustavo/sqlhooks) | 577 | Attach hooks to any database/sql driver. |
| <b>[godror](https://github.com/godror/godror) | 391 | Oracle driver for Go, using the ODPI-C driver. |
| <b>[Kivik](https://github.com/go-kivik/kivik) | 241 | Kivik provides a common Go and GopherJS client library for CouchDB, PouchDB, and similar databases. |
| <b>[firebirdsql](https://github.com/nakagami/firebirdsql) | 175 | Firebird RDBMS SQL driver for Go. |
| <b>[KSQL](https://github.com/VinGarcia/ksql) | 154 | A Simple and Powerful Golang SQL Library |
...
| <b>[avatica](https://github.com/apache/calcite-avatica-go) | 101 | Apache Avatica/Phoenix SQL driver for database/sql. |
| <b>[ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) | 61 | native and database/sql driver YDB (Yandex Database) |
...
| <b>[qmgo](https://github.com/qiniu/qmgo) | 966 | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
| <b>[mgm](https://github.com/kamva/mgm) | 557 | MongoDB model-based ODM for Go (based on official MongoDB driver). |
| <b>[redeo](https://github.com/bsm/redeo) | 417 | Redis-protocol compatible TCP servers/services. |
| <b>[aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 396 | Aerospike client in Go language. |
...
| <b>[gocb](https://github.com/couchbase/gocb) | 338 | Official Couchbase Go SDK. |
| <b>[go-couchbase](https://github.com/couchbase/go-couchbase) | 316 | Couchbase client in Go. |
| <b>[go-rejson](https://github.com/nitishm/go-rejson) | 281 | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| <b>[go-pilosa](https://github.com/pilosa/go-pilosa) | 55 | Go client library for Pilosa. |
| <b>[forestdb](https://github.com/couchbase/goforestdb) | 32 | Go bindings for ForestDB. |
| <b>[neo4j](https://github.com/cihangir/neo4j) | 28 | Neo4j Rest API Bindings for Golang. |
...
| <b>[elasticsql](https://github.com/cch123/elasticsql) | 958 | Convert sql to elasticsearch dsl in Go. |
...
| <b>[carbon](https://github.com/uniplaces/carbon) | 725 | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
| <b>[durafmt](https://github.com/hako/durafmt) | 444 | Time duration formatting library for Go. |
| <b>[timeutil](https://github.com/leekchan/timeutil) | 188 | Useful extensions (Timedelta, Strftime, ...) to the golang's time package. |
| <b>[gostradamus](https://github.com/bykof/gostradamus) | 170 | A Go package for working with dates. |
| <b>[go-persian-calendar](https://github.com/yaa110/go-persian-calendar) | 127 | The implementation of the Persian (Solar Hijri) Calendar in Go (golang). |
| <b>[iso8601](https://github.com/relvacode/iso8601) | 105 | Efficiently parse ISO8601 date-times without regex. |
| <b>[date](https://github.com/rickb777/date) | 95 | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
| <b>[timespan](https://github.com/SaidinWoT/timespan) | 81 | For interacting with intervals of time, defined as a start time and a duration. |
| <b>[go-sunrise](https://github.com/nathan-osman/go-sunrise) | 58 | Calculate the sunrise and sunset times for a given location. |
| <b>[go-str2duration](https://github.com/xhit/go-str2duration) | 46 | Convert string to duration. Support time.Duration returned string and more. |
...
| <b>[go-doudou](https://github.com/unionj-cloud/go-doudou) | 849 | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
| <b>[redis-lock](https://github.com/bsm/redislock) | 804 | Simplified distributed locking implementation using Redis. |
| <b>[rain](https://github.com/cenkalti/rain) | 757 | BitTorrent client and library. |
| <b>[ringpop-go](https://github.com/uber/ringpop-go) | 746 | Scalable, fault-tolerant application-layer sharding for Go applications. |
| <b>[gorpc](https://github.com/valyala/gorpc) | 654 | Simple, fast and scalable RPC library for high load. |
| <b>[go-health](https://github.com/InVisionApp/go-health) | 636 | Library for enabling asynchronous dependency health checks in your service. |
| <b>[arpc](https://github.com/lesismal/arpc) | 600 | More effective network communication, support two-way-calling, notify, broadcast. |
| <b>[consistent](https://github.com/buraksezer/consistent) | 507 | Consistent hashing with bounded loads. |
| <b>[go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 493 | A library built to provide support for defining async service health checks for golang services. |
| <b>[digota](https://github.com/digota/digota) | 461 | grpc ecommerce microservice. |
| <b>[sleuth](https://github.com/ursiform/sleuth) | 356 | Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq)). |
| <b>[go-jump](https://github.com/dgryski/go-jump) | 350 | Port of Google's "Jump" Consistent Hash function. |
| <b>[dht](https://github.com/anacrolix/dht) | 244 | BitTorrent Kademlia DHT implementation. |
| <b>[jsonrpc](https://github.com/ybbus/jsonrpc) | 240 | JSON-RPC 2.0 HTTP client implementation. |
...
| <b>[doublejump](https://github.com/edwingeng/doublejump) | 78 | A revamped Google's jump consistent hash. |
| <b>[Semaphore](https://github.com/jexia/semaphore) | 75 | A straightforward (micro) service orchestrator. |
...
| <b>[drmaa](https://github.com/dgruber/drmaa) | 41 | Job submission library for cluster schedulers based on the DRMAA standard. |
...
| <b>[DDNS](https://github.com/skibish/ddns) | 217 | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| <b>[SendGrid](https://github.com/sendgrid/sendgrid-go) | 842 | SendGrid's Go library for sending email. |
| <b>[mailgun-go](https://github.com/mailgun/mailgun-go) | 622 | Go library for sending mail with the Mailgun API. |
| <b>[email-verifier](https://github.com/AfterShip/email-verifier) | 508 | A Go library for email verification without sending any emails. |
| <b>[go-simple-mail](https://github.com/xhit/go-simple-mail) | 375 | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| <b>[go-message](https://github.com/emersion/go-message) | 268 | Streaming library for the Internet Message Format and mail messages. |
| <b>[douceur](https://github.com/aymerick/douceur) | 221 | CSS inliner for your HTML emails. |
| <b>[Hectane](https://github.com/hectane/hectane) | 220 | Lightweight SMTP client providing an HTTP API. |
| <b>[mailchain](https://github.com/mailchain/mailchain) | 125 | Send encrypted emails to blockchain addresses written in Go. |
| <b>[go-premailer](https://github.com/vanng822/go-premailer) | 91 | Inline styling for HTML mail in Go. |
| <b>[go-dkim](https://github.com/toorop/go-dkim) | 81 | DKIM library, to sign & verify email. |
...
| <b>[go-mail](https://github.com/wneessen/go-mail) | 50 | A simple Go library for sending mails in Go. |
...
| <b>[truemail-go](https://github.com/truemail-rb/truemail-go) | 20 | Configurable Golang email validator/verifier. Verify email via Regex, DNS, SMTP and even more. |
...
| <b>[golua](https://github.com/aarzilli/golua) | 592 | Go bindings for Lua C API. |
| <b>[gval](https://github.com/PaesslerAG/gval) | 527 | A highly customizable expression language written in Go. |
| <b>[gisp](https://github.com/jcla1/gisp) | 490 | Simple LISP in Go. |
| <b>[prolog](https://github.com/ichiban/prolog) | 422 | Embeddable Prolog. |
| <b>[gentee](https://github.com/gentee/gentee) | 97 | Embeddable scripting programming language. |
| <b>[binder](https://github.com/alexeyco/binder) | 61 | Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua). |
...
| <b>[errorx](https://github.com/joomcode/errorx) | 889 | A feature rich error package with stack traces, composition of errors and more. |
| <b>[tracerr](https://github.com/ztrue/tracerr) | 739 | Golang errors with stack trace and source fragments. |
| <b>[errlog](https://github.com/snwfdhmp/errlog) | 409 | Hackable package that determines responsible source code for an error (and some other fast-debugging features). Pluggable to any logger in-place. |
| <b>[emperror](https://github.com/emperror/emperror) | 261 | Error handling tools and best practices for Go libraries and applications. |
| <b>[errors](https://github.com/emperror/errors) | 159 | Drop-in replacement for the standard library errors package and github.com/pkg/errors. Provides various error handling primitives. |
| <b>[errors](https://github.com/bnkamalesh/errors) | 43 | Drop-in replacement for builting Go errors. This is a minimal error handling package with custom error types, user friendly messages, Unwrap & Is. With very easy to use and straightforward helper functions. |
| <b>[exception](https://github.com/rbrahul/exception) | 17 | A simple utility package for exception handling with try-catch in Golang. |
| <b>[Falcon](https://github.com/SonicRoshan/falcon) | 7 | A Simple Yet Highly Powerful Package For Error Handling. |
| <b>[errors](https://github.com/PumpkinSeed/errors) | 6 | The most simple error wrapper with awesome performance and minimal memory overhead. |
...
| <b>[notify](https://github.com/rjeczalik/notify) | 758 | File system event notification library with simple API, similar to os/signal. |
| <b>[copy](https://github.com/otiai10/copy) | 457 | Copy directory recursively. |
...
| <b>[afs](https://github.com/viant/afs) | 203 | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
| <b>[vfs](https://github.com/C2FO/vfs) | 195 | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
...
| <b>[go-csv-tag](https://github.com/artonge/go-csv-tag) | 97 | Load csv file using tag. |
| <b>[gofs](https://github.com/no-src/gofs) | 90 | A file synchronization tool out of the box. |
| <b>[skywalker](https://github.com/dixonwille/skywalker) | 84 | Package to allow one to concurrently go through a filesystem with ease. |
| <b>[opc](https://github.com/qmuntal/opc) | 72 | Load Open Packaging Conventions (OPC) files for Go. |
| <b>[checksum](https://github.com/codingsince1985/checksum) | 68 | Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files. |
...
| <b>[higgs](https://github.com/dastoori/higgs) | 11 | A tiny cross-platform Go library to hide/unhide files and directories. |
...
| <b>[accounting](https://github.com/leekchan/accounting) | 765 | money and currency formatting for golang. |
| <b>[bbgo](https://github.com/c9s/bbgo) | 689 | A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies. |
| <b>[techan](https://github.com/sdcoffey/techan) | 666 | Technical analysis library with advanced market analysis and trading strategies. |
| <b>[go-finance](https://github.com/FlashBoys/go-finance) | 536 | Comprehensive financial markets data in Go. |
| <b>[currency](https://github.com/bojanz/currency) | 331 | Handles currency amounts, provides currency information and formatting. |
| <b>[ach](https://github.com/moov-io/ach) | 329 | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
| <b>[orderbook](https://github.com/i25959341/orderbook) | 293 | Matching Engine for Limit Order Book in Golang. |
...
| <b>[transaction](https://github.com/claygod/transaction) | 114 | Embedded transactional database of accounts, running in multithreaded mode. |
| <b>[ofxgo](https://github.com/aclindsa/ofxgo) | 108 | Query OFX servers and/or parse the responses (with example command-line client). |
| <b>[sleet](https://github.com/BoltApp/sleet) | 99 | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
| <b>[vat](https://github.com/dannyvankooten/vat) | 96 | VAT number validation & EU VAT rates. |
| <b>[go-finnhub](https://github.com/m1/go-finnhub) | 75 | Client for stock market, forex and crypto data from finnhub.io. Access real-time financial market data from 60+ stock exchanges, 10 forex brokers, and 15+ crypto exchanges. |
...
| <b>[fpmoney](https://github.com/nikolaydubina/fpmoney) | 8 | Fast and simple ISO4217 fixed-point decimal money. |
...
| <b>[gorilla/csrf](https://github.com/gorilla/csrf) | 831 | CSRF protection for Go web applications & services. |
| <b>[binding](https://github.com/mholt/binding) | 790 | Binds form and JSON data from net/http Request to struct. |
| <b>[form](https://github.com/go-playground/form) | 555 | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
| <b>[conform](https://github.com/leebenson/conform) | 267 | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
| <b>[formam](https://github.com/monoculum/formam) | 173 | decode form's values into a struct. |
...
| <b>[httpin](https://github.com/ggicci/httpin) | 109 | Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc. |
...
| <b>[mo](https://github.com/samber/mo) | 908 | Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...). |
| <b>[fpGo](https://github.com/TeaEntityLab/fpGo) | 290 | Monad, Functional Programming features for Golang. |
| <b>[gofp](https://github.com/rbrahul/gofp) | 130 | A lodash like powerful utility library for Golang. |
| <b>[fuego](https://github.com/seborama/fuego) | 122 | Functional Experiment in Go. |
| <b>[fp-go](https://github.com/repeale/fp-go) | 112 | Collection of Functional Programming helpers powered by Golang 1.18+ generics. |
| <b>[underscore](https://github.com/rjNemo/underscore) | 70 | Functional programming helpers for Go 1.18 and beyond. |
| <b>[valor](https://github.com/phelmkamp/valor) | 6 | Generic option and result types that optionally contain a value. |
...
| <b>[raylib-go](https://github.com/gen2brain/raylib-go) | 866 | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
| <b>[Azul3D](https://github.com/azul3d/engine) | 553 | 3D game engine written in Go. |
| <b>[go-astar](https://github.com/beefsack/go-astar) | 519 | Go implementation of the A\* path finding algorithm. |
| <b>[go3d](https://github.com/ungerik/go3d) | 269 | Performance oriented 2D/3D math package for Go. |
...
| <b>[tile](https://github.com/kelindar/tile) | 69 | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
...
| <b>[GoWrap](https://github.com/hexdigest/gowrap) | 659 | Generate decorators for Go interfaces using simple templates. |
| <b>[go-enum](https://github.com/abice/go-enum) | 373 | Code generation for enums from code comments. |
| <b>[interfaces](https://github.com/rjeczalik/interfaces) | 356 | Command line tool for generating interface definitions. |
| <b>[copygen](https://github.com/switchupcb/copygen) | 181 | Generate type-to-type code without reflection. |
| <b>[goverter](https://github.com/jmattheis/goverter) | 147 | Generate converters by defining an interface. |
| <b>[gotype](https://github.com/wzshiming/gotype) | 47 | Golang source code parsing, usage like reflect package. |
| <b>[generis](https://github.com/senselogic/GENERIS) | 36 | Code generation tool providing generics, free-form macros, conditional compilation and HTML templating. |
...
| <b>[mbtileserver](https://github.com/consbio/mbtileserver) | 385 | A simple Go-based server for map tiles stored in mbtiles format. |
| <b>[osm](https://github.com/paulmach/osm) | 233 | Library for reading, writing and working with OpenStreetMap data and APIs. |
| <b>[WGS84](https://github.com/wroge/wgs84) | 87 | Library for Coordinate Conversion and Transformation (ETRS89, OSGB36, NAD83, RGF93, Web Mercator, UTM). |
| <b>[godal](https://github.com/airbusgeo/godal) | 81 | Go wrapper for GDAL. |
...
| <b>[simplefeatures](https://github.com/peterstace/simplefeatures) | 60 | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
| <b>[gismanager](https://github.com/hishamkaram/gismanager) | 47 | Publish Your GIS Data(Vector Data) to PostGIS and Geoserver. |
| <b>[pbf](https://github.com/maguro/pbf) | 38 | OpenStreetMap PBF golang encoder/decoder. |
| <b>[S2 geojson](https://github.com/pantrif/s2-geojson) | 18 | Convert geojson to s2 cells & demonstrating some S2 geometry features on map. |
...
| <b>[c4go](https://github.com/Konstantin8105/c4go) | 324 | Transpile C code to Go code. |
| <b>[c2go](https://github.com/goplus/c2go) | 202 | Convert C code to Go code. |
| <b>[esp32](https://github.com/andygeiss/esp32-transpiler) | 52 | Transpile Go into Arduino code. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[ants](https://github.com/panjf2000/ants) | 9.1k | A high-performance and low-cost goroutine pool in Go. |
...
| <b>[workerpool](https://github.com/gammazero/workerpool) | 909 | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| <b>[grpool](https://github.com/ivpusic/grpool) | 710 | Lightweight Goroutine pool. |
| <b>[pool](https://github.com/go-playground/pool) | 694 | Limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation. |
| <b>[pond](https://github.com/alitto/pond) | 632 | Minimalistic and High-performance goroutine worker pool written in Go. |
| <b>[gowp](https://github.com/xxjwxc/gowp) | 411 | gowp is concurrency limiting goroutine pool. |
| <b>[go-floc](https://github.com/workanator/go-floc) | 259 | Orchestrate goroutines with ease. |
| <b>[go-flow](https://github.com/kamildrazkiewicz/go-flow) | 197 | Control goroutines execution order. |
| <b>[semaphore](https://github.com/marusama/semaphore) | 151 | Fast resizable semaphore implementation based on CAS (faster than channel-based semaphore implementations). |
| <b>[go-workers](https://github.com/catmullet/go-workers) | 144 | Easily and safely run workers for large data processing pipelines. |
| <b>[neilotoole/errgroup](https://github.com/neilotoole/errgroup) | 135 | Drop-in alternative to `sync/errgroup`, limited to a pool of N worker goroutines. |
| <b>[artifex](https://github.com/borderstech/artifex) | 134 | Simple in-memory job queue for Golang using worker-based dispatching. |
| <b>[async](https://github.com/studiosol/async) | 112 | A safe way to execute functions asynchronously, recovering them in case of panic. |
| <b>[cyclicbarrier](https://github.com/marusama/cyclicbarrier) | 105 | CyclicBarrier for golang. |
| <b>[gollback](https://github.com/vardius/gollback) | 97 | asynchronous simple function utilities, for managing execution of closures and callbacks. |
| <b>[semaphore](https://github.com/kamilsk/semaphore) | 90 | Semaphore pattern implementation with timeout of lock/unlock operations based on channel and context. |
| <b>[async](https://github.com/reugn/async) | 88 | An alternative sync library for Go (Future, Promise, Locks). |
| <b>[Hunch](https://github.com/AaronJan/Hunch) | 87 | Hunch provides functions like: `All`, `First`, `Retry`, `Waterfall` etc., that makes asynchronous flow control more intuitive. |
...
| <b>[goccm](https://github.com/zenthangplus/goccm) | 55 | Go Concurrency Manager package limits the number of goroutines that allowed to run concurrently. |
...
| <b>[nursery](https://github.com/arunsworld/nursery) | 51 | Structured concurrency in Go. |
| <b>[gohive](https://github.com/loveleshsharma/gohive) | 42 | A highly performant and easy to use Goroutine pool for Go. |
| <b>[kyoo](https://github.com/dirkaholic/kyoo) | 38 | Provides an unlimited job queue and concurrent worker pools. |
| <b>[gowl](https://github.com/hamed-yousefi/gowl) | 37 | Gowl is a process management and process monitoring tool at once. An infinite worker pool gives you the ability to control the pool and processes and monitor their status. |
| <b>[parallel-fn](https://github.com/rafaeljesus/parallel-fn) | 33 | Run functions in parallel. |
| <b>[go-waitgroup](https://github.com/pieterclaerhout/go-waitgroup) | 32 | Like `sync.WaitGroup` with error handling and concurrency control. |
| <b>[go-trylock](https://github.com/subchen/go-trylock) | 30 | TryLock support on read-write lock for Golang. |
| <b>[channelify](https://github.com/ddelizia/channelify) | 24 | Transform your function to return channels for easy and powerful parallel processing. |
...
| <b>[concurrency-limiter](https://github.com/vivek-ng/concurrency-limiter) | 8 | Concurrency limiter with support for timeouts , dynamic priority and context cancellation of goroutines. |
...
| <b>[breaker](https://github.com/kamilsk/breaker) | 6 | Flexible mechanism to make execution flow interruptible. |
...
| <b>[gowd](https://github.com/dtylman/gowd) | 376 | Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform. |
| <b>[zenity](https://github.com/ncruces/zenity) | 333 | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
| <b>[trayhost](https://github.com/shurcooL/trayhost) | 232 | Cross-platform Go library to place an icon in the host operating system's taskbar. |
...
| <b>[emgo](https://github.com/ziutek/emgo) | 986 | Go-like language for programming embedded systems (e.g. STM32 MCU). |
| <b>[sysinfo](https://github.com/zcalusic/sysinfo) | 376 | A pure Go library providing Linux OS / kernel / hardware system information. |
| <b>[goroslib](https://github.com/aler9/goroslib) | 217 | Robot Operating System (ROS) library for Go. |
| <b>[go-osc](https://github.com/hypebeast/go-osc) | 157 | Open Sound Control (OSC) bindings for Go. |
...
| <b>[govips](https://github.com/davidbyttow/govips) | 751 | A lightning fast image processing and resizing library for Go. |
| <b>[image2ascii](https://github.com/qeesung/image2ascii) | 691 | Convert image to ASCII. |
| <b>[draft](https://github.com/lucasepe/draft) | 544 | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| <b>[goimagehash](https://github.com/corona10/goimagehash) | 533 | Go Perceptual image hashing package. |
| <b>[govatar](https://github.com/o1egl/govatar) | 517 | Library and CMD tool for generating funny avatars. |
| <b>[mort](https://github.com/aldor007/mort) | 459 | Storage and image processing server written in Go. |
| <b>[go-nude](https://github.com/koyachi/go-nude) | 353 | Nudity detection with Go. |
| <b>[rez](https://github.com/bamiaux/rez) | 207 | Image resizing in pure Go and SIMD. |
| <b>[darkroom](https://github.com/gojek/darkroom) | 197 | An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency. |
| <b>[mergi](https://github.com/noelyahan/mergi) | 181 | Tool & Go library for image manipulation (Merge, Crop, Resize, Watermark, Animate). |
| <b>[gltf](https://github.com/qmuntal/gltf) | 178 | Efficient and robust glTF 2.0 reader, writer and validator. |
| <b>[steganography](https://github.com/auyer/steganography) | 152 | Pure Go Library for LSB steganography. |
| <b>[img](https://github.com/hawx/img) | 140 | Selection of image manipulation tools. |
| <b>[go-cairo](https://github.com/ungerik/go-cairo) | 123 | Go binding for the cairo graphics library. |
| <b>[cameron](https://github.com/aofei/cameron) | 89 | An avatar generator for Go. |
| <b>[go-webp](https://github.com/kolesa-team/go-webp) | 71 | Library for encode and decode webp pictures, using libwebp. |
...
| <b>[scout](https://github.com/jonoton/scout) | 5 | Scout is a standalone open source software solution for DIY video security. |
...
| <b>[connectordb](https://github.com/connectordb/connectordb) | 346 | Open-Source Platform for Quantified Self & IoT. |
| <b>[devices](https://github.com/goiot/devices) | 255 | Suite of libraries for IoT devices, experimental for x/exp/io. |
| <b>[huego](https://github.com/amimof/huego) | 216 | An extensive Philips Hue client library for Go. |
| <b>[sensorbee](https://github.com/sensorbee/sensorbee) | 213 | Lightweight stream processing engine for IoT. |
| <b>[iot](https://github.com/vaelen/iot/) | 61 | IoT is a simple framework for implementing a Google IoT Core device. |
| <b>[eywa](https://github.com/xcodersun/eywa) | 57 | Project Eywa is essentially a connection manager that keeps track of connected devices. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gocron](https://github.com/go-co-op/gocron) | 2.3k | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
| <b>[go-quartz](https://github.com/reugn/go-quartz) | 939 | Simple, zero-dependency scheduling library for Go. |
| <b>[JobRunner](https://github.com/bamzi/jobrunner) | 938 | Smart and featureful cron job scheduler with job queuing and live monitoring built in. |
| <b>[gron](https://github.com/roylee0704/gron) | 910 | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| <b>[jobs](https://github.com/albrow/jobs) | 490 | Persistent and flexible background jobs library. |
| <b>[scheduler](https://github.com/carlescere/scheduler) | 397 | Cronjobs scheduling made easy. |
| <b>[Dagu](https://github.com/dagu-go/dagu) | 310 | No-code workflow executor. it executes DAGs defined in a simple YAML format. |
| <b>[gronx](https://github.com/adhocore/gronx) | 212 | Cron expression parser, task runner and daemon consuming crontab like task list. |
...
| <b>[clockwerk](https://github.com/onatm/clockwerk) | 125 | Go package to schedule periodic jobs using a simple, fluent syntax. |
| <b>[tasks](https://github.com/madflojo/tasks) | 110 | An easy to use in-process scheduler for recurring tasks in Go. |
| <b>[leprechaun](https://github.com/kilgaloon/leprechaun) | 88 | Job scheduler that supports webhooks, crons and classic scheduling. |
| <b>[goflow](https://github.com/fieldryand/goflow) | 61 | A workflow orchestrator and scheduler for rapid prototyping of ETL/ML/AI pipelines. |
| <b>[cheek](https://github.com/datarootsio/cheek) | 49 | A simple crontab like scheduler that aims to offer a KISS approach to job scheduling. |
| <b>[sched](https://github.com/romshark/sched) | 25 | A job scheduler with the ability to fast-forward time. |
| <b>[cdule](https://github.com/deepaksinghvi/cdule) | 10 | Job scheduler library with database support |
| <b>[cronticker](https://github.com/krayzpipes/cronticker) | 6 | A ticker implementation to support cron schedules. |
...
| <b>[OjG](https://github.com/ohler55/ojg) | 508 | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
| <b>[kazaam](https://github.com/Qntfy/kazaam) | 237 | API for arbitrary transformation of JSON documents. |
| <b>[marshmallow](https://github.com/PerimeterX/marshmallow) | 205 | Performant JSON unmarshaling for flexible use cases. |
| <b>[jsondiff](https://github.com/wI2L/jsondiff) | 193 | JSON diff library for Go based on RFC6902 (JSON Patch). |
| <b>[gojq](https://github.com/elgs/gojq) | 183 | JSON query in Golang. |
| <b>[jettison](https://github.com/wI2L/jettison) | 134 | Fast and flexible JSON encoder for Go. |
| <b>[ajson](https://github.com/spyzhov/ajson) | 126 | Abstract JSON for golang with JSONPath support. |
| <b>[gjo](https://github.com/skanehira/gjo) | 110 | Small utility to create JSON objects. |
| <b>[json2go](https://github.com/m-zajac/json2go) | 106 | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
| <b>[jsongo](https://github.com/ricardolonga/jsongo) | 104 | Fluent API to make it easier to create Json objects. |
| <b>[JayDiff](https://github.com/yazgazan/jaydiff) | 90 | JSON diff utility written in Go. |
...
| <b>[go-respond](https://github.com/nicklaw5/go-respond) | 49 | Go package for handling common HTTP JSON responses. |
...
| <b>[ask](https://github.com/simonnilsson/ask) | 18 | Easy access to nested values in maps and slices. Works in combination with encoding/json and other packages that "Unmarshal" arbitrary data into Go data-types. |
...
| <b>[zerolog](https://github.com/rs/zerolog) | 6.9k | Zero-allocation JSON logger. |
...
| <b>[phuslu/log](https://github.com/phuslu/log) | 446 | Structured Logging Made Easy. |
| <b>[onelog](https://github.com/francoispqt/onelog) | 401 | Onelog is a dead simple but very efficient JSON logger. It is the fastest JSON logger out there in all scenarios. Also, it is one of the logger with the lowest allocation. |
| <b>[logxi](https://github.com/mgutz/logxi) | 350 | 12-factor app logger that is fast and makes you happy. |
| <b>[logutils](https://github.com/hashicorp/logutils) | 330 | Utilities for slightly better logging in Go (Golang) extending the standard logger. |
| <b>[log](https://github.com/go-playground/log) | 281 | Simple, configurable and scalable Structured Logging for Go. |
| <b>[go-logger](https://github.com/apsdehal/go-logger) | 278 | Simple logger of Go Programs, with level handlers. |
| <b>[httpretty](https://github.com/henvic/httpretty) | 276 | Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest). |
| <b>[sqldb-logger](https://github.com/simukti/sqldb-logger) | 261 | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
| <b>[rollingwriter](https://github.com/arthurkiller/rollingWriter) | 244 | RollingWriter is an auto-rotate `io.Writer` implementation with multi policies to provide log file rotation. |
| <b>[logur](https://github.com/logur/logur) | 175 | An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus), [go-kit log](https://github.com/go-kit/kit/tree/master/log), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog), etc). |
| <b>[glg](https://github.com/kpango/glg) | 170 | glg is simple and fast leveled logging library for Go. |
| <b>[logger](https://github.com/azer/logger) | 156 | Minimalistic logging library for Go. |
| <b>[xlog](https://github.com/rs/xlog) | 136 | Structured logger for `net/context` aware HTTP handlers with flexible dispatching. |
| <b>[slog](https://github.com/gookit/slog) | 125 | Lightweight, configurable, extensible logger for Go. |
| <b>[ozzo-log](https://github.com/go-ozzo/ozzo-log) | 120 | High performance logging supporting log severity, categorization, and filtering. Can send filtered log messages to various targets (e.g. console, network, mail). |
| <b>[log-voyage](https://github.com/firstrow/logvoyage) | 92 | Full-featured logging saas written in golang. |
...
| <b>[gone/log](https://github.com/One-com/gone/tree/master/log) | 41 | Fast, extendable, full-featured, std-lib source compatible log library. |
...
| <b>[mlog](https://github.com/jbrodriguez/mlog) | 26 | Simple logging module for go, with 5 levels, an optional rotating logfile feature and stdout/stderr output. |
...
| <b>[zkits-logger](https://github.com/edoger/zkits-logger) | 19 | A powerful zero-dependency JSON logger. |
...
| <b>[logo](https://github.com/mbndr/logo) | 10 | Golang logger to different configurable writers. |
...
| <b>[eaopt](https://github.com/MaxHalford/eaopt) | 810 | An evolutionary optimization library. |
| <b>[bayesian](https://github.com/jbrukh/bayesian) | 741 | Naive Bayesian Classification for Golang. |
...
| <b>[ocrserver](https://github.com/otiai10/ocrserver) | 525 | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
| <b>[onnx-go](https://github.com/owulveryck/onnx-go) | 422 | Go Interface to Open Neural Network Exchange (ONNX). |
| <b>[go-deep](https://github.com/patrikeh/go-deep) | 384 | A feature-rich neural network library in Go. |
| <b>[regommend](https://github.com/muesli/regommend) | 300 | Recommendation & collaborative filtering engine. |
...
| <b>[goRecommend](https://github.com/timkaye11/goRecommend) | 191 | Recommendation Algorithms library written in Go. |
| <b>[goga](https://github.com/tomcraven/goga) | 167 | Genetic algorithm library for Go. |
...
| <b>[goscore](https://github.com/asafschers/goscore) | 83 | Go Scoring API for PMML. |
...
| <b>[Varis](https://github.com/Xamber/Varis) | 47 | Golang Neural Network. |
...
| <b>[godist](https://github.com/e-dard/godist) | 34 | Various probability distributions, and associated methods. |
| <b>[GoMind](https://github.com/surenderthakran/gomind) | 34 | A simplistic Neural Network Library in Go. |
...
| <b>[ddt](https://github.com/sgrodriguez/ddt) | 20 | Dynamic decision tree, create trees defining customizable rules. |
...
| <b>[Asynq](https://github.com/hibiken/asynq) | 4.1k | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| <b>[Chanify](https://github.com/chanify/chanify) | 919 | A push notification server send message to your iOS devices. |
| <b>[dbus](https://github.com/godbus/dbus) | 758 | Native Go bindings for D-Bus. |
| <b>[golongpoll](https://github.com/jcuga/golongpoll) | 607 | HTTP longpoll server library that makes web pub-sub simple. |
| <b>[mangos](https://github.com/nanomsg/mangos) | 548 | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
| <b>[amqp](https://github.com/rabbitmq/amqp091-go) | 506 | Go RabbitMQ Client Library. |
| <b>[emitter](https://github.com/olebedev/emitter) | 433 | Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins. |
| <b>[Glue](https://github.com/desertbit/glue) | 403 | Robust Go and Javascript Socket Library (Alternative to Socket.io). |
| <b>[pubsub](https://github.com/tuxychandru/pubsub) | 383 | Simple pubsub package for go. |
| <b>[Bus](https://github.com/mustafaturan/bus) | 275 | Minimalist message bus implementation for internal communication. |
| <b>[Quamina](https://github.com/timbray/quamina) | 267 | Fast pattern-matching for filtering messages and events. |
| <b>[messagebus](https://github.com/vardius/message-bus) | 229 | messagebus is a Go simple async message bus, perfect for using as event bus when doing event sourcing, CQRS, DDD. |
| <b>[rabtap](https://github.com/jandelgado/rabtap) | 220 | RabbitMQ swiss army knife cli app. |
...
| <b>[hub](https://github.com/leandro-lugaresi/hub) | 121 | A Message/Event Hub for Go applications, using publish/subscribe pattern with support for alias like rabbitMQ exchanges. |
...
| <b>[go-mq](https://github.com/cheshir/go-mq) | 76 | RabbitMQ client with declarative configuration. |
...
| <b>[hare](https://github.com/leozz37/hare) | 50 | A user friendly library for sending messages and listening to TCP sockets. |
...
| <b>[jazz](https://github.com/socifi/jazz) | 16 | A simple RabbitMQ abstraction layer for queue administration and publishing and consuming of messages. |
...
| <b>[go-excel](https://github.com/szyhf/go-excel) | 157 | A simple and light reader to read a relate-db-like excel as a table. |
| <b>[xlsx](https://github.com/plandem/xlsx) | 153 | Fast and safe way to read/update your existing Microsoft Excel files in Go programs. |
...
| <b>[exl](https://github.com/go-the-way/exl) | 11 | Excel binding to struct written in Go.(Only supports Go1.18+) |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[google/wire](https://github.com/google/wire) | 9.1k | Automated Initialization in Go. |
...
| <b>[do](https://github.com/samber/do) | 552 | A dependency injection framework based on Generics. |
| <b>[GoLobby/Container](https://github.com/golobby/container) | 377 | GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language. |
| <b>[goioc/di](https://github.com/goioc/di) | 203 | Spring-inspired Dependency Injection Container. |
| <b>[di](https://github.com/goava/di) | 161 | A dependency injection container for go programming language. |
| <b>[dingo](https://github.com/i-love-flamingo/dingo) | 139 | A dependency injection toolkit for Go, based on Guice. |
| <b>[alice](https://github.com/magic003/alice) | 46 | Additive dependency injection container for Golang. |
| <b>[wire](https://github.com/Fs02/wire) | 36 | Strict Runtime Dependency Injection for Golang. |
...
| <b>[nject](https://github.com/muir/nject) | 19 | A type safe, reflective framework for libraries, tests, http endpoints, and service startup. |
| <b>[gocontainer](https://github.com/vardius/gocontainer) | 17 | Simple Dependency Injection Container. |
...
| <b>[cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 545 | A Go application boilerplate template for quick starting projects following production best practices. |
| <b>[pagoda](https://github.com/mikestefanello/pagoda) | 429 | Rapid, easy full-stack web development starter kit built in Go. |
| <b>[golang-templates/seed](https://github.com/golang-templates/seed) | 320 | Go application GitHub repository template. |
| <b>[go-starter](https://github.com/allaboutapps/go-starter) | 184 | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| <b>[go-todo-backend](https://github.com/Fs02/go-todo-backend) | 167 | Go Todo Backend example using modular project layout for product microservice. |
| <b>[scaffold](https://github.com/catchplay/scaffold) | 120 | Scaffold generates a starter Go project layout. Lets you focus on business logic implemented. |
| <b>[go-sample](https://github.com/zitryss/go-sample) | 108 | A sample layout for Go application projects with the real code. |
...
| <b>[wangyoucao577/go-project-layout](https://github.com/wangyoucao577/go-project-layout) | 18 | Set of practices and discussions on how to structure Go project layout. |
| <b>[insidieux/inizio](https://github.com/insidieux/inizio) | 12 | Golang project layout generator with plugins. |
...
| <b>[sttr](https://github.com/abhimanyu003/sttr) | 416 | cross-platform, cli app to perform various operations on string. |
| <b>[strutil](https://github.com/ozgio/strutil) | 184 | String utilities. |
| <b>[gobeam/Stringy](https://github.com/gobeam/Stringy) | 144 | String manipulation library to convert string to camel case, snake case, kebab case / slugify etc. |
| <b>[bexp](https://github.com/mkungla/bexp) | 10 | Go implementation of Brace Expansion mechanism to generate arbitrary strings. |
...
| <b>[gatus](https://github.com/TwinProduction/gatus) | 2.9k | Automated service health dashboard. |
...
| <b>[llvm](https://github.com/llir/llvm) | 952 | Library for interacting with LLVM IR in pure Go. |
| <b>[shortid](https://github.com/teris-io/shortid) | 799 | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| <b>[health](https://github.com/alexliesenfeld/health) | 608 | A simple and flexible health check library for Go. |
| <b>[stateless](https://github.com/qmuntal/stateless) | 479 | A fluent library for creating state machines. |
| <b>[shoutrrr](https://github.com/containrrr/shoutrrr) | 444 | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
| <b>[health](https://github.com/dimiro1/health) | 434 | Easy to use, extensible health check library. |
| <b>[banner](https://github.com/dimiro1/banner) | 407 | Add beautiful banners into your Go applications. |
| <b>[xz](https://github.com/ulikunitz/xz) | 385 | Pure golang package for reading and writing xz-compressed files. |
| <b>[conv](https://github.com/cstockton/go-conv) | 382 | Package conv provides fast and intuitive conversions across Go types. |
| <b>[gountries](https://github.com/pariz/gountries) | 358 | Package that exposes country and subdivision data. |
| <b>[ffmt](https://github.com/go-ffmt/ffmt) | 277 | Beautify data display for Humans. |
...
| <b>[healthcheck](https://github.com/etherlabsio/healthcheck) | 231 | An opinionated and concurrent health-check HTTP handler for RESTful services. |
| <b>[battery](https://github.com/distatus/battery) | 209 | Cross-platform, normalized battery information library. |
| <b>[go-unarr](https://github.com/gen2brain/go-unarr) | 200 | Decompression library for RAR, TAR, ZIP and 7z archives. |
| <b>[bitio](https://github.com/icza/bitio) | 195 | Highly optimized bit-level Reader and Writer for Go. |
...
| <b>[captcha](https://github.com/steambap/captcha) | 117 | Package captcha provides an easy to use, unopinionated API for captcha generation. |
| <b>[gommit](https://github.com/antham/gommit) | 97 | Analyze git commit messages to ensure they follow defined patterns. |
...
| <b>[morse](https://github.com/alwindoss/morse) | 74 | Library to convert to and from morse code. |
| <b>[gtree](https://github.com/ddddddO/gtree) | 69 | Provide CLI and Package for tree output and directories creation from Markdown or programmatically. |
...
| <b>[pdfgen](https://github.com/hyperboloide/pdfgen) | 59 | HTTP service to generate PDF from Json requests. |
| <b>[xkg](https://github.com/go-xkg/xkg) | 53 | X Keyboard Grabber. |
| <b>[browscap_go](https://github.com/digitalcrab/browscap_go) | 42 | GoLang Library for [Browser Capabilities Project](https://browscap.org/). |
| <b>[datacounter](https://github.com/miolini/datacounter) | 40 | Go counters for readers/writer/http.ResponseWriter. |
| <b>[autoflags](https://github.com/artyom/autoflags) | 37 | Go package to automatically define command line flags from struct fields. |
| <b>[sandid](https://github.com/aofei/sandid) | 37 | Every grain of sand on earth has its own ID. |
| <b>[url-shortener](https://github.com/pantrif/url-shortener) | 37 | A modern, powerful, and robust URL shortener microservice with mysql support. |
| <b>[gosh](https://github.com/osamingo/gosh) | 30 | Provide Go Statistics Handler, Struct, Measure Method. |
...
| <b>[hostutils](https://github.com/Wing924/hostutils) | 11 | A golang library for packing and unpacking FQDNs list. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[whatlanggo](https://github.com/abadojack/whatlanggo) | 549 | Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc). |
...
| <b>[kagome](https://github.com/ikawaha/kagome) | 668 | JP morphological analyzer written in pure Go. |
| <b>[nlp](https://github.com/Shixzie/nlp) | 379 | Extract values from strings and fill your structs with nlp. |
| <b>[nlp](https://github.com/james-bowman/nlp) | 373 | Go Natural Language Processing library supporting LSA (Latent Semantic Analysis). |
| <b>[RAKE.go](https://github.com/afjoseph/RAKE.Go) | 95 | Go port of the Rapid Automatic Keyword Extraction Algorithm (RAKE). |
...
| <b>[govader](https://github.com/jonreiter/govader) | 26 | Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[slug](https://github.com/gosimple/slug) | 854 | URL-friendly slugify with multiple languages support. |
| <b>[go-slugify](https://github.com/mozillazg/go-slugify) | 81 | Make pretty slug with multiple languages support. |
...
| <b>[sentences](https://github.com/neurosnap/sentences) | 329 | Sentence tokenizer:  converts text into a list of sentences. |
...
| <b>[gotext](https://github.com/leonelquinteros/gotext) | 351 | GNU gettext utilities for Go. |
| <b>[go-localize](https://github.com/m1/go-localize) | 43 | Simple and easy to use i18n (Internationalization and localization) engine - used for translating locale strings. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-unidecode](https://github.com/mozillazg/go-unidecode) | 95 | ASCII transliterations of Unicode text. |
...
| <b>[webrtc](https://github.com/pions/webrtc) | 9.9k | A pure Go implementation of the WebRTC API. |
| <b>[quic-go](https://github.com/lucas-clemente/quic-go) | 7.3k | An implementation of the QUIC protocol in pure Go. |
| <b>[gnet](https://github.com/panjf2000/gnet) | 6.9k | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
...
| <b>[ftp](https://github.com/jlaffaye/ftp) | 988 | Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959). |
| <b>[mdns](https://github.com/hashicorp/mdns) | 901 | Simple mDNS (Multicast DNS) client/server library in Golang. |
| <b>[gosnmp](https://github.com/soniah/gosnmp) | 895 | Native Go library for performing SNMP actions. |
| <b>[vssh](https://github.com/yahoo/vssh) | 864 | Go library for building network and server automation over SSH protocol. |
| <b>[nbio](https://github.com/lesismal/nbio) | 777 | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
| <b>[cidranger](https://github.com/yl2chen/cidranger) | 744 | Fast IP to CIDR lookup for Go. |
| <b>[gmqtt](https://github.com/DrmagicE/gmqtt) | 735 | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| <b>[lhttp](https://github.com/fanux/lhttp) | 674 | Powerful websocket framework, build your IM server more easily. |
| <b>[peerdiscovery](https://github.com/schollz/peerdiscovery) | 558 | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| <b>[go-stun](https://github.com/ccding/go-stun) | 520 | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
| <b>[gotcp](https://github.com/gansidui/gotcp) | 498 | Go package for quickly writing tcp applications. |
| <b>[stun](https://github.com/go-rtc/stun) | 485 | Go implementation of RFC 5389 STUN protocol. |
| <b>[easytcp](https://github.com/DarthPestilane/easytcp) | 468 | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
| <b>[gaio](https://github.com/xtaci/gaio) | 455 | High performance async-io networking for Golang in proactor mode. |
| <b>[gopcap](https://github.com/akrennmair/gopcap) | 451 | Go wrapper for libpcap. |
...
| <b>[winrm](https://github.com/masterzen/winrm) | 377 | Go WinRM client to remotely execute commands on Windows machines. |
| <b>[ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 328 | Fully featured FTP server library. |
| <b>[arp](https://github.com/mdlayher/arp) | 293 | Package arp implements the ARP protocol, as described in RFC 826. |
| <b>[buffstreams](https://github.com/stabbycutyou/buffstreams) | 250 | Streaming protocolbuffer data over TCP made easy. |
| <b>[ethernet](https://github.com/mdlayher/ethernet) | 244 | Package ethernet implements marshaling and unmarshaling of IEEE 802.3 Ethernet II frames and IEEE 802.1Q VLAN tags. |
| <b>[gNxI](https://github.com/google/gnxi) | 221 | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
| <b>[dnsmonster](https://github.com/mosajjal/dnsmonster) | 208 | Passive DNS Capture/Monitoring Framework. |
| <b>[jazigo](https://github.com/udhos/jazigo) | 182 | Jazigo is a tool written in Go for retrieving configuration for multiple network devices. |
...
| <b>[iplib](https://github.com/c-robinson/iplib) | 92 | Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html) |
...
| <b>[gldap](https://github.com/jimlambrt/gldap) | 74 | gldap provides an ldap server implementation and you provide handlers for its ldap operations. |
...
| <b>[fullproxy](https://github.com/shoriwe/fullproxy) | 34 | A fully featured scriptable and daemon configurable proxy and pivoting toolkit with SOCKS5, HTTP, raw ports and reverse proxy protocols. |
...
| <b>[gohooks](https://github.com/averageflow/gohooks) | 18 | GoHooks make it easy to send and consume secured web-hooks from a Go application. Inspired by Spatie's Laravel Webhook Client and Server. |
...
| <b>[pester](https://github.com/sethgrid/pester) | 597 | Go HTTP client calls with retries, backoff, and concurrency. |
| <b>[requests](https://github.com/carlmjohnson/requests) | 411 | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| <b>[go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) | 260 | Get easily stdlib HTTP client, which does not share any state with other clients. |
| <b>[request](https://github.com/monaco-io/request) | 213 | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
| <b>[go-otelroundtripper](https://github.com/NdoleStudio/go-otelroundtripper) | 62 | Go http.RoundTripper that emits open telemetry metrics for HTTP requests. |
| <b>[go-http-client](https://github.com/bozd4g/go-http-client) | 41 | Make http calls simply and easily. |
| <b>[rq](https://github.com/ddo/rq) | 41 | A nicer interface for golang stdlib HTTP client. |
| <b>[httpretry](https://github.com/ybbus/httpretry) | 22 | Enriches the default go HTTP client with retry functionality. |
| <b>[go-zoox/fetch](https://github.com/go-zoox/fetch) | 15 | A Powerful, Lightweight, Easy Http Client, inspired by Web Fetch API. |
...
| <b>[gl](https://github.com/go-gl/gl) | 924 | Go bindings for OpenGL (generated via glow). |
| <b>[mathgl](https://github.com/go-gl/mathgl) | 457 | Pure Go math package specialized for 3D math, with inspiration from GLM. |
| <b>[goxjs/gl](https://github.com/goxjs/gl) | 159 | Go cross-platform OpenGL bindings (OS X, Linux, Windows, browsers, iOS, Android). |
...
| <b>[bun](https://github.com/uptrace/bun) | 1.4k | SQL-first Golang ORM. Successor of go-pg. |
...
| <b>[go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 835 | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| <b>[go-queryset](https://github.com/jirfag/go-queryset) | 674 | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
| <b>[rel](https://github.com/go-rel/rel) | 562 | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
| <b>[Zoom](https://github.com/albrow/zoom) | 292 | Blazing-fast datastore and querying engine built on Redis. |
| <b>[go-sql](https://github.com/rushteam/gosql) | 166 | A easy ORM for mysql. |
...
| <b>[golobby/orm](https://github.com/golobby/orm) | 109 | Simple, fast, type-safe, generic orm for developer happiness. |
...
| <b>[goop](https://github.com/nitrous-io/goop) | 777 | Simple dependency manager for Go (golang), inspired by Bundler. |
| <b>[modgv](https://github.com/lucasepe/modgv) | 413 | Converts 'go mod graph' output into Graphviz's DOT language. |
| <b>[nut](https://github.com/jingweno/nut) | 237 | Vendor Go dependencies. |
| <b>[johnny-deps](https://github.com/VividCortex/johnny-deps) | 213 | Minimal dependency version using Git. |
| <b>[mvn-golang](https://github.com/raydac/mvn-golang) | 144 | plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure. |
...
| <b>[pixie](https://github.com/pixie-labs/pixie) | 3.8k | No instrumentation tracing for Golang applications via eBPF. |
| <b>[statsviz](https://github.com/arl/statsviz) | 2.1k | Live visualization of your Go application runtime statistics. |
...
| <b>[jsonql](https://github.com/elgs/jsonql) | 255 | JSON query expression library in Golang. |
| <b>[jsonslice](https://github.com/bhmj/jsonslice) | 69 | Jsonpath queries with advanced filters. |
| <b>[graphql](https://github.com/tmc/graphql) | 56 | graphql parser + utilities. |
| <b>[rqp](https://github.com/timsolov/rest-query-parser) | 44 | Query Parser for REST API. Filtering, validations, both `AND`, `OR` operations are supported directly in the query. |
| <b>[api-fu](https://github.com/ccbrown/api-fu) | 43 | Comprehensive GraphQL implementation. |
| <b>[goven](https://github.com/SeldonIO/goven) | 37 | A drop-in query language for any database schema. |
...
| <b>[fileb0x](https://github.com/UnnoTed/fileb0x) | 612 | Simple tool to embed files in go with focus on "customization" and ease to use. |
...
| <b>[debme](https://github.com/leaanthony/debme) | 21 | Create an `embed.FS` from an existing `embed.FS` subdirectory. |
...
| <b>[dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 884 | Dataframes for machine-learning and statistics (similar to pandas). |
| <b>[go-dsp](https://github.com/mjibson/go-dsp) | 788 | Digital Signal Processing for Go. |
| <b>[chart](https://github.com/vdobler/chart) | 736 | Simple Chart Plotting library for Go. Supports many graphs types. |
| <b>[goraph](https://github.com/gyuho/goraph) | 693 | Pure Go graph theory library(data structure, algorithm visualization). |
| <b>[graph](https://github.com/yourbasic/graph) | 579 | Library of basic graph algorithms. |
| <b>[orb](https://github.com/paulmach/orb) | 574 | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| <b>[ewma](https://github.com/VividCortex/ewma) | 391 | Exponentially-weighted moving averages. |
| <b>[calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 356 | Calendar heatmap in plain Go inspired by Github contribution activity. |
| <b>[gohistogram](https://github.com/VividCortex/gohistogram) | 166 | Approximate histograms for data streams. |
| <b>[TextRank](https://github.com/DavidBelicza/TextRank) | 164 | TextRank implementation in Golang with extendable features (summarization, weighting, phrase extraction) and multithreading (goroutine) support. |
| <b>[sparse](https://github.com/james-bowman/sparse) | 134 | Go Sparse matrix formats for linear algebra supporting scientific and machine learning applications, compatible with gonum matrix libraries. |
| <b>[go-estimate](https://github.com/milosgajdos/go-estimate) | 99 | State estimation and filtering algorithms in Go. |
| <b>[pagerank](https://github.com/alixaxel/pagerank) | 77 | Weighted PageRank algorithm implemented in Go. |
| <b>[jsonl-graph](https://github.com/nikolaydubina/jsonl-graph) | 59 | Tool to manipulate JSONL graphs with graphviz support. |
...
| <b>[decimal](https://github.com/db47h/decimal) | 28 | Package decimal implements arbitrary-precision decimal floating-point arithmetic. |
...
| <b>[assocentity](https://github.com/ndabAP/assocentity) | 9 | Package assocentity returns the average distance from words to a given entity. |
| <b>[rootfinding](https://github.com/khezen/rootfinding) | 9 | root-finding algorithms library for finding roots of quadratic functions. |
| <b>[go-gt](https://github.com/ThePaw/go-gt) | 7 | Graph theory algorithms written in "Go" language. |
| <b>[bradleyterry](https://github.com/seanhagen/bradleyterry) | 6 | Provides a Bradley-Terry Model for pairwise comparisons. |
...
| <b>[Coraza](https://github.com/corazawaf/coraza) | 657 | Enterprise-ready, modsecurity and OWASP CRS compatible WAF library. |
| <b>[nacl](https://github.com/kevinburke/nacl) | 528 | Go implementation of the NaCL set of API's. |
| <b>[ssh-vault](https://github.com/ssh-vault/ssh-vault) | 357 | encrypt/decrypt using ssh keys. |
| <b>[go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 352 | Password validator based on raw cryptographic entropy values. |
| <b>[firewalld-rest](https://github.com/prashantgupta24/firewalld-rest) | 321 | A rest application to dynamically update firewalld rules on a linux server. |
| <b>[optimus-go](https://github.com/pjebs/optimus-go) | 320 | ID hashing and Obfuscation using Knuth's Algorithm. |
| <b>[BadActor](https://github.com/jaredfolkins/badactor) | 311 | In-memory, application-driven jailer built in the spirit of fail2ban. |
| <b>[dongle](https://github.com/golang-module/dongle) | 281 | A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption. |
| <b>[go-yara](https://github.com/hillu/go-yara) | 273 | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
| <b>[passlib](https://github.com/hlandau/passlib) | 270 | Futureproof password hashing library. |
| <b>[simple-scrypt](https://github.com/elithrar/simple-scrypt) | 181 | Scrypt package with a simple, obvious API and automatic cost calibration built-in. |
...
| <b>[argon2-hashing](https://github.com/andskur/argon2-hashing) | 18 | light wrapper around Go's argon2 package that closely mirrors with Go's standard library Bcrypt and simple-scrypt package. |
...
| <b>[secret](https://github.com/rsjethani/secret) | 15 | Prevent your secrets from leaking into logs, std* etc. |
...
| <b>[mapstructure](https://github.com/mitchellh/mapstructure) | 6.1k | Go library for decoding generic map values into native Go structures. |
...
| <b>[csvutil](https://github.com/jszwec/csvutil) | 748 | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| <b>[colfer](https://github.com/pascaldekloe/colfer) | 676 | Code generation for the Colfer binary format. |
| <b>[cbor](https://github.com/fxamacker/cbor) | 486 | Small, safe, and easy CBOR encoding and decoding library. |
...
| <b>[binstruct](https://github.com/ghostiam/binstruct) | 59 | Golang binary decoder for mapping data into the structure. |
| <b>[asn1](https://github.com/PromonLogicalis/asn1) | 51 | Asn.1 BER and DER encoding library for golang. |
| <b>[bel](https://github.com/32leaves/bel) | 27 | Generate TypeScript interfaces from Go structs/interfaces. Useful for JSON RPC. |
...
| <b>[fixedwidth](https://github.com/huydang284/fixedwidth) | 7 | Fixed-width text formatting (UTF-8 supported). |
...
| <b>[SFTPGo](https://github.com/drakkan/sftpgo) | 4.7k | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| <b>[go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 510 | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| <b>[Euterpe](https://github.com/ironsmile/euterpe) | 426 | Self-hosted music streaming server with built-in web UI and REST API. |
| <b>[dummy](https://github.com/neotoolkit/dummy) | 160 | Run mock server based off an API contract with one command. |
| <b>[dudeldu](https://github.com/krotik/dudeldu) | 137 | A simple SHOUTcast server. |
| <b>[lets-proxy2](https://github.com/rekby/lets-proxy2) | 66 | Reverse proxy for handle https with issue certificates in fly from lets-encrypt. |
| <b>[go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) | 65 | Simple Reverse Proxy with Caching, written in Go, using Redis. |
| <b>[cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 53 | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
| <b>[psql-streamer](https://github.com/blind-oracle/psql-streamer) | 42 | Stream database events from PostgreSQL to Kafka. |
| <b>[nginx-prometheus](https://github.com/blind-oracle/nginx-prometheus) | 32 | Nginx log parser and exporter to Prometheus. |
| <b>[simple-jwt-provider](https://github.com/leberKleber/simple-jwt-provider) | 28 | Simple and lightweight provider which exhibits JWTs, supports login, password-reset (via mail) and user management. |
| <b>[protoxy](https://github.com/camgraff/protoxy) | 25 | A proxy server that converts JSON request bodies to Protocol Buffers. |
...
| <b>[machine](https://github.com/whitaker-io/machine) | 115 | Go library for writing and generating stream workers with built in metrics and traceability. |
| <b>[stream](https://github.com/youthlin/stream) | 65 | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
| <b>[goio](https://github.com/primetalk/goio) | 46 | An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2. |
...
| <b>[jet](https://github.com/CloudyKit/jet) | 952 | Jet template engine. |
| <b>[Razor](https://github.com/sipin/gorazor) | 798 | Razor view engine for Golang. |
| <b>[maroto](https://github.com/johnfercher/maroto) | 748 | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
| <b>[fasttemplate](https://github.com/valyala/fasttemplate) | 630 | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
| <b>[ego](https://github.com/benbjohnson/ego) | 534 | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
| <b>[raymond](https://github.com/aymerick/raymond) | 490 | Complete handlebars implementation in Go. |
| <b>[goview](https://github.com/foolin/goview) | 298 | Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application. |
| <b>[liquid](https://github.com/osteele/liquid) | 170 | Go implementation of Shopify Liquid templates. |
...
| <b>[tbd](https://github.com/lucasepe/tbd) | 21 | A really simple way to create text templates with placeholders - exposes extra builtin Git repo metadata. |
...
| <b>[go-vcr](https://github.com/dnaeon/go-vcr) | 941 | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
| <b>[gnomock](https://github.com/orlangure/gnomock) | 937 | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| <b>[goblin](https://github.com/franela/goblin) | 862 | Mocha like testing framework fo Go. |
| <b>[testfixtures](https://github.com/go-testfixtures/testfixtures) | 849 | A helper for Rails' like test fixtures to test database applications. |
| <b>[baloo](https://github.com/h2non/baloo) | 739 | Expressive and versatile end-to-end HTTP API testing made easy. |
| <b>[goc](https://github.com/qiniu/goc) | 567 | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| <b>[go-mutesting](https://github.com/zimmski/go-mutesting) | 550 | Mutation testing for Go source code. |
| <b>[embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 429 | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| <b>[gofight](https://github.com/appleboy/gofight) | 425 | API Handler Testing for Golang Router framework. |
| <b>[testza](https://github.com/MarvinJWendt/testza) | 394 | Full-featured test framework with nice colorized output. |
| <b>[gotest.tools](https://github.com/gotestyourself/gotest.tools) | 352 | A collection of packages to augment the go testing package and support common patterns. |
| <b>[go-testdeep](https://github.com/maxatome/go-testdeep) | 317 | Extremely flexible golang deep comparison, extends the go testing package. |
| <b>[frisby](https://github.com/verdverm/frisby) | 272 | REST API testing framework. |
| <b>[got](https://github.com/ysmood/got) | 252 | An enjoyable golang test framework. |
| <b>[go-carpet](https://github.com/msoap/go-carpet) | 228 | Tool for viewing test coverage in terminal. |
| <b>[cupaloy](https://github.com/bradleyjkemp/cupaloy) | 225 | Simple snapshot testing addon for your test framework. |
| <b>[endly](https://github.com/viant/endly) | 220 | Declarative end to end functional testing. |
| <b>[commander](https://github.com/SimonBaeumer/commander) | 203 | Tool for testing cli applications on windows, linux and osx. |
| <b>[charlatan](https://github.com/percolate/charlatan) | 196 | Tool to generate fake interface implementations for tests. |
...
| <b>[go-hit](https://github.com/Eun/go-hit) | 130 | Hit is an http integration test framework written in golang. |
| <b>[GoSpec](https://github.com/orfjackal/gospec) | 113 | BDD-style testing framework for the Go programming language. |
| <b>[testcase](https://github.com/adamluzsi/testcase) | 99 | Idiomatic testing framework for Behavior Driven Development. |
| <b>[wstest](https://github.com/posener/wstest) | 94 | Websocket client for unit-testing a websocket http.Handler. |
| <b>[jsonassert](https://github.com/kinbiko/jsonassert) | 91 | Package for verifying that your JSON payloads are serialized correctly. |
...
| <b>[assert](https://github.com/go-playground/assert) | 46 | Basic Assertion Library used along side native go testing, with building blocks for custom assertions. |
...
| <b>[be](https://github.com/carlmjohnson/be) | 19 | The minimalist generic test assertion library. |
...
| <b>[flute](https://github.com/suzuki-shunsuke/flute) | 16 | HTTP client testing framework. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gomock](https://github.com/golang/mock) | 7.9k | Mocking framework for the Go programming language. |
...
| <b>[counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 719 | Tool for generating self-contained mock objects. |
| <b>[go-txdb](https://github.com/DATA-DOG/go-txdb) | 478 | Single transaction based database driver mainly for testing purposes. |
| <b>[minimock](https://github.com/gojuno/minimock) | 462 | Mock generator for Go interfaces. |
| <b>[govcr](https://github.com/seborama/govcr) | 128 | HTTP mock for Golang: record and replay HTTP interactions for offline testing. |
| <b>[timex](https://github.com/cabify/timex) | 64 | A test-friendly replacement for the native `time` package. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[chromedp](https://github.com/knq/chromedp) | 8.1k | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
...
| <b>[playwright-go](https://github.com/mxschmitt/playwright-go) | 928 | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| <b>[cdp](https://github.com/mafredri/cdp) | 633 | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[failpoint](https://github.com/pingcap/failpoint) | 736 | An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| <b>[bytes](https://github.com/labstack/gommon/tree/master/bytes) | 463 | Formats and parses numeric byte values (10K, 2M, 3G, etc.). |
| <b>[gotabulate](https://github.com/bndr/gotabulate) | 287 | Easily pretty-print your tabular data with Go. |
| <b>[align](https://github.com/Guitarbum722/align) | 77 | A general purpose application that aligns text. |
...
| <b>[address](https://github.com/bojanz/address) | 54 | Handles address representation, validation and formatting. |
...
| <b>[htmlquery](https://github.com/antchfx/htmlquery) | 516 | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| <b>[html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 385 | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
| <b>[goq](https://github.com/andrewstuart/goq) | 216 | Declarative unmarshaling of HTML using struct tags with jQuery syntax (uses GoQuery). |
| <b>[bafi](https://github.com/mmalcek/bafi) | 63 | Universal JSON, BSON, YAML, XML translator to ANY format using templates. |
...
| <b>[commonregex](https://github.com/mingrammer/commonregex) | 829 | A collection of common regular expressions for Go. |
| <b>[gographviz](https://github.com/awalterschulze/gographviz) | 493 | Parses the Graphviz DOT language. |
| <b>[omniparser](https://github.com/jf-tech/omniparser) | 492 | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| <b>[go-nmea](https://github.com/adrianmo/go-nmea) | 183 | NMEA parser library for the Go language. |
| <b>[sdp](https://github.com/gortc/sdp) | 113 | SDP: Session Description Protocol [[RFC 4566](https://tools.ietf.org/html/rfc4566)]. |
| <b>[editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) | 103 | Editorconfig file parser and manipulator for Go. |
| <b>[go-vcard](https://github.com/emersion/go-vcard) | 75 | Parse and format vCard. |
...
| <b>[gonameparts](https://github.com/polera/gonameparts) | 37 | Parses human names into individual name parts. |
| <b>[normalize](https://github.com/avito-tech/normalize) | 31 | Sanitize, normalize and compare fuzzy text. |
| <b>[xj2go](https://github.com/stackerzzq/xj2go) | 27 | Convert xml or json to go struct. |
| <b>[codetree](https://github.com/aerogo/codetree) | 21 | Parses indented code (python, pixy, scarlet, etc.) and returns a tree structure. |
| <b>[tokenizer](https://github.com/bzick/tokenizer) | 19 | — Parse any string, slice or infinite buffer to any tokens. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[regroup](https://github.com/oriser/regroup) | 118 | Match regex expression named groups into go struct using struct tags and automatic parsing. |
| <b>[rex](https://github.com/hedhyw/rex) | 116 | Regular expressions builder. |
| <b>[goregen](https://github.com/zach-klippenstein/goregen) | 74 | Library for generating random strings from regular expressions. |
| <b>[genex](https://github.com/alixaxel/genex) | 67 | Count and expand Regular Expressions into all matching Strings. |
...
| <b>[gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) | 49 | A sanitization-based swear filter for Go. |
...
| <b>[xurls](https://github.com/mvdan/xurls) | 953 | Extract urls from text. |
| <b>[dataflowkit](https://github.com/slotix/dataflowkit) | 541 | Web scraping Framework to turn websites into structured data. |
| <b>[gospider](https://github.com/zhshch2002/gospider) | 172 | A simple golang spider/scraping framework,build a spider in 3 lines. migrated from [goribot](https://github.com/zhshch2002/goribot) |
| <b>[pagser](https://github.com/foolin/pagser) | 69 | Pagser is a simple, extensible, configurable parse and deserialize html page to struct based on goquery and struct tags for golang crawler. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-runewidth](https://github.com/mattn/go-runewidth) | 482 | Functions to get fixed width of the character or string. |
| <b>[radix](https://github.com/yourbasic/radix) | 178 | Fast string sorting algorithm. |
| <b>[go-zero-width](https://github.com/trubitsyn/go-zero-width) | 104 | Zero-width character detection and removal for Go. |
| <b>[petrovich](https://github.com/striker2000/petrovich) | 40 | Petrovich is the library which inflects Russian names to given grammatical case. |
...
| <b>[githubql](https://github.com/shurcooL/githubql) | 916 | Go library for accessing the GitHub GraphQL API v4. |
| <b>[webhooks](https://github.com/go-playground/webhooks) | 772 | Webhook receiver for GitHub and Bitbucket. |
| <b>[paypal](https://github.com/logpacker/PayPal-Go-SDK) | 521 | Wrapper for PayPal payment API. |
...
| <b>[twitter-scraper](https://github.com/n0madic/twitter-scraper) | 250 | Scrape the Twitter Frontend API without authentication and limits. |
| <b>[ethrpc](https://github.com/onrik/ethrpc) | 242 | Go bindings for Ethereum JSON RPC API. |
| <b>[lark](https://github.com/chyroc/lark) | 225 | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
| <b>[Trello](https://github.com/adlio/trello) | 202 | Go wrapper for the Trello API. |
| <b>[go-marathon](https://github.com/gambol99/go-marathon) | 196 | Go library for interacting with Mesosphere's Marathon PAAS. |
...
| <b>[wit-go](https://github.com/wit-ai/wit-go) | 128 | Go client for wit.ai HTTP API. |
| <b>[pushover](https://github.com/gregdel/pushover) | 125 | Go wrapper for the Pushover API. |
...
| <b>[go-lark](https://github.com/go-lark/lark) | 111 | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
...
| <b>[simples3](https://github.com/rhnvrm/simples3) | 92 | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
...
| <b>[gosip](https://github.com/koltyakov/gosip) | 82 | Go client library SharePoint API. |
| <b>[igdb](https://github.com/Henry-Sarabia/igdb) | 75 | Go client for the [Internet Game Database API](https://api.igdb.com/). |
| <b>[go-unsplash](https://github.com/hbagdi/go-unsplash) | 67 | Go client library for the [Unsplash.com](https://unsplash.com) API. |
| <b>[gogtrends](https://github.com/groovili/gogtrends) | 67 | Google Trends Unofficial API. |
...
| <b>[go-atlassian](https://github.com/ctreminiom/go-atlassian) | 52 | Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud) |
| <b>[ynab](https://github.com/brunomvsouza/ynab.go) | 52 | Go wrapper for the YNAB API. |
| <b>[go-postman-collection](https://github.com/rbretecher/go-postman-collection) | 51 | Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia). |
| <b>[uptimerobot](https://github.com/bitfield/uptimerobot) | 50 | Go wrapper and command-line client for the Uptime Robot v2 API. |
| <b>[gads](https://github.com/emiddleton/gads) | 49 | Google Adwords Unofficial API. |
| <b>[mixpanel](https://github.com/dukex/mixpanel) | 48 | Mixpanel is a library for tracking events and sending Mixpanel profile updates to Mixpanel from your go applications. |
| <b>[fcm](https://github.com/maddevsio/fcm) | 47 | Go library for Firebase Cloud Messaging. |
| <b>[GoMusicBrainz](https://github.com/michiwend/gomusicbrainz) | 46 | Go MusicBrainz WS2 client library. |
...
| <b>[google-play-scraper](https://github.com/n0madic/google-play-scraper) | 40 | Get data from Google Play Store. |
...
| <b>[patreon-go](https://github.com/mxpv/patreon-go) | 32 | Go library for Patreon API. |
...
| <b>[device-check-go](https://github.com/rinchsan/device-check-go) | 15 | Go client library for interacting with [iOS DeviceCheck API](https://developer.apple.com/documentation/devicecheck) v1. |
...
| <b>[go-chronos](https://github.com/axelspringer/go-chronos) | 6 | Go library for interacting with the [Chronos](https://mesos.github.io/chronos/) Job Scheduler |
...
| <b>[lo](https://github.com/samber/lo) | 7.7k | A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...) |
...
| <b>[git-time-metric](https://github.com/git-time-metric/gtm) | 904 | Simple, seamless, lightweight time tracking for Git. |
| <b>[mimetype](https://github.com/gabriel-vasile/mimetype) | 817 | Package for MIME type detection based on magic numbers. |
| <b>[hostctl](https://github.com/guumaster/hostctl) | 802 | A CLI tool to manage /etc/hosts with easy commands. |
| <b>[immortal](https://github.com/immortal/immortal) | 749 | \*nix cross-platform (OS agnostic) supervisor. |
| <b>[scany](https://github.com/georgysavva/scany) | 678 | Library for scanning data from a database into Go structs and more. |
| <b>[circuit](https://github.com/cep21/circuit) | 660 | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
| <b>[htcat](https://github.com/htcat/htcat) | 549 | Parallel and Pipelined HTTP GET Utility. |
| <b>[ergo](https://github.com/cristianoliveira/ergo) | 536 | The management of multiple local services running over different ports made easy. |
| <b>[delve](https://github.com/derekparker/delve) | 520 | Go debugger. |
...
| <b>[gubrak](https://github.com/novalagung/gubrak) | 415 | Golang utility library with syntactic sugar. It's like lodash, but for golang. |
| <b>[clockwork](https://github.com/jonboulle/clockwork) | 411 | A simple fake clock for golang. |
| <b>[Deepcopier](https://github.com/ulule/deepcopier) | 391 | Simple struct copying for Go. |
| <b>[changie](https://github.com/miniscruff/changie) | 382 | Automated changelog tool for preparing releases with lots of customization options. |
| <b>[go-rate](https://github.com/beefsack/go-rate) | 369 | Timed rate limiter for Go. |
| <b>[remote-touchpad](https://github.com/Unrud/remote-touchpad) | 326 | Control mouse and keyboard from a smartphone. |
| <b>[retry](https://github.com/kamilsk/retry) | 324 | The most advanced functional mechanism to perform actions repetitively until successful. |
| <b>[mani](https://github.com/alajmo/mani) | 308 | CLI tool to help you manage multiple repositories. |
| <b>[scan](https://github.com/blockloop/scan) | 304 | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
| <b>[serve](https://github.com/syntaqx/serve) | 276 | A static http server anywhere you need. |
| <b>[clipboard](https://github.com/golang-design/clipboard) | 262 | 📋 cross-platform clipboard package in Go. |
| <b>[gohper](https://github.com/cosiner/gohper) | 256 | Various tools/modules help for development. |
| <b>[util](https://github.com/shomali11/util) | 254 | Collection of useful utility functions. (strings, concurrency, manipulations, ...). |
| <b>[gotenv](https://github.com/subosito/gotenv) | 232 | Load environment variables from `.env` or any `io.Reader` in Go. |
...
| <b>[grofer](https://github.com/pesos/grofer) | 219 | A system and resource monitoring tool written in Golang! |
| <b>[wifiqr](https://github.com/reugn/wifiqr) | 213 | Wi-Fi QR Code Generator. |
| <b>[pattern-match](https://github.com/alexpantyukhin/go-pattern-match) | 185 | Pattern matching libray. |
| <b>[Death](https://github.com/vrecan/death) | 181 | Managing go application shutdown with signals. |
| <b>[go-bind-plugin](https://github.com/wendigo/go-bind-plugin) | 181 | go:generate tool for wrapping symbols exported by golang plugins (1.8 only). |
| <b>[rospo](https://github.com/ferama/rospo) | 181 | Simple and reliable ssh tunnels with embedded ssh server in Golang. |
| <b>[toolbox](https://github.com/viant/toolbox) | 181 | Slice, map, multimap, struct, function, data conversion utilities. Service router, macro evaluator, tokenizer. |
| <b>[go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 180 | XML Sitemap generator written in Go. |
| <b>[countries](https://github.com/biter777/countries) | 179 | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
| <b>[rerun](https://github.com/ivpusic/rerun) | 164 | Recompiling and rerunning go apps when source changes. |
| <b>[moldova](https://github.com/StabbyCutyou/moldova) | 161 | Utility for generating random data based on an input template. |
...
| <b>[go-bsdiff](https://github.com/gabstv/go-bsdiff) | 135 | Pure Go bsdiff and bspatch libraries and CLI tools. |
...
| <b>[cryptgo](https://github.com/Gituser143/cryptgo) | 118 | Crytpgo is a TUI based application written purely in Go to monitor and observe cryptocurrency prices in real time! |
...
| <b>[cmd](https://github.com/SimonBaeumer/cmd) | 104 | Library for executing shell commands on osx, windows and linux. |
| <b>[mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 104 | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
| <b>[limiters](https://github.com/mennanov/limiters) | 102 | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
...
| <b>[goseaweedfs](https://github.com/linxGnu/goseaweedfs) | 97 | SeaweedFS client library with almost full features. |
| <b>[xferspdy](https://github.com/monmohan/xferspdy) | 93 | Xferspdy provides binary diff and patch library in golang. |
| <b>[filter](https://github.com/gookit/filter) | 90 | provide filtering, sanitizing, and conversion of Go data. |
...
| <b>[goval](https://github.com/maja42/goval) | 85 | Evaluate arbitrary expressions in Go. |
...
| <b>[go-lock](https://github.com/viney-shih/go-lock) | 78 | go-lock is a lock library implementing read-write mutex and read-write trylock without starvation. |
...
| <b>[pgo](https://github.com/arthurkushman/pgo) | 70 | Convenient functions for PHP community. |
...
| <b>[go-httpheader](https://github.com/mozillazg/go-httpheader) | 40 | Go library for encoding structs into Header fields. |
...
| <b>[set](https://github.com/nofeaturesonlybugs/set) | 38 | Performant and flexible struct mapping and loose type conversion. |
...
| <b>[gostrutils](https://github.com/ik5/gostrutils) | 37 | Collections of string manipulation and conversion functions. |
| <b>[shutdown](https://github.com/ztrue/shutdown) | 36 | App shutdown hooks for `os.Signal` handling. |
| <b>[evaluator](https://github.com/nullne/evaluator) | 34 | Evaluate an expression dynamicly based on s-expression. It's simple and easy to extend. |
| <b>[myhttp](https://github.com/inancgumus/myhttp) | 34 | Simple API to make HTTP GET requests with timeout support. |
| <b>[sshman](https://github.com/shoobyban/sshman) | 33 | SSH Manager for authorized_keys files on multiple remote servers. |
...
| <b>[cvt](https://github.com/shockerli/cvt) | 19 | Easy and safe convert any value to another type. |
...
| <b>[go-type](https://github.com/mikekonan/go-types) | 14 | Library providing Go types for store/validation and transfer of ISO-4217, ISO-3166, and other types. |
...
| <b>[retry](https://github.com/percolate/retry) | 7 | A simple but highly configurable retry package for Go. |
...
| <b>[loncha](https://github.com/kazu/loncha) | 5 | A high-performance slice Utilities. |
...
| <b>[wuid](https://github.com/edwingeng/wuid) | 471 | An extremely fast unique number generator, 10-135 times faster than UUID. |
| <b>[sno](https://github.com/muyo/sno) | 71 | Compact, sortable and fast unique IDs with embedded metadata. |
...
| <b>[validate](https://github.com/gookit/validate) | 778 | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| <b>[validate](https://github.com/gobuffalo/validate) | 74 | This package provides a framework for writing validations for Go applications. |
| <b>[jio](https://github.com/faceair/jio) | 69 | jio is a json schema validator similar to [joi](https://github.com/hapijs/joi). |
| <b>[gody](https://github.com/guiferpa/gody) | 62 | :balloon: A lightweight struct validator for Go. |
| <b>[govalid](https://github.com/twharmon/govalid) | 30 | Fast, tag-based validation for structs. |
| <b>[Validator](https://github.com/go-the-way/validator) | 3 | A lightweight model validator written in Go.Contains VFs:Min, Max, MinLength, MaxLength, Length, Enum, Regex. |
...
| <b>[m3u8](https://github.com/grafov/m3u8) | 955 | Parser and generator library of M3U8 playlists for Apple HLS. |
| <b>[gmf](https://github.com/3d0c/gmf) | 792 | Go bindings for FFmpeg av\* libraries. |
| <b>[go-astits](https://github.com/asticode/go-astits) | 434 | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
| <b>[go-astisub](https://github.com/asticode/go-astisub) | 406 | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| <b>[libvlc-go](https://github.com/adrg/libvlc-go) | 314 | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
| <b>[gortsplib](https://github.com/aler9/gortsplib) | 295 | Pure Go RTSP server and client library. |
| <b>[gst](https://github.com/ziutek/gst) | 165 | Go bindings for GStreamer. |
| <b>[go-m3u8](https://github.com/quangngotan95/go-m3u8) | 98 | Parser and generator library for Apple m3u8 playlists. |
...
| <b>[Gearbox](https://github.com/abahmed/gearbox) | 669 | A web framework written in Go with a focus on high performance and memory optimization. |
| <b>[Aero](https://github.com/aerogo/aero) | 498 | High-performance web framework for Go, reaches top scores in Lighthouse. |
...
| <b>[mango](https://github.com/paulbellamy/mango) | 369 | Mango is a modular web-application framework for Go, inspired by Rack, and PEP333. |
| <b>[Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 352 | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| <b>[Flamingo](https://github.com/i-love-flamingo/flamingo) | 312 | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| <b>[Gondola](https://github.com/rainycape/gondola) | 309 | The web framework for writing faster sites, faster. |
| <b>[rk-boot](https://github.com/rookie-ninja/rk-boot) | 281 | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
| <b>[Golf](https://github.com/dinever/golf) | 258 | Golf is a fast, simple and lightweight micro-web framework for Go. It comes with powerful features and has no dependencies other than the Go Standard Library. |
| <b>[WebGo](https://github.com/bnkamalesh/webgo) | 258 | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
| <b>[Ginrpc](https://github.com/xxjwxc/ginrpc) | 235 | Gin parameter automatic binding tool,gin rpc tools. |
| <b>[uAdmin](https://github.com/uadmin/uadmin) | 200 | Fully featured web framework for Golang, inspired by Django. |
| <b>[hiboot](https://github.com/hidevopsio/hiboot) | 177 | hiboot is a high performance web application framework with auto configuration and dependency injection support. |
| <b>[Huma](https://github.com/danielgtaylor/huma/) | 135 | Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI. |
...
| <b>[Microservice](https://github.com/claygod/microservice) | 102 | The framework for the creation of microservices, written in Golang. |
...
| <b>[anoweb](https://github.com/go-the-way/anoweb) | 4 | The lightweight and powerful web framework using the new way for Go.Another go the way. |
...
| <b>[XFF](https://github.com/sebest/xff) | 93 | Handle `X-Forwarded-For` header and friends. |
| <b>[rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 46 | Middleware for gRPC with logging, metrics, auth, tracing etc. |
| <b>[formjson](https://github.com/rs/formjson) | 36 | Transparently handle JSON input as a standard form POST. |
| <b>[rk-gin](https://github.com/rookie-ninja/rk-gin) | 34 | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
| <b>[client-timing](https://github.com/posener/client-timing) | 20 | An HTTP client for Server-Timing header. |
| <b>[echo-middleware](https://github.com/faabiosr/echo-middleware) | 11 | Middleware for Echo framework with logging and metrics. |
...
| <b>[mediary](https://github.com/HereMobilityDevelopers/mediary) | 80 | add interceptors to `http.Client` to allow dumping/shaping/tracing/... of requests/responses. |
...
| <b>[fasthttprouter](https://github.com/buaazp/fasthttprouter) | 869 | High performance router forked from `httprouter`. The first router fit for `fasthttp`. |
| <b>[httptreemux](https://github.com/dimfeld/httptreemux) | 557 | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
| <b>[xujiajun/gorouter](https://github.com/xujiajun/gorouter) | 527 | A simple and fast HTTP router for Go. |
| <b>[ozzo-routing](https://github.com/go-ozzo/ozzo-routing) | 440 | An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs. |
...
| <b>[GoRouter](https://github.com/vardius/gorouter) | 133 | GoRouter is a Server/API micro framework, HTTP request router, multiplexer, mux that provides request router with middleware supporting `net/context`. |
...
| <b>[goblin](https://github.com/bmf-san/goblin) | 38 | A golang http router based on trie tree. |
| <b>[FastRouter](https://github.com/razonyang/fastrouter) | 21 | a fast, flexible HTTP router written in Go. |
| <b>[GoLobby/Router](https://github.com/golobby/router) | 19 | GoLobby Router is a lightweight yet powerful HTTP router for the Go programming language. |
| <b>[goroute](https://github.com/goroute/route) | 8 | Simple yet powerful HTTP request multiplexer. |
| <b>[nchi](https://github.com/muir/nchi) | 5 | chi-like router built on httprouter with dependency injection based middleware wrappers |
...
| <b>[go-canvas](https://github.com/markfarnan/go-canvas) | 174 | Library to use HTML5 Canvas, with all drawing within go code. |
| <b>[wasmbrowsertest](https://github.com/agnivade/wasmbrowsertest) | 130 | Run Go WASM tests in your browser. |
| <b>[webapi](https://github.com/gowebapi/webapi) | 118 | Bindings for DOM and HTML generated from WebIDL. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-ole](https://github.com/go-ole/go-ole) | 899 | Win32 OLE implementation for golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[zek](https://github.com/miku/zek) | 593 | Generate a Go struct from XML. |
| <b>[xpath](https://github.com/antchfx/xpath) | 507 | XPath package for Go. |
...
| <b>[php-parser](https://github.com/z7zmey/php-parser) | 891 | A Parser for PHP written in Go. |
| <b>[goast-viewer](https://github.com/yuroyoro/goast-viewer) | 651 | Web based Golang AST visualizer. |
| <b>[go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 619 | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
...
| <b>[golines](https://github.com/segmentio/golines) | 459 | Formatter that automatically shortens long lines in Go code. |
| <b>[todocheck](https://github.com/preslavmihaylov/todocheck) | 389 | Static code analyser which links TODO comments in code with issues in your issue tracker. |
| <b>[unconvert](https://github.com/mdempsky/unconvert) | 331 | Remove unnecessary type conversions from Go source. |
| <b>[dupl](https://github.com/mibk/dupl) | 292 | Tool for code clone detection. |
| <b>[tickgit](https://github.com/augmentable-dev/tickgit) | 279 | CLI and go package for surfacing code comment TODOs (in any language) and applying a `git blame`to identify the author. |
...
| <b>[go-outdated](https://github.com/firstrow/go-outdated) | 43 | Console application that displays outdated packages. |
| <b>[ChainJacking](https://github.com/Checkmarx/chainjacking) | 28 | Find which of your Go lang direct GitHub dependencies is susceptible to ChainJacking attack. |
| <b>[usestdlibvars](https://github.com/sashamelentyev/usestdlibvars) | 20 | A linter that detect the possibility to use variables/constants from the Go standard library. |
...
| <b>[golang-ifood-sdk](https://github.com/arxdsilva/golang-ifood-sdk) | 9 | iFood API SDK. |
...
| <b>[coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) | 483 | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| <b>[Watch](https://github.com/eaburns/Watch) | 194 | Runs a command in an acme win on file changes. |
| <b>[goimports-reviser](https://github.com/incu6us/goimports-reviser) | 182 | Formatting tool for imports. |
...
| <b>[xgen](https://github.com/xuri/xgen) | 183 | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| <b>[gocontracts](https://github.com/Parquery/gocontracts) | 86 | brings design-by-contract to Go by synchronizing the code with the documentation. |
...
| <b>[depth](https://github.com/KyleBanks/depth) | 784 | Visualize dependency trees of any package by analyzing imports. |
| <b>[richgo](https://github.com/kyoh86/richgo) | 724 | Enrich `go test` outputs with text decorations. |
...
| <b>[roumon](https://github.com/becheran/roumon) | 117 | Monitor current state of all active goroutines via a command line interface. |
...
| <b>[go-james](https://github.com/pieterclaerhout/go-james) | 54 | Go project skeleton creator, builds and tests your projects without the manual setup. |
| <b>[igo](https://github.com/rocketlaunchr/igo) | 53 | An igo to go transpiler (new language features for Go language!) |
| <b>[go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) | 40 | Bash completion for go and wgo. |
...
| <b>[gotestdox](https://github.com/bitfield/gotestdox) | 16 | Show Go test results as readable sentences. |
| <b>[docs](https://github.com/go-oas/docs) | 13 | Automatically generate RESTful API documentation for GO projects - aligned with Open API Specification standard. |
...
| <b>[Ddosify](https://github.com/ddosify/ddosify) | 4.8k | High-performance load testing tool, written in Golang. |
...
| <b>[Fleet device management](https://github.com/fleetdm/fleet) | 917 | Lightweight, programmable telemetry for servers and workstations. |
| <b>[skm](https://github.com/TimothyYe/skm) | 811 | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| <b>[Scaleway-cli](https://github.com/scaleway/scaleway-cli) | 768 | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| <b>[uTask](https://github.com/ovh/utask) | 728 | Automation engine that models and executes business processes declared in yaml. |
| <b>[kwatch](https://github.com/abahmed/kwatch) | 678 | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
| <b>[cassowary](https://github.com/rogerwelin/cassowary) | 614 | Modern cross-platform HTTP load-testing tool written in Go. |
| <b>[kool](https://github.com/kool-dev/kool) | 610 | Command line tool for managing Docker environments as an easy way. |
| <b>[aurora](https://github.com/xuri/aurora) | 566 | Cross-platform web-based Beanstalkd queue server console. |
| <b>[govvv](https://github.com/ahmetalpbalkan/govvv) | 528 | “go build” wrapper to easily add version information into Go binaries. |
| <b>[Pewpew](https://github.com/bengadbois/pewpew) | 353 | Flexible HTTP command line stress tester. |
| <b>[jcli](https://github.com/jenkins-zh/jenkins-cli) | 336 | Jenkins CLI allows you manage your Jenkins as an easy way. |
| <b>[gonative](https://github.com/inconshreveable/gonative) | 332 | Tool which creates a build of Go that can cross compile to all platforms while still using the Cgo-enabled versions of the stdlib packages. |
...
| <b>[Mora](https://github.com/emicklei/mora) | 305 | REST server for accessing MongoDB documents and meta data. |
| <b>[lstags](https://github.com/ivanilves/lstags) | 293 | Tool and API to sync Docker images across different registries. |
| <b>[Balerter](https://github.com/balerter/balerter) | 275 | A self-hosted script-based alerting manager. |
| <b>[manssh](https://github.com/xwjdsh/manssh) | 270 | manssh is a command line tool for managing your ssh alias config easily. |
| <b>[easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 255 | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
| <b>[dogo](https://github.com/liudng/dogo) | 250 | Monitoring changes in the source file and automatically compile and run (restart). |
| <b>[godbg](https://github.com/sirnewton01/godbg) | 225 | Web-based gdb front-end application. |
| <b>[terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 218 | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
| <b>[Blast](https://github.com/dave/blast) | 210 | A simple tool for API load testing and batch jobs. |
| <b>[gobrew](https://github.com/cryptojuice/gobrew) | 191 | gobrew lets you easily switch between multiple versions of go. |
| <b>[abbreviate](https://github.com/dnnrly/abbreviate) | 185 | abbreviate is a tool turning long strings in to shorter ones with configurable seperaters, for example to embed branch names in to deployment stack IDs. |
| <b>[kcli](https://github.com/cswank/kcli) | 183 | Command line tool for inspecting kafka topics/partitions/messages. |
| <b>[ostent](https://github.com/ostrost/ostent) | 174 | collects and displays system metrics and optionally relays to Graphite and/or InfluxDB. |
| <b>[grapes](https://github.com/yaronsumel/grapes) | 157 | Lightweight tool designed to distribute commands over ssh with ease. |
| <b>[winrm-cli](https://github.com/masterzen/winrm-cli) | 142 | Cli tool to remotely execute commands on Windows machines. |
| <b>[Dockerfile-Generator](https://github.com/ozankasikci/dockerfile-generator) | 134 | A go library and an executable that produces valid Dockerfiles using various input channels. |
| <b>[s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 125 | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
| <b>[drone-scp](https://github.com/appleboy/drone-scp) | 109 | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
| <b>[go-furnace](https://github.com/go-furnace/go-furnace) | 92 | Hosting solution written in Go. Deploy your Application with ease on AWS, GCP or DigitalOcean. |
| <b>[Mantil](https://github.com/mantil-io/mantil) | 80 | Go specific framework for building serverless applications on AWS that enables you to focus on pure Go code while Mantil takes care of the infrastructure. |
| <b>[go-rocket-update](https://github.com/mouuff/go-rocket-update) | 70 | A simple way to make self updating Go applications - Supports Github and Gitlab. |
...
| <b>[toxiproxy](https://github.com/shopify/toxiproxy) | 8.5k | Proxy to simulate network and system conditions for automated tests. |
...
| <b>[blocky](https://github.com/0xERR0R/blocky) | 1.8k | Fast and lightweight DNS proxy as ad-blocker for local network with many features. |
...
| <b>[shell2http](https://github.com/msoap/shell2http) | 976 | Executing shell commands via http server (for prototyping or remote control). |
| <b>[vFlow](https://github.com/VerizonDigital/vflow) | 917 | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| <b>[peg](https://github.com/pointlander/peg) | 867 | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
| <b>[Leaps](https://github.com/jeffail/leaps) | 725 | Pair programming service using Operational Transforms. |
| <b>[gfile](https://github.com/Antonito/gfile) | 676 | Securely transfer files between two computers, without any third party, over WebRTC. |
| <b>[Guora](https://github.com/meloalright/guora) | 604 | A self-hosted Quora like web application written in Go. |
| <b>[Gebug](https://github.com/moshebe/gebug) | 600 | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
| <b>[gocc](https://github.com/goccmack/gocc) | 537 | Gocc is a compiler kit for Go written in Go. |
| <b>[mockingjay](https://github.com/quii/mockingjay-server) | 520 | Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests. |
| <b>[sake](https://github.com/alajmo/sake) | 463 | sake is a command runner for local and remote hosts. |
| <b>[go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 453 | Video streaming torrent client. |
| <b>[Gokapi](https://github.com/Forceu/gokapi) | 396 | Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload. |
...
| <b>[woke](https://github.com/get-woke/woke) | 346 | Detect non-inclusive language in your source code. |
| <b>[tcpprobe](https://github.com/mehrdadrad/tcpprobe) | 325 | TCP tool for network performance and path monitoring, including socket statistics. |
...
| <b>[Neo-cowsay](https://github.com/Code-Hex/Neo-cowsay) | 225 | 🐮 cowsay is reborn. for a New Era. |
| <b>[tcpdog](https://github.com/mehrdadrad/tcpdog) | 201 | eBPF based TCP observability. |
| <b>[joincap](https://github.com/assafmo/joincap) | 176 | Command-line utility for merging multiple pcap files together. |
| <b>[Orbit](https://github.com/gulien/orbit) | 170 | A simple tool for running commands and generating files from templates. |
| <b>[vaku](https://github.com/lingrino/vaku) | 138 | CLI & API for folder-based functions in Vault like copy, move, and search. |
| <b>[stew](https://github.com/marwanhawari/stew) | 104 | An independent package manager for compiled binaries. |
...
| <b>[crawley](https://github.com/s0rg/crawley) | 67 | Web scraper/crawler for cli. |
...
| <b>[speedtest-resize](https://github.com/fawick/speedtest-resize) | 221 | Compare various Image resize algorithms for the Go language. |
...
| <b>[gopherize.me](https://github.com/matryer/gopherize.me) | 595 | Gopherize yourself. |
| <b>[gopher-stickers](https://github.com/tenntenn/gopher-stickers) | 539 | gopher stickers |
| <b>[gopher-logos](https://github.com/GolangUA/gopher-logos) | 106 | adorable gopher logos. |
| <b>[gophers](https://github.com/sillecelik/go-gopher) | 105 | Gopher amigurumi toy pattern. |
...
| <b>[Awesome Golang Workshops](https://github.com/amit-davidson/awesome-golang-workshops) | 470 | A curated list of awesome golang workshops. |
...
| <b>[Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) | 6.9k | Go's reference card. |
| <b>[go-clean-template](https://github.com/evrone/go-clean-template) | 3.6k | Clean Architecture template for Golang services. |
...
| <b>[goapp](https://github.com/bnkamalesh/goapp) | 517 | An opinionated guideline to structure & develop a Go web application/service. |
