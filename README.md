...
| <b>[PortAudio](https://github.com/gordonklaus/portaudio) | 520 | Go bindings for the PortAudio audio I/O library. |
| <b>[music-theory](https://github.com/go-music-theory/music-theory) | 402 | Music theory models in Go. |
| <b>[id3v2](https://github.com/bogem/id3v2) | 252 | ID3 decoding and encoding library for Go. |
| <b>[GoAudio](https://github.com/DylanMeeus/GoAudio) | 239 | Native Go Audio Processing Library. |
| <b>[flac](https://github.com/mewkiz/flac) | 217 | Native Go FLAC encoder/decoder with support for FLAC streams. |
| <b>[malgo](https://github.com/gen2brain/malgo) | 185 | Mini audio library. |
| <b>[gaad](https://github.com/Comcast/gaad) | 103 | Native Go AAC bitstream parser. |
| <b>[minimp3](https://github.com/tosone/minimp3) | 84 | Lightweight MP3 decoder library. |
...
| <b>[paseto](https://github.com/o1egl/paseto) | 617 | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
| <b>[jwt](https://github.com/cristalhq/jwt) | 555 | Safe, simple and fast JSON Web Tokens for Go. |
| <b>[permissions2](https://github.com/xyproto/permissions2) | 459 | Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. |
...
| <b>[jwt](https://github.com/pascaldekloe/jwt) | 287 | Lightweight JSON Web Token (JWT) library. |
...
| <b>[sessionup](https://github.com/swithek/sessionup) | 117 | Simple, yet effective HTTP session management and identification package. |
...
| <b>[go-email-normalizer](https://github.com/dimuska139/go-email-normalizer) | 50 | Golang library for providing a canonical representation of email address. |
...
| <b>[solana-go](https://github.com/gagliardetto/solana-go) | 348 | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
| <b>[gossamer](https://github.com/ChainSafe/gossamer) | 345 | A Go implementation of the Polkadot Host. |
...
| <b>[Kelp](https://github.com/stellar/kelp) | 912 | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| <b>[Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) | 807 | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| <b>[go-chat-bot](https://github.com/go-chat-bot/bot) | 750 | IRC, Slack & Telegram bot written in Go. |
| <b>[slacker](https://github.com/shomali11/slacker) | 673 | Easy to use framework to create Slack bots. |
| <b>[tbot](https://github.com/yanzay/tbot) | 323 | Telegram bot server with API similar to net/http. |
| <b>[wayback](https://github.com/wabarc/wayback) | 292 | A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages. |
| <b>[go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 247 | Library to write bots for twitch.tv chat |
| <b>[go-sarah](https://github.com/oklahomer/go-sarah) | 246 | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
| <b>[Tenyks](https://github.com/kyleterry/tenyks) | 173 | Service oriented IRC bot using Redis and JSON for messaging. |
| <b>[echotron](https://github.com/NicoNex/echotron) | 162 | An elegant and concurrent library for Telegram Bots in Go. |
| <b>[hanu](https://github.com/sbstjn/hanu) | 138 | Framework for writing Slack bots. |
...
| <b>[slack-bot](https://github.com/innogames/slack-bot) | 104 | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
| <b>[telego](https://github.com/mymmrac/telego) | 85 | Telegram Bot API library for Golang with full one-to-one API implementation. |
...
| <b>[goyek](https://github.com/goyek/goyek) | 301 | Create build pipelines in Go. |
| <b>[taskctl](https://github.com/taskctl/taskctl) | 201 | Concurrent task runner. |
| <b>[1build](https://github.com/gopinath-langote/1build) | 174 | Command line tool to frictionlessly manage project-specific commands. |
...
| <b>[progressbar](https://github.com/schollz/progressbar) | 2.6k | Basic thread-safe progress bar that works in every OS. |
...
| <b>[go-isatty](https://github.com/mattn/go-isatty) | 632 | isatty for golang. |
| <b>[go-colorable](https://github.com/mattn/go-colorable) | 631 | Colorable writer for windows. |
| <b>[gommon/color](https://github.com/labstack/gommon/tree/master/color) | 453 | Style terminal text. |
| <b>[chalk](https://github.com/ttacon/chalk) | 404 | Intuitive package for prettifying terminal/console output. |
| <b>[simpletable](https://github.com/alexeyco/simpletable) | 375 | Simple tables in terminal with Go. |
| <b>[yacspin](https://github.com/theckman/yacspin) | 353 | Yet Another CLi Spinner package, for working with terminal spinners. |
| <b>[tabby](https://github.com/cheynewallace/tabby) | 319 | A tiny library for super simple Golang tables. |
| <b>[box-cli-maker](https://github.com/Delta456/box-cli-maker) | 222 | Make Highly Customized Boxes for your CLI. |
...
| <b>[liner](https://github.com/peterh/liner) | 910 | Go readline-like library for command-line interfaces. |
| <b>[complete](https://github.com/posener/complete) | 835 | Write bash completions in Go + Go command bash completion. |
| <b>[mow.cli](https://github.com/jawher/mow.cli) | 811 | Go library for building CLI applications with sophisticated flag and argument parsing and validation. |
| <b>[flaggy](https://github.com/integrii/flaggy) | 802 | A robust and idiomatic flags package with excellent subcommand support. |
| <b>[cli](https://github.com/mkideal/cli) | 664 | Feature-rich and easy to use command-line package based on golang struct tags. |
| <b>[argparse](https://github.com/akamensky/argparse) | 438 | Command line argument parser inspired by Python's argparse module. |
...
| <b>[sflags](https://github.com/octago/sflags) | 139 | Struct based flags generator for flag, urfave/cli, pflag, cobra, kingpin and other libraries. |
...
| <b>[cmdr](https://github.com/hedzr/cmdr) | 111 | A POSIX/GNU style, getopt-like command-line UI Go library. |
| <b>[env](https://github.com/codingconcepts/env) | 92 | Tag-based environment configuration for structs. |
| <b>[carapace-bin](https://github.com/rsteube/carapace-bin) | 62 | Multi-shell multi-command argument completer. |
...
| <b>[carapace](https://github.com/rsteube/carapace) | 41 | Command argument completion generator for spf13/cobra. |
...
| <b>[go-andotp](https://github.com/grijul/go-andotp) | 16 | A CLI program to encrypt/decrypt [andOTP](https://github.com/andOTP/andOTP) files. Can be used as library as well. |
...
| <b>[cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 673 | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| <b>[confita](https://github.com/heetch/confita) | 448 | Load configuration in cascade from multiple backends into a struct. |
| <b>[aconfig](https://github.com/cristalhq/aconfig) | 385 | Simple, useful and opinionated config loader. |
| <b>[gookit/config](https://github.com/gookit/config) | 375 | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| <b>[config](https://github.com/JeremyLoy/config) | 313 | Cloud native application configuration. Bind ENV to structs in only two lines. |
| <b>[GoLobby/Config](https://github.com/golobby/config) | 287 | GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language. |
| <b>[hjson](https://github.com/hjson/hjson-go) | 268 | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
...
| <b>[xdg](https://github.com/adrg/xdg) | 244 | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
| <b>[envconfig](https://github.com/vrischmann/envconfig) | 222 | Read your configuration from environment variables. |
| <b>[fig](https://github.com/kkyr/fig) | 222 | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
...
| <b>[harvester](https://github.com/beatlabs/harvester) | 112 | Harvester, a easy to use static and dynamic configuration package supportig seeding, env vars and Consul integration. |
| <b>[onion](https://github.com/goraz/onion) | 105 | Layer based configuration for Go, Supports JSON, TOML, YAML, properties, etcd, env, and encryption using PGP. |
...
| <b>[configuration](https://github.com/BoRuDar/configuration) | 73 | Library for initializing configuration structs from env variables, files, flags and 'default' tag. |
...
| <b>[goveralls](https://github.com/mattn/goveralls) | 732 | Go integration for Coveralls.io continuous code coverage tracking system. |
| <b>[gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 223 | go test output for humans. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gcss](https://github.com/yosssi/gcss) | 454 | Pure Go CSS Preprocessor. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[bitset](https://github.com/bits-and-blooms/bitset) | 953 | Go package implementing bitsets. |
| <b>[bitmap](https://github.com/kelindar/bitmap) | 162 | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| <b>[gostl](https://github.com/liyue201/gostl) | 688 | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| <b>[algorithms](https://github.com/shady831213/algorithms) | 657 | Algorithms and data structures.CLRS study. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[iter](https://github.com/disksing/iter) | 158 | Go implementation of C++ STL iterators and algorithms. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[cmap](https://github.com/lrita/cmap) | 33 | a thread-safe concurrent map for go, support using `interface{}` as key and auto scale up shards. |
| <b>[dict](https://github.com/srfrog/dict) | 28 | Python-like dictionaries (dict) for Go. |
| <b>[goradd/maps](https://github.com/goradd/maps) | 9 | Go 1.18+ generic map interface for maps; safe maps; ordered maps; ordered, safe maps; etc. |
...
| <b>[hyperloglog](https://github.com/axiomhq/hyperloglog) | 790 | HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |
...
| <b>[hide](https://github.com/emvi/hide) | 48 | ID type with marshalling to/from hash to prevent sending IDs to clients. |
| <b>[concurrent-writer](https://github.com/free/concurrent-writer) | 44 | Highly concurrent drop-in replacement for `bufio.Writer`. |
| <b>[go-tuple](https://github.com/barweiss/go-tuple) | 29 | Generic tuple implementation for Go 1.18+. |
| <b>[fsm](https://github.com/cocoonspace/fsm) | 26 | Finite-State Machine package. |
| <b>[genfuncs](https://github.com/nwillc/genfuncs) | 20 | Go 1.18+ generics package inspired by Kotlin's Sequence and Map. |
| <b>[go18ds](https://github.com/daichi-m/go18ds) | 19 | Go Data Structures using Go 1.18 generics. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[nan](https://github.com/kak-tus/nan) | 53 | Zero allocation Nullable structures in one library with handy conversion functions, marshallers and unmarshallers. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[deque](https://github.com/gammazero/deque) | 361 | Fast ring-buffer deque (double-ended queue). |
| <b>[goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 199 | Concurrent FIFO queue. |
| <b>[memlog](https://github.com/embano1/memlog) | 57 | An easy to use, lightweight, thread-safe and append-only in-memory data structure inspired by Apache Kafka. |
| <b>[deque](https://github.com/edwingeng/deque) | 53 | A highly optimized double-ended queue. |
...
| <b>[goset](https://github.com/zoumo/goset) | 48 | A useful Set collection implementation for Go. |
...
| <b>[trie](https://github.com/derekparker/trie) | 597 | Trie implementation in Go. |
| <b>[go-edlib](https://github.com/hbollon/go-edlib) | 335 | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| <b>[go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 239 | Go implementation of Adaptive Radix Tree. |
| <b>[levenshtein](https://github.com/agnivade/levenshtein) | 226 | Implementation to calculate levenshtein distance in Go. |
...
| <b>[treemap](https://github.com/igrmk/treemap) | 23 | Generic key-sorted map using a red-black tree under the hood. |
...
| <b>[ttlcache](https://github.com/jellydator/ttlcache) | 468 | An in-memory cache with item expiration and generics. |
...
| <b>[cache](https://github.com/akyoto/cache) | 109 | In-memory key:value store with expiration time, 0 dependencies, <100 LoC, 100% coverage. |
...
| <b>[go-cache](https://github.com/viney-shih/go-cache) | 66 | A flexible multi-layer Go caching library to deal with in-memory and shared cache by adopting Cache-Aside pattern. |
...
| <b>[VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 6.8k | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
...
| <b>[Databunker](https://github.com/paranoidguy/databunker) | 994 | Personally identifiable information (PII) storage service built to comply with GDPR and CCPA. |
| <b>[column](https://github.com/kelindar/column) | 959 | High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions. |
| <b>[eliasdb](https://github.com/krotik/eliasdb) | 930 | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| <b>[pogreb](https://github.com/akrylysov/pogreb) | 913 | Embedded key-value store for read-heavy workloads. |
| <b>[lotusdb](https://github.com/flower-corp/lotusdb) | 907 | Fast k/v database compatible with lsm and b+tree. |
| <b>[moss](https://github.com/couchbase/moss) | 877 | Moss is a simple LSM key-value storage engine written in 100% Go. |
| <b>[levigo](https://github.com/jmhodges/levigo) | 406 | Levigo is a Go wrapper for LevelDB. |
| <b>[pudge](https://github.com/recoilme/pudge) | 326 | Fast and simple key/value store written using Go's standard library. |
| <b>[dtf](https://github.com/dtm-labs/dtf) | 239 | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
...
| <b>[clover](https://github.com/ostafen/clover) | 237 | A lightweight document-oriented NoSQL database written in pure Golang. |
| <b>[piladb](https://github.com/fern4lvarez/piladb) | 195 | Lightweight RESTful database engine based on stack data structures. |
| <b>[unitdb](https://github.com/unit-io/unitdb) | 93 | Fast timeseries database for IoT, realtime messaging  applications. Access unitdb with pubsub over tcp or websocket using github.com/unit-io/unitd application. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[migrate](https://github.com/golang-migrate/migrate) | 9.3k | Database migrations. CLI and Golang library. |
...
| <b>[goavro](https://github.com/linkedin/goavro) | 817 | A Go package that encodes and decodes Avro data. |
| <b>[gormigrate](https://github.com/go-gormigrate/gormigrate) | 790 | Database schema migration helper for Gorm ORM. |
| <b>[darwin](https://github.com/GuiaBolso/darwin) | 131 | Database schema evolution library for Go. |
...
| <b>[sqlize](https://github.com/sunary/sqlize) | 36 | Database migration generator. Allows generate sql migration from model and existing sql by differ them. |
...
| <b>[gorm-seeder](https://github.com/Kachit/gorm-seeder) | 1 | Simple database seeder for Gorm ORM. |
...
| <b>[chproxy](https://github.com/Vertamedia/chproxy) | 941 | HTTP proxy for ClickHouse database. |
| <b>[pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 759 | Advanced scheduling for PostgreSQL. |
| <b>[clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 373 | Collects small inserts and sends big requests to ClickHouse servers. |
| <b>[myreplication](https://github.com/2tvenom/myreplication) | 186 | MySql binary log replication listener. Supports statement and row based replication. |
| <b>[octillery](https://github.com/knocknote/octillery) | 167 | Go package for sharding databases ( Supports every ORM or raw SQL ). |
| <b>[rdb](https://github.com/HDT3213/rdb) | 160 | Redis RDB file parser for secondary development and memory analysis. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sqlc](https://github.com/kyleconroy/sqlc) | 6.0k | Generate type-safe code from SQL. |
...
| <b>[jet](https://github.com/go-jet/jet) | 767 | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
| <b>[Dotsql](https://github.com/gchaincl/dotsql) | 642 | Go library that helps you keep sql files in one place and use them with ease. |
| <b>[ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 565 | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
| <b>[dbq](https://github.com/rocketlaunchr/dbq) | 350 | Zero boilerplate database operations for Go. |
| <b>[sqlingo](https://github.com/lqs/sqlingo) | 246 | A lightweight DSL to build SQL in Go. |
| <b>[sqrl](https://github.com/elgris/sqrl) | 242 | SQL query builder, fork of Squirrel with improved performance. |
| <b>[sq](https://github.com/bokwoon95/go-structured-query) | 164 | Type-safe SQL builder and struct mapper for Go. |
...
| <b>[sqlf](https://github.com/leporo/sqlf) | 77 | Fast SQL query builder. |
| <b>[buildsqlx](https://github.com/arthurkushman/buildsqlx) | 68 | Go database query builder library for PostgreSQL. |
...
| <b>[bqb](https://github.com/nullism/bqb) | 39 | Lightweight and easy to learn query builder. |
| <b>[gosql](https://github.com/twharmon/gosql) | 22 | SQL Query builder with better null values support. |
...
| <b>[gokv](https://github.com/philippgille/gokv) | 452 | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| <b>[sqlhooks](https://github.com/qustavo/sqlhooks) | 567 | Attach hooks to any database/sql driver. |
| <b>[godror](https://github.com/godror/godror) | 375 | Oracle driver for Go, using the ODPI-C driver. |
...
| <b>[firebirdsql](https://github.com/nakagami/firebirdsql) | 172 | Firebird RDBMS SQL driver for Go. |
...
| <b>[qmgo](https://github.com/qiniu/qmgo) | 937 | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
| <b>[mgm](https://github.com/kamva/mgm) | 536 | MongoDB model-based ODM for Go (based on official MongoDB driver). |
| <b>[redeo](https://github.com/bsm/redeo) | 415 | Redis-protocol compatible TCP servers/services. |
| <b>[aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 395 | Aerospike client in Go language. |
...
| <b>[go-rejson](https://github.com/nitishm/go-rejson) | 273 | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| <b>[elasticsql](https://github.com/cch123/elasticsql) | 942 | Convert sql to elasticsearch dsl in Go. |
...
| <b>[carbon](https://github.com/uniplaces/carbon) | 719 | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
...
| <b>[go-persian-calendar](https://github.com/yaa110/go-persian-calendar) | 122 | The implementation of the Persian (Solar Hijri) Calendar in Go (golang). |
...
| <b>[go-str2duration](https://github.com/xhit/go-str2duration) | 42 | Convert string to duration. Support time.Duration returned string and more. |
...
| <b>[go-doudou](https://github.com/unionj-cloud/go-doudou) | 835 | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
| <b>[redis-lock](https://github.com/bsm/redislock) | 754 | Simplified distributed locking implementation using Redis. |
| <b>[rain](https://github.com/cenkalti/rain) | 748 | BitTorrent client and library. |
| <b>[ringpop-go](https://github.com/uber/ringpop-go) | 740 | Scalable, fault-tolerant application-layer sharding for Go applications. |
| <b>[gorpc](https://github.com/valyala/gorpc) | 652 | Simple, fast and scalable RPC library for high load. |
| <b>[go-health](https://github.com/InVisionApp/go-health) | 627 | Library for enabling asynchronous dependency health checks in your service. |
| <b>[arpc](https://github.com/lesismal/arpc) | 550 | More effective network communication, support two-way-calling, notify, broadcast. |
| <b>[consistent](https://github.com/buraksezer/consistent) | 494 | Consistent hashing with bounded loads. |
| <b>[go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 487 | A library built to provide support for defining async service health checks for golang services. |
| <b>[digota](https://github.com/digota/digota) | 455 | grpc ecommerce microservice. |
...
| <b>[go-jump](https://github.com/dgryski/go-jump) | 344 | Port of Google's "Jump" Consistent Hash function. |
...
| <b>[DDNS](https://github.com/skibish/ddns) | 214 | Personal DDNS client with Digital Ocean Networking DNS as backend. |
...
| <b>[SendGrid](https://github.com/sendgrid/sendgrid-go) | 833 | SendGrid's Go library for sending email. |
| <b>[mailgun-go](https://github.com/mailgun/mailgun-go) | 610 | Go library for sending mail with the Mailgun API. |
| <b>[email-verifier](https://github.com/AfterShip/email-verifier) | 491 | A Go library for email verification without sending any emails. |
| <b>[go-simple-mail](https://github.com/xhit/go-simple-mail) | 350 | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
...
| <b>[smtpmock](https://github.com/mocktools/go-smtp-mock) | 50 | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
...
| <b>[go-mail](https://github.com/wneessen/go-mail) | 27 | A simple Go library for sending mails in Go. |
...
| <b>[metacall](https://github.com/metacall/core) | 995 | Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more. |
...
| <b>[gval](https://github.com/PaesslerAG/gval) | 516 | A highly customizable expression language written in Go. |
| <b>[gisp](https://github.com/jcla1/gisp) | 485 | Simple LISP in Go. |
| <b>[prolog](https://github.com/ichiban/prolog) | 391 | Embeddable Prolog. |
...
| <b>[errorx](https://github.com/joomcode/errorx) | 879 | A feature rich error package with stack traces, composition of errors and more. |
| <b>[tracerr](https://github.com/ztrue/tracerr) | 728 | Golang errors with stack trace and source fragments. |
...
| <b>[exception](https://github.com/rbrahul/exception) | 14 | A simple utility package for exception handling with try-catch in Golang. |
...
| <b>[notify](https://github.com/rjeczalik/notify) | 752 | File system event notification library with simple API, similar to os/signal. |
| <b>[copy](https://github.com/otiai10/copy) | 449 | Copy directory recursively. |
...
| <b>[vfs](https://github.com/C2FO/vfs) | 181 | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
| <b>[go-exiftool](https://github.com/barasher/go-exiftool) | 126 | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
| <b>[go-csv-tag](https://github.com/artonge/go-csv-tag) | 95 | Load csv file using tag. |
| <b>[gofs](https://github.com/no-src/gofs) | 83 | A file synchronization tool out of the box. |
...
| <b>[checksum](https://github.com/codingsince1985/checksum) | 64 | Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files. |
...
| <b>[baraka](https://github.com/xis/baraka) | 44 | A library to process http file uploads easily. |
...
| <b>[accounting](https://github.com/leekchan/accounting) | 758 | money and currency formatting for golang. |
| <b>[techan](https://github.com/sdcoffey/techan) | 655 | Technical analysis library with advanced market analysis and trading strategies. |
| <b>[go-finance](https://github.com/FlashBoys/go-finance) | 537 | Comprehensive financial markets data in Go. |
| <b>[currency](https://github.com/bojanz/currency) | 328 | Handles currency amounts, provides currency information and formatting. |
| <b>[ach](https://github.com/moov-io/ach) | 323 | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
...
| <b>[vat](https://github.com/dannyvankooten/vat) | 94 | VAT number validation & EU VAT rates. |
...
| <b>[fpmoney](https://github.com/nikolaydubina/fpmoney) | 5 | Fast and simple ISO4217 fixed-point decimal money. |
...
| <b>[gorilla/csrf](https://github.com/gorilla/csrf) | 815 | CSRF protection for Go web applications & services. |
| <b>[binding](https://github.com/mholt/binding) | 791 | Binds form and JSON data from net/http Request to struct. |
| <b>[form](https://github.com/go-playground/form) | 541 | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
| <b>[conform](https://github.com/leebenson/conform) | 263 | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
...
| <b>[httpin](https://github.com/ggicci/httpin) | 97 | Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc. |
...
| <b>[mo](https://github.com/samber/mo) | 739 | Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...). |
| <b>[fpGo](https://github.com/TeaEntityLab/fpGo) | 280 | Monad, Functional Programming features for Golang. |
| <b>[gofp](https://github.com/rbrahul/gofp) | 127 | A lodash like powerful utility library for Golang. |
| <b>[fuego](https://github.com/seborama/fuego) | 118 | Functional Experiment in Go. |
| <b>[fp-go](https://github.com/repeale/fp-go) | 79 | Collection of Functional Programming helpers powered by Golang 1.18+ generics. |
| <b>[underscore](https://github.com/rjNemo/underscore) | 59 | Functional programming helpers for Go 1.18 and beyond. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Ebiten](https://github.com/hajimehoshi/ebiten) | 6.8k | dead simple 2D game library in Go. |
...
| <b>[raylib-go](https://github.com/gen2brain/raylib-go) | 838 | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
| <b>[Azul3D](https://github.com/azul3d/engine) | 550 | 3D game engine written in Go. |
| <b>[go-astar](https://github.com/beefsack/go-astar) | 509 | Go implementation of the A\* path finding algorithm. |
...
| <b>[tile](https://github.com/kelindar/tile) | 59 | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
...
| <b>[goderive](https://github.com/awalterschulze/goderive) | 997 | Derives functions from input types. |
| <b>[GoWrap](https://github.com/hexdigest/gowrap) | 631 | Generate decorators for Go interfaces using simple templates. |
| <b>[go-enum](https://github.com/abice/go-enum) | 356 | Code generation for enums from code comments. |
| <b>[interfaces](https://github.com/rjeczalik/interfaces) | 348 | Command line tool for generating interface definitions. |
| <b>[copygen](https://github.com/switchupcb/copygen) | 154 | Generate type-to-type code without reflection. |
| <b>[goverter](https://github.com/jmattheis/goverter) | 135 | Generate converters by defining an interface. |
| <b>[gotype](https://github.com/wzshiming/gotype) | 44 | Golang source code parsing, usage like reflect package. |
...
| <b>[go-xray](https://github.com/pieterclaerhout/go-xray) | 22 | Helpers for making the use of reflection easier. |
...
| <b>[mbtileserver](https://github.com/consbio/mbtileserver) | 365 | A simple Go-based server for map tiles stored in mbtiles format. |
| <b>[osm](https://github.com/paulmach/osm) | 219 | Library for reading, writing and working with OpenStreetMap data and APIs. |
...
| <b>[geoserver](https://github.com/hishamkaram/geoserver) | 73 | geoserver Is a Go Package For Manipulating a GeoServer Instance via the GeoServer REST API. |
| <b>[simplefeatures](https://github.com/peterstace/simplefeatures) | 56 | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
...
| <b>[c2go](https://github.com/goplus/c2go) | 187 | Convert C code to Go code. |
| <b>[esp32](https://github.com/andygeiss/esp32-transpiler) | 48 | Transpile Go into Arduino code. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[ants](https://github.com/panjf2000/ants) | 8.8k | A high-performance and low-cost goroutine pool in Go. |
...
| <b>[workerpool](https://github.com/gammazero/workerpool) | 876 | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| <b>[grpool](https://github.com/ivpusic/grpool) | 699 | Lightweight Goroutine pool. |
...
| <b>[pond](https://github.com/alitto/pond) | 585 | Minimalistic and High-performance goroutine worker pool written in Go. |
| <b>[gowp](https://github.com/xxjwxc/gowp) | 401 | gowp is concurrency limiting goroutine pool. |
| <b>[go-floc](https://github.com/workanator/go-floc) | 255 | Orchestrate goroutines with ease. |
| <b>[go-flow](https://github.com/kamildrazkiewicz/go-flow) | 195 | Control goroutines execution order. |
...
| <b>[neilotoole/errgroup](https://github.com/neilotoole/errgroup) | 130 | Drop-in alternative to `sync/errgroup`, limited to a pool of N worker goroutines. |
...
| <b>[gollback](https://github.com/vardius/gollback) | 93 | asynchronous simple function utilities, for managing execution of closures and callbacks. |
...
| <b>[Hunch](https://github.com/AaronJan/Hunch) | 84 | Hunch provides functions like: `All`, `First`, `Retry`, `Waterfall` etc., that makes asynchronous flow control more intuitive. |
| <b>[async](https://github.com/reugn/async) | 83 | An alternative sync library for Go (Future, Promise, Locks). |
| <b>[worker-pool](https://github.com/vardius/worker-pool) | 82 | goworker is a Go simple async worker pool. |
| <b>[threadpool](https://github.com/shettyh/threadpool) | 74 | Golang threadpool implementation. |
...
| <b>[nursery](https://github.com/arunsworld/nursery) | 47 | Structured concurrency in Go. |
| <b>[gohive](https://github.com/loveleshsharma/gohive) | 39 | A highly performant and easy to use Goroutine pool for Go. |
...
| <b>[gowl](https://github.com/hamed-yousefi/gowl) | 27 | Gowl is a process management and process monitoring tool at once. An infinite worker pool gives you the ability to control the pool and processes and monitor their status. |
...
| <b>[gosx-notifier](https://github.com/deckarep/gosx-notifier) | 573 | OSX Desktop Notifications library for Go. |
| <b>[gowd](https://github.com/dtylman/gowd) | 368 | Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform. |
| <b>[zenity](https://github.com/ncruces/zenity) | 305 | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
...
| <b>[emgo](https://github.com/ziutek/emgo) | 984 | Go-like language for programming embedded systems (e.g. STM32 MCU). |
| <b>[sysinfo](https://github.com/zcalusic/sysinfo) | 363 | A pure Go library providing Linux OS / kernel / hardware system information. |
| <b>[goroslib](https://github.com/aler9/goroslib) | 204 | Robot Operating System (ROS) library for Go. |
| <b>[go-osc](https://github.com/hypebeast/go-osc) | 155 | Open Sound Control (OSC) bindings for Go. |
...
| <b>[govips](https://github.com/davidbyttow/govips) | 724 | A lightning fast image processing and resizing library for Go. |
| <b>[image2ascii](https://github.com/qeesung/image2ascii) | 678 | Convert image to ASCII. |
| <b>[draft](https://github.com/lucasepe/draft) | 541 | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| <b>[goimagehash](https://github.com/corona10/goimagehash) | 518 | Go Perceptual image hashing package. |
| <b>[govatar](https://github.com/o1egl/govatar) | 509 | Library and CMD tool for generating funny avatars. |
| <b>[mort](https://github.com/aldor007/mort) | 460 | Storage and image processing server written in Go. |
...
| <b>[gltf](https://github.com/qmuntal/gltf) | 168 | Efficient and robust glTF 2.0 reader, writer and validator. |
| <b>[steganography](https://github.com/auyer/steganography) | 150 | Pure Go Library for LSB steganography. |
| <b>[img](https://github.com/hawx/img) | 139 | Selection of image manipulation tools. |
| <b>[go-cairo](https://github.com/ungerik/go-cairo) | 120 | Go binding for the cairo graphics library. |
| <b>[cameron](https://github.com/aofei/cameron) | 87 | An avatar generator for Go. |
| <b>[go-webp](https://github.com/kolesa-team/go-webp) | 61 | Library for encode and decode webp pictures, using libwebp. |
...
| <b>[huego](https://github.com/amimof/huego) | 210 | An extensive Philips Hue client library for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gocron](https://github.com/go-co-op/gocron) | 2.1k | Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron). |
...
| <b>[go-quartz](https://github.com/reugn/go-quartz) | 906 | Simple, zero-dependency scheduling library for Go. |
| <b>[gron](https://github.com/roylee0704/gron) | 900 | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| <b>[jobs](https://github.com/albrow/jobs) | 489 | Persistent and flexible background jobs library. |
| <b>[scheduler](https://github.com/carlescere/scheduler) | 390 | Cronjobs scheduling made easy. |
| <b>[Dagu](https://github.com/dagu-go/dagu) | 253 | No-code workflow executor. it executes DAGs defined in a simple YAML format. |
...
| <b>[gronx](https://github.com/adhocore/gronx) | 207 | Cron expression parser, task runner and daemon consuming crontab like task list. |
...
| <b>[goflow](https://github.com/fieldryand/goflow) | 46 | A workflow orchestrator and scheduler for rapid prototyping of ETL/ML/AI pipelines. |
| <b>[cheek](https://github.com/datarootsio/cheek) | 44 | A simple crontab like scheduler that aims to offer a KISS approach to job scheduling. |
| <b>[sched](https://github.com/romshark/sched) | 25 | A job scheduler with the ability to fast-forward time. |
| <b>[cdule](https://github.com/deepaksinghvi/cdule) | 8 | Job scheduler library with database support |
...
| <b>[OjG](https://github.com/ohler55/ojg) | 491 | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
...
| <b>[marshmallow](https://github.com/PerimeterX/marshmallow) | 179 | Performant JSON unmarshaling for flexible use cases. |
| <b>[jsondiff](https://github.com/wI2L/jsondiff) | 176 | JSON diff library for Go based on RFC6902 (JSON Patch). |
| <b>[jettison](https://github.com/wI2L/jettison) | 129 | Fast and flexible JSON encoder for Go. |
| <b>[ajson](https://github.com/spyzhov/ajson) | 122 | Abstract JSON for golang with JSONPath support. |
| <b>[gjo](https://github.com/skanehira/gjo) | 110 | Small utility to create JSON objects. |
| <b>[json2go](https://github.com/m-zajac/json2go) | 103 | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
...
| <b>[ask](https://github.com/simonnilsson/ask) | 16 | Easy access to nested values in maps and slices. Works in combination with encoding/json and other packages that "Unmarshal" arbitrary data into Go data-types. |
...
| <b>[jzon](https://github.com/zerosnake0/jzon) | 7 | JSON library with standard compatible API/behavior. |
...
| <b>[phuslu/log](https://github.com/phuslu/log) | 437 | Structured Logging Made Easy. |
...
| <b>[httpretty](https://github.com/henvic/httpretty) | 268 | Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest). |
| <b>[rollingwriter](https://github.com/arthurkiller/rollingWriter) | 237 | RollingWriter is an auto-rotate `io.Writer` implementation with multi policies to provide log file rotation. |
| <b>[sqldb-logger](https://github.com/simukti/sqldb-logger) | 229 | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
| <b>[glg](https://github.com/kpango/glg) | 168 | glg is simple and fast leveled logging library for Go. |
| <b>[logur](https://github.com/logur/logur) | 164 | An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus), [go-kit log](https://github.com/go-kit/kit/tree/master/log), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog), etc). |
...
| <b>[slog](https://github.com/gookit/slog) | 110 | Lightweight, configurable, extensible logger for Go. |
...
| <b>[gorse](https://github.com/zhenghaoz/gorse) | 6.0k | An offline recommender system backend based on collaborative filtering written in Go. |
...
| <b>[eaopt](https://github.com/MaxHalford/eaopt) | 803 | An evolutionary optimization library. |
...
| <b>[ocrserver](https://github.com/otiai10/ocrserver) | 516 | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
| <b>[onnx-go](https://github.com/owulveryck/onnx-go) | 402 | Go Interface to Open Neural Network Exchange (ONNX). |
| <b>[go-deep](https://github.com/patrikeh/go-deep) | 380 | A feature-rich neural network library in Go. |
| <b>[regommend](https://github.com/muesli/regommend) | 299 | Recommendation & collaborative filtering engine. |
| <b>[Goptuna](https://github.com/c-bata/goptuna) | 219 | Bayesian optimization framework for black-box functions written in Go. Everything will be optimized. |
...
| <b>[goscore](https://github.com/asafschers/goscore) | 81 | Go Scoring API for PMML. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sarama](https://github.com/Shopify/sarama) | 9.0k | Go library for Apache Kafka. |
...
| <b>[Benthos](https://github.com/Jeffail/benthos) | 4.6k | A message streaming bridge between a range of protocols. |
...
| <b>[Asynq](https://github.com/hibiken/asynq) | 3.8k | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| <b>[Mercure](https://github.com/dunglas/mercure) | 2.9k | Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events). |
...
| <b>[Chanify](https://github.com/chanify/chanify) | 893 | A push notification server send message to your iOS devices. |
| <b>[dbus](https://github.com/godbus/dbus) | 736 | Native Go bindings for D-Bus. |
| <b>[golongpoll](https://github.com/jcuga/golongpoll) | 606 | HTTP longpoll server library that makes web pub-sub simple. |
| <b>[mangos](https://github.com/nanomsg/mangos) | 530 | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
| <b>[amqp](https://github.com/rabbitmq/amqp091-go) | 446 | Go RabbitMQ Client Library. |
...
| <b>[Bus](https://github.com/mustafaturan/bus) | 270 | Minimalist message bus implementation for internal communication. |
| <b>[Quamina](https://github.com/timbray/quamina) | 231 | Fast pattern-matching for filtering messages and events. |
...
| <b>[hub](https://github.com/leandro-lugaresi/hub) | 117 | A Message/Event Hub for Go applications, using publish/subscribe pattern with support for alias like rabbitMQ exchanges. |
...
| <b>[go-excel](https://github.com/szyhf/go-excel) | 151 | A simple and light reader to read a relate-db-like excel as a table. |
...
| <b>[exl](https://github.com/go-the-way/exl) | 9 | Excel binding to struct written in Go.(Only supports Go1.18+) |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[google/wire](https://github.com/google/wire) | 8.8k | Automated Initialization in Go. |
...
| <b>[do](https://github.com/samber/do) | 445 | A dependency injection framework based on Generics. |
...
| <b>[dingo](https://github.com/i-love-flamingo/dingo) | 133 | A dependency injection toolkit for Go, based on Guice. |
...
| <b>[cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 532 | A Go application boilerplate template for quick starting projects following production best practices. |
| <b>[pagoda](https://github.com/mikestefanello/pagoda) | 377 | Rapid, easy full-stack web development starter kit built in Go. |
| <b>[golang-templates/seed](https://github.com/golang-templates/seed) | 277 | Go application GitHub repository template. |
| <b>[go-starter](https://github.com/allaboutapps/go-starter) | 174 | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| <b>[go-todo-backend](https://github.com/Fs02/go-todo-backend) | 163 | Go Todo Backend example using modular project layout for product microservice. |
| <b>[scaffold](https://github.com/catchplay/scaffold) | 116 | Scaffold generates a starter Go project layout. Lets you focus on business logic implemented. |
| <b>[go-sample](https://github.com/zitryss/go-sample) | 103 | A sample layout for Go application projects with the real code. |
| <b>[gobase](https://github.com/wajox/gobase) | 29 | A simple skeleton for golang application with basic setup for real golang application. |
...
| <b>[sttr](https://github.com/abhimanyu003/sttr) | 402 | cross-platform, cli app to perform various operations on string. |
...
| <b>[gatus](https://github.com/TwinProduction/gatus) | 2.7k | Automated service health dashboard. |
...
| <b>[llvm](https://github.com/llir/llvm) | 930 | Library for interacting with LLVM IR in pure Go. |
| <b>[shortid](https://github.com/teris-io/shortid) | 779 | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| <b>[health](https://github.com/alexliesenfeld/health) | 517 | A simple and flexible health check library for Go. |
| <b>[stateless](https://github.com/qmuntal/stateless) | 465 | A fluent library for creating state machines. |
| <b>[health](https://github.com/dimiro1/health) | 431 | Easy to use, extensible health check library. |
| <b>[banner](https://github.com/dimiro1/banner) | 402 | Add beautiful banners into your Go applications. |
| <b>[shoutrrr](https://github.com/containrrr/shoutrrr) | 402 | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
| <b>[xz](https://github.com/ulikunitz/xz) | 381 | Pure golang package for reading and writing xz-compressed files. |
| <b>[conv](https://github.com/cstockton/go-conv) | 380 | Package conv provides fast and intuitive conversions across Go types. |
| <b>[gountries](https://github.com/pariz/gountries) | 346 | Package that exposes country and subdivision data. |
| <b>[ffmt](https://github.com/go-ffmt/ffmt) | 275 | Beautify data display for Humans. |
| <b>[lk](https://github.com/hyperboloide/lk) | 251 | A simple licensing library for golang. |
| <b>[antch](https://github.com/antchfx/antch) | 234 | A fast, powerful and extensible web crawling & scraping framework. |
| <b>[healthcheck](https://github.com/etherlabsio/healthcheck) | 224 | An opinionated and concurrent health-check HTTP handler for RESTful services. |
...
| <b>[go-unarr](https://github.com/gen2brain/go-unarr) | 191 | Decompression library for RAR, TAR, ZIP and 7z archives. |
...
| <b>[gtree](https://github.com/ddddddO/gtree) | 52 | Provide CLI and Package for tree output and directories creation from Markdown or programmatically. |
...
| <b>[faker](https://github.com/neotoolkit/faker) | 6 | Fake data generator. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[whatlanggo](https://github.com/abadojack/whatlanggo) | 546 | Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc). |
...
| <b>[kagome](https://github.com/ikawaha/kagome) | 663 | JP morphological analyzer written in pure Go. |
| <b>[nlp](https://github.com/Shixzie/nlp) | 379 | Extract values from strings and fill your structs with nlp. |
| <b>[nlp](https://github.com/james-bowman/nlp) | 370 | Go Natural Language Processing library supporting LSA (Latent Semantic Analysis). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[slug](https://github.com/gosimple/slug) | 842 | URL-friendly slugify with multiple languages support. |
...
| <b>[sentences](https://github.com/neurosnap/sentences) | 325 | Sentence tokenizer:  converts text into a list of sentences. |
...
| <b>[gotext](https://github.com/leonelquinteros/gotext) | 347 | GNU gettext utilities for Go. |
| <b>[go-localize](https://github.com/m1/go-localize) | 38 | Simple and easy to use i18n (Internationalization and localization) engine - used for translating locale strings. |
...
| <b>[transliterator](https://github.com/alexsergivan/transliterator) | 23 | Provides one-way string transliteration with supporting of language-specific transliteration rules. |
...
| <b>[webrtc](https://github.com/pions/webrtc) | 9.6k | A pure Go implementation of the WebRTC API. |
| <b>[quic-go](https://github.com/lucas-clemente/quic-go) | 7.0k | An implementation of the QUIC protocol in pure Go. |
...
| <b>[ftp](https://github.com/jlaffaye/ftp) | 965 | Package ftp implements a FTP client as described in [RFC 959](https://tools.ietf.org/html/rfc959). |
| <b>[mdns](https://github.com/hashicorp/mdns) | 894 | Simple mDNS (Multicast DNS) client/server library in Golang. |
| <b>[gosnmp](https://github.com/soniah/gosnmp) | 870 | Native Go library for performing SNMP actions. |
| <b>[vssh](https://github.com/yahoo/vssh) | 856 | Go library for building network and server automation over SSH protocol. |
| <b>[cidranger](https://github.com/yl2chen/cidranger) | 730 | Fast IP to CIDR lookup for Go. |
| <b>[nbio](https://github.com/lesismal/nbio) | 726 | Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use. |
| <b>[gmqtt](https://github.com/DrmagicE/gmqtt) | 701 | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| <b>[lhttp](https://github.com/fanux/lhttp) | 675 | Powerful websocket framework, build your IM server more easily. |
| <b>[peerdiscovery](https://github.com/schollz/peerdiscovery) | 551 | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| <b>[go-stun](https://github.com/ccding/go-stun) | 509 | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
| <b>[gotcp](https://github.com/gansidui/gotcp) | 494 | Go package for quickly writing tcp applications. |
| <b>[stun](https://github.com/go-rtc/stun) | 489 | Go implementation of RFC 5389 STUN protocol. |
| <b>[gaio](https://github.com/xtaci/gaio) | 446 | High performance async-io networking for Golang in proactor mode. |
| <b>[gopcap](https://github.com/akrennmair/gopcap) | 445 | Go wrapper for libpcap. |
| <b>[easytcp](https://github.com/DarthPestilane/easytcp) | 434 | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
...
| <b>[tcp_server](https://github.com/firstrow/tcp_server) | 416 | Go library for building tcp servers faster. |
| <b>[winrm](https://github.com/masterzen/winrm) | 369 | Go WinRM client to remotely execute commands on Windows machines. |
| <b>[ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 323 | Fully featured FTP server library. |
| <b>[arp](https://github.com/mdlayher/arp) | 289 | Package arp implements the ARP protocol, as described in RFC 826. |
...
| <b>[gNxI](https://github.com/google/gnxi) | 216 | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
| <b>[dnsmonster](https://github.com/mosajjal/dnsmonster) | 197 | Passive DNS Capture/Monitoring Framework. |
...
| <b>[sslb](https://github.com/eduardonunesp/sslb) | 140 | It's a Super Simples Load Balancer, just a little project to achieve some kind of performance. |
...
| <b>[iplib](https://github.com/c-robinson/iplib) | 86 | Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html) |
...
| <b>[go-powerdns](https://github.com/joeig/go-powerdns) | 59 | PowerDNS API bindings for Golang. |
...
| <b>[fullproxy](https://github.com/shoriwe/fullproxy) | 29 | A fully featured scriptable and daemon configurable proxy and pivoting toolkit with SOCKS5, HTTP, raw ports and reverse proxy protocols. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[resty](https://github.com/go-resty/resty) | 6.4k | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
...
| <b>[gentleman](https://github.com/h2non/gentleman) | 961 | Full-featured plugin-driven HTTP client library. |
| <b>[pester](https://github.com/sethgrid/pester) | 593 | Go HTTP client calls with retries, backoff, and concurrency. |
| <b>[requests](https://github.com/carlmjohnson/requests) | 393 | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| <b>[go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) | 255 | Get easily stdlib HTTP client, which does not share any state with other clients. |
| <b>[request](https://github.com/monaco-io/request) | 207 | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
| <b>[go-otelroundtripper](https://github.com/NdoleStudio/go-otelroundtripper) | 59 | Go http.RoundTripper that emits open telemetry metrics for HTTP requests. |
...
| <b>[gl](https://github.com/go-gl/gl) | 915 | Go bindings for OpenGL (generated via glow). |
| <b>[mathgl](https://github.com/go-gl/mathgl) | 445 | Pure Go math package specialized for 3D math, with inspiration from GLM. |
| <b>[goxjs/gl](https://github.com/goxjs/gl) | 158 | Go cross-platform OpenGL bindings (OS X, Linux, Windows, browsers, iOS, Android). |
| <b>[goxjs/glfw](https://github.com/goxjs/glfw) | 75 | Go cross-platform glfw library for creating an OpenGL context and receiving events. |
...
| <b>[go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 813 | A flexible and powerful SQL string builder library plus a zero-config ORM. |
| <b>[go-queryset](https://github.com/jirfag/go-queryset) | 666 | 100% type-safe ORM with code generation and MySQL, PostgreSQL, Sqlite3, SQL Server support based on GORM. |
| <b>[rel](https://github.com/go-rel/rel) | 553 | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| <b>[golobby/orm](https://github.com/golobby/orm) | 100 | Simple, fast, type-safe, generic orm for developer happiness. |
...
| <b>[pixie](https://github.com/pixie-labs/pixie) | 3.6k | No instrumentation tracing for Golang applications via eBPF. |
...
| <b>[gqlgen](https://github.com/99designs/gqlgen) | 7.8k | go generate based graphql server library. |
| <b>[graphql](https://github.com/neelance/graphql-go) | 4.2k | GraphQL server with a focus on ease of use. |
| <b>[dasel](https://github.com/tomwright/dasel) | 3.5k | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
...
| <b>[rqp](https://github.com/timsolov/rest-query-parser) | 40 | Query Parser for REST API. Filtering, validations, both `AND`, `OR` operations are supported directly in the query. |
...
| <b>[vfsgen](https://github.com/shurcooL/vfsgen) | 946 | Generates a vfsdata.go file that statically implements the given virtual filesystem. |
| <b>[esc](https://github.com/mjibson/esc) | 624 | Embeds files into Go programs and provides http.FileSystem interfaces to them. |
...
| <b>[debme](https://github.com/leaanthony/debme) | 19 | Create an `embed.FS` from an existing `embed.FS` subdirectory. |
...
| <b>[dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 851 | Dataframes for machine-learning and statistics (similar to pandas). |
| <b>[go-dsp](https://github.com/mjibson/go-dsp) | 782 | Digital Signal Processing for Go. |
| <b>[chart](https://github.com/vdobler/chart) | 732 | Simple Chart Plotting library for Go. Supports many graphs types. |
| <b>[goraph](https://github.com/gyuho/goraph) | 691 | Pure Go graph theory library(data structure, algorithm visualization). |
| <b>[graph](https://github.com/yourbasic/graph) | 565 | Library of basic graph algorithms. |
| <b>[orb](https://github.com/paulmach/orb) | 556 | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| <b>[ewma](https://github.com/VividCortex/ewma) | 388 | Exponentially-weighted moving averages. |
| <b>[calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 353 | Calendar heatmap in plain Go inspired by Github contribution activity. |
| <b>[gohistogram](https://github.com/VividCortex/gohistogram) | 166 | Approximate histograms for data streams. |
| <b>[TextRank](https://github.com/DavidBelicza/TextRank) | 157 | TextRank implementation in Golang with extendable features (summarization, weighting, phrase extraction) and multithreading (goroutine) support. |
...
| <b>[Coraza](https://github.com/corazawaf/coraza) | 584 | Enterprise-ready, modsecurity and OWASP CRS compatible WAF library. |
| <b>[nacl](https://github.com/kevinburke/nacl) | 526 | Go implementation of the NaCL set of API's. |
| <b>[ssh-vault](https://github.com/ssh-vault/ssh-vault) | 354 | encrypt/decrypt using ssh keys. |
| <b>[go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 346 | Password validator based on raw cryptographic entropy values. |
...
| <b>[BadActor](https://github.com/jaredfolkins/badactor) | 308 | In-memory, application-driven jailer built in the spirit of fail2ban. |
| <b>[passlib](https://github.com/hlandau/passlib) | 268 | Futureproof password hashing library. |
| <b>[go-yara](https://github.com/hillu/go-yara) | 266 | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
| <b>[dongle](https://github.com/golang-module/dongle) | 256 | A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption. |
...
| <b>[csvutil](https://github.com/jszwec/csvutil) | 734 | High Performance, idiomatic CSV record encoding and decoding to native Go structures. |
| <b>[colfer](https://github.com/pascaldekloe/colfer) | 671 | Code generation for the Colfer binary format. |
| <b>[cbor](https://github.com/fxamacker/cbor) | 467 | Small, safe, and easy CBOR encoding and decoding library. |
...
| <b>[binstruct](https://github.com/ghostiam/binstruct) | 56 | Golang binary decoder for mapping data into the structure. |
...
| <b>[Wish](https://github.com/charmbracelet/wish) | 1.4k | Make SSH apps, just like that! |
| <b>[jackal](https://github.com/ortuman/jackal) | 1.3k | An XMPP server written in Go. |
| <b>[go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 476 | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| <b>[Euterpe](https://github.com/ironsmile/euterpe) | 408 | Self-hosted music streaming server with built-in web UI and REST API. |
| <b>[dummy](https://github.com/neotoolkit/dummy) | 156 | Run mock server based off an API contract with one command. |
...
| <b>[cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 51 | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
...
| <b>[simple-jwt-provider](https://github.com/leberKleber/simple-jwt-provider) | 26 | Simple and lightweight provider which exhibits JWTs, supports login, password-reset (via mail) and user management. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-streams](https://github.com/reugn/go-streams) | 991 | Go stream processing library. |
...
| <b>[stream](https://github.com/youthlin/stream) | 63 | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
| <b>[goio](https://github.com/primetalk/goio) | 39 | An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2. |
...
| <b>[Razor](https://github.com/sipin/gorazor) | 800 | Razor view engine for Golang. |
| <b>[maroto](https://github.com/johnfercher/maroto) | 698 | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
| <b>[fasttemplate](https://github.com/valyala/fasttemplate) | 623 | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
...
| <b>[raymond](https://github.com/aymerick/raymond) | 485 | Complete handlebars implementation in Go. |
...
| <b>[gospin](https://github.com/m1/gospin) | 38 | Article spinning and spintax/spinning syntax engine, useful for A/B, testing pieces of text/articles and creating more natural conversations. |
...
| <b>[go-vcr](https://github.com/dnaeon/go-vcr) | 893 | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
| <b>[gnomock](https://github.com/orlangure/gnomock) | 869 | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| <b>[goblin](https://github.com/franela/goblin) | 858 | Mocha like testing framework fo Go. |
| <b>[testfixtures](https://github.com/go-testfixtures/testfixtures) | 824 | A helper for Rails' like test fixtures to test database applications. |
| <b>[baloo](https://github.com/h2non/baloo) | 728 | Expressive and versatile end-to-end HTTP API testing made easy. |
| <b>[goc](https://github.com/qiniu/goc) | 547 | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| <b>[go-mutesting](https://github.com/zimmski/go-mutesting) | 543 | Mutation testing for Go source code. |
| <b>[gofight](https://github.com/appleboy/gofight) | 423 | API Handler Testing for Golang Router framework. |
| <b>[embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 409 | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| <b>[testza](https://github.com/MarvinJWendt/testza) | 392 | Full-featured test framework with nice colorized output. |
| <b>[gotest.tools](https://github.com/gotestyourself/gotest.tools) | 333 | A collection of packages to augment the go testing package and support common patterns. |
| <b>[go-testdeep](https://github.com/maxatome/go-testdeep) | 311 | Extremely flexible golang deep comparison, extends the go testing package. |
| <b>[frisby](https://github.com/verdverm/frisby) | 272 | REST API testing framework. |
| <b>[got](https://github.com/ysmood/got) | 232 | An enjoyable golang test framework. |
...
| <b>[endly](https://github.com/viant/endly) | 214 | Declarative end to end functional testing. |
...
| <b>[go-hit](https://github.com/Eun/go-hit) | 119 | Hit is an http integration test framework written in golang. |
...
| <b>[jsonassert](https://github.com/kinbiko/jsonassert) | 86 | Package for verifying that your JSON payloads are serialized correctly. |
...
| <b>[covergates](https://github.com/covergates/covergates) | 49 | Self-hosted code coverage report review and management service. |
| <b>[gherkingen](https://github.com/hedhyw/gherkingen) | 48 | BDD boilerplate generator and framework. |
...
| <b>[assert](https://github.com/go-playground/assert) | 40 | Basic Assertion Library used along side native go testing, with building blocks for custom assertions. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gomock](https://github.com/golang/mock) | 7.7k | Mocking framework for the Go programming language. |
...
| <b>[counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 707 | Tool for generating self-contained mock objects. |
| <b>[minimock](https://github.com/gojuno/minimock) | 458 | Mock generator for Go interfaces. |
| <b>[go-txdb](https://github.com/DATA-DOG/go-txdb) | 456 | Single transaction based database driver mainly for testing purposes. |
| <b>[govcr](https://github.com/seborama/govcr) | 106 | HTTP mock for Golang: record and replay HTTP interactions for offline testing. |
| <b>[timex](https://github.com/cabify/timex) | 63 | A test-friendly replacement for the native `time` package. |
| <b>[go-localstack](https://github.com/elgohr/go-localstack) | 52 | Tool for using localstack in AWS testing. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[chromedp](https://github.com/knq/chromedp) | 7.9k | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
...
| <b>[playwright-go](https://github.com/mxschmitt/playwright-go) | 875 | browser automation library to control Chromium, Firefox and WebKit with a single API. |
| <b>[cdp](https://github.com/mafredri/cdp) | 619 | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[failpoint](https://github.com/pingcap/failpoint) | 709 | An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| <b>[bytes](https://github.com/labstack/gommon/tree/master/bytes) | 453 | Formats and parses numeric byte values (10K, 2M, 3G, etc.). |
...
| <b>[address](https://github.com/bojanz/address) | 50 | Handles address representation, validation and formatting. |
...
| <b>[mxj](https://github.com/clbanning/mxj) | 522 | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
| <b>[htmlquery](https://github.com/antchfx/htmlquery) | 503 | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| <b>[html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 374 | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| <b>[bafi](https://github.com/mmalcek/bafi) | 59 | Universal JSON, BSON, YAML, XML translator to ANY format using templates. |
...
| <b>[commonregex](https://github.com/mingrammer/commonregex) | 820 | A collection of common regular expressions for Go. |
| <b>[gographviz](https://github.com/awalterschulze/gographviz) | 488 | Parses the Graphviz DOT language. |
| <b>[omniparser](https://github.com/jf-tech/omniparser) | 481 | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| <b>[go-nmea](https://github.com/adrianmo/go-nmea) | 180 | NMEA parser library for the Go language. |
...
| <b>[did](https://github.com/ockam-network/did) | 63 | DID (Decentralized Identifiers) Parser and Stringer in Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[regroup](https://github.com/oriser/regroup) | 115 | Match regex expression named groups into go struct using struct tags and automatic parsing. |
| <b>[rex](https://github.com/hedhyw/rex) | 112 | Regular expressions builder. |
| <b>[goregen](https://github.com/zach-klippenstein/goregen) | 71 | Library for generating random strings from regular expressions. |
...
| <b>[xurls](https://github.com/mvdan/xurls) | 939 | Extract urls from text. |
| <b>[dataflowkit](https://github.com/slotix/dataflowkit) | 537 | Web scraping Framework to turn websites into structured data. |
| <b>[gospider](https://github.com/zhshch2002/gospider) | 168 | A simple golang spider/scraping framework,build a spider in 3 lines. migrated from [goribot](https://github.com/zhshch2002/goribot) |
| <b>[pagser](https://github.com/foolin/pagser) | 66 | Pagser is a simple, extensible, configurable parse and deserialize html page to struct based on goquery and struct tags for golang crawler. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[podcast](https://github.com/eduncan911/podcast) | 111 | iTunes Compliant and RSS 2.0 Podcast Generator in Golang |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-runewidth](https://github.com/mattn/go-runewidth) | 472 | Functions to get fixed width of the character or string. |
...
| <b>[githubql](https://github.com/shurcooL/githubql) | 907 | Go library for accessing the GitHub GraphQL API v4. |
| <b>[webhooks](https://github.com/go-playground/webhooks) | 746 | Webhook receiver for GitHub and Bitbucket. |
| <b>[paypal](https://github.com/logpacker/PayPal-Go-SDK) | 512 | Wrapper for PayPal payment API. |
| <b>[geo-golang](https://github.com/codingsince1985/geo-golang) | 436 | Go Library to access [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro), [MapQuest](https://open.mapquestapi.com/geocoding/), [Nominatim](https://developer.mapquest.com/documentation/open/nominatim-search), [OpenCage](https://opencagedata.com/api), [Bing](https://msdn.microsoft.com/en-us/library/ff701715.aspx), [Mapbox](https://www.mapbox.com/developers/api/geocoding/), and [OpenStreetMap](https://wiki.openstreetmap.org/wiki/Nominatim) geocoding / reverse geocoding APIs. |
| <b>[twitter-scraper](https://github.com/n0madic/twitter-scraper) | 242 | Scrape the Twitter Frontend API without authentication and limits. |
| <b>[ethrpc](https://github.com/onrik/ethrpc) | 237 | Go bindings for Ethereum JSON RPC API. |
| <b>[lark](https://github.com/chyroc/lark) | 208 | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| <b>[wit-go](https://github.com/wit-ai/wit-go) | 122 | Go client for wit.ai HTTP API. |
...
| <b>[go-lark](https://github.com/go-lark/lark) | 102 | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
...
| <b>[go-unsplash](https://github.com/hbagdi/go-unsplash) | 65 | Go client library for the [Unsplash.com](https://unsplash.com) API. |
...
| <b>[uptimerobot](https://github.com/bitfield/uptimerobot) | 48 | Go wrapper and command-line client for the Uptime Robot v2 API. |
| <b>[fcm](https://github.com/maddevsio/fcm) | 47 | Go library for Firebase Cloud Messaging. |
| <b>[go-atlassian](https://github.com/ctreminiom/go-atlassian) | 47 | Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud) |
...
| <b>[google-play-scraper](https://github.com/n0madic/google-play-scraper) | 36 | Get data from Google Play Store. |
...
| <b>[goami2](https://github.com/staskobzar/goami2) | 6 | AMI v2 library for Asterisk PBX. |
...
| <b>[lo](https://github.com/samber/lo) | 7.1k | A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...) |
...
| <b>[EaseProbe](https://github.com/megaease/easeprobe) | 1000 | A simple, standalone, and lightWeight tool that can do health/status checking daemon, support HTTP/TCP/SSH/Shell/Client/... probes, and Slack/Discord/Telegram/SMS... notification. |
| <b>[git-time-metric](https://github.com/git-time-metric/gtm) | 901 | Simple, seamless, lightweight time tracking for Git. |
| <b>[hostctl](https://github.com/guumaster/hostctl) | 785 | A CLI tool to manage /etc/hosts with easy commands. |
| <b>[mimetype](https://github.com/gabriel-vasile/mimetype) | 776 | Package for MIME type detection based on magic numbers. |
| <b>[immortal](https://github.com/immortal/immortal) | 746 | \*nix cross-platform (OS agnostic) supervisor. |
| <b>[circuit](https://github.com/cep21/circuit) | 653 | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
| <b>[scany](https://github.com/georgysavva/scany) | 619 | Library for scanning data from a database into Go structs and more. |
| <b>[htcat](https://github.com/htcat/htcat) | 548 | Parallel and Pipelined HTTP GET Utility. |
| <b>[ergo](https://github.com/cristianoliveira/ergo) | 527 | The management of multiple local services running over different ports made easy. |
| <b>[delve](https://github.com/derekparker/delve) | 510 | Go debugger. |
| <b>[koazee](https://github.com/wesovilabs/koazee) | 503 | Library inspired in Lazy evaluation and functional programming that takes the hassle out of working with arrays. |
...
| <b>[request](https://github.com/mozillazg/request) | 416 | Go HTTP Requests for Humans™. |
| <b>[gubrak](https://github.com/novalagung/gubrak) | 409 | Golang utility library with syntactic sugar. It's like lodash, but for golang. |
| <b>[clockwork](https://github.com/jonboulle/clockwork) | 405 | A simple fake clock for golang. |
| <b>[Deepcopier](https://github.com/ulule/deepcopier) | 391 | Simple struct copying for Go. |
| <b>[changie](https://github.com/miniscruff/changie) | 366 | Automated changelog tool for preparing releases with lots of customization options. |
...
| <b>[mani](https://github.com/alajmo/mani) | 289 | CLI tool to help you manage multiple repositories. |
| <b>[scan](https://github.com/blockloop/scan) | 288 | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
...
| <b>[util](https://github.com/shomali11/util) | 249 | Collection of useful utility functions. (strings, concurrency, manipulations, ...). |
| <b>[clipboard](https://github.com/golang-design/clipboard) | 240 | 📋 cross-platform clipboard package in Go. |
...
| <b>[gotenv](https://github.com/subosito/gotenv) | 225 | Load environment variables from `.env` or any `io.Reader` in Go. |
| <b>[grofer](https://github.com/pesos/grofer) | 213 | A system and resource monitoring tool written in Golang! |
| <b>[wifiqr](https://github.com/reugn/wifiqr) | 211 | Wi-Fi QR Code Generator. |
...
| <b>[go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 178 | XML Sitemap generator written in Go. |
| <b>[rospo](https://github.com/ferama/rospo) | 177 | Simple and reliable ssh tunnels with embedded ssh server in Golang. |
| <b>[countries](https://github.com/biter777/countries) | 169 | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
...
| <b>[go-bsdiff](https://github.com/gabstv/go-bsdiff) | 130 | Pure Go bsdiff and bspatch libraries and CLI tools. |
...
| <b>[cryptgo](https://github.com/Gituser143/cryptgo) | 114 | Crytpgo is a TUI based application written purely in Go to monitor and observe cryptocurrency prices in real time! |
| <b>[sorty](https://github.com/jfcg/sorty) | 106 | Fast Concurrent / Parallel Sorting. |
| <b>[cmd](https://github.com/SimonBaeumer/cmd) | 100 | Library for executing shell commands on osx, windows and linux. |
| <b>[limiters](https://github.com/mennanov/limiters) | 99 | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
...
| <b>[mssqlx](https://github.com/linxGnu/mssqlx) | 98 | Database client library, proxy for any master slave, master master structures. Lightweight and auto balancing in mind. |
...
| <b>[goval](https://github.com/maja42/goval) | 82 | Evaluate arbitrary expressions in Go. |
...
| <b>[go-lock](https://github.com/viney-shih/go-lock) | 73 | go-lock is a lock library implementing read-write mutex and read-write trylock without starvation. |
...
| <b>[pgo](https://github.com/arthurkushman/pgo) | 67 | Convenient functions for PHP community. |
...
| <b>[copy](https://github.com/gotidy/copy) | 23 | Package for fast copying structs of different types. |
...
| <b>[ctxutil](https://github.com/posener/ctxutil) | 18 | A collection of utility functions for contexts. |
...
| <b>[sno](https://github.com/muyo/sno) | 68 | Compact, sortable and fast unique IDs with embedded metadata. |
...
| <b>[validate](https://github.com/gookit/validate) | 753 | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
| <b>[checkdigit](https://github.com/osamingo/checkdigit) | 92 | Provide check digit algorithms (Luhn, Verhoeff, Damm) and calculators (ISBN, EAN, JAN, UPC, etc.). |
| <b>[terraform-validator](https://github.com/thazelart/terraform-validator) | 78 | A norms and conventions validator for Terraform. |
| <b>[validate](https://github.com/gobuffalo/validate) | 70 | This package provides a framework for writing validations for Go applications. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-git](https://github.com/go-git/go-git) | 3.7k | highly extensible Git implementation in pure Go. |
...
| <b>[m3u8](https://github.com/grafov/m3u8) | 945 | Parser and generator library of M3U8 playlists for Apple HLS. |
| <b>[gmf](https://github.com/3d0c/gmf) | 776 | Go bindings for FFmpeg av\* libraries. |
| <b>[go-astits](https://github.com/asticode/go-astits) | 426 | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
| <b>[go-astisub](https://github.com/asticode/go-astisub) | 399 | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| <b>[libvlc-go](https://github.com/adrg/libvlc-go) | 310 | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
| <b>[gortsplib](https://github.com/aler9/gortsplib) | 278 | Pure Go RTSP server and client library. |
...
| <b>[go-mpd](https://github.com/unki2aut/go-mpd) | 12 | Parser and generator library for MPEG-DASH manifest files. |
...
| <b>[Gearbox](https://github.com/abahmed/gearbox) | 653 | A web framework written in Go with a focus on high performance and memory optimization. |
| <b>[Aero](https://github.com/aerogo/aero) | 482 | High-performance web framework for Go, reaches top scores in Lighthouse. |
...
| <b>[mango](https://github.com/paulbellamy/mango) | 367 | Mango is a modular web-application framework for Go, inspired by Rack, and PEP333. |
| <b>[Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 337 | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
| <b>[Gondola](https://github.com/rainycape/gondola) | 309 | The web framework for writing faster sites, faster. |
| <b>[Flamingo](https://github.com/i-love-flamingo/flamingo) | 305 | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| <b>[rk-boot](https://github.com/rookie-ninja/rk-boot) | 264 | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
...
| <b>[WebGo](https://github.com/bnkamalesh/webgo) | 252 | A micro-framework to build web apps; with handler chaining, middleware and context injection. With standard library compliant HTTP handlers(i.e. http.HandlerFunc). |
| <b>[Ginrpc](https://github.com/xxjwxc/ginrpc) | 229 | Gin parameter automatic binding tool,gin rpc tools. |
...
| <b>[Huma](https://github.com/danielgtaylor/huma/) | 122 | Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI. |
| <b>[Microservice](https://github.com/claygod/microservice) | 99 | The framework for the creation of microservices, written in Golang. |
...
| <b>[go-fault](https://github.com/github/go-fault) | 459 | Fault injection middleware for Go. |
...
| <b>[rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 43 | Middleware for gRPC with logging, metrics, auth, tracing etc. |
...
| <b>[httptreemux](https://github.com/dimfeld/httptreemux) | 549 | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
...
| <b>[pure](https://github.com/go-playground/pure) | 127 | Is a lightweight HTTP router that sticks to the std "net/http" implementation. |
...
| <b>[dom](https://github.com/dennwc/dom) | 458 | DOM library. |
| <b>[go-canvas](https://github.com/markfarnan/go-canvas) | 172 | Library to use HTML5 Canvas, with all drawing within go code. |
| <b>[wasmbrowsertest](https://github.com/agnivade/wasmbrowsertest) | 127 | Run Go WASM tests in your browser. |
| <b>[webapi](https://github.com/gowebapi/webapi) | 116 | Bindings for DOM and HTML generated from WebIDL. |
| <b>[vert](https://github.com/norunners/vert) | 75 | Interop between Go and JS values. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-ole](https://github.com/go-ole/go-ole) | 885 | Win32 OLE implementation for golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[zek](https://github.com/miku/zek) | 576 | Generate a Go struct from XML. |
| <b>[xpath](https://github.com/antchfx/xpath) | 494 | XPath package for Go. |
...
| <b>[in-toto](https://github.com/in-toto/in-toto-golang) | 61 | Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation. |
| <b>[Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) | 41 | Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication. |
...
| <b>[GoPlantUML](https://github.com/jfeliu007/goplantuml) | 1000 | Library and CLI that generates text plantump class diagram containing information about structures and interfaces with the relationship among them. |
| <b>[php-parser](https://github.com/z7zmey/php-parser) | 887 | A Parser for PHP written in Go. |
| <b>[goast-viewer](https://github.com/yuroyoro/goast-viewer) | 629 | Web based Golang AST visualizer. |
| <b>[go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 607 | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
...
| <b>[golines](https://github.com/segmentio/golines) | 436 | Formatter that automatically shortens long lines in Go code. |
...
| <b>[unconvert](https://github.com/mdempsky/unconvert) | 321 | Remove unnecessary type conversions from Go source. |
| <b>[dupl](https://github.com/mibk/dupl) | 285 | Tool for code clone detection. |
...
| <b>[coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) | 474 | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| <b>[Watch](https://github.com/eaburns/Watch) | 192 | Runs a command in an acme win on file changes. |
| <b>[goimports-reviser](https://github.com/incu6us/goimports-reviser) | 155 | Formatting tool for imports. |
...
| <b>[xgen](https://github.com/xuri/xgen) | 173 | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| <b>[gounit](https://github.com/hexdigest/gounit) | 62 | Generate Go tests using your own templates. |
...
| <b>[depth](https://github.com/KyleBanks/depth) | 767 | Visualize dependency trees of any package by analyzing imports. |
| <b>[richgo](https://github.com/kyoh86/richgo) | 718 | Enrich `go test` outputs with text decorations. |
...
| <b>[go-james](https://github.com/pieterclaerhout/go-james) | 52 | Go project skeleton creator, builds and tests your projects without the manual setup. |
...
| <b>[webhook](https://github.com/adnanh/webhook) | 8.0k | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| <b>[GVM](https://github.com/moovweb/gvm) | 7.6k | GVM provides an interface to manage Go versions. |
...
| <b>[ko](https://github.com/google/ko) | 4.7k | Command line tool for building and deploying Go applications on Kubernetes |
...
| <b>[go-selfupdate](https://github.com/sanbornm/go-selfupdate) | 1000 | Enable your Go applications to self update. |
| <b>[ghorg](https://github.com/gabrie30/ghorg) | 988 | Quickly clone an entire org/users repositories into one directory - Supports GitHub, GitLab, Gitea, and Bitbucket. |
| <b>[skm](https://github.com/TimothyYe/skm) | 789 | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| <b>[Scaleway-cli](https://github.com/scaleway/scaleway-cli) | 757 | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| <b>[uTask](https://github.com/ovh/utask) | 687 | Automation engine that models and executes business processes declared in yaml. |
| <b>[kwatch](https://github.com/abahmed/kwatch) | 629 | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
| <b>[kool](https://github.com/kool-dev/kool) | 601 | Command line tool for managing Docker environments as an easy way. |
| <b>[cassowary](https://github.com/rogerwelin/cassowary) | 600 | Modern cross-platform HTTP load-testing tool written in Go. |
...
| <b>[jcli](https://github.com/jenkins-zh/jenkins-cli) | 329 | Jenkins CLI allows you manage your Jenkins as an easy way. |
| <b>[trubka](https://github.com/xitonix/trubka) | 321 | A CLI tool to manage and troubleshoot Apache Kafka clusters with the ability of generically publishing/consuming protocol buffer and plain text events to/from Kafka. |
| <b>[Mora](https://github.com/emicklei/mora) | 302 | REST server for accessing MongoDB documents and meta data. |
| <b>[lstags](https://github.com/ivanilves/lstags) | 290 | Tool and API to sync Docker images across different registries. |
...
| <b>[easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 251 | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
...
| <b>[terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 212 | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| <b>[s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 116 | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
| <b>[drone-scp](https://github.com/appleboy/drone-scp) | 108 | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
...
| <b>[Comcast](https://github.com/tylertreat/Comcast) | 9.4k | Simulate bad network connections. |
...
| <b>[shell2http](https://github.com/msoap/shell2http) | 953 | Executing shell commands via http server (for prototyping or remote control). |
| <b>[vFlow](https://github.com/VerizonDigital/vflow) | 910 | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| <b>[peg](https://github.com/pointlander/peg) | 858 | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
| <b>[Leaps](https://github.com/jeffail/leaps) | 724 | Pair programming service using Operational Transforms. |
| <b>[gfile](https://github.com/Antonito/gfile) | 671 | Securely transfer files between two computers, without any third party, over WebRTC. |
| <b>[Guora](https://github.com/meloalright/guora) | 598 | A self-hosted Quora like web application written in Go. |
| <b>[Gebug](https://github.com/moshebe/gebug) | 592 | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
| <b>[gocc](https://github.com/goccmack/gocc) | 536 | Gocc is a compiler kit for Go written in Go. |
...
| <b>[ide](https://github.com/thestrukture/ide) | 347 | Browser accessible IDE. Designed for Go with Go. |
| <b>[woke](https://github.com/get-woke/woke) | 335 | Detect non-inclusive language in your source code. |
...
| <b>[Neo-cowsay](https://github.com/Code-Hex/Neo-cowsay) | 217 | 🐮 cowsay is reborn. for a New Era. |
| <b>[tcpdog](https://github.com/mehrdadrad/tcpdog) | 195 | eBPF based TCP observability. |
...
| <b>[speedtest-resize](https://github.com/fawick/speedtest-resize) | 217 | Compare various Image resize algorithms for the Go language. |
...
| <b>[gopherize.me](https://github.com/matryer/gopherize.me) | 589 | Gopherize yourself. |
| <b>[gopher-stickers](https://github.com/tenntenn/gopher-stickers) | 534 | gopher stickers |
...
| <b>[Go-gopher-Vector](https://github.com/keygx/Go-gopher-Vector) | 54 | Go gopher Vector Data [.ai, .svg]. |
...
| <b>[Trybe](https://github.com/betrybe/playbook-go/blob/main/README_EN.md) | 308 | Playbook da linguagem Go |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Go Projects](https://github.com/golang/go/wiki/Projects) | 102.0k | List of projects on the Go community wiki. |
...
| <b>[Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) | 6.7k | Go's reference card. |
| <b>[go-clean-template](https://github.com/evrone/go-clean-template) | 3.3k | Clean Architecture template for Golang services. |
...
| <b>[goapp](https://github.com/bnkamalesh/goapp) | 494 | An opinionated guideline to structure & develop a Go web application/service. |
