...
| <b>[PortAudio](https://github.com/gordonklaus/portaudio) | 541 | Go bindings for the PortAudio audio I/O library. |
| <b>[music-theory](https://github.com/go-music-theory/music-theory) | 414 | Music theory models in Go. |
| <b>[id3v2](https://github.com/bogem/id3v2) | 269 | ID3 decoding and encoding library for Go. |
| <b>[GoAudio](https://github.com/DylanMeeus/GoAudio) | 262 | Native Go Audio Processing Library. |
| <b>[flac](https://github.com/mewkiz/flac) | 225 | Native Go FLAC encoder/decoder with support for FLAC streams. |
| <b>[malgo](https://github.com/gen2brain/malgo) | 202 | Mini audio library. |
| <b>[gaad](https://github.com/Comcast/gaad) | 107 | Native Go AAC bitstream parser. |
| <b>[minimp3](https://github.com/tosone/minimp3) | 91 | Lightweight MP3 decoder library. |
...
| <b>[paseto](https://github.com/o1egl/paseto) | 643 | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
| <b>[jwt](https://github.com/cristalhq/jwt) | 573 | Safe, simple and fast JSON Web Tokens for Go. |
...
| <b>[go-guardian](https://github.com/shaj13/go-guardian) | 412 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
| <b>[jwt](https://github.com/pascaldekloe/jwt) | 300 | Lightweight JSON Web Token (JWT) library. |
...
| <b>[sjwt](https://github.com/brianvoe/sjwt) | 105 | Simple jwt generator and parser. |
...
| <b>[securecookie](https://github.com/chmike/securecookie) | 62 | Efficient secure cookie encoding/decoding. |
...
| <b>[branca](https://github.com/essentialkaos/branca) | 46 | branca token [specification implementation](https://github.com/tuupola/branca-spec) for Golang 1.15+. |
...
| <b>[cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 4.6k | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| <b>[solana-go](https://github.com/gagliardetto/solana-go) | 378 | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
| <b>[gossamer](https://github.com/ChainSafe/gossamer) | 361 | A Go implementation of the Polkadot Host. |
...
| <b>[Kelp](https://github.com/stellar/kelp) | 939 | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| <b>[Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) | 840 | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| <b>[go-chat-bot](https://github.com/go-chat-bot/bot) | 763 | IRC, Slack & Telegram bot written in Go. |
| <b>[slacker](https://github.com/shomali11/slacker) | 699 | Easy to use framework to create Slack bots. |
| <b>[wayback](https://github.com/wabarc/wayback) | 349 | A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages. |
| <b>[tbot](https://github.com/yanzay/tbot) | 330 | Telegram bot server with API similar to net/http. |
| <b>[go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 262 | Library to write bots for twitch.tv chat |
| <b>[go-sarah](https://github.com/oklahomer/go-sarah) | 251 | Framework to build bot for desired chat services including LINE, Slack, Gitter and more. |
| <b>[echotron](https://github.com/NicoNex/echotron) | 199 | An elegant and concurrent library for Telegram Bots in Go. |
...
| <b>[slack-bot](https://github.com/innogames/slack-bot) | 122 | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
...
| <b>[telego](https://github.com/mymmrac/telego) | 112 | Telegram Bot API library for Golang with full one-to-one API implementation. |
| <b>[larry](https://github.com/ezeoleaf/larry) | 90 | Larry 🐦 is a really simple Twitter bot generator that tweets random repositories from Github built in Go. |
| <b>[margelet](https://github.com/zhulik/margelet) | 76 | Framework for building Telegram bots. |
| <b>[ephemeral-roles](https://github.com/ewohltman/ephemeral-roles) | 68 | A Discord bot for managing ephemeral roles based upon voice channel member presence. |
...
| <b>[micha](https://github.com/onrik/micha) | 24 | Go Library for Telegram bot api. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Task](https://github.com/go-task/task) | 6.0k | simple "Make" alternative. |
...
| <b>[goyek](https://github.com/goyek/goyek) | 321 | Create build pipelines in Go. |
| <b>[taskctl](https://github.com/taskctl/taskctl) | 219 | Concurrent task runner. |
| <b>[1build](https://github.com/gopinath-langote/1build) | 188 | Command line tool to frictionlessly manage project-specific commands. |
| <b>[gaper](https://github.com/maxcnunes/gaper) | 61 | Builds and restarts a Go project when it crashes or some watched file changes. |
...
| <b>[gocui](https://github.com/jroimartin/gocui) | 8.6k | Minimalist Go library aimed at creating Console User Interfaces. |
...
| <b>[uitable](https://github.com/gosuri/uitable) | 670 | Library to improve readability in terminal apps using tabular data. |
| <b>[go-colorable](https://github.com/mattn/go-colorable) | 653 | Colorable writer for windows. |
| <b>[go-isatty](https://github.com/mattn/go-isatty) | 649 | isatty for golang. |
| <b>[gommon/color](https://github.com/labstack/gommon/tree/master/color) | 471 | Style terminal text. |
| <b>[chalk](https://github.com/ttacon/chalk) | 412 | Intuitive package for prettifying terminal/console output. |
| <b>[simpletable](https://github.com/alexeyco/simpletable) | 396 | Simple tables in terminal with Go. |
| <b>[yacspin](https://github.com/theckman/yacspin) | 380 | Yet Another CLi Spinner package, for working with terminal spinners. |
| <b>[tabby](https://github.com/cheynewallace/tabby) | 321 | A tiny library for super simple Golang tables. |
| <b>[box-cli-maker](https://github.com/Delta456/box-cli-maker) | 261 | Make Highly Customized Boxes for your CLI. |
...
| <b>[table](https://github.com/tomlazar/table) | 39 | Small library for terminal color based tables . |
...
| <b>[liner](https://github.com/peterh/liner) | 934 | Go readline-like library for command-line interfaces. |
| <b>[complete](https://github.com/posener/complete) | 865 | Write bash completions in Go + Go command bash completion. |
| <b>[mow.cli](https://github.com/jawher/mow.cli) | 834 | Go library for building CLI applications with sophisticated flag and argument parsing and validation. |
| <b>[flaggy](https://github.com/integrii/flaggy) | 816 | A robust and idiomatic flags package with excellent subcommand support. |
| <b>[cli](https://github.com/mkideal/cli) | 673 | Feature-rich and easy to use command-line package based on golang struct tags. |
| <b>[argparse](https://github.com/akamensky/argparse) | 467 | Command line argument parser inspired by Python's argparse module. |
...
| <b>[wmenu](https://github.com/dixonwille/wmenu) | 178 | Easy to use menu structure for cli applications that prompts users to make choices. |
...
| <b>[clîr](https://github.com/leaanthony/clir) | 127 | A Simple and Clear CLI library. Dependency free. |
...
| <b>[job](https://github.com/liujianping/job) | 122 | JOB, make your short-term command as a long-term job. |
...
| <b>[carapace-bin](https://github.com/rsteube/carapace-bin) | 93 | Multi-shell multi-command argument completer. |
| <b>[acmd](https://github.com/cristalhq/acmd) | 62 | Simple, useful and opinionated CLI package in Go. |
...
| <b>[carapace](https://github.com/rsteube/carapace) | 57 | Command argument completion generator for spf13/cobra. |
...
| <b>[version](https://github.com/mszostok/version) | 41 | Collects and displays CLI version information in multiple formats along with upgrade notice. |
...
| <b>[command-chain](https://github.com/rainu/go-command-chain) | 34 | A go library for configure and run command chains - such like pipelining in unix shells. |
...
| <b>[godotenv](https://github.com/joho/godotenv) | 5.4k | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| <b>[env](https://github.com/caarlos0/env) | 2.8k | Parse environment variables to Go structs (with defaults). |
...
| <b>[cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 765 | Minimalistic configuration reader (from files, ENV, and wherever you want). |
| <b>[konfig](https://github.com/lalamove/konfig) | 633 | Composable, observable and performant config handling for Go for the distributed processing era. |
| <b>[confita](https://github.com/heetch/confita) | 458 | Load configuration in cascade from multiple backends into a struct. |
| <b>[gookit/config](https://github.com/gookit/config) | 406 | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| <b>[aconfig](https://github.com/cristalhq/aconfig) | 404 | Simple, useful and opinionated config loader. |
...
| <b>[GoLobby/Config](https://github.com/golobby/config) | 296 | GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language. |
| <b>[hjson](https://github.com/hjson/hjson-go) | 281 | Human JSON, a configuration file format for humans. Relaxed syntax, fewer mistakes, more comments. |
| <b>[xdg](https://github.com/adrg/xdg) | 280 | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
| <b>[store](https://github.com/tucnak/store) | 263 | Lightweight configuration manager for Go. |
| <b>[config](https://github.com/olebedev/config) | 257 | JSON or YAML configuration wrapper with environment variables and flags parsing. |
| <b>[fig](https://github.com/kkyr/fig) | 242 | Tiny library for reading configuration from a file and from environment variables (with validation & defaults). |
| <b>[envconfig](https://github.com/vrischmann/envconfig) | 228 | Read your configuration from environment variables. |
...
| <b>[uConfig](https://github.com/omeid/uconfig) | 53 | Lightweight, zero-dependency, and extendable configuration management. |
...
| <b>[woodpecker](https://github.com/woodpecker-ci/woodpecker) | 1.6k | Woodpecker is a community fork of the Drone CI system. |
| <b>[goveralls](https://github.com/mattn/goveralls) | 742 | Go integration for Coveralls.io continuous code coverage tracking system. |
| <b>[gotestfmt](https://github.com/GoTestTools/gotestfmt) | 331 | go test output for humans. |
...
| <b>[binpacker](https://github.com/zhuangsirui/binpacker) | 195 | Binary packer and unpacker helps user build custom binary stream. |
...
| <b>[go-ef](https://github.com/amallia/go-ef) | 25 | A Go implementation of the Elias-Fano encoding. |
| <b>[bingo](https://github.com/iancmcc/bingo) | 15 | Fast, zero-allocation, lexicographical-order-preserving packing of native types to bytes. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[bitset](https://github.com/bits-and-blooms/bitset) | 990 | Go package implementing bitsets. |
| <b>[bitmap](https://github.com/kelindar/bitmap) | 180 | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| <b>[cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 939 | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
| <b>[cuckoo-filter](https://github.com/linvon/cuckoo-filter) | 232 | Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper is available. |
...
| <b>[gostl](https://github.com/liyue201/gostl) | 735 | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| <b>[algorithms](https://github.com/shady831213/algorithms) | 682 | Algorithms and data structures.CLRS study. |
...
| <b>[dict](https://github.com/srfrog/dict) | 33 | Python-like dictionaries (dict) for Go. |
...
| <b>[hyperloglog](https://github.com/axiomhq/hyperloglog) | 803 | HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |
...
| <b>[go-rampart](https://github.com/francesconi/go-rampart) | 85 | Determine how intervals relate to each other. |
...
| <b>[go-tuple](https://github.com/barweiss/go-tuple) | 38 | Generic tuple implementation for Go 1.18+. |
| <b>[genfuncs](https://github.com/nwillc/genfuncs) | 33 | Go 1.18+ generics package inspired by Kotlin's Sequence and Map. |
| <b>[fsm](https://github.com/cocoonspace/fsm) | 32 | Finite-State Machine package. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[nan](https://github.com/kak-tus/nan) | 58 | Zero allocation Nullable structures in one library with handy conversion functions, marshallers and unmarshallers. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[deque](https://github.com/gammazero/deque) | 394 | Fast ring-buffer deque (double-ended queue). |
| <b>[goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 218 | Concurrent FIFO queue. |
| <b>[deque](https://github.com/edwingeng/deque) | 68 | A highly optimized double-ended queue. |
| <b>[memlog](https://github.com/embano1/memlog) | 64 | An easy to use, lightweight, thread-safe and append-only in-memory data structure inspired by Apache Kafka. |
...
| <b>[trie](https://github.com/derekparker/trie) | 612 | Trie implementation in Go. |
| <b>[go-edlib](https://github.com/hbollon/go-edlib) | 362 | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| <b>[go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 250 | Go implementation of Adaptive Radix Tree. |
| <b>[levenshtein](https://github.com/agnivade/levenshtein) | 245 | Implementation to calculate levenshtein distance in Go. |
...
| <b>[ptrie](https://github.com/viant/ptrie) | 30 | An implementation of prefix tree. |
...
| <b>[ttlcache](https://github.com/jellydator/ttlcache) | 509 | An in-memory cache with item expiration and generics. |
| <b>[cachego](https://github.com/fabiorphp/cachego) | 189 | Golang Cache component for multiple drivers. |
| <b>[cachego](https://github.com/faabiosr/cachego) | 189 | Golang Cache component for multiple drivers. |
...
| <b>[bcache](https://github.com/iwanbk/bcache) | 99 | Eventually consistent distributed in-memory  cache Go library. |
| <b>[go-mcache](https://github.com/OrlovEvgeny/go-mcache) | 85 | Fast in-memory key:value store/cache library. Pointer caches. |
| <b>[go-cache](https://github.com/viney-shih/go-cache) | 80 | A flexible multi-layer Go caching library to deal with in-memory and shared cache by adopting Cache-Aside pattern. |
...
| <b>[2q](https://github.com/floatdrop/2q) | 13 | 2Q in-memory cache implementation. |
...
| <b>[VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 7.3k | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
...
| <b>[rosedb](https://github.com/roseduan/rosedb) | 3.3k | An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset. |
...
| <b>[lotusdb](https://github.com/flower-corp/lotusdb) | 996 | Fast k/v database compatible with lsm and b+tree. |
| <b>[pogreb](https://github.com/akrylysov/pogreb) | 958 | Embedded key-value store for read-heavy workloads. |
| <b>[eliasdb](https://github.com/krotik/eliasdb) | 948 | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| <b>[moss](https://github.com/couchbase/moss) | 893 | Moss is a simple LSM key-value storage engine written in 100% Go. |
| <b>[objectbox-go](https://github.com/objectbox/objectbox-go) | 798 | High-performance embedded Object Database (NoSQL) with Go API. |
...
| <b>[clover](https://github.com/ostafen/clover) | 283 | A lightweight document-oriented NoSQL database written in pure Golang. |
...
| <b>[dtf](https://github.com/dtm-labs/dtf) | 229 | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
| <b>[piladb](https://github.com/fern4lvarez/piladb) | 199 | Lightweight RESTful database engine based on stack data structures. |
| <b>[unitdb](https://github.com/unit-io/unitdb) | 98 | Fast timeseries database for IoT, realtime messaging  applications. Access unitdb with pubsub over tcp or websocket using github.com/unit-io/unitd application. |
| <b>[hare](https://github.com/jameycribbs/hare) | 63 | A simple database management system that stores each table as a text file of line-delimited JSON. |
...
| <b>[atlas](https://github.com/ariga/atlas) | 2.0k | A Database Toolkit. A CLI designed to help companies better work with their data. |
...
| <b>[goavro](https://github.com/linkedin/goavro) | 846 | A Go package that encodes and decodes Avro data. |
| <b>[gormigrate](https://github.com/go-gormigrate/gormigrate) | 835 | Database schema migration helper for Gorm ORM. |
| <b>[darwin](https://github.com/GuiaBolso/darwin) | 134 | Database schema evolution library for Go. |
| <b>[migrator](https://github.com/lopezator/migrator) | 134 | Dead simple Go database migration library. |
...
| <b>[libschema](https://github.com/muir/libschema) | 10 | Define your migrations separately in each libary.  Migrations for open source libraries.  MySQL & PostgreSQL. |
...
| <b>[pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 806 | Advanced scheduling for PostgreSQL. |
| <b>[clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 393 | Collects small inserts and sends big requests to ClickHouse servers. |
| <b>[rdb](https://github.com/HDT3213/rdb) | 194 | Redis RDB file parser for secondary development and memory analysis. |
...
| <b>[dbbench](https://github.com/sj14/dbbench) | 75 | Database benchmarking tool with support for several databases and scripts. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sqlc](https://github.com/kyleconroy/sqlc) | 6.6k | Generate type-safe code from SQL. |
...
| <b>[jet](https://github.com/go-jet/jet) | 861 | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
...
| <b>[ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 582 | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
| <b>[dbq](https://github.com/rocketlaunchr/dbq) | 353 | Zero boilerplate database operations for Go. |
...
| <b>[sq](https://github.com/bokwoon95/go-structured-query) | 177 | Type-safe SQL builder and struct mapper for Go. |
| <b>[sqlf](https://github.com/leporo/sqlf) | 89 | Fast SQL query builder. |
...
| <b>[buildsqlx](https://github.com/arthurkushman/buildsqlx) | 81 | Go database query builder library for PostgreSQL. |
| <b>[bqb](https://github.com/nullism/bqb) | 57 | Lightweight and easy to learn query builder. |
...
| <b>[qry](https://github.com/HnH/qry) | 24 | Tool that generates constants from files with raw SQL queries. |
...
| <b>[pgx](https://github.com/jackc/pgx) | 6.2k | PostgreSQL driver supporting features beyond those exposed by database/sql. |
| <b>[go-sqlite3](https://github.com/mattn/go-sqlite3) | 6.1k | SQLite3 driver for go that uses database/sql. |
...
| <b>[sqlhooks](https://github.com/qustavo/sqlhooks) | 593 | Attach hooks to any database/sql driver. |
| <b>[godror](https://github.com/godror/godror) | 397 | Oracle driver for Go, using the ODPI-C driver. |
...
| <b>[KSQL](https://github.com/VinGarcia/ksql) | 189 | A Simple and Powerful Golang SQL Library |
| <b>[firebirdsql](https://github.com/nakagami/firebirdsql) | 181 | Firebird RDBMS SQL driver for Go. |
| <b>[go-adodb](https://github.com/mattn/go-adodb) | 131 | Microsoft ActiveX Object DataBase driver for go that uses database/sql. |
| <b>[Sqinn-Go](https://github.com/cvilsmeier/sqinn-go) | 128 | SQLite with pure Go. |
| <b>[gofreetds](https://github.com/minus5/gofreetds) | 106 | Microsoft MSSQL driver. Go wrapper over [FreeTDS](https://www.freetds.org). |
| <b>[avatica](https://github.com/apache/calcite-avatica-go) | 104 | Apache Avatica/Phoenix SQL driver for database/sql. |
| <b>[ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) | 66 | native and database/sql driver YDB (Yandex Database) |
...
| <b>[qmgo](https://github.com/qiniu/qmgo) | 994 | The MongoDB driver for Go. It‘s based on official MongoDB driver but easier to use like Mgo. |
| <b>[mgm](https://github.com/kamva/mgm) | 579 | MongoDB model-based ODM for Go (based on official MongoDB driver). |
| <b>[redeo](https://github.com/bsm/redeo) | 420 | Redis-protocol compatible TCP servers/services. |
| <b>[aerospike-client-go](https://github.com/aerospike/aerospike-client-go) | 398 | Aerospike client in Go language. |
...
| <b>[go-rejson](https://github.com/nitishm/go-rejson) | 288 | Golang client for redislabs' ReJSON module using Redigo golang client. Store and manipulate structs as JSON objects in redis with ease. |
...
| <b>[elasticsql](https://github.com/cch123/elasticsql) | 973 | Convert sql to elasticsearch dsl in Go. |
...
| <b>[carbon](https://github.com/golang-module/carbon) | 2.5k | A simple, semantic and developer-friendly golang package for datetime. |
| <b>[dateparse](https://github.com/araddon/dateparse) | 1.8k | Parse date's without knowing format in advance. |
| <b>[carbon](https://github.com/uniplaces/carbon) | 734 | Simple Time extension with a lot of util methods, ported from PHP Carbon library. |
| <b>[durafmt](https://github.com/hako/durafmt) | 450 | Time duration formatting library for Go. |
...
| <b>[date](https://github.com/rickb777/date) | 98 | Augments Time for working with dates, date ranges, time spans, periods, and time-of-day. |
...
| <b>[go-str2duration](https://github.com/xhit/go-str2duration) | 52 | Convert string to duration. Support time.Duration returned string and more. |
...
| <b>[go-anytime](https://github.com/ijt/go-anytime) | 2 | Parse dates/times like "next dec 22nd at 3pm" and ranges like "from today until next thursday" without knowing the format in advance. |
...
| <b>[Kitex](https://github.com/cloudwego/kitex) | 5.2k | A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice. |
...
| <b>[go-doudou](https://github.com/unionj-cloud/go-doudou) | 865 | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
| <b>[redis-lock](https://github.com/bsm/redislock) | 837 | Simplified distributed locking implementation using Redis. |
| <b>[rain](https://github.com/cenkalti/rain) | 778 | BitTorrent client and library. |
| <b>[ringpop-go](https://github.com/uber/ringpop-go) | 753 | Scalable, fault-tolerant application-layer sharding for Go applications. |
| <b>[gorpc](https://github.com/valyala/gorpc) | 663 | Simple, fast and scalable RPC library for high load. |
| <b>[go-health](https://github.com/InVisionApp/go-health) | 641 | Library for enabling asynchronous dependency health checks in your service. |
| <b>[arpc](https://github.com/lesismal/arpc) | 628 | More effective network communication, support two-way-calling, notify, broadcast. |
| <b>[consistent](https://github.com/buraksezer/consistent) | 526 | Consistent hashing with bounded loads. |
| <b>[go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 498 | A library built to provide support for defining async service health checks for golang services. |
...
| <b>[jsonrpc](https://github.com/ybbus/jsonrpc) | 251 | JSON-RPC 2.0 HTTP client implementation. |
...
| <b>[outboxer](https://github.com/italolelis/outboxer) | 93 | Outboxer is a go library that implements the outbox pattern. |
...
| <b>[go-pdu](https://github.com/pdupub/go-pdu) | 42 | A decentralized identity-based social network. |
...
| <b>[SendGrid](https://github.com/sendgrid/sendgrid-go) | 862 | SendGrid's Go library for sending email. |
| <b>[mailgun-go](https://github.com/mailgun/mailgun-go) | 621 | Go library for sending mail with the Mailgun API. |
| <b>[email-verifier](https://github.com/AfterShip/email-verifier) | 533 | A Go library for email verification without sending any emails. |
| <b>[go-simple-mail](https://github.com/xhit/go-simple-mail) | 397 | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| <b>[go-message](https://github.com/emersion/go-message) | 275 | Streaming library for the Internet Message Format and mail messages. |
| <b>[douceur](https://github.com/aymerick/douceur) | 222 | CSS inliner for your HTML emails. |
| <b>[Hectane](https://github.com/hectane/hectane) | 222 | Lightweight SMTP client providing an HTTP API. |
| <b>[mailchain](https://github.com/mailchain/mailchain) | 129 | Send encrypted emails to blockchain addresses written in Go. |
| <b>[go-premailer](https://github.com/vanng822/go-premailer) | 95 | Inline styling for HTML mail in Go. |
| <b>[go-mail](https://github.com/wneessen/go-mail) | 91 | A simple Go library for sending mails in Go. |
...
| <b>[Mailpit](https://github.com/axllent/mailpit) | 60 | Email and SMTP testing tool for developers. |
...
| <b>[expr](https://github.com/antonmedv/expr) | 3.1k | Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing. |
...
| <b>[go-php](https://github.com/deuill/go-php) | 875 | PHP bindings for Go. |
...
| <b>[gval](https://github.com/PaesslerAG/gval) | 544 | A highly customizable expression language written in Go. |
| <b>[gisp](https://github.com/jcla1/gisp) | 497 | Simple LISP in Go. |
| <b>[prolog](https://github.com/ichiban/prolog) | 436 | Embeddable Prolog. |
...
| <b>[ecal](https://github.com/krotik/ecal) | 28 | A simple embeddable scripting language which supports concurrent event processing. |
...
| <b>[errorx](https://github.com/joomcode/errorx) | 900 | A feature rich error package with stack traces, composition of errors and more. |
| <b>[tracerr](https://github.com/ztrue/tracerr) | 744 | Golang errors with stack trace and source fragments. |
...
| <b>[emperror](https://github.com/emperror/emperror) | 269 | Error handling tools and best practices for Go libraries and applications. |
| <b>[errors](https://github.com/emperror/errors) | 164 | Drop-in replacement for the standard library errors package and github.com/pkg/errors. Provides various error handling primitives. |
...
| <b>[copy](https://github.com/otiai10/copy) | 477 | Copy directory recursively. |
...
| <b>[afs](https://github.com/viant/afs) | 208 | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
...
| <b>[go-exiftool](https://github.com/barasher/go-exiftool) | 137 | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
| <b>[gofs](https://github.com/no-src/gofs) | 103 | A file synchronization tool out of the box. |
| <b>[go-csv-tag](https://github.com/artonge/go-csv-tag) | 99 | Load csv file using tag. |
| <b>[skywalker](https://github.com/dixonwille/skywalker) | 86 | Package to allow one to concurrently go through a filesystem with ease. |
| <b>[opc](https://github.com/qmuntal/opc) | 74 | Load Open Packaging Conventions (OPC) files for Go. |
| <b>[checksum](https://github.com/codingsince1985/checksum) | 71 | Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files. |
...
| <b>[accounting](https://github.com/leekchan/accounting) | 775 | money and currency formatting for golang. |
| <b>[bbgo](https://github.com/c9s/bbgo) | 722 | A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies. |
| <b>[techan](https://github.com/sdcoffey/techan) | 687 | Technical analysis library with advanced market analysis and trading strategies. |
| <b>[go-finance](https://github.com/FlashBoys/go-finance) | 537 | Comprehensive financial markets data in Go. |
| <b>[ach](https://github.com/moov-io/ach) | 340 | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
| <b>[currency](https://github.com/bojanz/currency) | 337 | Handles currency amounts, provides currency information and formatting. |
...
| <b>[ofxgo](https://github.com/aclindsa/ofxgo) | 111 | Query OFX servers and/or parse the responses (with example command-line client). |
...
| <b>[vat](https://github.com/dannyvankooten/vat) | 99 | VAT number validation & EU VAT rates. |
...
| <b>[currency](https://github.com/bnkamalesh/currency) | 51 | High performant & accurate currency computation package. |
...
| <b>[payme](https://github.com/jovandeginste/payme) | 13 | QR code generator (ASCII & PNG) for SEPA payments. |
...
| <b>[gorilla/csrf](https://github.com/gorilla/csrf) | 846 | CSRF protection for Go web applications & services. |
| <b>[binding](https://github.com/mholt/binding) | 792 | Binds form and JSON data from net/http Request to struct. |
| <b>[form](https://github.com/go-playground/form) | 560 | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
...
| <b>[fpGo](https://github.com/TeaEntityLab/fpGo) | 298 | Monad, Functional Programming features for Golang. |
| <b>[gofp](https://github.com/rbrahul/gofp) | 132 | A lodash like powerful utility library for Golang. |
| <b>[fp-go](https://github.com/repeale/fp-go) | 131 | Collection of Functional Programming helpers powered by Golang 1.18+ generics. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Ebiten](https://github.com/hajimehoshi/ebiten) | 7.3k | dead simple 2D game library in Go. |
...
| <b>[raylib-go](https://github.com/gen2brain/raylib-go) | 894 | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
| <b>[Azul3D](https://github.com/azul3d/engine) | 559 | 3D game engine written in Go. |
| <b>[go-astar](https://github.com/beefsack/go-astar) | 527 | Go implementation of the A\* path finding algorithm. |
| <b>[go3d](https://github.com/ungerik/go3d) | 275 | Performance oriented 2D/3D math package for Go. |
| <b>[Harfang3D](https://github.com/harfang3d/harfang3d) | 216 | 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev](github.com/harfang3d/harfang-go)). |
...
| <b>[tile](https://github.com/kelindar/tile) | 73 | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
| <b>[fantasyname](https://github.com/s0rg/fantasyname) | 11 | Fantasy names generator. |
...
| <b>[GoWrap](https://github.com/hexdigest/gowrap) | 680 | Generate decorators for Go interfaces using simple templates. |
| <b>[go-enum](https://github.com/abice/go-enum) | 388 | Code generation for enums from code comments. |
| <b>[interfaces](https://github.com/rjeczalik/interfaces) | 358 | Command line tool for generating interface definitions. |
| <b>[copygen](https://github.com/switchupcb/copygen) | 191 | Generate type-to-type code without reflection. |
| <b>[goverter](https://github.com/jmattheis/goverter) | 170 | Generate converters by defining an interface. |
| <b>[gotype](https://github.com/wzshiming/gotype) | 50 | Golang source code parsing, usage like reflect package. |
...
| <b>[mbtileserver](https://github.com/consbio/mbtileserver) | 413 | A simple Go-based server for map tiles stored in mbtiles format. |
| <b>[osm](https://github.com/paulmach/osm) | 236 | Library for reading, writing and working with OpenStreetMap data and APIs. |
...
| <b>[simplefeatures](https://github.com/peterstace/simplefeatures) | 68 | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
...
| <b>[c2go](https://github.com/goplus/c2go) | 211 | Convert C code to Go code. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[ants](https://github.com/panjf2000/ants) | 9.3k | A high-performance and low-cost goroutine pool in Go. |
...
| <b>[workerpool](https://github.com/gammazero/workerpool) | 950 | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
| <b>[grpool](https://github.com/ivpusic/grpool) | 716 | Lightweight Goroutine pool. |
| <b>[pool](https://github.com/go-playground/pool) | 701 | Limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation. |
| <b>[pond](https://github.com/alitto/pond) | 658 | Minimalistic and High-performance goroutine worker pool written in Go. |
| <b>[gowp](https://github.com/xxjwxc/gowp) | 424 | gowp is concurrency limiting goroutine pool. |
...
| <b>[neilotoole/errgroup](https://github.com/neilotoole/errgroup) | 142 | Drop-in alternative to `sync/errgroup`, limited to a pool of N worker goroutines. |
| <b>[artifex](https://github.com/borderstech/artifex) | 139 | Simple in-memory job queue for Golang using worker-based dispatching. |
...
| <b>[gollback](https://github.com/vardius/gollback) | 99 | asynchronous simple function utilities, for managing execution of closures and callbacks. |
| <b>[async](https://github.com/reugn/async) | 92 | An alternative sync library for Go (Future, Promise, Locks). |
| <b>[Hunch](https://github.com/AaronJan/Hunch) | 92 | Hunch provides functions like: `All`, `First`, `Retry`, `Waterfall` etc., that makes asynchronous flow control more intuitive. |
...
| <b>[routine](https://github.com/timandy/routine) | 71 | `routine` is a `ThreadLocal` for go library. It encapsulates and provides some easy-to-use, non-competitive, high-performance `goroutine` context access interfaces, which can help you access coroutine context information more gracefully. |
...
| <b>[go-actor](https://github.com/vladopajic/go-actor) | 15 | A tiny library for writing concurrent programs using actor model. |
...
| <b>[breaker](https://github.com/kamilsk/breaker) | 9 | Flexible mechanism to make execution flow interruptible. |
...
| <b>[zenity](https://github.com/ncruces/zenity) | 356 | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
...
| <b>[emgo](https://github.com/ziutek/emgo) | 991 | Go-like language for programming embedded systems (e.g. STM32 MCU). |
| <b>[sysinfo](https://github.com/zcalusic/sysinfo) | 392 | A pure Go library providing Linux OS / kernel / hardware system information. |
| <b>[goroslib](https://github.com/aler9/goroslib) | 232 | Robot Operating System (ROS) library for Go. |
...
| <b>[govips](https://github.com/davidbyttow/govips) | 778 | A lightning fast image processing and resizing library for Go. |
| <b>[image2ascii](https://github.com/qeesung/image2ascii) | 705 | Convert image to ASCII. |
| <b>[draft](https://github.com/lucasepe/draft) | 552 | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| <b>[goimagehash](https://github.com/corona10/goimagehash) | 546 | Go Perceptual image hashing package. |
| <b>[govatar](https://github.com/o1egl/govatar) | 524 | Library and CMD tool for generating funny avatars. |
...
| <b>[darkroom](https://github.com/gojek/darkroom) | 202 | An image proxy with changeable storage backends and image processing engines with focus on speed and resiliency. |
| <b>[mergi](https://github.com/noelyahan/mergi) | 189 | Tool & Go library for image manipulation (Merge, Crop, Resize, Watermark, Animate). |
| <b>[gltf](https://github.com/qmuntal/gltf) | 182 | Efficient and robust glTF 2.0 reader, writer and validator. |
| <b>[steganography](https://github.com/auyer/steganography) | 163 | Pure Go Library for LSB steganography. |
...
| <b>[cameron](https://github.com/aofei/cameron) | 94 | An avatar generator for Go. |
| <b>[go-webp](https://github.com/kolesa-team/go-webp) | 88 | Library for encode and decode webp pictures, using libwebp. |
...
| <b>[huego](https://github.com/amimof/huego) | 220 | An extensive Philips Hue client library for Go. |
...
| <b>[go-quartz](https://github.com/reugn/go-quartz) | 958 | Simple, zero-dependency scheduling library for Go. |
| <b>[JobRunner](https://github.com/bamzi/jobrunner) | 945 | Smart and featureful cron job scheduler with job queuing and live monitoring built in. |
| <b>[gron](https://github.com/roylee0704/gron) | 927 | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| <b>[jobs](https://github.com/albrow/jobs) | 493 | Persistent and flexible background jobs library. |
| <b>[Dagu](https://github.com/dagu-go/dagu) | 473 | No-code workflow executor. it executes DAGs defined in a simple YAML format. |
| <b>[scheduler](https://github.com/carlescere/scheduler) | 403 | Cronjobs scheduling made easy. |
| <b>[gronx](https://github.com/adhocore/gronx) | 219 | Cron expression parser, task runner and daemon consuming crontab like task list. |
...
| <b>[tasks](https://github.com/madflojo/tasks) | 117 | An easy to use in-process scheduler for recurring tasks in Go. |
| <b>[leprechaun](https://github.com/kilgaloon/leprechaun) | 92 | Job scheduler that supports webhooks, crons and classic scheduling. |
| <b>[goflow](https://github.com/fieldryand/goflow) | 69 | A workflow orchestrator and scheduler for rapid prototyping of ETL/ML/AI pipelines. |
| <b>[cheek](https://github.com/datarootsio/cheek) | 60 | A simple crontab like scheduler that aims to offer a KISS approach to job scheduling. |
...
| <b>[OjG](https://github.com/ohler55/ojg) | 524 | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
| <b>[kazaam](https://github.com/Qntfy/kazaam) | 240 | API for arbitrary transformation of JSON documents. |
| <b>[marshmallow](https://github.com/PerimeterX/marshmallow) | 219 | Performant JSON unmarshaling for flexible use cases. |
| <b>[jsondiff](https://github.com/wI2L/jsondiff) | 208 | JSON diff library for Go based on RFC6902 (JSON Patch). |
...
| <b>[ajson](https://github.com/spyzhov/ajson) | 134 | Abstract JSON for golang with JSONPath support. |
| <b>[gjo](https://github.com/skanehira/gjo) | 114 | Small utility to create JSON objects. |
| <b>[json2go](https://github.com/m-zajac/json2go) | 109 | Advanced JSON to Go struct conversion. Provides package that can parse multiple JSON documents and create struct to fit them all. |
| <b>[jsongo](https://github.com/ricardolonga/jsongo) | 106 | Fluent API to make it easier to create Json objects. |
...
| <b>[phuslu/log](https://github.com/phuslu/log) | 457 | Structured Logging Made Easy. |
...
| <b>[logutils](https://github.com/hashicorp/logutils) | 332 | Utilities for slightly better logging in Go (Golang) extending the standard logger. |
...
| <b>[sqldb-logger](https://github.com/simukti/sqldb-logger) | 274 | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
...
| <b>[logur](https://github.com/logur/logur) | 178 | An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus), [go-kit log](https://github.com/go-kit/kit/tree/master/log), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog), etc). |
...
| <b>[slog](https://github.com/gookit/slog) | 137 | Lightweight, configurable, extensible logger for Go. |
...
| <b>[eaopt](https://github.com/MaxHalford/eaopt) | 814 | An evolutionary optimization library. |
| <b>[bayesian](https://github.com/jbrukh/bayesian) | 743 | Naive Bayesian Classification for Golang. |
...
| <b>[ocrserver](https://github.com/otiai10/ocrserver) | 531 | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
| <b>[gobrain](https://github.com/goml/gobrain) | 526 | Neural Networks written in go. |
| <b>[onnx-go](https://github.com/owulveryck/onnx-go) | 439 | Go Interface to Open Neural Network Exchange (ONNX). |
| <b>[go-deep](https://github.com/patrikeh/go-deep) | 391 | A feature-rich neural network library in Go. |
...
| <b>[goga](https://github.com/tomcraven/goga) | 170 | Genetic algorithm library for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sarama](https://github.com/Shopify/sarama) | 9.3k | Go library for Apache Kafka. |
...
| <b>[Benthos](https://github.com/Jeffail/benthos) | 4.9k | A message streaming bridge between a range of protocols. |
...
| <b>[Asynq](https://github.com/hibiken/asynq) | 4.5k | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| <b>[Chanify](https://github.com/chanify/chanify) | 940 | A push notification server send message to your iOS devices. |
...
| <b>[dbus](https://github.com/godbus/dbus) | 775 | Native Go bindings for D-Bus. |
| <b>[golongpoll](https://github.com/jcuga/golongpoll) | 614 | HTTP longpoll server library that makes web pub-sub simple. |
| <b>[amqp](https://github.com/rabbitmq/amqp091-go) | 576 | Go RabbitMQ Client Library. |
| <b>[mangos](https://github.com/nanomsg/mangos) | 558 | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
| <b>[emitter](https://github.com/olebedev/emitter) | 440 | Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins. |
| <b>[Glue](https://github.com/desertbit/glue) | 406 | Robust Go and Javascript Socket Library (Alternative to Socket.io). |
| <b>[pubsub](https://github.com/tuxychandru/pubsub) | 386 | Simple pubsub package for go. |
| <b>[Quamina](https://github.com/timbray/quamina) | 281 | Fast pattern-matching for filtering messages and events. |
| <b>[Bus](https://github.com/mustafaturan/bus) | 278 | Minimalist message bus implementation for internal communication. |
| <b>[messagebus](https://github.com/vardius/message-bus) | 234 | messagebus is a Go simple async message bus, perfect for using as event bus when doing event sourcing, CQRS, DDD. |
| <b>[rabtap](https://github.com/jandelgado/rabtap) | 226 | RabbitMQ swiss army knife cli app. |
...
| <b>[hub](https://github.com/leandro-lugaresi/hub) | 123 | A Message/Event Hub for Go applications, using publish/subscribe pattern with support for alias like rabbitMQ exchanges. |
...
| <b>[redisqueue](https://github.com/robinjoseph08/redisqueue) | 94 | redisqueue provides a producer and consumer of a queue that uses Redis streams. |
...
| <b>[Ratus](https://github.com/hyperonym/ratus) | 58 | Ratus is a RESTful asynchronous task queue server. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[google/wire](https://github.com/google/wire) | 9.4k | Automated Initialization in Go. |
| <b>[fx](https://github.com/uber-go/fx) | 3.2k | A dependency injection based application framework for Go (built on top of dig). |
| <b>[dig](https://github.com/uber-go/dig) | 2.8k | A reflection based dependency injection toolkit for Go. |
| <b>[do](https://github.com/samber/do) | 640 | A dependency injection framework based on Generics. |
| <b>[GoLobby/Container](https://github.com/golobby/container) | 386 | GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language. |
| <b>[goioc/di](https://github.com/goioc/di) | 213 | Spring-inspired Dependency Injection Container. |
| <b>[di](https://github.com/goava/di) | 165 | A dependency injection container for go programming language. |
| <b>[dingo](https://github.com/i-love-flamingo/dingo) | 146 | A dependency injection toolkit for Go, based on Guice. |
...
| <b>[cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 554 | A Go application boilerplate template for quick starting projects following production best practices. |
| <b>[pagoda](https://github.com/mikestefanello/pagoda) | 520 | Rapid, easy full-stack web development starter kit built in Go. |
| <b>[golang-templates/seed](https://github.com/golang-templates/seed) | 340 | Go application GitHub repository template. |
| <b>[go-starter](https://github.com/allaboutapps/go-starter) | 262 | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| <b>[go-todo-backend](https://github.com/Fs02/go-todo-backend) | 177 | Go Todo Backend example using modular project layout for product microservice. |
| <b>[scaffold](https://github.com/catchplay/scaffold) | 130 | Scaffold generates a starter Go project layout. Lets you focus on business logic implemented. |
| <b>[go-sample](https://github.com/zitryss/go-sample) | 112 | A sample layout for Go application projects with the real code. |
| <b>[gobase](https://github.com/wajox/gobase) | 37 | A simple skeleton for golang application with basic setup for real golang application. |
...
| <b>[sttr](https://github.com/abhimanyu003/sttr) | 424 | cross-platform, cli app to perform various operations on string. |
| <b>[strutil](https://github.com/ozgio/strutil) | 188 | String utilities. |
| <b>[gobeam/Stringy](https://github.com/gobeam/Stringy) | 150 | String manipulation library to convert string to camel case, snake case, kebab case / slugify etc. |
...
| <b>[llvm](https://github.com/llir/llvm) | 974 | Library for interacting with LLVM IR in pure Go. |
| <b>[shortid](https://github.com/teris-io/shortid) | 812 | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| <b>[health](https://github.com/alexliesenfeld/health) | 626 | A simple and flexible health check library for Go. |
| <b>[stateless](https://github.com/qmuntal/stateless) | 498 | A fluent library for creating state machines. |
| <b>[shoutrrr](https://github.com/containrrr/shoutrrr) | 482 | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
...
| <b>[xz](https://github.com/ulikunitz/xz) | 388 | Pure golang package for reading and writing xz-compressed files. |
| <b>[conv](https://github.com/cstockton/go-conv) | 386 | Package conv provides fast and intuitive conversions across Go types. |
| <b>[gountries](https://github.com/pariz/gountries) | 363 | Package that exposes country and subdivision data. |
| <b>[ffmt](https://github.com/go-ffmt/ffmt) | 280 | Beautify data display for Humans. |
| <b>[lk](https://github.com/hyperboloide/lk) | 259 | A simple licensing library for golang. |
| <b>[antch](https://github.com/antchfx/antch) | 241 | A fast, powerful and extensible web crawling & scraping framework. |
| <b>[healthcheck](https://github.com/etherlabsio/healthcheck) | 238 | An opinionated and concurrent health-check HTTP handler for RESTful services. |
| <b>[battery](https://github.com/distatus/battery) | 211 | Cross-platform, normalized battery information library. |
| <b>[go-unarr](https://github.com/gen2brain/go-unarr) | 208 | Decompression library for RAR, TAR, ZIP and 7z archives. |
...
| <b>[turtle](https://github.com/hackebrot/turtle) | 139 | Emojis for Go. |
| <b>[captcha](https://github.com/steambap/captcha) | 122 | Package captcha provides an easy to use, unopinionated API for captcha generation. |
| <b>[gommit](https://github.com/antham/gommit) | 100 | Analyze git commit messages to ensure they follow defined patterns. |
...
| <b>[gtree](https://github.com/ddddddO/gtree) | 74 | Provide CLI and Package for tree output and directories creation from Markdown or programmatically. |
...
| <b>[url-shortener](https://github.com/pantrif/url-shortener) | 39 | A modern, powerful, and robust URL shortener microservice with mysql support. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[whatlanggo](https://github.com/abadojack/whatlanggo) | 566 | Natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc). |
| <b>[getlang](https://github.com/rylans/getlang) | 143 | Fast natural language detection package. |
...
| <b>[nlp](https://github.com/james-bowman/nlp) | 379 | Go Natural Language Processing library supporting LSA (Latent Semantic Analysis). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[slug](https://github.com/gosimple/slug) | 879 | URL-friendly slugify with multiple languages support. |
...
| <b>[sentences](https://github.com/neurosnap/sentences) | 335 | Sentence tokenizer:  converts text into a list of sentences. |
| <b>[segment](https://github.com/blevesearch/segment) | 72 | Go library for performing Unicode Text Segmentation as described in [Unicode Standard Annex #29](https://www.unicode.org/reports/tr29/) |
...
| <b>[go-localize](https://github.com/m1/go-localize) | 46 | Simple and easy to use i18n (Internationalization and localization) engine - used for translating locale strings. |
| <b>[iuliia-go](https://github.com/mehanizm/iuliia-go) | 33 | Transliterate Cyrillic → Latin in every possible way. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-unidecode](https://github.com/mozillazg/go-unidecode) | 97 | ASCII transliterations of Unicode text. |
...
| <b>[quic-go](https://github.com/lucas-clemente/quic-go) | 7.4k | An implementation of the QUIC protocol in pure Go. |
...
| <b>[mdns](https://github.com/hashicorp/mdns) | 912 | Simple mDNS (Multicast DNS) client/server library in Golang. |
| <b>[gosnmp](https://github.com/soniah/gosnmp) | 908 | Native Go library for performing SNMP actions. |
| <b>[vssh](https://github.com/yahoo/vssh) | 871 | Go library for building network and server automation over SSH protocol. |
| <b>[gmqtt](https://github.com/DrmagicE/gmqtt) | 755 | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| <b>[cidranger](https://github.com/yl2chen/cidranger) | 752 | Fast IP to CIDR lookup for Go. |
| <b>[lhttp](https://github.com/fanux/lhttp) | 679 | Powerful websocket framework, build your IM server more easily. |
| <b>[peerdiscovery](https://github.com/schollz/peerdiscovery) | 560 | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| <b>[go-stun](https://github.com/ccding/go-stun) | 531 | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
| <b>[easytcp](https://github.com/DarthPestilane/easytcp) | 501 | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
...
| <b>[gaio](https://github.com/xtaci/gaio) | 470 | High performance async-io networking for Golang in proactor mode. |
...
| <b>[winrm](https://github.com/masterzen/winrm) | 383 | Go WinRM client to remotely execute commands on Windows machines. |
| <b>[ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 336 | Fully featured FTP server library. |
| <b>[arp](https://github.com/mdlayher/arp) | 297 | Package arp implements the ARP protocol, as described in RFC 826. |
| <b>[buffstreams](https://github.com/stabbycutyou/buffstreams) | 251 | Streaming protocolbuffer data over TCP made easy. |
| <b>[ethernet](https://github.com/mdlayher/ethernet) | 247 | Package ethernet implements marshaling and unmarshaling of IEEE 802.3 Ethernet II frames and IEEE 802.1Q VLAN tags. |
| <b>[gNxI](https://github.com/google/gnxi) | 225 | A collection of tools for Network Management that use the gNMI and gNOI protocols. |
| <b>[dnsmonster](https://github.com/mosajjal/dnsmonster) | 212 | Passive DNS Capture/Monitoring Framework. |
...
| <b>[xtcp](https://github.com/xfxdev/xtcp) | 135 | TCP Server Framework with simultaneous full duplex communication, graceful shutdown, and custom protocol. |
| <b>[iplib](https://github.com/c-robinson/iplib) | 94 | Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html) |
| <b>[ether](https://github.com/songgao/ether) | 78 | Cross-platform Go package for sending and receiving ethernet frames. |
| <b>[gldap](https://github.com/jimlambrt/gldap) | 77 | gldap provides an ldap server implementation and you provide handlers for its ldap operations. |
...
| <b>[fullproxy](https://github.com/shoriwe/fullproxy) | 39 | A fully featured scriptable and daemon configurable proxy and pivoting toolkit with SOCKS5, HTTP, raw ports and reverse proxy protocols. |
...
| <b>[pester](https://github.com/sethgrid/pester) | 602 | Go HTTP client calls with retries, backoff, and concurrency. |
| <b>[requests](https://github.com/carlmjohnson/requests) | 433 | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| <b>[go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) | 270 | Get easily stdlib HTTP client, which does not share any state with other clients. |
| <b>[request](https://github.com/monaco-io/request) | 218 | HTTP client for golang. If you have experience about axios or requests, you will love it. No 3rd dependency. |
...
| <b>[go-http-client](https://github.com/bozd4g/go-http-client) | 43 | Make http calls simply and easily. |
| <b>[rq](https://github.com/ddo/rq) | 42 | A nicer interface for golang stdlib HTTP client. |
| <b>[httpretry](https://github.com/ybbus/httpretry) | 25 | Enriches the default go HTTP client with retry functionality. |
| <b>[go-zoox/fetch](https://github.com/go-zoox/fetch) | 19 | A Powerful, Lightweight, Easy Http Client, inspired by Web Fetch API. |
...
| <b>[go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 858 | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| <b>[rel](https://github.com/go-rel/rel) | 592 | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
| <b>[Zoom](https://github.com/albrow/zoom) | 294 | Blazing-fast datastore and querying engine built on Redis. |
...
| <b>[golobby/orm](https://github.com/golobby/orm) | 116 | Simple, fast, type-safe, generic orm for developer happiness. |
...
| <b>[mvn-golang](https://github.com/raydac/mvn-golang) | 146 | plugin that provides way for auto-loading of Golang SDK, dependency management and start build environment in Maven project infrastructure. |
| <b>[gup](https://github.com/nao1215/gup) | 144 | Update binaries installed by "go install". |
...
| <b>[statsviz](https://github.com/arl/statsviz) | 2.4k | Live visualization of your Go application runtime statistics. |
...
| <b>[gqlgen](https://github.com/99designs/gqlgen) | 8.2k | go generate based graphql server library. |
...
| <b>[dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 896 | Dataframes for machine-learning and statistics (similar to pandas). |
| <b>[go-dsp](https://github.com/mjibson/go-dsp) | 798 | Digital Signal Processing for Go. |
| <b>[chart](https://github.com/vdobler/chart) | 744 | Simple Chart Plotting library for Go. Supports many graphs types. |
| <b>[goraph](https://github.com/gyuho/goraph) | 698 | Pure Go graph theory library(data structure, algorithm visualization). |
| <b>[orb](https://github.com/paulmach/orb) | 592 | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| <b>[graph](https://github.com/yourbasic/graph) | 588 | Library of basic graph algorithms. |
| <b>[ewma](https://github.com/VividCortex/ewma) | 394 | Exponentially-weighted moving averages. |
| <b>[calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 364 | Calendar heatmap in plain Go inspired by Github contribution activity. |
...
| <b>[Coraza](https://github.com/corazawaf/coraza) | 755 | Enterprise-ready, modsecurity and OWASP CRS compatible WAF library. |
| <b>[nacl](https://github.com/kevinburke/nacl) | 529 | Go implementation of the NaCL set of API's. |
| <b>[go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 363 | Password validator based on raw cryptographic entropy values. |
...
| <b>[optimus-go](https://github.com/pjebs/optimus-go) | 326 | ID hashing and Obfuscation using Knuth's Algorithm. |
...
| <b>[dongle](https://github.com/golang-module/dongle) | 290 | A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption. |
...
| <b>[cbor](https://github.com/fxamacker/cbor) | 499 | Small, safe, and easy CBOR encoding and decoding library. |
...
| <b>[RoadRunner](https://github.com/spiral/roadrunner) | 6.8k | High-performance PHP application server, load-balancer and process manager. |
| <b>[SFTPGo](https://github.com/drakkan/sftpgo) | 5.0k | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
...
| <b>[go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 543 | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| <b>[Euterpe](https://github.com/ironsmile/euterpe) | 443 | Self-hosted music streaming server with built-in web UI and REST API. |
| <b>[dummy](https://github.com/neotoolkit/dummy) | 162 | Run mock server based off an API contract with one command. |
...
| <b>[psql-streamer](https://github.com/blind-oracle/psql-streamer) | 44 | Stream database events from PostgreSQL to Kafka. |
...
| <b>[goio](https://github.com/primetalk/goio) | 51 | An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2. |
...
| <b>[jet](https://github.com/CloudyKit/jet) | 969 | Jet template engine. |
| <b>[maroto](https://github.com/johnfercher/maroto) | 824 | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
| <b>[Razor](https://github.com/sipin/gorazor) | 801 | Razor view engine for Golang. |
| <b>[fasttemplate](https://github.com/valyala/fasttemplate) | 642 | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
...
| <b>[raymond](https://github.com/aymerick/raymond) | 498 | Complete handlebars implementation in Go. |
| <b>[goview](https://github.com/foolin/goview) | 307 | Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application. |
| <b>[liquid](https://github.com/osteele/liquid) | 180 | Go implementation of Shopify Liquid templates. |
...
| <b>[gnomock](https://github.com/orlangure/gnomock) | 964 | integration testing with real dependencies (database, cache, even Kubernetes or AWS) running in Docker, without mocks. |
| <b>[go-vcr](https://github.com/dnaeon/go-vcr) | 961 | Record and replay your HTTP interactions for fast, deterministic and accurate tests. |
...
| <b>[goblin](https://github.com/franela/goblin) | 867 | Mocha like testing framework fo Go. |
| <b>[baloo](https://github.com/h2non/baloo) | 742 | Expressive and versatile end-to-end HTTP API testing made easy. |
| <b>[goc](https://github.com/qiniu/goc) | 587 | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| <b>[go-mutesting](https://github.com/zimmski/go-mutesting) | 558 | Mutation testing for Go source code. |
| <b>[embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 460 | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| <b>[gofight](https://github.com/appleboy/gofight) | 428 | API Handler Testing for Golang Router framework. |
| <b>[testza](https://github.com/MarvinJWendt/testza) | 406 | Full-featured test framework with nice colorized output. |
| <b>[gotest.tools](https://github.com/gotestyourself/gotest.tools) | 364 | A collection of packages to augment the go testing package and support common patterns. |
| <b>[go-testdeep](https://github.com/maxatome/go-testdeep) | 324 | Extremely flexible golang deep comparison, extends the go testing package. |
| <b>[frisby](https://github.com/verdverm/frisby) | 274 | REST API testing framework. |
| <b>[got](https://github.com/ysmood/got) | 255 | An enjoyable golang test framework. |
| <b>[cupaloy](https://github.com/bradleyjkemp/cupaloy) | 232 | Simple snapshot testing addon for your test framework. |
| <b>[go-carpet](https://github.com/msoap/go-carpet) | 230 | Tool for viewing test coverage in terminal. |
...
| <b>[go-hit](https://github.com/Eun/go-hit) | 145 | Hit is an http integration test framework written in golang. |
| <b>[dbcleaner](https://github.com/khaiql/dbcleaner) | 144 | Clean database for testing purpose, inspired by `database_cleaner` in Ruby. |
| <b>[GoSpec](https://github.com/orfjackal/gospec) | 114 | BDD-style testing framework for the Go programming language. |
| <b>[testcase](https://github.com/adamluzsi/testcase) | 102 | Idiomatic testing framework for Behavior Driven Development. |
...
| <b>[be](https://github.com/carlmjohnson/be) | 21 | The minimalist generic test assertion library. |
...
| <b>[stop-and-go](https://github.com/elgohr/stop-and-go) | 7 | Testing helper for concurrency. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gomock](https://github.com/golang/mock) | 8.1k | Mocking framework for the Go programming language. |
...
| <b>[counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 732 | Tool for generating self-contained mock objects. |
| <b>[go-txdb](https://github.com/DATA-DOG/go-txdb) | 491 | Single transaction based database driver mainly for testing purposes. |
| <b>[minimock](https://github.com/gojuno/minimock) | 467 | Mock generator for Go interfaces. |
| <b>[govcr](https://github.com/seborama/govcr) | 132 | HTTP mock for Golang: record and replay HTTP interactions for offline testing. |
| <b>[timex](https://github.com/cabify/timex) | 65 | A test-friendly replacement for the native `time` package. |
| <b>[go-localstack](https://github.com/elgohr/go-localstack) | 57 | Tool for using localstack in AWS testing. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[chromedp](https://github.com/knq/chromedp) | 8.3k | a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol. |
| <b>[rod](https://github.com/go-rod/rod) | 3.0k | A Devtools driver to make web automation and scraping easy. |
...
| <b>[cdp](https://github.com/mafredri/cdp) | 645 | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[failpoint](https://github.com/pingcap/failpoint) | 748 | An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| <b>[bytes](https://github.com/labstack/gommon/tree/master/bytes) | 471 | Formats and parses numeric byte values (10K, 2M, 3G, etc.). |
...
| <b>[htmlquery](https://github.com/antchfx/htmlquery) | 530 | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| <b>[mxj](https://github.com/clbanning/mxj) | 528 | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
| <b>[html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 411 | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
...
| <b>[bafi](https://github.com/mmalcek/bafi) | 66 | Universal JSON, BSON, YAML, XML translator to ANY format using templates. |
...
| <b>[commonregex](https://github.com/mingrammer/commonregex) | 837 | A collection of common regular expressions for Go. |
| <b>[omniparser](https://github.com/jf-tech/omniparser) | 514 | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| <b>[gographviz](https://github.com/awalterschulze/gographviz) | 500 | Parses the Graphviz DOT language. |
...
| <b>[editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) | 108 | Editorconfig file parser and manipulator for Go. |
| <b>[go-vcard](https://github.com/emersion/go-vcard) | 81 | Parse and format vCard. |
...
| <b>[tokenizer](https://github.com/bzick/tokenizer) | 21 | — Parse any string, slice or infinite buffer to any tokens. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[regroup](https://github.com/oriser/regroup) | 123 | Match regex expression named groups into go struct using struct tags and automatic parsing. |
| <b>[rex](https://github.com/hedhyw/rex) | 121 | Regular expressions builder. |
| <b>[goregen](https://github.com/zach-klippenstein/goregen) | 78 | Library for generating random strings from regular expressions. |
...
| <b>[xurls](https://github.com/mvdan/xurls) | 970 | Extract urls from text. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[podcast](https://github.com/eduncan911/podcast) | 113 | iTunes Compliant and RSS 2.0 Podcast Generator in Golang |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-runewidth](https://github.com/mattn/go-runewidth) | 495 | Functions to get fixed width of the character or string. |
...
| <b>[githubql](https://github.com/shurcooL/githubql) | 936 | Go library for accessing the GitHub GraphQL API v4. |
| <b>[webhooks](https://github.com/go-playground/webhooks) | 783 | Webhook receiver for GitHub and Bitbucket. |
| <b>[paypal](https://github.com/logpacker/PayPal-Go-SDK) | 540 | Wrapper for PayPal payment API. |
...
| <b>[twitter-scraper](https://github.com/n0madic/twitter-scraper) | 265 | Scrape the Twitter Frontend API without authentication and limits. |
| <b>[ethrpc](https://github.com/onrik/ethrpc) | 245 | Go bindings for Ethereum JSON RPC API. |
| <b>[lark](https://github.com/chyroc/lark) | 243 | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
...
| <b>[pushover](https://github.com/gregdel/pushover) | 128 | Go wrapper for the Pushover API. |
...
| <b>[go-lark](https://github.com/go-lark/lark) | 116 | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
...
| <b>[simples3](https://github.com/rhnvrm/simples3) | 94 | Simple no frills AWS S3 Library using REST with V4 Signing written in Go. |
...
| <b>[gosip](https://github.com/koltyakov/gosip) | 85 | Go client library SharePoint API. |
...
| <b>[go-postman-collection](https://github.com/rbretecher/go-postman-collection) | 58 | Go module to work with [Postman Collections](https://learning.getpostman.com/docs/postman/collections/creating-collections/) (compatible with Insomnia). |
...
| <b>[go-xkcd](https://github.com/nishanths/go-xkcd) | 47 | Go client for the xkcd API. |
...
| <b>[GoFreeDB](https://github.com/FreeLeh/GoFreeDB) | 16 | Golang library providing common and simple database abstractions on top of Google Sheets. |
...
| <b>[lo](https://github.com/samber/lo) | 8.3k | A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...) |
...
| <b>[go-funk](https://github.com/thoas/go-funk) | 3.9k | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| <b>[retry-go](https://github.com/avast/retry-go) | 1.2k | Simple library for retry mechanism. |
| <b>[circuitbreaker](https://github.com/rubyist/circuitbreaker) | 1000 | Circuit Breakers in Go. |
| <b>[git-time-metric](https://github.com/git-time-metric/gtm) | 913 | Simple, seamless, lightweight time tracking for Git. |
| <b>[mimetype](https://github.com/gabriel-vasile/mimetype) | 863 | Package for MIME type detection based on magic numbers. |
| <b>[hostctl](https://github.com/guumaster/hostctl) | 815 | A CLI tool to manage /etc/hosts with easy commands. |
| <b>[scany](https://github.com/georgysavva/scany) | 758 | Library for scanning data from a database into Go structs and more. |
| <b>[immortal](https://github.com/immortal/immortal) | 754 | \*nix cross-platform (OS agnostic) supervisor. |
| <b>[circuit](https://github.com/cep21/circuit) | 672 | An efficient and feature complete Hystrix like Go implementation of the circuit breaker pattern. |
| <b>[htcat](https://github.com/htcat/htcat) | 549 | Parallel and Pipelined HTTP GET Utility. |
| <b>[ergo](https://github.com/cristianoliveira/ergo) | 539 | The management of multiple local services running over different ports made easy. |
| <b>[delve](https://github.com/derekparker/delve) | 533 | Go debugger. |
...
| <b>[godaemon](https://github.com/VividCortex/godaemon) | 490 | Utility to write daemons. |
...
| <b>[request](https://github.com/mozillazg/request) | 420 | Go HTTP Requests for Humans™. |
| <b>[clockwork](https://github.com/jonboulle/clockwork) | 419 | A simple fake clock for golang. |
...
| <b>[changie](https://github.com/miniscruff/changie) | 394 | Automated changelog tool for preparing releases with lots of customization options. |
| <b>[go-rate](https://github.com/beefsack/go-rate) | 372 | Timed rate limiter for Go. |
| <b>[remote-touchpad](https://github.com/Unrud/remote-touchpad) | 339 | Control mouse and keyboard from a smartphone. |
...
| <b>[mani](https://github.com/alajmo/mani) | 321 | CLI tool to help you manage multiple repositories. |
| <b>[scan](https://github.com/blockloop/scan) | 311 | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
| <b>[clipboard](https://github.com/golang-design/clipboard) | 288 | 📋 cross-platform clipboard package in Go. |
| <b>[serve](https://github.com/syntaqx/serve) | 282 | A static http server anywhere you need. |
| <b>[util](https://github.com/shomali11/util) | 260 | Collection of useful utility functions. (strings, concurrency, manipulations, ...). |
...
| <b>[grofer](https://github.com/pesos/grofer) | 225 | A system and resource monitoring tool written in Golang! |
| <b>[wifiqr](https://github.com/reugn/wifiqr) | 217 | Wi-Fi QR Code Generator. |
| <b>[countries](https://github.com/biter777/countries) | 192 | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
| <b>[pattern-match](https://github.com/alexpantyukhin/go-pattern-match) | 189 | Pattern matching libray. |
| <b>[go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 186 | XML Sitemap generator written in Go. |
...
| <b>[cryptgo](https://github.com/Gituser143/cryptgo) | 123 | Crytpgo is a TUI based application written purely in Go to monitor and observe cryptocurrency prices in real time! |
| <b>[nostromo](https://github.com/pokanop/nostromo) | 123 | CLI for building powerful aliases. |
...
| <b>[mongo-go-pagination](https://github.com/gobeam/mongo-go-pagination) | 109 | Mongodb Pagination for official mongodb/mongo-go-driver package which supports  both normal queries and Aggregation pipelines. |
| <b>[sorty](https://github.com/jfcg/sorty) | 109 | Fast Concurrent / Parallel Sorting. |
| <b>[limiters](https://github.com/mennanov/limiters) | 106 | Rate limiters for distributed applications in Golang with configurable back-ends and distributed locks. |
| <b>[filter](https://github.com/gookit/filter) | 105 | provide filtering, sanitizing, and conversion of Go data. |
...
| <b>[goseaweedfs](https://github.com/linxGnu/goseaweedfs) | 99 | SeaweedFS client library with almost full features. |
...
| <b>[goval](https://github.com/maja42/goval) | 92 | Evaluate arbitrary expressions in Go. |
| <b>[mimemagic](https://github.com/zRedShift/mimemagic) | 82 | Pure Go ultra performant MIME sniffing library/utility. |
| <b>[go-lock](https://github.com/viney-shih/go-lock) | 81 | go-lock is a lock library implementing read-write mutex and read-write trylock without starvation. |
...
| <b>[scan](https://github.com/wroge/scan) | 41 | Scan sql rows into any type powered by generics. |
| <b>[set](https://github.com/nofeaturesonlybugs/set) | 40 | Performant and flexible struct mapping and loose type conversion. |
| <b>[slicer](https://github.com/leaanthony/slicer) | 40 | Makes working with slices easier. |
| <b>[backscanner](https://github.com/icza/backscanner) | 39 | A scanner similar to bufio.Scanner, but it reads and returns lines in reverse order, starting at a given position and going backward. |
...
| <b>[cvt](https://github.com/shockerli/cvt) | 28 | Easy and safe convert any value to another type. |
...
| <b>[copy](https://github.com/gotidy/copy) | 27 | Package for fast copying structs of different types. |
...
| <b>[ptr](https://github.com/gotidy/ptr) | 18 | Package that provide functions for simplified creation of pointers from constants of basic types. |
...
| <b>[wuid](https://github.com/edwingeng/wuid) | 475 | An extremely fast unique number generator, 10-135 times faster than UUID. |
| <b>[sno](https://github.com/muyo/sno) | 72 | Compact, sortable and fast unique IDs with embedded metadata. |
| <b>[nanoid](https://github.com/aidarkhanov/nanoid) | 55 | A tiny and efficient Go unique string ID generator. |
...
| <b>[validate](https://github.com/gookit/validate) | 795 | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| <b>[valix](https://github.com/marrow16/valix) | 3 | Go package for validating requests |
...
| <b>[githooks](https://github.com/gabyx/githooks) | 52 | Per-repo and shared Git hooks with version control and auto update. |
...
| <b>[m3u8](https://github.com/grafov/m3u8) | 971 | Parser and generator library of M3U8 playlists for Apple HLS. |
| <b>[gmf](https://github.com/3d0c/gmf) | 805 | Go bindings for FFmpeg av\* libraries. |
| <b>[go-astits](https://github.com/asticode/go-astits) | 443 | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
| <b>[go-astisub](https://github.com/asticode/go-astisub) | 417 | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| <b>[libvlc-go](https://github.com/adrg/libvlc-go) | 321 | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
| <b>[gortsplib](https://github.com/aler9/gortsplib) | 317 | Pure Go RTSP server and client library. |
| <b>[gst](https://github.com/ziutek/gst) | 166 | Go bindings for GStreamer. |
| <b>[go-m3u8](https://github.com/quangngotan95/go-m3u8) | 100 | Parser and generator library for Apple m3u8 playlists. |
...
| <b>[go-m3u8](https://github.com/etherlabsio/go-m3u8) | 7 | Parser and generator library for Apple m3u8 playlists. Actively maintained version of quangngotan95/go-m3u8 with improvements and latest HLS playlist parsing compatibility. |
...
| <b>[Hertz](https://github.com/cloudwego/hertz) | 2.3k | A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices. |
...
| <b>[Atreugo](https://github.com/savsgio/atreugo) | 955 | High performance and extensible micro web framework with zero memory allocations in hot paths. |
| <b>[tango](https://github.com/lunny/tango) | 835 | Micro & pluggable web framework for Go. |
| <b>[Gearbox](https://github.com/abahmed/gearbox) | 681 | A web framework written in Go with a focus on high performance and memory optimization. |
...
| <b>[Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 372 | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| <b>[Flamingo](https://github.com/i-love-flamingo/flamingo) | 323 | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
| <b>[rk-boot](https://github.com/rookie-ninja/rk-boot) | 317 | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
...
| <b>[Ginrpc](https://github.com/xxjwxc/ginrpc) | 238 | Gin parameter automatic binding tool,gin rpc tools. |
| <b>[uAdmin](https://github.com/uadmin/uadmin) | 210 | Fully featured web framework for Golang, inspired by Django. |
...
| <b>[Huma](https://github.com/danielgtaylor/huma/) | 141 | Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI. |
...
| <b>[Microservice](https://github.com/claygod/microservice) | 106 | The framework for the creation of microservices, written in Golang. |
...
| <b>[go-fault](https://github.com/github/go-fault) | 468 | Fault injection middleware for Go. |
| <b>[ln-paywall](https://github.com/philippgille/ln-paywall) | 130 | Go middleware for monetizing APIs on a per-request basis with the Lightning Network (Bitcoin). |
| <b>[XFF](https://github.com/sebest/xff) | 93 | Handle `X-Forwarded-For` header and friends. |
| <b>[rk-grpc](https://github.com/rookie-ninja/rk-grpc) | 52 | Middleware for gRPC with logging, metrics, auth, tracing etc. |
...
| <b>[renderer](https://github.com/thedevsaddam/renderer) | 247 | Simple, lightweight and faster response (JSON, JSONP, XML, YAML, HTML, File) rendering package for Go. |
...
| <b>[httptreemux](https://github.com/dimfeld/httptreemux) | 563 | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
...
| <b>[pure](https://github.com/go-playground/pure) | 130 | Is a lightweight HTTP router that sticks to the std "net/http" implementation. |
...
| <b>[ngamux](https://github.com/ngamux/ngamux) | 54 | Simple HTTP router for Go. |
...
| <b>[dom](https://github.com/dennwc/dom) | 465 | DOM library. |
| <b>[go-canvas](https://github.com/markfarnan/go-canvas) | 179 | Library to use HTML5 Canvas, with all drawing within go code. |
| <b>[wasmbrowsertest](https://github.com/agnivade/wasmbrowsertest) | 132 | Run Go WASM tests in your browser. |
| <b>[webapi](https://github.com/gowebapi/webapi) | 126 | Bindings for DOM and HTML generated from WebIDL. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-ole](https://github.com/go-ole/go-ole) | 916 | Win32 OLE implementation for golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[zek](https://github.com/miku/zek) | 605 | Generate a Go struct from XML. |
| <b>[xpath](https://github.com/antchfx/xpath) | 520 | XPath package for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Cosign](https://github.com/sigstore/cosign) | 2.7k | Container Signing, Verification and Storage in an OCI registry. |
...
| <b>[in-toto](https://github.com/in-toto/in-toto-golang) | 67 | Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation. |
| <b>[Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) | 45 | Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication. |
...
| <b>[php-parser](https://github.com/z7zmey/php-parser) | 895 | A Parser for PHP written in Go. |
| <b>[goast-viewer](https://github.com/yuroyoro/goast-viewer) | 662 | Web based Golang AST visualizer. |
| <b>[go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 629 | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
| <b>[go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 601 | An easy way to find outdated dependencies of your Go projects. |
| <b>[golines](https://github.com/segmentio/golines) | 488 | Formatter that automatically shortens long lines in Go code. |
...
| <b>[unconvert](https://github.com/mdempsky/unconvert) | 342 | Remove unnecessary type conversions from Go source. |
| <b>[dupl](https://github.com/mibk/dupl) | 299 | Tool for code clone detection. |
| <b>[tickgit](https://github.com/augmentable-dev/tickgit) | 287 | CLI and go package for surfacing code comment TODOs (in any language) and applying a `git blame`to identify the author. |
...
| <b>[ChainJacking](https://github.com/Checkmarx/chainjacking) | 35 | Find which of your Go lang direct GitHub dependencies is susceptible to ChainJacking attack. |
...
| <b>[asty](https://github.com/asty-org/asty) | 30 | Converts golang AST to JSON and JSON to AST. |
...
| <b>[coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) | 499 | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| <b>[goimports-reviser](https://github.com/incu6us/goimports-reviser) | 220 | Formatting tool for imports. |
| <b>[Watch](https://github.com/eaburns/Watch) | 197 | Runs a command in an acme win on file changes. |
...
| <b>[xgen](https://github.com/xuri/xgen) | 192 | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| <b>[depth](https://github.com/KyleBanks/depth) | 797 | Visualize dependency trees of any package by analyzing imports. |
| <b>[richgo](https://github.com/kyoh86/richgo) | 736 | Enrich `go test` outputs with text decorations. |
...
| <b>[typex](https://github.com/dtgorski/typex) | 153 | Examine Go types and their transitive dependencies, alternatively export results as TypeScript value objects (or types) declaration. |
| <b>[roumon](https://github.com/becheran/roumon) | 122 | Monitor current state of all active goroutines via a command line interface. |
...
| <b>[gotestdox](https://github.com/bitfield/gotestdox) | 22 | Show Go test results as readable sentences. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[kubernetes](https://github.com/kubernetes/kubernetes) | 93.0k | Container Cluster Manager from Google. |
...
| <b>[webhook](https://github.com/adnanh/webhook) | 8.3k | Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server. |
| <b>[GVM](https://github.com/moovweb/gvm) | 7.9k | GVM provides an interface to manage Go versions. |
| <b>[ko](https://github.com/google/ko) | 5.2k | Command line tool for building and deploying Go applications on Kubernetes |
...
| <b>[Mizu](https://github.com/up9inc/mizu) | 4.1k | API traffic viewer for Kubernetes enabling you to view all API communication between microservices, multiprotocol support: HTTP1.1, HTTP/2, AMQP, Kafka, Redis. |
...
| <b>[Fleet device management](https://github.com/fleetdm/fleet) | 959 | Lightweight, programmable telemetry for servers and workstations. |
| <b>[skm](https://github.com/TimothyYe/skm) | 833 | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| <b>[Scaleway-cli](https://github.com/scaleway/scaleway-cli) | 784 | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| <b>[uTask](https://github.com/ovh/utask) | 780 | Automation engine that models and executes business processes declared in yaml. |
| <b>[kwatch](https://github.com/abahmed/kwatch) | 687 | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
| <b>[cassowary](https://github.com/rogerwelin/cassowary) | 624 | Modern cross-platform HTTP load-testing tool written in Go. |
| <b>[kool](https://github.com/kool-dev/kool) | 615 | Command line tool for managing Docker environments as an easy way. |
| <b>[aurora](https://github.com/xuri/aurora) | 569 | Cross-platform web-based Beanstalkd queue server console. |
| <b>[govvv](https://github.com/ahmetalpbalkan/govvv) | 531 | “go build” wrapper to easily add version information into Go binaries. |
| <b>[Pewpew](https://github.com/bengadbois/pewpew) | 359 | Flexible HTTP command line stress tester. |
| <b>[jcli](https://github.com/jenkins-zh/jenkins-cli) | 339 | Jenkins CLI allows you manage your Jenkins as an easy way. |
...
| <b>[manssh](https://github.com/xwjdsh/manssh) | 273 | manssh is a command line tool for managing your ssh alias config easily. |
| <b>[easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 263 | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
...
| <b>[terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 219 | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| <b>[abbreviate](https://github.com/dnnrly/abbreviate) | 190 | abbreviate is a tool turning long strings in to shorter ones with configurable seperaters, for example to embed branch names in to deployment stack IDs. |
...
| <b>[s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 139 | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
| <b>[Dockerfile-Generator](https://github.com/ozankasikci/dockerfile-generator) | 138 | A go library and an executable that produces valid Dockerfiles using various input channels. |
| <b>[drone-scp](https://github.com/appleboy/drone-scp) | 113 | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
| <b>[Mantil](https://github.com/mantil-io/mantil) | 95 | Go specific framework for building serverless applications on AWS that enables you to focus on pure Go code while Mantil takes care of the infrastructure. |
...
| <b>[httpref](https://github.com/dnnrly/httpref) | 25 | httpref is a handy CLI reference for HTTP methods, status codes, headers, and TCP and UDP ports. |
...
| <b>[aptly](https://github.com/smira/aptly) | 7 | aptly is a Debian repository management tool. |
...
| <b>[vFlow](https://github.com/VerizonDigital/vflow) | 930 | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
...
| <b>[Guora](https://github.com/meloalright/guora) | 610 | A self-hosted Quora like web application written in Go. |
| <b>[sake](https://github.com/alajmo/sake) | 567 | sake is a command runner for local and remote hosts. |
| <b>[gocc](https://github.com/goccmack/gocc) | 543 | Gocc is a compiler kit for Go written in Go. |
| <b>[mockingjay](https://github.com/quii/mockingjay-server) | 523 | Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests. |
| <b>[go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 454 | Video streaming torrent client. |
| <b>[Gokapi](https://github.com/Forceu/gokapi) | 444 | Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload. |
| <b>[ipe](https://github.com/dimiro1/ipe) | 358 | Open source Pusher server implementation compatible with Pusher client libraries written in GO. |
| <b>[ide](https://github.com/thestrukture/ide) | 353 | Browser accessible IDE. Designed for Go with Go. |
| <b>[woke](https://github.com/get-woke/woke) | 352 | Detect non-inclusive language in your source code. |
| <b>[tcpprobe](https://github.com/mehrdadrad/tcpprobe) | 329 | TCP tool for network performance and path monitoring, including socket statistics. |
...
| <b>[Cherry](https://github.com/rafael-santiago/cherry) | 285 | Tiny webchat server in Go. |
| <b>[Neo-cowsay](https://github.com/Code-Hex/Neo-cowsay) | 231 | 🐮 cowsay is reborn. for a New Era. |
| <b>[tcpdog](https://github.com/mehrdadrad/tcpdog) | 210 | eBPF based TCP observability. |
...
| <b>[stew](https://github.com/marwanhawari/stew) | 107 | An independent package manager for compiled binaries. |
| <b>[crawley](https://github.com/s0rg/crawley) | 103 | Web scraper/crawler for cli. |
...
| <b>[gopherize.me](https://github.com/matryer/gopherize.me) | 605 | Gopherize yourself. |
| <b>[gopher-stickers](https://github.com/tenntenn/gopher-stickers) | 543 | gopher stickers |
...
| <b>[Trybe](https://github.com/betrybe/playbook-go/blob/main/README_EN.md) | 311 | Playbook da linguagem Go |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Go Projects](https://github.com/golang/go/wiki/Projects) | 105.0k | List of projects on the Go community wiki. |
...
| <b>[Awesome Golang Workshops](https://github.com/amit-davidson/awesome-golang-workshops) | 475 | A curated list of awesome golang workshops. |
...
| <b>[goapp](https://github.com/bnkamalesh/goapp) | 533 | An opinionated guideline to structure & develop a Go web application/service. |
| <b>[Go in 7 days](https://github.com/harrytran103/7_days_of_go) | 105 | Learn everything about Go in 7 days (from a Nodejs developer). |
| <b>[Design Patterns in Go](https://github.com/shubhamzanwar/design-patterns) | 85 | Collection of programming design patterns implemented in Go. |
