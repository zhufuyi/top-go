...
| :------ | :------ | :------ |
| <b>[Oto](https://github.com/hajimehoshi/oto) | 1.2k | A low-level library to play sound on multiple platforms. |
| <b>[PortAudio](https://github.com/gordonklaus/portaudio) | 561 | Go bindings for the PortAudio audio I/O library. |
| <b>[music-theory](https://github.com/go-music-theory/music-theory) | 415 | Music theory models in Go. |
| <b>[id3v2](https://github.com/bogem/id3v2) | 277 | ID3 decoding and encoding library for Go. |
| <b>[GoAudio](https://github.com/DylanMeeus/GoAudio) | 271 | Native Go Audio Processing Library. |
| <b>[flac](https://github.com/mewkiz/flac) | 232 | Native Go FLAC encoder/decoder with support for FLAC streams. |
| <b>[malgo](https://github.com/gen2brain/malgo) | 212 | Mini audio library. |
| <b>[gaad](https://github.com/Comcast/gaad) | 107 | Native Go AAC bitstream parser. |
| <b>[minimp3](https://github.com/tosone/minimp3) | 96 | Lightweight MP3 decoder library. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[casbin](https://github.com/hsluoyz/casbin) | 14.0k | Authorization library that supports access control models like ACL, RBAC, ABAC. |
...
| <b>[paseto](https://github.com/o1egl/paseto) | 661 | Golang implementation of Platform-Agnostic Security Tokens (PASETO). |
| <b>[jwt](https://github.com/cristalhq/jwt) | 584 | Safe, simple and fast JSON Web Tokens for Go. |
| <b>[permissions2](https://github.com/xyproto/permissions2) | 471 | Library for keeping track of users, login states and permissions. Uses secure cookies and bcrypt. |
| <b>[go-guardian](https://github.com/shaj13/go-guardian) | 430 | Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token and Certificate based authentication. |
| <b>[jwt](https://github.com/pascaldekloe/jwt) | 306 | Lightweight JSON Web Token (JWT) library. |
| <b>[jeff](https://github.com/abraithwaite/jeff) | 249 | Simple, flexible, secure and idiomatic web session management with pluggable backends. |
...
| <b>[otpgen](https://github.com/grijul/otpgen) | 122 | Library to generate TOTP/HOTP codes. |
...
| <b>[otpgo](https://github.com/jltorresm/otpgo) | 50 | Time-Based One-Time Password (TOTP) and HMAC-Based One-Time Password (HOTP) library for Go. |
| <b>[scope](https://github.com/SonicRoshan/scope) | 28 | Easily Manage OAuth2 Scopes In Go. |
...
| <b>[tendermint](https://github.com/tendermint/tendermint) | 5.4k | High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols. |
| <b>[cosmos-sdk](https://github.com/cosmos/cosmos-sdk) | 4.9k | A Framework for Building Public Blockchains in the Cosmos Ecosystem. |
| <b>[solana-go](https://github.com/gagliardetto/solana-go) | 398 | Go library to interface with Solana JSON RPC and WebSocket interfaces. |
| <b>[gossamer](https://github.com/ChainSafe/gossamer) | 368 | A Go implementation of the Polkadot Host. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[telegram-bot-api](https://github.com/Syfaro/telegram-bot-api) | 4.3k | Simple and clean Telegram bot client. |
...
| <b>[Kelp](https://github.com/stellar/kelp) | 960 | official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies. |
| <b>[Golang CryptoTrading Bot](https://github.com/saniales/golang-crypto-trading-bot) | 869 | A golang implementation of a console-based trading bot for cryptocurrency exchanges. |
| <b>[go-chat-bot](https://github.com/go-chat-bot/bot) | 770 | IRC, Slack & Telegram bot written in Go. |
| <b>[slacker](https://github.com/shomali11/slacker) | 723 | Easy to use framework to create Slack bots. |
| <b>[wayback](https://github.com/wabarc/wayback) | 424 | A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages. |
| <b>[tbot](https://github.com/yanzay/tbot) | 332 | Telegram bot server with API similar to net/http. |
| <b>[go-twitch-irc](https://github.com/gempir/go-twitch-irc) | 275 | Library to write bots for twitch.tv chat |
...
| <b>[echotron](https://github.com/NicoNex/echotron) | 219 | An elegant and concurrent library for Telegram Bots in Go. |
...
| <b>[telego](https://github.com/mymmrac/telego) | 136 | Telegram Bot API library for Golang with full one-to-one API implementation. |
| <b>[slack-bot](https://github.com/innogames/slack-bot) | 131 | Ready to use Slack Bot for lazy developers: Custom commands, Jenkins, Jira, Bitbucket, Github... |
...
| <b>[larry](https://github.com/ezeoleaf/larry) | 112 | Larry 🐦 is a really simple Twitter bot generator that tweets random repositories from Github built in Go. |
...
| <b>[teleterm](https://github.com/alfiankan/teleterm) | 17 | Telegram Bot Exec Terminal Command. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Task](https://github.com/go-task/task) | 6.7k | simple "Make" alternative. |
...
| <b>[goyek](https://github.com/goyek/goyek) | 353 | Create build pipelines in Go. |
| <b>[taskctl](https://github.com/taskctl/taskctl) | 237 | Concurrent task runner. |
| <b>[1build](https://github.com/gopinath-langote/1build) | 204 | Command line tool to frictionlessly manage project-specific commands. |
| <b>[gaper](https://github.com/maxcnunes/gaper) | 65 | Builds and restarts a Go project when it crashes or some watched file changes. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[bubbletea](https://github.com/charmbracelet/bubbletea) | 17.0k | Go framework to build terminal apps, based on The Elm Architecture. |
...
| <b>[gocui](https://github.com/jroimartin/gocui) | 8.8k | Minimalist Go library aimed at creating Console User Interfaces. |
...
| <b>[go-prompt](https://github.com/c-bata/go-prompt) | 4.8k | Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). |
| <b>[termbox-go](https://github.com/nsf/termbox-go) | 4.5k | Termbox is a library for creating cross-platform text-based interfaces. |
| <b>[pterm](https://github.com/pterm/pterm) | 3.2k | A library to beautify console output on every platform with many combinable components. |
| <b>[progressbar](https://github.com/schollz/progressbar) | 3.1k | Basic thread-safe progress bar that works in every OS. |
...
| <b>[uitable](https://github.com/gosuri/uitable) | 688 | Library to improve readability in terminal apps using tabular data. |
| <b>[go-colorable](https://github.com/mattn/go-colorable) | 670 | Colorable writer for windows. |
| <b>[go-isatty](https://github.com/mattn/go-isatty) | 669 | isatty for golang. |
| <b>[gommon/color](https://github.com/labstack/gommon/tree/master/color) | 484 | Style terminal text. |
| <b>[chalk](https://github.com/ttacon/chalk) | 419 | Intuitive package for prettifying terminal/console output. |
| <b>[simpletable](https://github.com/alexeyco/simpletable) | 409 | Simple tables in terminal with Go. |
| <b>[yacspin](https://github.com/theckman/yacspin) | 387 | Yet Another CLi Spinner package, for working with terminal spinners. |
| <b>[box-cli-maker](https://github.com/Delta456/box-cli-maker) | 328 | Make Highly Customized Boxes for your CLI. |
...
| <b>[cfmt](https://github.com/mingrammer/cfmt) | 92 | Contextual fmt inspired by bootstrap color classes. |
...
| <b>[cfmt](https://github.com/i582/cfmt) | 54 | Simple and convenient formatted stylized output fully compatible with fmt library. |
...
| <b>[marker](https://github.com/cyucelen/marker) | 36 | Easiest way to match and mark strings for colorful terminal outputs. |
...
| <b>[survey](https://github.com/go-survey/survey) | 3.5k | Build interactive and accessible prompts with full support for windows and posix terminals. |
...
| <b>[liner](https://github.com/peterh/liner) | 949 | Go readline-like library for command-line interfaces. |
| <b>[complete](https://github.com/posener/complete) | 870 | Write bash completions in Go + Go command bash completion. |
...
| <b>[cli](https://github.com/mkideal/cli) | 677 | Feature-rich and easy to use command-line package based on golang struct tags. |
| <b>[argparse](https://github.com/akamensky/argparse) | 492 | Command line argument parser inspired by Python's argparse module. |
...
| <b>[clîr](https://github.com/leaanthony/clir) | 149 | A Simple and Clear CLI library. Dependency free. |
...
| <b>[carapace-bin](https://github.com/rsteube/carapace-bin) | 137 | Multi-shell multi-command argument completer. |
...
| <b>[carapace](https://github.com/rsteube/carapace) | 75 | Command argument completion generator for spf13/cobra. |
...
| <b>[version](https://github.com/mszostok/version) | 59 | Collects and displays CLI version information in multiple formats along with upgrade notice. |
...
| <b>[go-andotp](https://github.com/grijul/go-andotp) | 19 | A CLI program to encrypt/decrypt [andOTP](https://github.com/andOTP/andOTP) files. Can be used as library as well. |
...
| <b>[godotenv](https://github.com/joho/godotenv) | 5.7k | Go port of Ruby's dotenv library (Loads environment variables from `.env`). |
...
| <b>[env](https://github.com/caarlos0/env) | 3.1k | Parse environment variables to Go structs (with defaults). |
...
| <b>[cleanenv](https://github.com/ilyakaznacheev/cleanenv) | 863 | Minimalistic configuration reader (from files, ENV, and wherever you want). |
...
| <b>[aconfig](https://github.com/cristalhq/aconfig) | 423 | Simple, useful and opinionated config loader. |
| <b>[gookit/config](https://github.com/gookit/config) | 418 | application config manage(load,get,set). support JSON, YAML, TOML, INI, HCL. multi file load, data override merge. |
| <b>[config](https://github.com/JeremyLoy/config) | 323 | Cloud native application configuration. Bind ENV to structs in only two lines. |
| <b>[xdg](https://github.com/adrg/xdg) | 311 | Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories). |
| <b>[GoLobby/Config](https://github.com/golobby/config) | 308 | GoLobby Config is a lightweight yet powerful configuration manager for the Go programming language. |
...
| <b>[envconfig](https://github.com/vrischmann/envconfig) | 231 | Read your configuration from environment variables. |
...
| <b>[configuro](https://github.com/sherifabdlnaby/configuro) | 83 | opinionated configuration loading & validation framework from ENV and Files focused towards 12-Factor compliant applications. |
...
| <b>[go-aws-ssm](https://github.com/PaddleHQ/go-aws-ssm) | 53 | Go package that fetches parameters from AWS System Manager - Parameter Store. |
...
| <b>[env](https://github.com/junk1tm/env) | 37 | A lightweight package for loading environment variables into structs. |
...
| <b>[config](https://github.com/num30/config) | 28 | configure you app using file, environment variables, or flags in two lines of code |
...
| <b>[goveralls](https://github.com/mattn/goveralls) | 751 | Go integration for Coveralls.io continuous code coverage tracking system. |
| <b>[gotestfmt](https://github.com/GoTestTools/gotestfmt) | 350 | go test output for humans. |
| <b>[gotestfmt](https://github.com/haveyoudebuggedit/gotestfmt) | 350 | go test output for humans. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gcss](https://github.com/yosssi/gcss) | 469 | Pure Go CSS Preprocessor. |
...
| <b>[bit](https://github.com/yourbasic/bit) | 138 | Golang set data structure with bonus bit-twiddling functions. |
| <b>[crunch](https://github.com/superwhiskers/crunch) | 63 | Go package implementing buffers for handling various datatypes easily. |
...
| <b>[bitmap](https://github.com/kelindar/bitmap) | 189 | Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go. |
...
| <b>[cuckoofilter](https://github.com/seiflotfy/cuckoofilter) | 953 | Cuckoo filter: a good alternative to a counting bloom filter implemented in Go. |
| <b>[cuckoo-filter](https://github.com/linvon/cuckoo-filter) | 244 | Cuckoo filter: a comprehensive cuckoo filter, which is configurable and space optimized compared with other implements, and all features mentioned in original paper is available. |
...
| <b>[gostl](https://github.com/liyue201/gostl) | 765 | Data structure and algorithm library for go, designed to provide functions similar to C++ STL. |
| <b>[algorithms](https://github.com/shady831213/algorithms) | 695 | Algorithms and data structures.CLRS study. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[iter](https://github.com/disksing/iter) | 172 | Go implementation of C++ STL iterators and algorithms. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[cmap](https://github.com/lrita/cmap) | 46 | a thread-safe concurrent map for go, support using `interface{}` as key and auto scale up shards. |
| <b>[dict](https://github.com/srfrog/dict) | 35 | Python-like dictionaries (dict) for Go. |
...
| <b>[hyperloglog](https://github.com/axiomhq/hyperloglog) | 823 | HyperLogLog implementation with Sparse, LogLog-Beta bias correction and TailCut space reduction. |
| <b>[go-geoindex](https://github.com/hailocab/go-geoindex) | 343 | In-memory geo index. |
| <b>[hilbert](https://github.com/google/hilbert) | 257 | Go package for mapping values to and from space-filling curves, such as Hilbert and Peano curves. |
...
| <b>[count-min-log](https://github.com/seiflotfy/count-min-log) | 59 | Go implementation Count-Min-Log sketch: Approximately counting with approximate counters (Like Count-Min sketch but using less memory). |
...
| <b>[go-tuple](https://github.com/barweiss/go-tuple) | 45 | Generic tuple implementation for Go 1.18+. |
| <b>[genfuncs](https://github.com/nwillc/genfuncs) | 41 | Go 1.18+ generics package inspired by Kotlin's Sequence and Map. |
| <b>[fsm](https://github.com/cocoonspace/fsm) | 36 | Finite-State Machine package. |
| <b>[go18ds](https://github.com/daichi-m/go18ds) | 31 | Go Data Structures using Go 1.18 generics. |
...
| <b>[go-generics](https://github.com/bobg/go-generics) | 10 | Generic slice, map, set, iterator, and goroutine utilities. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[nan](https://github.com/kak-tus/nan) | 64 | Zero allocation Nullable structures in one library with handy conversion functions, marshallers and unmarshallers. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[deque](https://github.com/gammazero/deque) | 417 | Fast ring-buffer deque (double-ended queue). |
| <b>[goconcurrentqueue](https://github.com/enriquebris/goconcurrentqueue) | 245 | Concurrent FIFO queue. |
| <b>[deque](https://github.com/edwingeng/deque) | 92 | A highly optimized double-ended queue. |
| <b>[memlog](https://github.com/embano1/memlog) | 75 | An easy to use, lightweight, thread-safe and append-only in-memory data structure inspired by Apache Kafka. |
...
| <b>[trie](https://github.com/derekparker/trie) | 625 | Trie implementation in Go. |
| <b>[go-edlib](https://github.com/hbollon/go-edlib) | 374 | Go string comparison and edit distance algorithms library (Levenshtein, LCS, Hamming, Damerau levenshtein, Jaro-Winkler, etc.) compatible with Unicode. |
| <b>[go-adaptive-radix-tree](https://github.com/plar/go-adaptive-radix-tree) | 261 | Go implementation of Adaptive Radix Tree. |
| <b>[levenshtein](https://github.com/agnivade/levenshtein) | 257 | Implementation to calculate levenshtein distance in Go. |
...
| <b>[ttlcache](https://github.com/jellydator/ttlcache) | 569 | An in-memory cache with item expiration and generics. |
...
| <b>[bcache](https://github.com/iwanbk/bcache) | 107 | Eventually consistent distributed in-memory  cache Go library. |
...
| <b>[timedmap](https://github.com/zekroTJA/timedmap) | 52 | Map with expiring key-value pairs. |
...
| <b>[VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) | 7.7k | fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL. |
...
| <b>[rosedb](https://github.com/roseduan/rosedb) | 3.5k | An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset. |
...
| <b>[eliasdb](https://github.com/krotik/eliasdb) | 959 | Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language. |
| <b>[moss](https://github.com/couchbase/moss) | 898 | Moss is a simple LSM key-value storage engine written in 100% Go. |
| <b>[objectbox-go](https://github.com/objectbox/objectbox-go) | 818 | High-performance embedded Object Database (NoSQL) with Go API. |
| <b>[levigo](https://github.com/jmhodges/levigo) | 412 | Levigo is a Go wrapper for LevelDB. |
| <b>[pudge](https://github.com/recoilme/pudge) | 332 | Fast and simple key/value store written using Go's standard library. |
| <b>[clover](https://github.com/ostafen/clover) | 317 | A lightweight document-oriented NoSQL database written in pure Golang. |
| <b>[Vasto](https://github.com/chrislusf/vasto) | 246 | A distributed high-performance key-value store. On Disk. Eventual consistent. HA. Able to grow or shrink without service interruption. |
| <b>[dtf](https://github.com/dtm-labs/dtf) | 224 | A distributed transaction manager. Support XA, TCC, SAGA, Reliable Messages. |
| <b>[piladb](https://github.com/fern4lvarez/piladb) | 200 | Lightweight RESTful database engine based on stack data structures. |
| <b>[unitdb](https://github.com/unit-io/unitdb) | 101 | Fast timeseries database for IoT, realtime messaging  applications. Access unitdb with pubsub over tcp or websocket using github.com/unit-io/unitd application. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[migrate](https://github.com/golang-migrate/migrate) | 11.0k | Database migrations. CLI and Golang library. |
| <b>[bytebase](https://github.com/bytebase/bytebase) | 4.7k | Safe database schema change and version control for DevOps teams. |
...
| <b>[atlas](https://github.com/ariga/atlas) | 2.3k | A Database Toolkit. A CLI designed to help companies better work with their data. |
...
| <b>[goavro](https://github.com/linkedin/goavro) | 860 | A Go package that encodes and decodes Avro data. |
| <b>[gormigrate](https://github.com/go-gormigrate/gormigrate) | 853 | Database schema migration helper for Gorm ORM. |
...
| <b>[sqlize](https://github.com/sunary/sqlize) | 48 | Database migration generator. Allows generate sql migration from model and existing sql by differ them. |
...
| <b>[pg_timetable](https://github.com/cybertec-postgresql/pg_timetable) | 821 | Advanced scheduling for PostgreSQL. |
| <b>[clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) | 398 | Collects small inserts and sends big requests to ClickHouse servers. |
| <b>[rdb](https://github.com/HDT3213/rdb) | 220 | Redis RDB file parser for secondary development and memory analysis. |
...
| <b>[octillery](https://github.com/knocknote/octillery) | 177 | Go package for sharding databases ( Supports every ORM or raw SQL ). |
| <b>[dbbench](https://github.com/sj14/dbbench) | 82 | Database benchmarking tool with support for several databases and scripts. |
...
| <b>[dynago](https://github.com/twharmon/dynago) | 6 | Simplify working with AWS DynamoDB. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sqlc](https://github.com/kyleconroy/sqlc) | 7.2k | Generate type-safe code from SQL. |
| <b>[Squirrel](https://github.com/Masterminds/squirrel) | 5.5k | Go library that helps you build SQL queries. |
...
| <b>[jet](https://github.com/go-jet/jet) | 995 | Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure. |
| <b>[Dotsql](https://github.com/gchaincl/dotsql) | 656 | Go library that helps you keep sql files in one place and use them with ease. |
| <b>[ozzo-dbx](https://github.com/go-ozzo/ozzo-dbx) | 589 | Powerful data retrieval methods as well as DB-agnostic query building capabilities. |
| <b>[dbq](https://github.com/rocketlaunchr/dbq) | 357 | Zero boilerplate database operations for Go. |
| <b>[sqlingo](https://github.com/lqs/sqlingo) | 275 | A lightweight DSL to build SQL in Go. |
| <b>[sqrl](https://github.com/elgris/sqrl) | 246 | SQL query builder, fork of Squirrel with improved performance. |
| <b>[sq](https://github.com/bokwoon95/go-structured-query) | 186 | Type-safe SQL builder and struct mapper for Go. |
| <b>[sqlf](https://github.com/leporo/sqlf) | 92 | Fast SQL query builder. |
| <b>[igor](https://github.com/galeone/igor) | 90 | Abstraction layer for PostgreSQL that supports advanced functionality and uses gorm-like syntax. |
| <b>[buildsqlx](https://github.com/arthurkushman/buildsqlx) | 87 | Go database query builder library for PostgreSQL. |
...
| <b>[builq](https://github.com/cristalhq/builq) | 45 | Easily build SQL queries in Go. |
...
| <b>[ormlite](https://github.com/pupizoid/ormlite) | 5 | Lightweight package containing some ORM-like features and helpers for sqlite databases. |
...
| <b>[gokv](https://github.com/philippgille/gokv) | 510 | Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more). |
...
| <b>[sqlhooks](https://github.com/qustavo/sqlhooks) | 599 | Attach hooks to any database/sql driver. |
| <b>[go-oci8](https://github.com/mattn/go-oci8) | 598 | Oracle driver for go that uses database/sql. |
| <b>[godror](https://github.com/godror/godror) | 409 | Oracle driver for Go, using the ODPI-C driver. |
...
| <b>[go-adodb](https://github.com/mattn/go-adodb) | 133 | Microsoft ActiveX Object DataBase driver for go that uses database/sql. |
| <b>[Sqinn-Go](https://github.com/cvilsmeier/sqinn-go) | 132 | SQLite with pure Go. |
...
| <b>[ydb-go-sdk](https://github.com/ydb-platform/ydb-go-sdk) | 72 | native and database/sql driver YDB (Yandex Database) |
...
| <b>[mongo-go-driver](https://github.com/mongodb/mongo-go-driver) | 7.2k | Official MongoDB driver for the Go language. |
...
| <b>[mgm](https://github.com/kamva/mgm) | 611 | MongoDB model-based ODM for Go (based on official MongoDB driver). |
...
| <b>[gocb](https://github.com/couchbase/gocb) | 340 | Official Couchbase Go SDK. |
...
| <b>[go-elasticsearch](https://github.com/elastic/go-elasticsearch) | 4.7k | Official Elasticsearch client for Go. |
| <b>[elasticsql](https://github.com/cch123/elasticsql) | 1000 | Convert sql to elasticsearch dsl in Go. |
...
| <b>[carbon](https://github.com/golang-module/carbon) | 2.9k | A simple, semantic and developer-friendly golang package for datetime. |
...
| <b>[gostradamus](https://github.com/bykof/gostradamus) | 174 | A Go package for working with dates. |
| <b>[go-persian-calendar](https://github.com/yaa110/go-persian-calendar) | 141 | The implementation of the Persian (Solar Hijri) Calendar in Go (golang). |
...
| <b>[go-anytime](https://github.com/ijt/go-anytime) | 8 | Parse dates/times like "next dec 22nd at 3pm" and ranges like "from today until next thursday" without knowing the format in advance. |
...
| <b>[raft](https://github.com/hashicorp/raft) | 6.8k | Golang implementation of the Raft consensus protocol, by HashiCorp. |
| <b>[Kitex](https://github.com/cloudwego/kitex) | 5.5k | A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice. |
...
| <b>[emitter-io](https://github.com/emitter-io/emitter) | 3.5k | High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love. |
...
| <b>[go-doudou](https://github.com/unionj-cloud/go-doudou) | 969 | A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity. |
| <b>[redis-lock](https://github.com/bsm/redislock) | 893 | Simplified distributed locking implementation using Redis. |
| <b>[rain](https://github.com/cenkalti/rain) | 798 | BitTorrent client and library. |
| <b>[ringpop-go](https://github.com/uber/ringpop-go) | 767 | Scalable, fault-tolerant application-layer sharding for Go applications. |
| <b>[arpc](https://github.com/lesismal/arpc) | 668 | More effective network communication, support two-way-calling, notify, broadcast. |
| <b>[gorpc](https://github.com/valyala/gorpc) | 667 | Simple, fast and scalable RPC library for high load. |
| <b>[go-health](https://github.com/InVisionApp/go-health) | 658 | Library for enabling asynchronous dependency health checks in your service. |
| <b>[consistent](https://github.com/buraksezer/consistent) | 558 | Consistent hashing with bounded loads. |
| <b>[go-sundheit](https://github.com/AppsFlyer/go-sundheit) | 508 | A library built to provide support for defining async service health checks for golang services. |
| <b>[digota](https://github.com/digota/digota) | 470 | grpc ecommerce microservice. |
...
| <b>[go-jump](https://github.com/dgryski/go-jump) | 355 | Port of Google's "Jump" Consistent Hash function. |
...
| <b>[jsonrpc](https://github.com/osamingo/jsonrpc) | 173 | The jsonrpc package helps implement of JSON-RPC 2.0. |
| <b>[outboxer](https://github.com/italolelis/outboxer) | 114 | Outboxer is a go library that implements the outbox pattern. |
...
| <b>[go-mysql-lock](https://github.com/sanketplus/go-mysql-lock) | 51 | MySQL based distributed lock. |
| <b>[go-pdu](https://github.com/pdupub/go-pdu) | 45 | A decentralized identity-based social network. |
...
| <b>[mailgun-go](https://github.com/mailgun/mailgun-go) | 627 | Go library for sending mail with the Mailgun API. |
| <b>[email-verifier](https://github.com/AfterShip/email-verifier) | 612 | A Go library for email verification without sending any emails. |
| <b>[go-simple-mail](https://github.com/xhit/go-simple-mail) | 416 | Very simple package to send emails with SMTP Keep Alive and two timeouts: Connect and Send. |
| <b>[go-message](https://github.com/emersion/go-message) | 291 | Streaming library for the Internet Message Format and mail messages. |
...
| <b>[go-mail](https://github.com/wneessen/go-mail) | 214 | A simple Go library for sending mails in Go. |
| <b>[mailchain](https://github.com/mailchain/mailchain) | 134 | Send encrypted emails to blockchain addresses written in Go. |
| <b>[Mailpit](https://github.com/axllent/mailpit) | 121 | Email and SMTP testing tool for developers. |
| <b>[go-premailer](https://github.com/vanng822/go-premailer) | 96 | Inline styling for HTML mail in Go. |
| <b>[go-dkim](https://github.com/toorop/go-dkim) | 87 | DKIM library, to sign & verify email. |
| <b>[smtp](https://github.com/mailhog/smtp) | 74 | SMTP server protocol state machine. |
| <b>[smtpmock](https://github.com/mocktools/go-smtp-mock) | 66 | Lightweight configurable multithreaded fake SMTP server. Mimic any SMTP behaviour for your test environment. |
| <b>[go-email-validator](https://github.com/go-email-validator/go-email-validator) | 44 | Modular email validator for syntax, disposable, smtp, etc... checking. |
...
| <b>[go-php](https://github.com/deuill/go-php) | 884 | PHP bindings for Go. |
| <b>[go-duktape](https://github.com/olebedev/go-duktape) | 777 | Duktape JavaScript engine bindings for Go. |
| <b>[golua](https://github.com/aarzilli/golua) | 604 | Go bindings for Lua C API. |
| <b>[gval](https://github.com/PaesslerAG/gval) | 564 | A highly customizable expression language written in Go. |
| <b>[gisp](https://github.com/jcla1/gisp) | 498 | Simple LISP in Go. |
| <b>[prolog](https://github.com/ichiban/prolog) | 458 | Embeddable Prolog. |
| <b>[gentee](https://github.com/gentee/gentee) | 101 | Embeddable scripting programming language. |
| <b>[binder](https://github.com/alexeyco/binder) | 65 | Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua). |
...
| <b>[errorx](https://github.com/joomcode/errorx) | 938 | A feature rich error package with stack traces, composition of errors and more. |
| <b>[tracerr](https://github.com/ztrue/tracerr) | 755 | Golang errors with stack trace and source fragments. |
| <b>[errlog](https://github.com/snwfdhmp/errlog) | 414 | Hackable package that determines responsible source code for an error (and some other fast-debugging features). Pluggable to any logger in-place. |
| <b>[emperror](https://github.com/emperror/emperror) | 282 | Error handling tools and best practices for Go libraries and applications. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[afero](https://github.com/spf13/afero) | 5.0k | FileSystem Abstraction System for Go. |
...
| <b>[notify](https://github.com/rjeczalik/notify) | 792 | File system event notification library with simple API, similar to os/signal. |
| <b>[copy](https://github.com/otiai10/copy) | 512 | Copy directory recursively. |
| <b>[bigfile](https://github.com/bigfile/bigfile) | 238 | A file transfer system, support to manage files with http api, rpc call and ftp client. |
| <b>[afs](https://github.com/viant/afs) | 221 | Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go. |
| <b>[vfs](https://github.com/C2FO/vfs) | 213 | A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS. |
| <b>[go-exiftool](https://github.com/barasher/go-exiftool) | 156 | Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...). |
| <b>[gofs](https://github.com/no-src/gofs) | 117 | A file synchronization tool out of the box. |
| <b>[go-csv-tag](https://github.com/artonge/go-csv-tag) | 103 | Load csv file using tag. |
...
| <b>[parquet](https://github.com/parsyl/parquet) | 62 | Read and write [parquet](https://parquet.apache.org) files. |
...
| <b>[higgs](https://github.com/dastoori/higgs) | 16 | A tiny cross-platform Go library to hide/unhide files and directories. |
...
| <b>[accounting](https://github.com/leekchan/accounting) | 783 | money and currency formatting for golang. |
| <b>[bbgo](https://github.com/c9s/bbgo) | 773 | A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies. |
| <b>[techan](https://github.com/sdcoffey/techan) | 698 | Technical analysis library with advanced market analysis and trading strategies. |
| <b>[go-finance](https://github.com/FlashBoys/go-finance) | 536 | Comprehensive financial markets data in Go. |
| <b>[currency](https://github.com/bojanz/currency) | 362 | Handles currency amounts, provides currency information and formatting. |
| <b>[ach](https://github.com/moov-io/ach) | 355 | A reader, writer, and valdiator for Automated Clearing House (ACH) files. |
| <b>[orderbook](https://github.com/i25959341/orderbook) | 321 | Matching Engine for Limit Order Book in Golang. |
| <b>[go-finance](https://github.com/alpeb/go-finance) | 144 | Library of financial functions for time value of money (annuities), cash flow, interest rate conversions, bonds and depreciation calculations. |
...
| <b>[ofxgo](https://github.com/aclindsa/ofxgo) | 114 | Query OFX servers and/or parse the responses (with example command-line client). |
| <b>[sleet](https://github.com/BoltApp/sleet) | 106 | One unified interface for multiple Payment Service Providers (PsP) to process online payment. |
...
| <b>[gorilla/csrf](https://github.com/gorilla/csrf) | 864 | CSRF protection for Go web applications & services. |
| <b>[binding](https://github.com/mholt/binding) | 794 | Binds form and JSON data from net/http Request to struct. |
| <b>[form](https://github.com/go-playground/form) | 574 | Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support. |
| <b>[conform](https://github.com/leebenson/conform) | 285 | Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags. |
...
| <b>[httpin](https://github.com/ggicci/httpin) | 128 | Decode an HTTP request into a custom struct, including querystring, forms, HTTP headers, etc. |
| <b>[qs](https://github.com/sonh/qs) | 66 | Go module for encoding structs into URL query parameters. |
...
| <b>[fpGo](https://github.com/TeaEntityLab/fpGo) | 306 | Monad, Functional Programming features for Golang. |
| <b>[fp-go](https://github.com/repeale/fp-go) | 152 | Collection of Functional Programming helpers powered by Golang 1.18+ generics. |
| <b>[gofp](https://github.com/rbrahul/gofp) | 134 | A lodash like powerful utility library for Golang. |
| <b>[fuego](https://github.com/seborama/fuego) | 124 | Functional Experiment in Go. |
| <b>[underscore](https://github.com/rjNemo/underscore) | 78 | Functional programming helpers for Go 1.18 and beyond. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Ebiten](https://github.com/hajimehoshi/ebiten) | 7.7k | dead simple 2D game library in Go. |
...
| <b>[raylib-go](https://github.com/gen2brain/raylib-go) | 916 | Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming. |
| <b>[Azul3D](https://github.com/azul3d/engine) | 567 | 3D game engine written in Go. |
| <b>[go-astar](https://github.com/beefsack/go-astar) | 538 | Go implementation of the A\* path finding algorithm. |
| <b>[Harfang3D](https://github.com/harfang3d/harfang3d) | 307 | 3D engine for the Go language, works on Windows and Linux ([Harfang on Go.dev](github.com/harfang3d/harfang-go)). |
| <b>[go3d](https://github.com/ungerik/go3d) | 275 | Performance oriented 2D/3D math package for Go. |
| <b>[tile](https://github.com/kelindar/tile) | 83 | Data-oriented and cache-friendly 2D Grid library (TileMap), includes pathfinding, observers and import/export. |
| <b>[prototype](https://github.com/gonutz/prototype) | 79 | Cross-platform (Windows/Linux/Mac) library for creating desktop games using a minimal API. |
| <b>[fantasyname](https://github.com/s0rg/fantasyname) | 16 | Fantasy names generator. |
...
| <b>[GoWrap](https://github.com/hexdigest/gowrap) | 703 | Generate decorators for Go interfaces using simple templates. |
| <b>[go-enum](https://github.com/abice/go-enum) | 428 | Code generation for enums from code comments. |
| <b>[interfaces](https://github.com/rjeczalik/interfaces) | 364 | Command line tool for generating interface definitions. |
| <b>[copygen](https://github.com/switchupcb/copygen) | 227 | Generate type-to-type code without reflection. |
| <b>[goverter](https://github.com/jmattheis/goverter) | 191 | Generate converters by defining an interface. |
...
| <b>[mbtileserver](https://github.com/consbio/mbtileserver) | 437 | A simple Go-based server for map tiles stored in mbtiles format. |
| <b>[osm](https://github.com/paulmach/osm) | 258 | Library for reading, writing and working with OpenStreetMap data and APIs. |
| <b>[H3](https://github.com/uber/h3-go) | 209 | Go bindings for H3, a hierarchical hexagonal geospatial indexing system. |
...
| <b>[simplefeatures](https://github.com/peterstace/simplefeatures) | 72 | simplesfeatures is a 2D geometry library that provides Go types that model geometries, as well as algorithms that operate on them. |
...
| <b>[c4go](https://github.com/Konstantin8105/c4go) | 330 | Transpile C code to Go code. |
| <b>[c2go](https://github.com/goplus/c2go) | 234 | Convert C code to Go code. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[ants](https://github.com/panjf2000/ants) | 9.7k | A high-performance and low-cost goroutine pool in Go. |
| <b>[conc](https://github.com/sourcegraph/conc) | 4.4k | `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer. |
...
| <b>[workerpool](https://github.com/gammazero/workerpool) | 988 | Goroutine pool that limits the concurrency of task execution, not the number of tasks queued. |
...
| <b>[pond](https://github.com/alitto/pond) | 695 | Minimalistic and High-performance goroutine worker pool written in Go. |
| <b>[gowp](https://github.com/xxjwxc/gowp) | 429 | gowp is concurrency limiting goroutine pool. |
| <b>[go-floc](https://github.com/workanator/go-floc) | 260 | Orchestrate goroutines with ease. |
| <b>[go-flow](https://github.com/kamildrazkiewicz/go-flow) | 204 | Control goroutines execution order. |
| <b>[artifex](https://github.com/borderstech/artifex) | 161 | Simple in-memory job queue for Golang using worker-based dispatching. |
...
| <b>[go-workers](https://github.com/catmullet/go-workers) | 149 | Easily and safely run workers for large data processing pipelines. |
...
| <b>[async](https://github.com/reugn/async) | 105 | An alternative sync library for Go (Future, Promise, Locks). |
...
| <b>[semaphore](https://github.com/kamilsk/semaphore) | 94 | Semaphore pattern implementation with timeout of lock/unlock operations based on channel and context. |
| <b>[routine](https://github.com/timandy/routine) | 92 | `routine` is a `ThreadLocal` for go library. It encapsulates and provides some easy-to-use, non-competitive, high-performance `goroutine` context access interfaces, which can help you access coroutine context information more gracefully. |
...
| <b>[gohive](https://github.com/loveleshsharma/gohive) | 44 | A highly performant and easy to use Goroutine pool for Go. |
| <b>[gowl](https://github.com/hamed-yousefi/gowl) | 41 | Gowl is a process management and process monitoring tool at once. An infinite worker pool gives you the ability to control the pool and processes and monitor their status. |
| <b>[kyoo](https://github.com/dirkaholic/kyoo) | 39 | Provides an unlimited job queue and concurrent worker pools. |
| <b>[go-waitgroup](https://github.com/pieterclaerhout/go-waitgroup) | 36 | Like `sync.WaitGroup` with error handling and concurrency control. |
...
| <b>[go-actor](https://github.com/vladopajic/go-actor) | 22 | A tiny library for writing concurrent programs using actor model. |
...
| <b>[concurrency-limiter](https://github.com/vivek-ng/concurrency-limiter) | 11 | Concurrency limiter with support for timeouts , dynamic priority and context cancellation of goroutines. |
...
| <b>[app](https://github.com/murlokswarm/app) | 6.8k | Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress. |
...
| <b>[zenity](https://github.com/ncruces/zenity) | 393 | Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user. |
| <b>[gowd](https://github.com/dtylman/gowd) | 387 | Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform. |
...
| <b>[sysinfo](https://github.com/zcalusic/sysinfo) | 405 | A pure Go library providing Linux OS / kernel / hardware system information. |
| <b>[goroslib](https://github.com/aler9/goroslib) | 246 | Robot Operating System (ROS) library for Go. |
...
| <b>[govips](https://github.com/davidbyttow/govips) | 816 | A lightning fast image processing and resizing library for Go. |
| <b>[image2ascii](https://github.com/qeesung/image2ascii) | 729 | Convert image to ASCII. |
| <b>[goimagehash](https://github.com/corona10/goimagehash) | 561 | Go Perceptual image hashing package. |
| <b>[draft](https://github.com/lucasepe/draft) | 559 | Generate High Level Microservice Architecture diagrams for GraphViz using simple YAML syntax. |
| <b>[govatar](https://github.com/o1egl/govatar) | 540 | Library and CMD tool for generating funny avatars. |
| <b>[mort](https://github.com/aldor007/mort) | 478 | Storage and image processing server written in Go. |
| <b>[go-nude](https://github.com/koyachi/go-nude) | 363 | Nudity detection with Go. |
...
| <b>[mergi](https://github.com/noelyahan/mergi) | 198 | Tool & Go library for image manipulation (Merge, Crop, Resize, Watermark, Animate). |
| <b>[gltf](https://github.com/qmuntal/gltf) | 188 | Efficient and robust glTF 2.0 reader, writer and validator. |
| <b>[steganography](https://github.com/auyer/steganography) | 176 | Pure Go Library for LSB steganography. |
| <b>[img](https://github.com/hawx/img) | 146 | Selection of image manipulation tools. |
| <b>[go-cairo](https://github.com/ungerik/go-cairo) | 125 | Go binding for the cairo graphics library. |
| <b>[go-webp](https://github.com/kolesa-team/go-webp) | 103 | Library for encode and decode webp pictures, using libwebp. |
| <b>[cameron](https://github.com/aofei/cameron) | 99 | An avatar generator for Go. |
...
| <b>[webp-server](https://github.com/mehdipourfar/webp-server) | 53 | Simple and minimal image server capable of storing, resizing, converting and caching images. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gobot](https://github.com/hybridgroup/gobot/) | 8.1k | Gobot is a framework for robotics, physical computing, and the Internet of Things. |
...
| <b>[connectordb](https://github.com/connectordb/connectordb) | 358 | Open-Source Platform for Quantified Self & IoT. |
| <b>[devices](https://github.com/goiot/devices) | 257 | Suite of libraries for IoT devices, experimental for x/exp/io. |
| <b>[huego](https://github.com/amimof/huego) | 230 | An extensive Philips Hue client library for Go. |
| <b>[sensorbee](https://github.com/sensorbee/sensorbee) | 218 | Lightweight stream processing engine for IoT. |
...
| <b>[JobRunner](https://github.com/bamzi/jobrunner) | 949 | Smart and featureful cron job scheduler with job queuing and live monitoring built in. |
| <b>[gron](https://github.com/roylee0704/gron) | 946 | Define time-based tasks using a simple Go API and Gron’s scheduler will run them accordingly. |
| <b>[Dagu](https://github.com/dagu-go/dagu) | 561 | No-code workflow executor. it executes DAGs defined in a simple YAML format. |
...
| <b>[gronx](https://github.com/adhocore/gronx) | 242 | Cron expression parser, task runner and daemon consuming crontab like task list. |
...
| <b>[tasks](https://github.com/madflojo/tasks) | 134 | An easy to use in-process scheduler for recurring tasks in Go. |
| <b>[clockwerk](https://github.com/onatm/clockwerk) | 131 | Go package to schedule periodic jobs using a simple, fluent syntax. |
| <b>[goflow](https://github.com/fieldryand/goflow) | 95 | A workflow orchestrator and scheduler for rapid prototyping of ETL/ML/AI pipelines. |
| <b>[leprechaun](https://github.com/kilgaloon/leprechaun) | 94 | Job scheduler that supports webhooks, crons and classic scheduling. |
| <b>[cheek](https://github.com/datarootsio/cheek) | 69 | A simple crontab like scheduler that aims to offer a KISS approach to job scheduling. |
| <b>[cdule](https://github.com/deepaksinghvi/cdule) | 29 | Job scheduler library with database support |
...
| <b>[OjG](https://github.com/ohler55/ojg) | 551 | Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath. |
| <b>[marshmallow](https://github.com/PerimeterX/marshmallow) | 262 | Performant JSON unmarshaling for flexible use cases. |
| <b>[kazaam](https://github.com/Qntfy/kazaam) | 249 | API for arbitrary transformation of JSON documents. |
| <b>[jsondiff](https://github.com/wI2L/jsondiff) | 216 | JSON diff library for Go based on RFC6902 (JSON Patch). |
| <b>[gojq](https://github.com/elgs/gojq) | 184 | JSON query in Golang. |
| <b>[ajson](https://github.com/spyzhov/ajson) | 145 | Abstract JSON for golang with JSONPath support. |
...
| <b>[ask](https://github.com/simonnilsson/ask) | 23 | Easy access to nested values in maps and slices. Works in combination with encoding/json and other packages that "Unmarshal" arbitrary data into Go data-types. |
| <b>[jscan](https://github.com/romshark/jscan) | 16 | High performance zero-allocation JSON iterator. |
...
| <b>[zerolog](https://github.com/rs/zerolog) | 7.5k | Zero-allocation JSON logger. |
| <b>[spew](https://github.com/davecgh/go-spew) | 5.4k | Implements a deep pretty printer for Go data structures to aid in debugging. |
| <b>[lumberjack](https://github.com/natefinch/lumberjack) | 3.8k | Simple rolling logger, implements io.WriteCloser. |
...
| <b>[phuslu/log](https://github.com/phuslu/log) | 465 | Structured Logging Made Easy. |
| <b>[onelog](https://github.com/francoispqt/onelog) | 403 | Onelog is a dead simple but very efficient JSON logger. It is the fastest JSON logger out there in all scenarios. Also, it is one of the logger with the lowest allocation. |
...
| <b>[httpretty](https://github.com/henvic/httpretty) | 282 | Pretty-prints your regular HTTP requests on your terminal for debugging (similar to http.DumpRequest). |
| <b>[log](https://github.com/go-playground/log) | 282 | Simple, configurable and scalable Structured Logging for Go. |
| <b>[sqldb-logger](https://github.com/simukti/sqldb-logger) | 280 | A logger for Go SQL database driver without modify existing *sql.DB stdlib usage. |
| <b>[rollingwriter](https://github.com/arthurkiller/rollingWriter) | 251 | RollingWriter is an auto-rotate `io.Writer` implementation with multi policies to provide log file rotation. |
| <b>[logur](https://github.com/logur/logur) | 187 | An opinionated logger interface and collection of logging best practices with adapters and integrations for well-known libraries ([logrus](https://github.com/sirupsen/logrus), [go-kit log](https://github.com/go-kit/kit/tree/master/log), [zap](https://github.com/uber-go/zap), [zerolog](https://github.com/rs/zerolog), etc). |
| <b>[glg](https://github.com/kpango/glg) | 175 | glg is simple and fast leveled logging library for Go. |
| <b>[slog](https://github.com/gookit/slog) | 168 | Lightweight, configurable, extensible logger for Go. |
...
| <b>[noodlog](https://github.com/gyozatech/noodlog) | 43 | Parametrized JSON logging library which lets you obfuscate sensitive data and marshal any kind of content. No more printed pointers instead of values, nor escape chars for the JSON strings. |
...
| <b>[xylog](https://github.com/xybor-x/xylog) | 12 | Leveled and structured logging, dynamic fields, high performance, zone management, simple configuration, and readable syntax. |
...
| <b>[gosseract](https://github.com/otiai10/gosseract) | 2.0k | Go package for OCR (Optical Character Recognition), by using Tesseract C++ library. |
| <b>[goml](https://github.com/cdipaolo/goml) | 1.4k | On-line Machine Learning in Go. |
| <b>[eaopt](https://github.com/MaxHalford/eaopt) | 824 | An evolutionary optimization library. |
...
| <b>[ocrserver](https://github.com/otiai10/ocrserver) | 543 | A simple OCR API server, seriously easy to be deployed by Docker and Heroku. |
| <b>[gobrain](https://github.com/goml/gobrain) | 531 | Neural Networks written in go. |
| <b>[onnx-go](https://github.com/owulveryck/onnx-go) | 461 | Go Interface to Open Neural Network Exchange (ONNX). |
| <b>[go-deep](https://github.com/patrikeh/go-deep) | 408 | A feature-rich neural network library in Go. |
| <b>[regommend](https://github.com/muesli/regommend) | 301 | Recommendation & collaborative filtering engine. |
| <b>[Goptuna](https://github.com/c-bata/goptuna) | 229 | Bayesian optimization framework for black-box functions written in Go. Everything will be optimized. |
...
| <b>[goscore](https://github.com/asafschers/goscore) | 86 | Go Scoring API for PMML. |
| <b>[gonet](https://github.com/dathoangnd/gonet) | 77 | Neural Network for Go. |
| <b>[fonet](https://github.com/Fontinalis/fonet) | 73 | A Deep Neural Network library written in Go. |
...
| <b>[GoMind](https://github.com/surenderthakran/gomind) | 43 | A simplistic Neural Network Library in Go. |
...
| <b>[gorush](https://github.com/appleboy/gorush) | 6.8k | Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm). |
...
| <b>[Benthos](https://github.com/Jeffail/benthos) | 5.6k | A message streaming bridge between a range of protocols. |
| <b>[Asynq](https://github.com/hibiken/asynq) | 5.2k | A simple, reliable, and efficient distributed task queue for Go built on top of Redis. |
...
| <b>[Confluent Kafka Golang Client](https://github.com/confluentinc/confluent-kafka-go) | 3.8k | confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform. |
...
| <b>[Chanify](https://github.com/chanify/chanify) | 992 | A push notification server send message to your iOS devices. |
| <b>[Gollum](https://github.com/trivago/gollum) | 927 | A n:m multiplexer that gathers messages from different sources and broadcasts them to a set of destinations. |
| <b>[dbus](https://github.com/godbus/dbus) | 808 | Native Go bindings for D-Bus. |
| <b>[amqp](https://github.com/rabbitmq/amqp091-go) | 691 | Go RabbitMQ Client Library. |
| <b>[golongpoll](https://github.com/jcuga/golongpoll) | 620 | HTTP longpoll server library that makes web pub-sub simple. |
| <b>[mangos](https://github.com/nanomsg/mangos) | 569 | Pure go implementation of the Nanomsg ("Scalability Protocols") with transport interoperability. |
| <b>[emitter](https://github.com/olebedev/emitter) | 448 | Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins. |
| <b>[Glue](https://github.com/desertbit/glue) | 408 | Robust Go and Javascript Socket Library (Alternative to Socket.io). |
| <b>[pubsub](https://github.com/tuxychandru/pubsub) | 387 | Simple pubsub package for go. |
| <b>[Quamina](https://github.com/timbray/quamina) | 296 | Fast pattern-matching for filtering messages and events. |
| <b>[Bus](https://github.com/mustafaturan/bus) | 283 | Minimalist message bus implementation for internal communication. |
...
| <b>[Ratus](https://github.com/hyperonym/ratus) | 69 | Ratus is a RESTful asynchronous task queue server. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[google/wire](https://github.com/google/wire) | 9.8k | Automated Initialization in Go. |
...
| <b>[do](https://github.com/samber/do) | 768 | A dependency injection framework based on Generics. |
| <b>[GoLobby/Container](https://github.com/golobby/container) | 413 | GoLobby Container is a lightweight yet powerful IoC dependency injection container for the Go programming language. |
| <b>[goioc/di](https://github.com/goioc/di) | 231 | Spring-inspired Dependency Injection Container. |
| <b>[di](https://github.com/goava/di) | 169 | A dependency injection container for go programming language. |
| <b>[dingo](https://github.com/i-love-flamingo/dingo) | 155 | A dependency injection toolkit for Go, based on Guice. |
...
| <b>[ardanlabs/service](https://github.com/ardanlabs/service) | 2.6k | A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications. |
| <b>[modern-go-application](https://github.com/sagikazarmark/modern-go-application) | 1.5k | Go application boilerplate and example applying modern practices. |
| <b>[pagoda](https://github.com/mikestefanello/pagoda) | 661 | Rapid, easy full-stack web development starter kit built in Go. |
| <b>[cookiecutter-golang](https://github.com/lacion/cookiecutter-golang) | 572 | A Go application boilerplate template for quick starting projects following production best practices. |
| <b>[golang-templates/seed](https://github.com/golang-templates/seed) | 357 | Go application GitHub repository template. |
| <b>[go-starter](https://github.com/allaboutapps/go-starter) | 296 | An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers. |
| <b>[go-todo-backend](https://github.com/Fs02/go-todo-backend) | 193 | Go Todo Backend example using modular project layout for product microservice. |
...
| <b>[go-sample](https://github.com/zitryss/go-sample) | 116 | A sample layout for Go application projects with the real code. |
| <b>[gobase](https://github.com/wajox/gobase) | 44 | A simple skeleton for golang application with basic setup for real golang application. |
...
| <b>[sttr](https://github.com/abhimanyu003/sttr) | 637 | cross-platform, cli app to perform various operations on string. |
| <b>[strutil](https://github.com/ozgio/strutil) | 195 | String utilities. |
| <b>[gobeam/Stringy](https://github.com/gobeam/Stringy) | 152 | String manipulation library to convert string to camel case, snake case, kebab case / slugify etc. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gopsutil](https://github.com/shirou/gopsutil) | 8.6k | Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc). |
...
| <b>[base64Captcha](https://github.com/mojocn/base64Captcha) | 1.7k | Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha. |
| <b>[go-resiliency](https://github.com/eapache/go-resiliency) | 1.7k | Resiliency patterns for golang. |
...
| <b>[llvm](https://github.com/llir/llvm) | 1000 | Library for interacting with LLVM IR in pure Go. |
| <b>[shortid](https://github.com/teris-io/shortid) | 834 | Distributed generation of super short, unique, non-sequential, URL friendly IDs. |
| <b>[health](https://github.com/alexliesenfeld/health) | 639 | A simple and flexible health check library for Go. |
| <b>[shoutrrr](https://github.com/containrrr/shoutrrr) | 543 | Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others. |
| <b>[stateless](https://github.com/qmuntal/stateless) | 528 | A fluent library for creating state machines. |
| <b>[health](https://github.com/dimiro1/health) | 444 | Easy to use, extensible health check library. |
| <b>[banner](https://github.com/dimiro1/banner) | 416 | Add beautiful banners into your Go applications. |
| <b>[xz](https://github.com/ulikunitz/xz) | 400 | Pure golang package for reading and writing xz-compressed files. |
...
| <b>[ffmt](https://github.com/go-ffmt/ffmt) | 287 | Beautify data display for Humans. |
| <b>[lk](https://github.com/hyperboloide/lk) | 272 | A simple licensing library for golang. |
| <b>[healthcheck](https://github.com/etherlabsio/healthcheck) | 247 | An opinionated and concurrent health-check HTTP handler for RESTful services. |
| <b>[antch](https://github.com/antchfx/antch) | 244 | A fast, powerful and extensible web crawling & scraping framework. |
| <b>[go-unarr](https://github.com/gen2brain/go-unarr) | 222 | Decompression library for RAR, TAR, ZIP and 7z archives. |
| <b>[battery](https://github.com/distatus/battery) | 214 | Cross-platform, normalized battery information library. |
| <b>[bitio](https://github.com/icza/bitio) | 206 | Highly optimized bit-level Reader and Writer for Go. |
...
| <b>[gtree](https://github.com/ddddddO/gtree) | 89 | Provide CLI and Package for tree output and directories creation from Markdown or programmatically. |
| <b>[morse](https://github.com/alwindoss/morse) | 76 | Library to convert to and from morse code. |
| <b>[persian](https://github.com/mavihq/persian) | 69 | Some utilities for Persian language in go. |
| <b>[faker](https://github.com/pioz/faker) | 68 | Random fake data and struct generator for Go. |
...
| <b>[gosh](https://github.com/osamingo/gosh) | 33 | Provide Go Statistics Handler, Struct, Measure Method. |
...
| <b>[kagome](https://github.com/ikawaha/kagome) | 704 | JP morphological analyzer written in pure Go. |
| <b>[nlp](https://github.com/james-bowman/nlp) | 387 | Go Natural Language Processing library supporting LSA (Latent Semantic Analysis). |
...
| <b>[govader](https://github.com/jonreiter/govader) | 29 | Go implementation of [VADER Sentiment Analysis](https://github.com/cjhutto/vaderSentiment). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[slug](https://github.com/gosimple/slug) | 909 | URL-friendly slugify with multiple languages support. |
...
| <b>[gotext](https://github.com/leonelquinteros/gotext) | 366 | GNU gettext utilities for Go. |
...
| <b>[iuliia-go](https://github.com/mehanizm/iuliia-go) | 36 | Transliterate Cyrillic → Latin in every possible way. |
...
| <b>[spreak](https://github.com/vorlif/spreak) | 16 | Flexible translation and humanization library for Go, based on the concepts behind gettext. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-unidecode](https://github.com/mozillazg/go-unidecode) | 102 | ASCII transliterations of Unicode text. |
| <b>[gounidecode](https://github.com/fiam/gounidecode) | 77 | Unicode transliterator (also known as unidecode) for Go. |
...
| <b>[quic-go](https://github.com/lucas-clemente/quic-go) | 7.7k | An implementation of the QUIC protocol in pure Go. |
| <b>[gnet](https://github.com/panjf2000/gnet) | 7.3k | `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go. |
...
| <b>[mdns](https://github.com/hashicorp/mdns) | 935 | Simple mDNS (Multicast DNS) client/server library in Golang. |
| <b>[gosnmp](https://github.com/soniah/gosnmp) | 929 | Native Go library for performing SNMP actions. |
| <b>[vssh](https://github.com/yahoo/vssh) | 883 | Go library for building network and server automation over SSH protocol. |
| <b>[gmqtt](https://github.com/DrmagicE/gmqtt) | 820 | Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1. |
| <b>[cidranger](https://github.com/yl2chen/cidranger) | 780 | Fast IP to CIDR lookup for Go. |
| <b>[lhttp](https://github.com/fanux/lhttp) | 679 | Powerful websocket framework, build your IM server more easily. |
| <b>[peerdiscovery](https://github.com/schollz/peerdiscovery) | 578 | Pure Go library for cross-platform local peer discovery using UDP multicast. |
| <b>[easytcp](https://github.com/DarthPestilane/easytcp) | 553 | A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful. |
| <b>[go-stun](https://github.com/ccding/go-stun) | 548 | Go implementation of the STUN client (RFC 3489 and RFC 5389). |
...
| <b>[winrm](https://github.com/masterzen/winrm) | 390 | Go WinRM client to remotely execute commands on Windows machines. |
| <b>[ftpserverlib](https://github.com/fclairamb/ftpserverlib) | 341 | Fully featured FTP server library. |
...
| <b>[ethernet](https://github.com/mdlayher/ethernet) | 250 | Package ethernet implements marshaling and unmarshaling of IEEE 802.3 Ethernet II frames and IEEE 802.1Q VLAN tags. |
| <b>[dnsmonster](https://github.com/mosajjal/dnsmonster) | 242 | Passive DNS Capture/Monitoring Framework. |
...
| <b>[jazigo](https://github.com/udhos/jazigo) | 189 | Jazigo is a tool written in Go for retrieving configuration for multiple network devices. |
...
| <b>[iplib](https://github.com/c-robinson/iplib) | 99 | Library for working with IP addresses (net.IP, net.IPNet), inspired by python [ipaddress](https://docs.python.org/3/library/ipaddress.html) and ruby [ipaddr](https://ruby-doc.org/stdlib-2.5.1/libdoc/ipaddr/rdoc/IPAddr.html) |
| <b>[gldap](https://github.com/jimlambrt/gldap) | 83 | gldap provides an ldap server implementation and you provide handlers for its ldap operations. |
...
| <b>[go-powerdns](https://github.com/joeig/go-powerdns) | 68 | PowerDNS API bindings for Golang. |
| <b>[linkio](https://github.com/ian-kent/linkio) | 53 | Network link speed simulation for Reader/Writer interfaces. |
| <b>[portproxy](https://github.com/aybabtme/portproxy) | 52 | Simple TCP proxy which adds CORS support to API's which don't support it. |
| <b>[fullproxy](https://github.com/shoriwe/fullproxy) | 42 | A fully featured scriptable and daemon configurable proxy and pivoting toolkit with SOCKS5, HTTP, raw ports and reverse proxy protocols. |
| <b>[panoptes-stream](https://github.com/yahoo/panoptes-stream) | 38 | A cloud native distributed streaming network telemetry (gNMI, Juniper JTI and Cisco MDT). |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[resty](https://github.com/go-resty/resty) | 7.2k | Simple HTTP and REST client for Go inspired by Ruby rest-client. |
| <b>[req](https://github.com/imroc/req) | 3.0k | Simple Go HTTP client with Black Magic (Less code and More efficiency). |
...
| <b>[gentleman](https://github.com/h2non/gentleman) | 992 | Full-featured plugin-driven HTTP client library. |
| <b>[pester](https://github.com/sethgrid/pester) | 614 | Go HTTP client calls with retries, backoff, and concurrency. |
| <b>[requests](https://github.com/carlmjohnson/requests) | 494 | HTTP requests for Gophers. Uses context.Context and doesn't hide the underlying net/http.Client, making it compatible with standard Go APIs. Also includes testing tools. |
| <b>[go-cleanhttp](https://github.com/hashicorp/go-cleanhttp) | 276 | Get easily stdlib HTTP client, which does not share any state with other clients. |
...
| <b>[go-otelroundtripper](https://github.com/NdoleStudio/go-otelroundtripper) | 69 | Go http.RoundTripper that emits open telemetry metrics for HTTP requests. |
| <b>[go-http-client](https://github.com/bozd4g/go-http-client) | 52 | Make http calls simply and easily. |
| <b>[rq](https://github.com/ddo/rq) | 45 | A nicer interface for golang stdlib HTTP client. |
| <b>[httpretry](https://github.com/ybbus/httpretry) | 28 | Enriches the default go HTTP client with retry functionality. |
| <b>[go-zoox/fetch](https://github.com/go-zoox/fetch) | 26 | A Powerful, Lightweight, Easy Http Client, inspired by Web Fetch API. |
...
| <b>[gl](https://github.com/go-gl/gl) | 948 | Go bindings for OpenGL (generated via glow). |
| <b>[mathgl](https://github.com/go-gl/mathgl) | 470 | Pure Go math package specialized for 3D math, with inspiration from GLM. |
...
| <b>[go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) | 912 | A flexible and powerful SQL string builder library plus a zero-config ORM. |
...
| <b>[rel](https://github.com/go-rel/rel) | 615 | Modern Database Access Layer for Golang - Testable, Extendable and Crafted Into a Clean and Elegant API. |
...
| <b>[golobby/orm](https://github.com/golobby/orm) | 121 | Simple, fast, type-safe, generic orm for developer happiness. |
...
| <b>[gup](https://github.com/nao1215/gup) | 166 | Update binaries installed by "go install". |
...
| <b>[pixie](https://github.com/pixie-labs/pixie) | 4.2k | No instrumentation tracing for Golang applications via eBPF. |
...
| <b>[go-instrument](https://github.com/nikolaydubina/go-instrument) | 66 | Automatically add spans to all methods and functions. |
...
| <b>[graphql](https://github.com/neelance/graphql-go) | 4.4k | GraphQL server with a focus on ease of use. |
| <b>[dasel](https://github.com/tomwright/dasel) | 4.0k | Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies. |
| <b>[gojsonq](https://github.com/thedevsaddam/gojsonq) | 2.0k | A simple Go package to Query over JSON Data. |
| <b>[rql](https://github.com/a8m/rql) | 276 | Resource Query Language for REST API. |
| <b>[jsonql](https://github.com/elgs/jsonql) | 261 | JSON query expression library in Golang. |
...
| <b>[rqp](https://github.com/timsolov/rest-query-parser) | 51 | Query Parser for REST API. Filtering, validations, both `AND`, `OR` operations are supported directly in the query. |
...
| <b>[jsonpath](https://github.com/AsaiYusuke/jsonpath) | 14 | A query library for retrieving part of JSON based on JSONPath syntax. |
...
| <b>[fileb0x](https://github.com/UnnoTed/fileb0x) | 623 | Simple tool to embed files in go with focus on "customization" and ease to use. |
...
| <b>[gonum/plot](https://github.com/gonum/plot) | 2.4k | gonum/plot provides an API for building and drawing plots in Go. |
...
| <b>[dataframe-go](https://github.com/rocketlaunchr/dataframe-go) | 925 | Dataframes for machine-learning and statistics (similar to pandas). |
| <b>[go-dsp](https://github.com/mjibson/go-dsp) | 803 | Digital Signal Processing for Go. |
| <b>[chart](https://github.com/vdobler/chart) | 750 | Simple Chart Plotting library for Go. Supports many graphs types. |
| <b>[goraph](https://github.com/gyuho/goraph) | 706 | Pure Go graph theory library(data structure, algorithm visualization). |
| <b>[graph](https://github.com/yourbasic/graph) | 617 | Library of basic graph algorithms. |
| <b>[orb](https://github.com/paulmach/orb) | 611 | 2D geometry types with clipping, GeoJSON and Mapbox Vector Tile support. |
| <b>[ewma](https://github.com/VividCortex/ewma) | 401 | Exponentially-weighted moving averages. |
| <b>[calendarheatmap](https://github.com/nikolaydubina/calendarheatmap) | 368 | Calendar heatmap in plain Go inspired by Github contribution activity. |
| <b>[gohistogram](https://github.com/VividCortex/gohistogram) | 170 | Approximate histograms for data streams. |
| <b>[TextRank](https://github.com/DavidBelicza/TextRank) | 170 | TextRank implementation in Golang with extendable features (summarization, weighting, phrase extraction) and multithreading (goroutine) support. |
...
| <b>[pagerank](https://github.com/alixaxel/pagerank) | 78 | Weighted PageRank algorithm implemented in Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[age](https://github.com/FiloSottile/age) | 13.0k | A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability. |
...
| <b>[Coraza](https://github.com/corazawaf/coraza) | 853 | Enterprise-ready, modsecurity and OWASP CRS compatible WAF library. |
| <b>[dongle](https://github.com/golang-module/dongle) | 587 | A simple, semantic and developer-friendly golang package for encoding&decoding and encryption&decryption. |
| <b>[nacl](https://github.com/kevinburke/nacl) | 531 | Go implementation of the NaCL set of API's. |
| <b>[go-password-validator](https://github.com/lane-c-wagner/go-password-validator) | 373 | Password validator based on raw cryptographic entropy values. |
| <b>[ssh-vault](https://github.com/ssh-vault/ssh-vault) | 367 | encrypt/decrypt using ssh keys. |
| <b>[firewalld-rest](https://github.com/prashantgupta24/firewalld-rest) | 330 | A rest application to dynamically update firewalld rules on a linux server. |
...
| <b>[go-yara](https://github.com/hillu/go-yara) | 283 | Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)". |
...
| <b>[secureio](https://github.com/xaionaro-go/secureio) | 27 | An keyexchanging+authenticating+encrypting wrapper and multiplexer for `io.ReadWriteCloser` based on XChaCha20-poly1305, ECDH and ED25519. |
...
| <b>[cbor](https://github.com/fxamacker/cbor) | 519 | Small, safe, and easy CBOR encoding and decoding library. |
| <b>[go-capnproto](https://github.com/glycerine/go-capnproto) | 287 | Cap'n Proto library and parser for go. |
| <b>[php_session_decoder](https://github.com/yvasiyarov/php_session_decoder) | 156 | GoLang library for working with PHP session format and PHP Serialize/Unserialize functions. |
...
| <b>[SFTPGo](https://github.com/drakkan/sftpgo) | 5.4k | Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support. It can serve local filesystem and Cloud Storage backends such as S3 and Google Cloud Storage. |
| <b>[Easegress](https://github.com/megaease/easegress) | 5.0k | A cloud native high availability/performance traffic orchestration system with observability and extensibility. |
...
| <b>[Fider](https://github.com/getfider/fider) | 2.2k | Fider is an open platform to collect and organize customer feedback. |
...
| <b>[Wish](https://github.com/charmbracelet/wish) | 1.8k | Make SSH apps, just like that! |
...
| <b>[go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) | 572 | A feature flag solution, with only a YAML file in the backend (S3, GitHub, HTTP, local file ...), no server to install, just add a file in a central system and refer to it. |
| <b>[Euterpe](https://github.com/ironsmile/euterpe) | 457 | Self-hosted music streaming server with built-in web UI and REST API. |
...
| <b>[go-proxy-cache](https://github.com/fabiocicerchia/go-proxy-cache) | 83 | Simple Reverse Proxy with Caching, written in Go, using Redis. |
| <b>[lets-proxy2](https://github.com/rekby/lets-proxy2) | 71 | Reverse proxy for handle https with issue certificates in fly from lets-encrypt. |
| <b>[cortex-tenant](https://github.com/blind-oracle/cortex-tenant) | 61 | Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels. |
| <b>[psql-streamer](https://github.com/blind-oracle/psql-streamer) | 48 | Stream database events from PostgreSQL to Kafka. |
| <b>[nginx-prometheus](https://github.com/blind-oracle/nginx-prometheus) | 35 | Nginx log parser and exporter to Prometheus. |
...
| <b>[stream](https://github.com/youthlin/stream) | 71 | Go Stream, like Java 8 Stream: Filter/Map/FlatMap/Peek/Sorted/ForEach/Reduce... |
| <b>[goio](https://github.com/primetalk/goio) | 61 | An implementation of IO, Stream, Fiber for Golang, inspired by awesome Scala libraries cats and fs2. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sprig](https://github.com/Masterminds/sprig) | 3.4k | Useful template functions for Go templates. |
...
| <b>[jet](https://github.com/CloudyKit/jet) | 989 | Jet template engine. |
| <b>[maroto](https://github.com/johnfercher/maroto) | 899 | A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple. |
| <b>[Razor](https://github.com/sipin/gorazor) | 806 | Razor view engine for Golang. |
| <b>[fasttemplate](https://github.com/valyala/fasttemplate) | 677 | Simple and fast template engine. Substitutes template placeholders up to 10x faster than [text/template](https://golang.org/pkg/text/template/). |
| <b>[ego](https://github.com/benbjohnson/ego) | 544 | Lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled. |
| <b>[raymond](https://github.com/aymerick/raymond) | 509 | Complete handlebars implementation in Go. |
| <b>[goview](https://github.com/foolin/goview) | 320 | Goview is a lightweight, minimalist and idiomatic template library based on golang html/template for building Go web application. |
| <b>[liquid](https://github.com/osteele/liquid) | 189 | Go implementation of Shopify Liquid templates. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Testify](https://github.com/stretchr/testify) | 19.0k | Sacred extension to the standard go testing package. |
...
| <b>[testfixtures](https://github.com/go-testfixtures/testfixtures) | 895 | A helper for Rails' like test fixtures to test database applications. |
| <b>[goblin](https://github.com/franela/goblin) | 873 | Mocha like testing framework fo Go. |
| <b>[baloo](https://github.com/h2non/baloo) | 749 | Expressive and versatile end-to-end HTTP API testing made easy. |
| <b>[goc](https://github.com/qiniu/goc) | 614 | Goc is a comprehensive coverage testing system for The Go Programming Language. |
| <b>[go-mutesting](https://github.com/zimmski/go-mutesting) | 569 | Mutation testing for Go source code. |
| <b>[embedded-postgres](https://github.com/fergusstrange/embedded-postgres) | 503 | Run a real Postgres database locally on Linux, OSX or Windows as part of another Go application or test. |
| <b>[gofight](https://github.com/appleboy/gofight) | 430 | API Handler Testing for Golang Router framework. |
| <b>[testza](https://github.com/MarvinJWendt/testza) | 409 | Full-featured test framework with nice colorized output. |
| <b>[gotest.tools](https://github.com/gotestyourself/gotest.tools) | 386 | A collection of packages to augment the go testing package and support common patterns. |
| <b>[go-testdeep](https://github.com/maxatome/go-testdeep) | 339 | Extremely flexible golang deep comparison, extends the go testing package. |
| <b>[frisby](https://github.com/verdverm/frisby) | 274 | REST API testing framework. |
| <b>[got](https://github.com/ysmood/got) | 260 | An enjoyable golang test framework. |
| <b>[cupaloy](https://github.com/bradleyjkemp/cupaloy) | 250 | Simple snapshot testing addon for your test framework. |
| <b>[go-carpet](https://github.com/msoap/go-carpet) | 234 | Tool for viewing test coverage in terminal. |
| <b>[endly](https://github.com/viant/endly) | 233 | Declarative end to end functional testing. |
| <b>[commander](https://github.com/SimonBaeumer/commander) | 210 | Tool for testing cli applications on windows, linux and osx. |
| <b>[charlatan](https://github.com/percolate/charlatan) | 199 | Tool to generate fake interface implementations for tests. |
| <b>[go-hit](https://github.com/Eun/go-hit) | 167 | Hit is an http integration test framework written in golang. |
| <b>[dbcleaner](https://github.com/khaiql/dbcleaner) | 147 | Clean database for testing purpose, inspired by `database_cleaner` in Ruby. |
...
| <b>[jsonassert](https://github.com/kinbiko/jsonassert) | 102 | Package for verifying that your JSON payloads are serialized correctly. |
...
| <b>[be](https://github.com/carlmjohnson/be) | 53 | The minimalist generic test assertion library. |
| <b>[assert](https://github.com/go-playground/assert) | 52 | Basic Assertion Library used along side native go testing, with building blocks for custom assertions. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[gomock](https://github.com/golang/mock) | 8.4k | Mocking framework for the Go programming language. |
...
| <b>[hoverfly](https://github.com/SpectoLabs/hoverfly) | 2.0k | HTTP(S) proxy for recording and simulating REST/SOAP APIs with extensible middleware and easy-to-use CLI. |
...
| <b>[counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) | 774 | Tool for generating self-contained mock objects. |
| <b>[go-txdb](https://github.com/DATA-DOG/go-txdb) | 502 | Single transaction based database driver mainly for testing purposes. |
| <b>[minimock](https://github.com/gojuno/minimock) | 474 | Mock generator for Go interfaces. |
...
| <b>[mockit](https://github.com/pasdam/mockit) | 13 | Allows functions and method easy mocking, without defining new types; it's similar to Mockito for Java. |
...
| <b>[cdp](https://github.com/mafredri/cdp) | 656 | Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[failpoint](https://github.com/pingcap/failpoint) | 762 | An implementation of [failpoints](https://www.freebsd.org/cgi/man.cgi?query=fail) for Golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-humanize](https://github.com/dustin/go-humanize) | 3.5k | Formatters for time, numbers, and memory size to human readable format. |
| <b>[bytes](https://github.com/labstack/gommon/tree/master/bytes) | 484 | Formats and parses numeric byte values (10K, 2M, 3G, etc.). |
...
| <b>[htmlquery](https://github.com/antchfx/htmlquery) | 556 | An XPath query package for HTML, lets you extract data or evaluate from HTML documents by an XPath expression. |
| <b>[mxj](https://github.com/clbanning/mxj) | 540 | Encode / decode XML as JSON or map[string]interface{}; extract values with dot-notation paths and wildcards. Replaces x2j and j2x packages. |
| <b>[html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) | 440 | Convert HTML to Markdown. Even works with entire websites and can be extended through rules. |
| <b>[goq](https://github.com/andrewstuart/goq) | 223 | Declarative unmarshaling of HTML using struct tags with jQuery syntax (uses GoQuery). |
| <b>[bafi](https://github.com/mmalcek/bafi) | 71 | Universal JSON, BSON, YAML, XML translator to ANY format using templates. |
| <b>[go-output-format](https://github.com/drewstinnett/go-output-format) | 10 | Output go structures into multiple formats (YAML/JSON/etc) in your command line app. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[sh](https://github.com/mvdan/sh) | 5.4k | Shell parser and formatter. |
...
| <b>[commonregex](https://github.com/mingrammer/commonregex) | 847 | A collection of common regular expressions for Go. |
| <b>[omniparser](https://github.com/jf-tech/omniparser) | 534 | A versatile ETL library that parses text input (CSV/txt/JSON/XML/EDI/X12/EDIFACT/etc) in streaming fashion and transforms data into JSON output using data-driven schema. |
| <b>[gographviz](https://github.com/awalterschulze/gographviz) | 506 | Parses the Graphviz DOT language. |
| <b>[go-nmea](https://github.com/adrianmo/go-nmea) | 187 | NMEA parser library for the Go language. |
| <b>[sdp](https://github.com/gortc/sdp) | 113 | SDP: Session Description Protocol [[RFC 4566](https://tools.ietf.org/html/rfc4566)]. |
| <b>[editorconfig-core-go](https://github.com/editorconfig/editorconfig-core-go) | 112 | Editorconfig file parser and manipulator for Go. |
...
| <b>[go-fasttld](https://github.com/elliotwutingfeng/go-fasttld) | 14 | High performance top level domains (TLD) extraction module. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[rex](https://github.com/hedhyw/rex) | 130 | Regular expressions builder. |
| <b>[regroup](https://github.com/oriser/regroup) | 127 | Match regex expression named groups into go struct using struct tags and automatic parsing. |
...
| <b>[xurls](https://github.com/mvdan/xurls) | 999 | Extract urls from text. |
| <b>[dataflowkit](https://github.com/slotix/dataflowkit) | 564 | Web scraping Framework to turn websites into structured data. |
| <b>[gospider](https://github.com/zhshch2002/gospider) | 182 | A simple golang spider/scraping framework,build a spider in 3 lines. migrated from [goribot](https://github.com/zhshch2002/goribot) |
| <b>[pagser](https://github.com/foolin/pagser) | 80 | Pagser is a simple, extensible, configurable parse and deserialize html page to struct based on goquery and struct tags for golang crawler. |
| <b>[Tagify](https://github.com/zoomio/tagify) | 26 | Produces a set of tags from given source. |
| <b>[go-recipe](https://github.com/kkyr/go-recipe) | 15 | A package for scraping recipes from websites. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-runewidth](https://github.com/mattn/go-runewidth) | 508 | Functions to get fixed width of the character or string. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[github](https://github.com/google/go-github) | 9.1k | Go library for accessing the GitHub REST API v3. |
| <b>[aws-sdk-go](https://github.com/aws/aws-sdk-go) | 8.1k | The official AWS SDK for the Go programming language. |
| <b>[slack](https://github.com/slack-go/slack) | 4.2k | Slack API in Go. |
...
| <b>[google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) | 3.2k | Google Cloud APIs Go Client Library. |
...
| <b>[githubql](https://github.com/shurcooL/githubql) | 963 | Go library for accessing the GitHub GraphQL API v4. |
| <b>[webhooks](https://github.com/go-playground/webhooks) | 797 | Webhook receiver for GitHub and Bitbucket. |
| <b>[paypal](https://github.com/logpacker/PayPal-Go-SDK) | 557 | Wrapper for PayPal payment API. |
...
| <b>[twitter-scraper](https://github.com/n0madic/twitter-scraper) | 316 | Scrape the Twitter Frontend API without authentication and limits. |
| <b>[lark](https://github.com/chyroc/lark) | 279 | [Feishu](https://open.feishu.cn/)/[Lark](https://open.larksuite.com/) Open API Go SDK, Support ALL Open API and Event Callback. |
| <b>[ethrpc](https://github.com/onrik/ethrpc) | 247 | Go bindings for Ethereum JSON RPC API. |
| <b>[Trello](https://github.com/adlio/trello) | 208 | Go wrapper for the Trello API. |
| <b>[go-marathon](https://github.com/gambol99/go-marathon) | 197 | Go library for interacting with Mesosphere's Marathon PAAS. |
| <b>[wit-go](https://github.com/wit-ai/wit-go) | 137 | Go client for wit.ai HTTP API. |
...
| <b>[go-lark](https://github.com/go-lark/lark) | 126 | An easy-to-use unofficial SDK for [Feishu](https://open.feishu.cn/) and [Lark](https://open.larksuite.com/) Open Platform. |
...
| <b>[gosip](https://github.com/koltyakov/gosip) | 94 | Go client library SharePoint API. |
...
| <b>[go-unsplash](https://github.com/hbagdi/go-unsplash) | 70 | Go client library for the [Unsplash.com](https://unsplash.com) API. |
...
| <b>[golang-tmdb](https://github.com/cyruzin/golang-tmdb) | 65 | Golang wrapper for The Movie Database API v3. |
...
| <b>[go-atlassian](https://github.com/ctreminiom/go-atlassian) | 59 | Go library for accessing the [Atlassian Cloud](https://www.atlassian.com/enterprise/cloud) services (Jira, Jira Service Management, Jira Agile, Confluence, Admin Cloud) |
...
| <b>[uptimerobot](https://github.com/bitfield/uptimerobot) | 54 | Go wrapper and command-line client for the Uptime Robot v2 API. |
| <b>[google-play-scraper](https://github.com/n0madic/google-play-scraper) | 53 | Get data from Google Play Store. |
...
| <b>[airtable](https://github.com/mehanizm/airtable) | 47 | Go client library for the [Airtable API](https://airtable.com/api). |
...
| <b>[patreon-go](https://github.com/mxpv/patreon-go) | 34 | Go library for Patreon API. |
...
| <b>[jokeapi-go](https://github.com/icelain/jokeapi) | 20 | Go client for [JokeAPI](https://sv443.net/jokeapi/v2/). |
| <b>[GoFreeDB](https://github.com/FreeLeh/GoFreeDB) | 20 | Golang library providing common and simple database abstractions on top of Google Sheets. |
...
| <b>[coinpaprika-go](https://github.com/coinpaprika/coinpaprika-api-go-client) | 18 | Go client library for interacting with Coinpaprika's API. |
...
| <b>[lo](https://github.com/samber/lo) | 9.4k | A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...) |
...
| <b>[go-funk](https://github.com/thoas/go-funk) | 4.1k | Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...). |
...
| <b>[lancet](https://github.com/duke-git/lancet) | 2.0k | A comprehensive, efficient, and reusable util function library of go. |
| <b>[create-go-app](https://github.com/create-go-app/cli) | 1.8k | A powerful CLI for create a new production-ready project with backend (Golang), frontend (JavaScript, TypeScript) & deploy automation (Ansible, Docker) by running one command. |
...
| <b>[retry-go](https://github.com/avast/retry-go) | 1.4k | Simple library for retry mechanism. |
| <b>[circuitbreaker](https://github.com/rubyist/circuitbreaker) | 1000 | Circuit Breakers in Go. |
| <b>[git-time-metric](https://github.com/git-time-metric/gtm) | 925 | Simple, seamless, lightweight time tracking for Git. |
| <b>[mimetype](https://github.com/gabriel-vasile/mimetype) | 899 | Package for MIME type detection based on magic numbers. |
| <b>[hostctl](https://github.com/guumaster/hostctl) | 839 | A CLI tool to manage /etc/hosts with easy commands. |
| <b>[scany](https://github.com/georgysavva/scany) | 824 | Library for scanning data from a database into Go structs and more. |
| <b>[immortal](https://github.com/immortal/immortal) | 757 | \*nix cross-platform (OS agnostic) supervisor. |
...
| <b>[delve](https://github.com/derekparker/delve) | 555 | Go debugger. |
...
| <b>[clockwork](https://github.com/jonboulle/clockwork) | 429 | A simple fake clock for golang. |
| <b>[gubrak](https://github.com/novalagung/gubrak) | 424 | Golang utility library with syntactic sugar. It's like lodash, but for golang. |
| <b>[request](https://github.com/mozillazg/request) | 423 | Go HTTP Requests for Humans™. |
| <b>[changie](https://github.com/miniscruff/changie) | 410 | Automated changelog tool for preparing releases with lots of customization options. |
| <b>[Deepcopier](https://github.com/ulule/deepcopier) | 397 | Simple struct copying for Go. |
| <b>[go-rate](https://github.com/beefsack/go-rate) | 376 | Timed rate limiter for Go. |
| <b>[remote-touchpad](https://github.com/Unrud/remote-touchpad) | 357 | Control mouse and keyboard from a smartphone. |
| <b>[mani](https://github.com/alajmo/mani) | 334 | CLI tool to help you manage multiple repositories. |
| <b>[scan](https://github.com/blockloop/scan) | 333 | Scan golang `sql.Rows` directly to structs, slices, or primitive types. |
...
| <b>[clipboard](https://github.com/golang-design/clipboard) | 326 | 📋 cross-platform clipboard package in Go. |
| <b>[serve](https://github.com/syntaqx/serve) | 285 | A static http server anywhere you need. |
| <b>[util](https://github.com/shomali11/util) | 268 | Collection of useful utility functions. (strings, concurrency, manipulations, ...). |
| <b>[gohper](https://github.com/cosiner/gohper) | 255 | Various tools/modules help for development. |
| <b>[grofer](https://github.com/pesos/grofer) | 250 | A system and resource monitoring tool written in Golang! |
| <b>[gotenv](https://github.com/subosito/gotenv) | 245 | Load environment variables from `.env` or any `io.Reader` in Go. |
...
| <b>[wifiqr](https://github.com/reugn/wifiqr) | 227 | Wi-Fi QR Code Generator. |
| <b>[countries](https://github.com/biter777/countries) | 214 | Full implementation of ISO-3166-1, ISO-4217, ITU-T E.164, Unicode CLDR and IANA ccTLD standarts. |
| <b>[pattern-match](https://github.com/alexpantyukhin/go-pattern-match) | 197 | Pattern matching libray. |
| <b>[go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) | 191 | XML Sitemap generator written in Go. |
| <b>[rospo](https://github.com/ferama/rospo) | 190 | Simple and reliable ssh tunnels with embedded ssh server in Golang. |
...
| <b>[go-bsdiff](https://github.com/gabstv/go-bsdiff) | 138 | Pure Go bsdiff and bspatch libraries and CLI tools. |
...
| <b>[nostromo](https://github.com/pokanop/nostromo) | 128 | CLI for building powerful aliases. |
...
| <b>[filter](https://github.com/gookit/filter) | 118 | provide filtering, sanitizing, and conversion of Go data. |
| <b>[sorty](https://github.com/jfcg/sorty) | 117 | Fast Concurrent / Parallel Sorting. |
...
| <b>[goval](https://github.com/maja42/goval) | 102 | Evaluate arbitrary expressions in Go. |
...
| <b>[mimemagic](https://github.com/zRedShift/mimemagic) | 84 | Pure Go ultra performant MIME sniffing library/utility. |
...
| <b>[pgo](https://github.com/arthurkushman/pgo) | 75 | Convenient functions for PHP community. |
...
| <b>[dbt](https://github.com/nikogura/dbt) | 53 | A framework for running self-updating signed binaries from a central, trusted repository. |
...
| <b>[backscanner](https://github.com/icza/backscanner) | 43 | A scanner similar to bufio.Scanner, but it reads and returns lines in reverse order, starting at a given position and going backward. |
| <b>[go-httpheader](https://github.com/mozillazg/go-httpheader) | 43 | Go library for encoding structs into Header fields. |
| <b>[gpath](https://github.com/tenntenn/gpath) | 42 | Library to simplify access struct fields with Go's expression in reflection. |
| <b>[slicer](https://github.com/leaanthony/slicer) | 41 | Makes working with slices easier. |
...
| <b>[gostrutils](https://github.com/ik5/gostrutils) | 39 | Collections of string manipulation and conversion functions. |
...
| <b>[ghokin](https://github.com/antham/ghokin) | 31 | Parallelized formatter with no external dependencies for gherkin (cucumber, behat...). |
...
| <b>[ulid](https://github.com/oklog/ulid) | 3.2k | Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier). |
...
| <b>[uuid](https://github.com/gofrs/uuid) | 1.3k | Implementation of Universally Unique Identifier (UUID). Supports both creation and parsing of UUIDs. Actively maintained fork of satori uuid. |
| <b>[wuid](https://github.com/edwingeng/wuid) | 482 | An extremely fast unique number generator, 10-135 times faster than UUID. |
...
| <b>[ozzo-validation](https://github.com/go-ozzo/ozzo-validation) | 3.1k | Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags. |
...
| <b>[validate](https://github.com/gookit/validate) | 830 | Go package for data validation and filtering. support validate Map, Struct, Request(Form, JSON, url.Values, Uploaded Files) data and more features. |
...
| <b>[validate](https://github.com/gobuffalo/validate) | 80 | This package provides a framework for writing validations for Go applications. |
...
| <b>[valix](https://github.com/marrow16/valix) | 7 | Go package for validating requests |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-git](https://github.com/go-git/go-git) | 4.2k | highly extensible Git implementation in pure Go. |
...
| <b>[githooks](https://github.com/gabyx/githooks) | 60 | Per-repo and shared Git hooks with version control and auto update. |
| <b>[froggit-go](https://github.com/jfrog/froggit-go) | 28 | Froggit-Go is a Go library, allowing to perform actions on VCS providers. |
...
| <b>[m3u8](https://github.com/grafov/m3u8) | 988 | Parser and generator library of M3U8 playlists for Apple HLS. |
| <b>[gmf](https://github.com/3d0c/gmf) | 816 | Go bindings for FFmpeg av\* libraries. |
| <b>[go-astits](https://github.com/asticode/go-astits) | 458 | Parse and demux MPEG Transport Streams (.ts) natively in GO. |
| <b>[go-astisub](https://github.com/asticode/go-astisub) | 433 | Manipulate subtitles in GO (.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.). |
| <b>[gortsplib](https://github.com/aler9/gortsplib) | 340 | Pure Go RTSP server and client library. |
| <b>[libvlc-go](https://github.com/adrg/libvlc-go) | 329 | Go bindings for libvlc 2.X/3.X/4.X (used by the VLC media player). |
...
| <b>[go-m3u8](https://github.com/etherlabsio/go-m3u8) | 11 | Parser and generator library for Apple m3u8 playlists. Actively maintained version of quangngotan95/go-m3u8 with improvements and latest HLS playlist parsing compatibility. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Gin](https://github.com/gin-gonic/gin) | 66.0k | Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity. |
...
| <b>[Hertz](https://github.com/cloudwego/hertz) | 3.0k | A high-performance and strong-extensibility Go HTTP framework that helps developers build microservices. |
...
| <b>[Atreugo](https://github.com/savsgio/atreugo) | 992 | High performance and extensible micro web framework with zero memory allocations in hot paths. |
| <b>[tango](https://github.com/lunny/tango) | 832 | Micro & pluggable web framework for Go. |
| <b>[Gearbox](https://github.com/abahmed/gearbox) | 700 | A web framework written in Go with a focus on high performance and memory optimization. |
| <b>[Aero](https://github.com/aerogo/aero) | 511 | High-performance web framework for Go, reaches top scores in Lighthouse. |
| <b>[gongular](https://github.com/mustafaakin/gongular) | 477 | Fast Go web framework with input mapping/validation and (DI) Dependency Injection. |
...
| <b>[Flamingo Commerce](https://github.com/i-love-flamingo/flamingo-commerce) | 390 | Providing e-commerce features using clean architecture like DDD and ports and adapters, that you can use to build flexible e-commerce applications. |
...
| <b>[rk-boot](https://github.com/rookie-ninja/rk-boot) | 353 | A bootstrapper library for building enterprise go microservice with Gin and gRPC quickly and easily. |
| <b>[Flamingo](https://github.com/i-love-flamingo/flamingo) | 343 | Framework for pluggable web projects. Including a concept for modules and offering features for DI, Configareas, i18n, template engines, graphql, observability, security, events, routing & reverse routing etc. |
...
| <b>[Ginrpc](https://github.com/xxjwxc/ginrpc) | 248 | Gin parameter automatic binding tool,gin rpc tools. |
| <b>[uAdmin](https://github.com/uadmin/uadmin) | 225 | Fully featured web framework for Golang, inspired by Django. |
...
| <b>[Huma](https://github.com/danielgtaylor/huma/) | 180 | Framework for modern REST/GraphQL APIs with built-in OpenAPI 3, generated documentation, and a CLI. |
...
| <b>[Microservice](https://github.com/claygod/microservice) | 110 | The framework for the creation of microservices, written in Golang. |
...
| <b>[rux](https://github.com/gookit/rux) | 87 | Simple and fast web framework for build golang HTTP applications. |
...
| <b>[go-server-timing](https://github.com/mitchellh/go-server-timing) | 845 | Add/parse Server-Timing header. |
| <b>[go-fault](https://github.com/github/go-fault) | 472 | Fault injection middleware for Go. |
| <b>[ln-paywall](https://github.com/philippgille/ln-paywall) | 132 | Go middleware for monetizing APIs on a per-request basis with the Lightning Network (Bitcoin). |
...
| <b>[rk-gin](https://github.com/rookie-ninja/rk-gin) | 39 | Middleware for Gin framework with logging, metrics, auth, tracing etc. |
...
| <b>[renderer](https://github.com/thedevsaddam/renderer) | 250 | Simple, lightweight and faster response (JSON, JSONP, XML, YAML, HTML, File) rendering package for Go. |
...
| <b>[rye](https://github.com/InVisionApp/rye) | 99 | Tiny Go middleware library (with canned Middlewares) that supports JWT, CORS, Statsd, and Go 1.7 context. |
...
| <b>[Goji](https://github.com/goji/goji) | 928 | Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`. |
| <b>[fasthttprouter](https://github.com/buaazp/fasthttprouter) | 872 | High performance router forked from `httprouter`. The first router fit for `fasthttp`. |
| <b>[httptreemux](https://github.com/dimfeld/httptreemux) | 578 | High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter. |
...
| <b>[GoRouter](https://github.com/vardius/gorouter) | 144 | GoRouter is a Server/API micro framework, HTTP request router, multiplexer, mux that provides request router with middleware supporting `net/context`. |
...
| <b>[alien](https://github.com/gernest/alien) | 124 | Lightweight and fast http router from outer space. |
...
| <b>[goblin](https://github.com/bmf-san/goblin) | 49 | A golang http router based on trie tree. |
...
| <b>[nchi](https://github.com/muir/nchi) | 11 | chi-like router built on httprouter with dependency injection based middleware wrappers |
...
| <b>[dom](https://github.com/dennwc/dom) | 472 | DOM library. |
| <b>[go-canvas](https://github.com/markfarnan/go-canvas) | 194 | Library to use HTML5 Canvas, with all drawing within go code. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-ole](https://github.com/go-ole/go-ole) | 934 | Win32 OLE implementation for golang. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[zek](https://github.com/miku/zek) | 622 | Generate a Go struct from XML. |
| <b>[xpath](https://github.com/antchfx/xpath) | 532 | XPath package for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Cosign](https://github.com/sigstore/cosign) | 3.0k | Container Signing, Verification and Storage in an OCI registry. |
...
| <b>[in-toto](https://github.com/in-toto/in-toto-golang) | 74 | Go implementation of the in-toto (provides a framework to protect the integrity of the software supply chain) python reference implementation. |
| <b>[Spiffe-Vault](https://github.com/philips-labs/spiffe-vault) | 51 | Utilizes Spiffe JWT authentication with Hashicorp Vault for secretless authentication. |
...
| <b>[php-parser](https://github.com/z7zmey/php-parser) | 900 | A Parser for PHP written in Go. |
| <b>[go-cleanarch](https://github.com/roblaszczak/go-cleanarch) | 681 | go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects. |
| <b>[goast-viewer](https://github.com/yuroyoro/goast-viewer) | 678 | Web based Golang AST visualizer. |
| <b>[go-mod-outdated](https://github.com/psampaz/go-mod-outdated) | 607 | An easy way to find outdated dependencies of your Go projects. |
| <b>[golines](https://github.com/segmentio/golines) | 533 | Formatter that automatically shortens long lines in Go code. |
| <b>[todocheck](https://github.com/preslavmihaylov/todocheck) | 396 | Static code analyser which links TODO comments in code with issues in your issue tracker. |
...
| <b>[tickgit](https://github.com/augmentable-dev/tickgit) | 293 | CLI and go package for surfacing code comment TODOs (in any language) and applying a `git blame`to identify the author. |
...
| <b>[vscode-go](https://github.com/golang/vscode-go) | 3.2k | Extension for Visual Studio Code (VS Code) which provides support for the Go language. |
...
| <b>[coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) | 514 | This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) features to Vim/Neovim. |
| <b>[goimports-reviser](https://github.com/incu6us/goimports-reviser) | 247 | Formatting tool for imports. |
...
| <b>[xgen](https://github.com/xuri/xgen) | 212 | XSD (XML Schema Definition) parser and Go/C/Java/Rust/TypeScript code generator. |
...
| <b>[hasgo](https://github.com/DylanMeeus/hasgo) | 124 | Generate Haskell inspired functions for your slices. |
| <b>[gonerics](https://github.com/bouk/gonerics) | 115 | Idiomatic Generics in Go. |
| <b>[gocontracts](https://github.com/Parquery/gocontracts) | 94 | brings design-by-contract to Go by synchronizing the code with the documentation. |
| <b>[gounit](https://github.com/hexdigest/gounit) | 67 | Generate Go tests using your own templates. |
| <b>[generic](https://github.com/usk81/generic) | 46 | flexible data type for Go. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[go-swagger](https://github.com/go-swagger/go-swagger) | 8.3k | Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API. |
...
| <b>[depth](https://github.com/KyleBanks/depth) | 811 | Visualize dependency trees of any package by analyzing imports. |
| <b>[richgo](https://github.com/kyoh86/richgo) | 757 | Enrich `go test` outputs with text decorations. |
| <b>[rts](https://github.com/galeone/rts) | 237 | RTS: response to struct. Generates Go structs from server responses. |
| <b>[godbg](https://github.com/tylerwince/godbg) | 190 | Implementation of Rusts `dbg!` macro for quick and easy debugging during development. |
| <b>[typex](https://github.com/dtgorski/typex) | 176 | Examine Go types and their transitive dependencies, alternatively export results as TypeScript value objects (or types) declaration. |
| <b>[roumon](https://github.com/becheran/roumon) | 132 | Monitor current state of all active goroutines via a command line interface. |
...
| <b>[go-james](https://github.com/pieterclaerhout/go-james) | 57 | Go project skeleton creator, builds and tests your projects without the manual setup. |
...
| <b>[Mizu](https://github.com/up9inc/mizu) | 8.1k | API traffic viewer for Kubernetes enabling you to view all API communication between microservices, multiprotocol support: HTTP1.1, HTTP/2, AMQP, Kafka, Redis. |
| <b>[ko](https://github.com/google/ko) | 5.5k | Command line tool for building and deploying Go applications on Kubernetes |
| <b>[Ddosify](https://github.com/ddosify/ddosify) | 5.4k | High-performance load testing tool, written in Golang. |
...
| <b>[script](https://github.com/bitfield/script) | 3.7k | Making it easy to write shell-like scripts in Go for DevOps and system administration tasks. |
...
| <b>[s5cmd](https://github.com/peak/s5cmd) | 1.5k | Blazing fast S3 and local filesystem execution tool. |
...
| <b>[skm](https://github.com/TimothyYe/skm) | 836 | SKM is a simple and powerful SSH Keys Manager, it helps you to manage your multiple SSH keys easily! |
| <b>[uTask](https://github.com/ovh/utask) | 810 | Automation engine that models and executes business processes declared in yaml. |
| <b>[Scaleway-cli](https://github.com/scaleway/scaleway-cli) | 798 | Manage BareMetal Servers from Command Line (as easily as with Docker). |
| <b>[kwatch](https://github.com/abahmed/kwatch) | 711 | Monitor & detect crashes in your Kubernetes(K8s) cluster instantly. |
| <b>[cassowary](https://github.com/rogerwelin/cassowary) | 649 | Modern cross-platform HTTP load-testing tool written in Go. |
| <b>[kool](https://github.com/kool-dev/kool) | 618 | Command line tool for managing Docker environments as an easy way. |
...
| <b>[Pewpew](https://github.com/bengadbois/pewpew) | 367 | Flexible HTTP command line stress tester. |
| <b>[jcli](https://github.com/jenkins-zh/jenkins-cli) | 346 | Jenkins CLI allows you manage your Jenkins as an easy way. |
| <b>[gonative](https://github.com/inconshreveable/gonative) | 335 | Tool which creates a build of Go that can cross compile to all platforms while still using the Cgo-enabled versions of the stdlib packages. |
...
| <b>[lstags](https://github.com/ivanilves/lstags) | 303 | Tool and API to sync Docker images across different registries. |
| <b>[Balerter](https://github.com/balerter/balerter) | 279 | A self-hosted script-based alerting manager. |
| <b>[manssh](https://github.com/xwjdsh/manssh) | 276 | manssh is a command line tool for managing your ssh alias config easily. |
| <b>[easyssh-proxy](https://github.com/appleboy/easyssh-proxy) | 271 | Golang package for easy remote execution through SSH and SCP downloading via `ProxyCommand`. |
| <b>[dogo](https://github.com/liudng/dogo) | 254 | Monitoring changes in the source file and automatically compile and run (restart). |
| <b>[terraform-provider-openapi](https://github.com/dikhan/terraform-provider-openapi) | 230 | Terraform provider plugin that dynamically configures itself at runtime based on an OpenAPI document (formerly known as swagger file) containing the definitions of the APIs exposed. |
...
| <b>[abbreviate](https://github.com/dnnrly/abbreviate) | 194 | abbreviate is a tool turning long strings in to shorter ones with configurable seperaters, for example to embed branch names in to deployment stack IDs. |
| <b>[gobrew](https://github.com/cryptojuice/gobrew) | 193 | gobrew lets you easily switch between multiple versions of go. |
| <b>[kcli](https://github.com/cswank/kcli) | 190 | Command line tool for inspecting kafka topics/partitions/messages. |
...
| <b>[s3-proxy](https://github.com/oxyno-zeta/s3-proxy) | 154 | S3 Proxy with GET, PUT and DELETE methods and authentication (OpenID Connect and Basic Auth). |
...
| <b>[drone-scp](https://github.com/appleboy/drone-scp) | 117 | Copy files and artifacts via SSH using a binary, docker or Drone CI. |
...
| <b>[go-furnace](https://github.com/go-furnace/go-furnace) | 95 | Hosting solution written in Go. Deploy your Application with ease on AWS, GCP or DigitalOcean. |
...
| <b>[httpref](https://github.com/dnnrly/httpref) | 28 | httpref is a handy CLI reference for HTTP methods, status codes, headers, and TCP and UDP ports. |
...
| <b>[wait-for](https://github.com/dnnrly/wait-for) | 8 | Wait for something to happen (from the command line) before continuing. Easy orchestration of Docker services and other things. |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[croc](https://github.com/schollz/croc) | 22.0k | Easily and securely send files or folders from one computer to another. |
...
| <b>[Duplicacy](https://github.com/gilbertchen/duplicacy) | 4.5k | A cross-platform network and cloud backup tool based on the idea of lock-free deduplication. |
...
| <b>[Documize](https://github.com/documize/community) | 1.8k | Modern wiki software that integrates data from SaaS tools. |
...
| <b>[vFlow](https://github.com/VerizonDigital/vflow) | 950 | High-performance, scalable and reliable IPFIX, sFlow and Netflow collector. |
| <b>[Go Package Store](https://github.com/shurcooL/Go-Package-Store) | 895 | App that displays updates for the Go packages in your GOPATH. |
| <b>[peg](https://github.com/pointlander/peg) | 888 | Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator. |
...
| <b>[Gebug](https://github.com/moshebe/gebug) | 615 | A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly. |
| <b>[sake](https://github.com/alajmo/sake) | 586 | sake is a command runner for local and remote hosts. |
| <b>[gocc](https://github.com/goccmack/gocc) | 550 | Gocc is a compiler kit for Go written in Go. |
| <b>[mockingjay](https://github.com/quii/mockingjay-server) | 530 | Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests. |
| <b>[Gokapi](https://github.com/Forceu/gokapi) | 504 | Lightweight server to share files, which expire after a set amount of downloads or days. Similar to Firefox Send, but without public upload. |
| <b>[go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) | 453 | Video streaming torrent client. |
| <b>[woke](https://github.com/get-woke/woke) | 363 | Detect non-inclusive language in your source code. |
| <b>[ipe](https://github.com/dimiro1/ipe) | 362 | Open source Pusher server implementation compatible with Pusher client libraries written in GO. |
...
| <b>[Neo-cowsay](https://github.com/Code-Hex/Neo-cowsay) | 238 | 🐮 cowsay is reborn. for a New Era. |
| <b>[tcpdog](https://github.com/mehrdadrad/tcpdog) | 217 | eBPF based TCP observability. |
| <b>[joincap](https://github.com/assafmo/joincap) | 181 | Command-line utility for merging multiple pcap files together. |
| <b>[Orbit](https://github.com/gulien/orbit) | 174 | A simple tool for running commands and generating files from templates. |
| <b>[vaku](https://github.com/lingrino/vaku) | 143 | CLI & API for folder-based functions in Vault like copy, move, and search. |
| <b>[crawley](https://github.com/s0rg/crawley) | 117 | Web scraper/crawler for cli. |
| <b>[stew](https://github.com/marwanhawari/stew) | 113 | An independent package manager for compiled binaries. |
...
| <b>[hoofli](https://github.com/dnnrly/hoofli) | 7 | Generate PlantUML diagrams from Chrome or Firefox network inspections. |
...
| <b>[speedtest-resize](https://github.com/fawick/speedtest-resize) | 230 | Compare various Image resize algorithms for the Go language. |
...
| <b>[gopherize.me](https://github.com/matryer/gopherize.me) | 620 | Gopherize yourself. |
| <b>[gophericons](https://github.com/shalakhin/gophericons) | 609 | 34 gopher images for Go developers community |
| <b>[gopher-stickers](https://github.com/tenntenn/gopher-stickers) | 547 | gopher stickers |
...
| Repo | Stars | Description |
| :------ | :------ | :------ |
| <b>[Go Projects](https://github.com/golang/go/wiki/Projects) | 108.0k | List of projects on the Go community wiki. |
...
| <b>[go-clean-template](https://github.com/evrone/go-clean-template) | 4.4k | Clean Architecture template for Golang services. |
| <b>[Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) | 3.5k | Examples of Golang compared to Node.js for learning. |
...
| <b>[goapp](https://github.com/bnkamalesh/goapp) | 572 | An opinionated guideline to structure & develop a Go web application/service. |
| <b>[Go in 7 days](https://github.com/harrytran103/7_days_of_go) | 116 | Learn everything about Go in 7 days (from a Nodejs developer). |
| <b>[Design Patterns in Go](https://github.com/shubhamzanwar/design-patterns) | 95 | Collection of programming design patterns implemented in Go. |
